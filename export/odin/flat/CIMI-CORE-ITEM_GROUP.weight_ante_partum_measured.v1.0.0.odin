(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/8338-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Body weight Measured --ante partum' concept">
				use = <"Use for Body weight Measured --ante partum.">
				keywords = <"Wt", "Bdy weight", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "bod", "Bodies", "BODY WEIGHT.MOLEC", "BODY WEIGHT.MOLEC">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.weight_ante_partum_measured.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"weight_ante_partum_measured">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Body weight Measured --ante partum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[lb_av]">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258693003">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/8338-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/8338-6">
			>
		>
	>
	adl_version = <"2.0.5">
