(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33893-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Karyotype [Identifier] in Bone marrow Nominal' concept">
				use = <"Use for Karyotype [Identifier] in Bone marrow Nominal.">
				keywords = <"Karyotyp", "Karyogram", "Genotype", "Chromosome analysis", "Identity or presence", "Point in time", "Random", "BM", "Bone marrow", "BON", "Nominal", "Molecular pathology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.karyotyp_mar.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"karyotyp_mar">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Karyotype [Identifier] in Bone marrow Nominal">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33893-9">
			>
			["opencem"] = <
