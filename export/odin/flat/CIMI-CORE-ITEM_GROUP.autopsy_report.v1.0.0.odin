(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/18743-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Autopsy report' concept">
				use = <"Use for Autopsy report.">
				keywords = <"Finding", "Findings", "Point in time", "Random", "DOCUMENT.CLINICAL REPORT", "DOCUMENT.CLINICAL REPORT">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.autopsy_report.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"autopsy_report">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/18743-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/18743-5">
			>
		>
	>
	adl_version = <"2.0.5">
