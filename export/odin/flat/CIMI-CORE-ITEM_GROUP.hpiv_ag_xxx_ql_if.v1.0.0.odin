(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13327-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Parainfluenza virus Ag [Presence] in Unspecified specimen by Immunofluorescence' concept">
				use = <"Use for Parainfluenza virus Ag [Presence] in Unspecified specimen by Immunofluorescence.">
				keywords = <"HPIV", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ACIF", "FA", "Fluorescent antibody", "Immune fluorescence", "Fluoresent", "Immunoflour", "Immunofluor", "Immunofluorescence", "IFA", "Time Resolved Fluorescence", "Anticomplement Immunofluorescence", "TRF", "Antigen", "Antigens", "Parainflu", "Para", "Microbiology", "DFA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hpiv_ag_xxx_ql_if.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hpiv_ag_xxx_ql_if">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Parainfluenza virus Ag [Presence] in Unspecified specimen by Immunofluorescence">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Parainfluenza virus Ag [Presence] in Unspecified specimen by Immunofluorescence">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13327-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13327-2">
			>
		>
	>
	adl_version = <"2.0.5">
