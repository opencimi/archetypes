(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/28539-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Erythrocyte mean corpuscular hemoglobin [Entitic mass]' concept">
				use = <"Use for Erythrocyte mean corpuscular hemoglobin [Entitic mass].">
				keywords = <"Hgb", "Hb", "Haemoglobin", "MCH", "Erythrocytes", "Red blood corpusles", "Red blood corpuscle", "Red blood cell", "Red cell", "Red cells", "Discocyte", "Erc", "Red blood cells", "Entitic mass", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "Average", "Avg", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.mch_rbc_qn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"mch_rbc_qn">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/28539-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/28539-5">
			>
		>
	>
	adl_version = <"2.0.5">
