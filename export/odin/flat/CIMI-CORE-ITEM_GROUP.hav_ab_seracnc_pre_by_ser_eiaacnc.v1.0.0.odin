(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5183-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hepatitis A virus Ab [Units/volume] in Serum by Immunoassay' concept">
				use = <"Use for Hepatitis A virus Ab [Units/volume] in Serum by Immunoassay.">
				keywords = <"Hep A", "HAV", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Hepatit", "Hepatis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hav_ab_seracnc_pre_by_ser_eiaacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hav_ab_seracnc_pre_by_ser_eiaacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hepatitis A virus Ab [Units/volume] in Serum by Immunoassay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{Index_val}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5183-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5183-9">
			>
		>
	>
	adl_version = <"2.0.5">
