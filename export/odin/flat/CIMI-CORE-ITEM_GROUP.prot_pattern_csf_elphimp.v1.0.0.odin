(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49295-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Protein Fractions [interpretation] in Cerebral spinal fluid by Electrophoresis Narrative' concept">
				use = <"Use for Protein Fractions [interpretation] in Cerebral spinal fluid by Electrophoresis Narrative.">
				keywords = <"Prot Pattern", "Protein fractions", "PR", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Cerebral spinal fluid", "Spinal Fluid", "Cerebrospinal Fl", "Spinal Flu", "Spinal Fld", "Narrative", "Report", "Elph", "Elp", "Elect", "Electrophrs", "Electrophhrs", "Electr", "Elec", "Ep", "Electro", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.prot_pattern_csf_elphimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"prot_pattern_csf_elphimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Protein Fractions [interpretation] in Cerebral spinal fluid by Electrophoresis Narrative">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Protein Fractions [interpretation] in Cerebral spinal fluid by Electrophoresis Narrative">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49295-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49295-9">
			>
		>
	>
	adl_version = <"2.0.5">
