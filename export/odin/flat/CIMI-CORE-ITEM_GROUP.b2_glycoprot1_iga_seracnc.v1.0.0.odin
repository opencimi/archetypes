(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/21108-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Beta 2 glycoprotein 1 IgA Ab [Units/volume] in Serum' concept">
				use = <"Use for Beta 2 glycoprotein 1 IgA Ab [Units/volume] in Serum.">
				keywords = <"Immune globulin A", "Immunoglobulin A", "B2GPI", "Apolipoprotein H", "APOH", "B2 glycoprotein 1", "B2-GPI", "B2 Glycoprot1", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Glycoprot", "Glycoproteins", "gG", "GP", "B", "II", "I", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.b2_glycoprot1_iga_seracnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"b2_glycoprot1_iga_seracnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Beta 2 glycoprotein 1 IgA Ab [Units/volume] in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[arb'U]/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/21108-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/21108-6">
			>
		>
	>
	adl_version = <"2.0.5">
