(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1003-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Indirect antiglobulin test.complement specific reagent [Presence] in Serum or Plasma' concept">
				use = <"Use for Indirect antiglobulin test.complement specific reagent [Presence] in Serum or Plasma.">
				keywords = <"IAT Comp-Sp Reag", "Ind Coombs", "IDC", "IAGT", "Indirect Coomb", "Indirect Coombs", "Complmt", "Comp", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Antiglob", "Spec", "Indir", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.iat_compsp_reag_serpl_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"iat_compsp_reag_serpl_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Indirect antiglobulin test.complement specific reagent [Presence] in Serum or Plasma">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Indirect antiglobulin test.complement specific reagent [Presence] in Serum or Plasma">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1003-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1003-3">
			>
		>
	>
	adl_version = <"2.0.5">
