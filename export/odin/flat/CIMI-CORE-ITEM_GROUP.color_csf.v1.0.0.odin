(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/10335-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Color of Cerebral spinal fluid' concept">
				use = <"Use for Color of Cerebral spinal fluid.">
				keywords = <"Colour", "Appearance", "Typ", "Point in time", "Random", "Cerebral spinal fluid", "Spinal Fluid", "Cerebrospinal Fl", "Spinal Flu", "Spinal Fld", "Nominal">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.color_csf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"color_csf">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"CSFColor_VALUESET_CODE">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Color of Cerebral spinal fluid">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/10335-8">
			>
			["opencem"] = <
				["at0.0.0.0.0.1"] = <"http://opencem.org/id/CSFColor_VALUESET_CODE">
			>
		>
	>
	adl_version = <"2.0.5">
