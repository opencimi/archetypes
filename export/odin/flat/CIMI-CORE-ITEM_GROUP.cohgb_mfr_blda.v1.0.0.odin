(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2030-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Carboxyhemoglobin/Hemoglobin.total in Arterial blood' concept">
				use = <"Use for Carboxyhemoglobin/Hemoglobin.total in Arterial blood.">
				keywords = <"COHgb", "Carboxyhemoglob", "Carbon monoxide.hemoglobin", "COHb", "HbCO", "Carbonyl hemoglobin", "Carbonmonoxyhemoglobin", "CO haemoglobin", "CO hemoglobin", "Carboxyhaemoglobin", "Hemoglobin bound with carbon dioxide", "Carbonyl Hgb", "Carbonyl haemoglobin", "Hb", "Haemoglobin", "Mass fraction", "Percent", "Point in time", "Random", "Arterial blood", "ART", "Art blood", "Art bld", "ABG", "Quantitative", "QNT", "Quant", "Quan", "Tot", "Totl", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cohgb_mfr_blda.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cohgb_mfr_blda">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2030-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2030-5">
			>
		>
	>
	adl_version = <"2.0.5">
