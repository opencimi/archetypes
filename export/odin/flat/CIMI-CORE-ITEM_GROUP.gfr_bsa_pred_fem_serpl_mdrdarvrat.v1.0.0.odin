(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/50044-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Glomerular filtration rate/1.73 sq M predicted among females by Creatinine-based formula (MDRD)' concept">
				use = <"Use for Glomerular filtration rate/1.73 sq M predicted among females by Creatinine-based formula (MDRD).">
				keywords = <"GFR", "Pred GFR.female", "Estimated GFR", "eGFR", "BSA pred.fem", "Volume rate/area", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Modification of Diet in Renal Disease", "Square Meter", "Glom", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.gfr_bsa_pred_fem_serpl_mdrdarvrat.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"gfr_bsa_pred_fem_serpl_mdrdarvrat">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/50044-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/50044-7">
			>
		>
	>
	adl_version = <"2.0.5">
