(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/31019-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI '10-Hydroxycarbazepine [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for 10-Hydroxycarbazepine [Mass/volume] in Serum or Plasma.">
				keywords = <"10OH-Carbazepine", "10-Hydroxy carbazepine", "Oxcarbazepine metabolite", "10-OH-carbazepine", "10,11-dihydro-10-hydroxycarbamazepine", "10-hydroxycarbamazepine", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.10ohcarbazepine_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"10ohcarbazepine_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"10-Hydroxycarbazepine [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/31019-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/31019-3">
			>
		>
	>
	adl_version = <"2.0.5">
