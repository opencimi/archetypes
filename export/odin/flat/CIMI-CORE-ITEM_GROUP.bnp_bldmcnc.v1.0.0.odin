(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/42637-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Natriuretic peptide B [Mass/volume] in Blood' concept">
				use = <"Use for Natriuretic peptide B [Mass/volume] in Blood.">
				keywords = <"BNP", "B-type natriuretic peptide", "Brain Natriuretic Peptide", "Natriutietic peptide.B", "Beta Natriuretic Peptide", "Mass concentration", "Level", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Pept", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bnp_bldmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bnp_bldmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Natriuretic peptide B [Mass/volume] in Blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"pg/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/42637-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/42637-9">
			>
		>
	>
	adl_version = <"2.0.5">
