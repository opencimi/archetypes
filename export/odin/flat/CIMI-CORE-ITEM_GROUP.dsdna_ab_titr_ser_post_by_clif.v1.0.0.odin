(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.dsdna_ab_titr_ser_post_by_clif.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"dsdna_ab_titr_ser_post_by_clif">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.3"] = <
					text = <"Immunofluorescence (IF) Crithidia luciliae">
				>
				["id1.1.1.1.1.1"] = <
					text = <"DNA double strand Ab [Titer] in Serum">
				>
