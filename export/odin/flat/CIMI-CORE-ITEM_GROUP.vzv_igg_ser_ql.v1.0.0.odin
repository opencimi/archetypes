(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19162-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Varicella zoster virus IgG Ab [Presence] in Serum' concept">
				use = <"Use for Varicella zoster virus IgG Ab [Presence] in Serum.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.vzv_igg_ser_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"vzv_igg_ser_ql">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19162-7">
			>
			["opencem"] = <
