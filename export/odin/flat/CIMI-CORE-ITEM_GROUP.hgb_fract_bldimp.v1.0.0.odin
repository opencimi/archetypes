(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/12710-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemoglobin pattern [interpretation] in Blood' concept">
				use = <"Use for Hemoglobin pattern [interpretation] in Blood.">
				keywords = <"Hgb Fract", "Hb", "Haemoglobin", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Blood", "WB", "Whole blood", "Nominal", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hgb_fract_bldimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hgb_fract_bldimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hemoglobin pattern [interpretation] in Blood">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Hemoglobin pattern [interpretation] in Blood">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/12710-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/12710-0">
			>
		>
	>
	adl_version = <"2.0.5">
