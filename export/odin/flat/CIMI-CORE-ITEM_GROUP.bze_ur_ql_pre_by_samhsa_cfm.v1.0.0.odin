(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/8192-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Benzoylecgonine [Presence] in Urine by SAMHSA confirm method' concept">
				use = <"Use for Benzoylecgonine [Presence] in Urine by SAMHSA confirm method.">
				keywords = <"BZE", "Benz", "BEC", "Benzoylec", "Cocaine degradation production", "BEG", "Crack metabolite", "Cocaine metabolite", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "SAMHSA Cfm", "SAMSHA", "CNFR", "CNFRM", "Conf", "Confirmation", "GCMS", "Confirmatory", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bze_ur_ql_pre_by_samhsa_cfm.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bze_ur_ql_pre_by_samhsa_cfm">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Benzoylecgonine [Presence] in Urine by SAMHSA confirm method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Benzoylecgonine [Presence] in Urine by SAMHSA confirm method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/8192-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/8192-7">
			>
		>
	>
	adl_version = <"2.0.5">
