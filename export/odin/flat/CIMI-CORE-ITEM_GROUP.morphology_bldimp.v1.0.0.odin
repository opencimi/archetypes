(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/18314-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Morphology [interpretation] in Blood Narrative' concept">
				use = <"Use for Morphology [interpretation] in Blood Narrative.">
				keywords = <"Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Blood", "WB", "Whole blood", "Narrative", "Report", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.morphology_bldimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"morphology_bldimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Morphology [interpretation] in Blood Narrative">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Morphology [interpretation] in Blood Narrative">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/18314-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/18314-5">
			>
		>
	>
	adl_version = <"2.0.5">
