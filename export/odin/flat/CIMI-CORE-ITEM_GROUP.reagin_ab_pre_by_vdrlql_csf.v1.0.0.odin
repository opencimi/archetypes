(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5290-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Reagin Ab [Presence] in Cerebral spinal fluid by VDRL' concept">
				use = <"Use for Reagin Ab [Presence] in Cerebral spinal fluid by VDRL.">
				keywords = <"Treponema", "Syphilis", "Neurosyphilis", "Arbitrary concentration", "Point in time", "Random", "Cerebral spinal fluid", "Spinal Fluid", "Cerebrospinal Fl", "Spinal Flu", "Spinal Fld", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Venereal Disease Research Laboratory", "Microscopic flocculation", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.reagin_ab_pre_by_vdrlql_csf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"reagin_ab_pre_by_vdrlql_csf">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Reagin Ab [Presence] in Cerebral spinal fluid by VDRL">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5290-2">
			>
			["opencem"] = <
