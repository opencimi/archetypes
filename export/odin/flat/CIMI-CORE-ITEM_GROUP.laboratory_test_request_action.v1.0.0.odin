(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'laboratory test request action' concept">
				use = <"Use for laboratory test request action.">
				keywords = <"laboratory", "test", "request", "action">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.laboratory_test_request_action.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"laboratory_test_request_action">
		release_version = <"1.0.0">
		version_status = <0>
		build_count = <0>
	>
	parent_archetype_id = <"CIMI-CORE-ITEM_GROUP.request_action.v1">
	definition = <
