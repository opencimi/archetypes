(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49701-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'pH of Blood adjusted to patients actual temperature' concept">
				use = <"Use for pH of Blood adjusted to patients actual temperature.">
				keywords = <"Temp", "temp adj", "Log molar concentration", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ph_temp_adj_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ph_temp_adj_bld">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49701-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49701-6">
			>
		>
	>
	adl_version = <"2.0.5">
