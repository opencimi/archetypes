(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/51916-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Herpes simplex virus 1 IgG Ab [Presence] in Serum by Immunoassay' concept">
				use = <"Use for Herpes simplex virus 1 IgG Ab [Presence] in Serum by Immunoassay.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hsv1_igg_ser_ql_pre_by_eia.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hsv1_igg_ser_ql_pre_by_eia">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Herpes simplex virus 1 IgG Ab [Presence] in Serum by Immunoassay">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Herpes simplex virus 1 IgG Ab [Presence] in Serum by Immunoassay">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/51916-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/51916-5">
			>
		>
	>
	adl_version = <"2.0.5">
