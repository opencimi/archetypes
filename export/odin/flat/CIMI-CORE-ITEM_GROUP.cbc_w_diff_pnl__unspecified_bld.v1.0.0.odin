(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cbc_w_diff_pnl__unspecified_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cbc_w_diff_pnl__unspecified_bld">
			...
			["1"] = <
				...
				children = <
					...
					["22"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.3">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.platelet_num_bld.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					...
					["25"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.6">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.pmv_bld.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					...
					["30"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.2.1.1">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.diff_pnl__unspecified_bld.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
				>
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.1"] = <
					text = <"CBC W Differential panel, method unspecified - Blood">
				>
				["id0.1.1.1.1"] = <
				...
				>
				["id0.1.1.1.3"] = <
					text = <"Platelets [#/volume] in Blood">
				>
				["id0.1.1.1.4"] = <
				...
				>
				["id0.1.1.1.6"] = <
					text = <"Platelet mean volume [Entitic volume] in Blood">
				>
				["id0.1.1.1.7"] = <
				...
				>
				["id0.1.2.1.1"] = <
					text = <"Differential panel, method unspecified - Blood">
				>
				["id1.1.1.1.1"] = <
					text = <"CBC W Differential panel, method unspecified - Blood">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/69742-5">
				["at0.0.0.0.1"] = <"http://loinc.org/id/69742-5">
				["id0.1.1.1.1"] = <"http://loinc.org/id/20570-8">
				["id0.1.1.1.2"] = <"http://loinc.org/id/26453-1">
				["id0.1.1.1.3"] = <"http://loinc.org/id/26515-7">
				["id0.1.1.1.4"] = <"http://loinc.org/id/28539-5">
				["id0.1.1.1.5"] = <"http://loinc.org/id/28540-3">
				["id0.1.1.1.6"] = <"http://loinc.org/id/28542-9">
				["id0.1.1.1.7"] = <"http://loinc.org/id/30384-2">
				["id0.1.1.1.8"] = <"http://loinc.org/id/30385-9">
				["id0.1.1.1.9"] = <"http://loinc.org/id/30428-7">
				["id0.1.1.1.10"] = <"http://loinc.org/id/718-7">
				["id0.1.2.1.1"] = <"http://loinc.org/id/69738-3">
			>
		>
	>
	adl_version = <"2.0.5">
