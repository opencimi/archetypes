(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/9632-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Aspergillus fumigatus Ab [Presence] in Serum' concept">
				use = <"Use for Aspergillus fumigatus Ab [Presence] in Serum.">
				keywords = <"A fumigatus", "m003", "m3", "Farmers lung", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Fum", "Aspergil", "Asperg", "Aspergils", "Aspergilus", "Aspergilis", "Aspergilla", "Aspergillin", "Aspergillosis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.a_fumigatus_ab_ser_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"a_fumigatus_ab_ser_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Aspergillus fumigatus Ab [Presence] in Serum">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Aspergillus fumigatus Ab [Presence] in Serum">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/9632-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/9632-1">
			>
		>
	>
	adl_version = <"2.0.5">
