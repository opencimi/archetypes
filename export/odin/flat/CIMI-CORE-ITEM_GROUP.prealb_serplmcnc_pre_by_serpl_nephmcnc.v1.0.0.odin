(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/46130-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Prealbumin [Mass/volume] in Serum or Plasma by Nephlometry' concept">
				use = <"Use for Prealbumin [Mass/volume] in Serum or Plasma by Nephlometry.">
				keywords = <"Prealb", "Pre albumin", "PALB", "Transthyretin", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Neph", "Nephelom", "Light scattering", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.prealb_serplmcnc_pre_by_serpl_nephmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"prealb_serplmcnc_pre_by_serpl_nephmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Prealbumin [Mass/volume] in Serum or Plasma by Nephlometry">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/46130-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/46130-1">
			>
		>
	>
	adl_version = <"2.0.5">
