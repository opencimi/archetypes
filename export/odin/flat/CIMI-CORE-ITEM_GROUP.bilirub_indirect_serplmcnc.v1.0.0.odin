(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1971-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Bilirubin.indirect [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Bilirubin.indirect [Mass/volume] in Serum or Plasma.">
				keywords = <"Bilirub Indirect", "Bu", "Bilirubin indirect", "Bilirubin primary", "Bilirubin non-conjugated", "Bilirubin unconjugated", "Bili", "TBIL", "Bilirubins", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bilirub_indirect_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bilirub_indirect_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Bilirubin.indirect [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1971-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1971-1">
			>
		>
	>
	adl_version = <"2.0.5">
