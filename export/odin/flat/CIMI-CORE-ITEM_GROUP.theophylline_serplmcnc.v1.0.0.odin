(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/4049-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Theophylline [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Theophylline [Mass/volume] in Serum or Plasma.">
				keywords = <"Theo", "Sabidal SR", "Biophyllin", "Lasma", "Nuelin", "Phyllocontin", "Pro-vent", "Slo-Phyllin", "Theo-dur", "Uniphyllin", "Continus", "Aminophylline", "Somophylline", "Somophyllin", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.theophylline_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"theophylline_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Theophylline [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/4049-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/4049-3">
			>
		>
	>
	adl_version = <"2.0.5">
