(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/46137-6.html>">
			["tool"] = <"cimi-gen v0.0.1">
			["time"] = <"2015-08-05T22:27:25">
		>
		details = <
			["en"] = <
				language = <[ISO_639-1::en]>
				purpose = <"Archetype for CIMI 'Triple phosphate crystals [#/area] in Urine sediment by Microscopy high power field' concept">
				use = <"Use for Triple phosphate crystals [#/area] in Urine sediment by Microscopy high power field.">
				keywords = <"Tri-Phos Cry", "MAP", "Strive", "MgNH4PO4.6H2O", "Struvite", "Tri-Phos", "Magnesium ammonium phosphate", "Phos", "Phosphrous", "Phosphorous", "Pi", "i Phos", "PO4", "Phosphorus", "Inorganic phosphate", "Phosphate total", "Cryst", "Crys", "Crystal", "#/area", "Number areic", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Micro", "LM", "Micros", "Microscopic", "Trip", "Tri", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.triphos_cry_num_per_area_urns_hpf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"triphos_cry_num_per_area_urns_hpf">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/46137-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/46137-6">
			>
		>
	>
	adl_version = <"2.0.5">
