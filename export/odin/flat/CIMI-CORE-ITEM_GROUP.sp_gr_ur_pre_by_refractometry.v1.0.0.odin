(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5810-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Specific gravity of Urine by Refractometry' concept">
				use = <"Use for Specific gravity of Urine by Refractometry.">
				keywords = <"Sp Gr", "Spec grav", "Den", "SG", "Conc", "Sp Grav", "Density", "Concentration", "Sp G", "Relative density", "Point in time", "Random", "Ur", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Refract", "URINALYSIS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.sp_gr_ur_pre_by_refractometry.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"sp_gr_ur_pre_by_refractometry">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Specific gravity of Urine by Refractometry">
				>
				["at0.0.0.0.0.2"] = <
					text = <"">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5810-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5810-7">
			>
		>
	>
	adl_version = <"2.0.5">
