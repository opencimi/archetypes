(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/934-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Blood product unit ID [#]' concept">
				use = <"Use for Blood product unit ID [#].">
				keywords = <"Bld Prod Unit Id", "Number", "Count", "Cnt", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "Identifier", "Intradermal", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bpu_id.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bpu_id">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/934-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/934-0">
			>
		>
	>
	adl_version = <"2.0.5">
