(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/11266-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Streptococcus agalactiae Ag [Presence] in Unspecified specimen' concept">
				use = <"Use for Streptococcus agalactiae Ag [Presence] in Unspecified specimen.">
				keywords = <"Gp B Strep", "Strep group B", "Strep B", "S agalactiae", "Group B", "GBS", "Steptococcus Group B", "Group B Strep", "Streptococci group B", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Antigen", "Antigens", "Strept", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.gp_b_strep_ag_xxx_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"gp_b_strep_ag_xxx_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Streptococcus agalactiae Ag [Presence] in Unspecified specimen">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Streptococcus agalactiae Ag [Presence] in Unspecified specimen">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/11266-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/11266-4">
			>
		>
	>
	adl_version = <"2.0.5">
