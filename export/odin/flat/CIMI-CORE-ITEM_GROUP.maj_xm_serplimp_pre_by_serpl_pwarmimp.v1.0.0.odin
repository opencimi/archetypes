(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1253-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Major crossmatch [interpretation] by Prewarmed' concept">
				use = <"Use for Major crossmatch [interpretation] by Prewarmed.">
				keywords = <"Maj XM", "Compatability testing", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Nominal", "Pwarm", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.maj_xm_serplimp_pre_by_serpl_pwarmimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"maj_xm_serplimp_pre_by_serpl_pwarmimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Major crossmatch [interpretation] by Prewarmed">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Major crossmatch [interpretation] by Prewarmed">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1253-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1253-4">
			>
		>
	>
	adl_version = <"2.0.5">
