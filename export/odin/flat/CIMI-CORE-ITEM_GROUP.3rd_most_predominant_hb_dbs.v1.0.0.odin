(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/64119-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Third most predominant hemoglobin in Dried blood spot' concept">
				use = <"Use for Third most predominant hemoglobin in Dried blood spot.">
				keywords = <"3rd most predominant Hb", "Hgb", "Haemoglobin", "Finding", "Findings", "Point in time", "Random", "DBS", "Filter paper", "FP", "Dried blood spot", "Blood", "WB", "Whole blood", "Nominal", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.3rd_most_predominant_hb_dbs.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"3rd_most_predominant_hb_dbs">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/64119-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/64119-1">
			>
		>
	>
	adl_version = <"2.0.5">
