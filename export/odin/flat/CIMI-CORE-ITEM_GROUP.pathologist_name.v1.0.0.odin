(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19139-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Pathologist name' concept">
				use = <"Use for Pathologist name.">
				keywords = <"Path", "Person name", "Point in time", "Random", "Nominal">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pathologist_name.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pathologist_name">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19139-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19139-5">
			>
		>
	>
	adl_version = <"2.0.5">
