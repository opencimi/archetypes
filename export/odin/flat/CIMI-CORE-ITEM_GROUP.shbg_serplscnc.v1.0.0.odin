(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13967-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Sex hormone binding globulin [Moles/volume] in Serum or Plasma' concept">
				use = <"Use for Sex hormone binding globulin [Moles/volume] in Serum or Plasma.">
				keywords = <"SHBG", "Testosterone/estradiol binding globulin", "Androgen binding protein", "TeBG", "SSBG", "SBP", "Sex steroid binding globulin", "Sex steroid binding protein", "Estradiol binding globulin", "Testosterone binding globulin", "GLB", "Globulins", "Glob", "Glob%", "Globul", "Substance concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Horm", "Bind", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.shbg_serplscnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"shbg_serplscnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Sex hormone binding globulin [Moles/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"nmol/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13967-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13967-5">
			>
		>
	>
	adl_version = <"2.0.5">
