(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/31999-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Broad casts [Presence] in Urine sediment by Light microscopy' concept">
				use = <"Use for Broad casts [Presence] in Urine sediment by Light microscopy.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.broad_casts_urns_ql_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"broad_casts_urns_ql_micro">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/31999-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/31999-6">
			>
		>
	>
	adl_version = <"2.0.5">
