(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5774-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Calcium oxalate crystals [Presence] in Urine sediment by Light microscopy' concept">
				use = <"Use for Calcium oxalate crystals [Presence] in Urine sediment by Light microscopy.">
				keywords = <"Oxal", "Ethanedioic acid", "Ethanedioate", "Oxalic acid", "Cryst", "Crys", "Crystal", "CaOx Cry", "CaC2O4", "Cal", "Ca", "Arbitrary concentration", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Micro", "LM", "Micros", "Microscopic", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.caox_cry_urns_ql_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"caox_cry_urns_ql_micro">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5774-5">
			>
			["opencem"] = <
