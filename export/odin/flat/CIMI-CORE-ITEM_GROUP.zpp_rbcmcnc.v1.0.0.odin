(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2895-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Protoporphyrin.zinc [Mass/volume] in Red Blood Cells' concept">
				use = <"Use for Protoporphyrin.zinc [Mass/volume] in Red Blood Cells.">
				keywords = <"Zn", "ZPP", "Zn-PP", "Zinc protoporphyrin", "Protoporphrn", "Dicarboxylporphyrin", "Protoporph", "Protoporphyrins", "Dicarboxyl porphyrin", "Mass concentration", "Level", "Point in time", "Random", "Erythrocytes", "Red blood corpusles", "Red blood cells", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.zpp_rbcmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"zpp_rbcmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Protoporphyrin.zinc [Mass/volume] in Red Blood Cells">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2895-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2895-1">
			>
		>
	>
	adl_version = <"2.0.5">
