(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/51383-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Leukocytes other [#/volume] in Blood by Automated count' concept">
				use = <"Use for Leukocytes other [#/volume] in Blood by Automated count.">
				keywords = <"WBC Other", "White blood cell", "Leuc", "Leuk", "Leukocyte", "Lkcs", "White blood cells", "WBCs", "#", "Number concentration", "Count/volume", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Auto", "Othr", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.wbc_other_num_bld_pre_by_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"wbc_other_num_bld_pre_by_auto">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Leukocytes other [#/volume] in Blood by Automated count">
				>
				["at0.0.0.0.0.2"] = <
					text = <"10*3/uL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/51383-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/51383-8">
			>
		>
	>
	adl_version = <"2.0.5">
