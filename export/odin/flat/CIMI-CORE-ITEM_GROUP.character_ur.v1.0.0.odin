(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19244-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Character of Urine' concept">
				use = <"Use for Character of Urine.">
				keywords = <"Appearance", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Nominal">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.character_ur.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"character_ur">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19244-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19244-3">
			>
		>
	>
	adl_version = <"2.0.5">
