(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/31156-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemoglobin Barts/Hemoglobin.total in Blood' concept">
				use = <"Use for Hemoglobin Barts/Hemoglobin.total in Blood.">
				keywords = <"Hgb Barts", "Hb", "Haemoglobin", "Mass fraction", "Percent", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Tot", "Totl", "Bart", "Bart's", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hgb_barts_mfr_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hgb_barts_mfr_bld">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hemoglobin Barts/Hemoglobin.total in Blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/31156-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/31156-3">
			>
		>
	>
	adl_version = <"2.0.5">
