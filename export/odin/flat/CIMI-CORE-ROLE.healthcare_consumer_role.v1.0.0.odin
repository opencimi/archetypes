(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ROLE.healthcare_consumer_role.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ROLE">
		concept_id = <"healthcare_consumer_role">
		release_version = <"1.0.0">
		version_status = <0>
		build_count = <0>
	>
	parent_archetype_id = <"CIMI-CORE-ROLE.person_role.v1">
	definition = <
		rm_type_name = <"ROLE">
		node_id = <"id1.1.1.1">
		attributes = <
			...
			["2"] = <
				...
				children = <
					...
					["3"] = (P_C_ARCHETYPE_ROOT) <
						rm_type_name = <"PARTY_RELATIONSHIP">
						node_id = <"id8.0.0.2">
						archetype_ref = <"CIMI-CORE-PARTY_RELATIONSHIP.next_of_kin_relationship.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
				>
