(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19763-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Specimen source [Identifier] in Cervical or vaginal smear or scraping by Cyto stain' concept">
				use = <"Use for Specimen source [Identifier] in Cervical or vaginal smear or scraping by Cyto stain.">
				keywords = <"Identity or presence", "Point in time", "Random", "Genital tract", "Genital vaginal", "Vagina", "Vaginal fluid", "Vag fluid", "Vag fld", "Cervix", "Nominal", "Pap Smear", "Pap Stain", "Cytostain", "Cytology stain", "Papanicolaou smear", "Spec", "Srce">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.specimen_source_cvx_vag_cyto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"specimen_source_cvx_vag_cyto">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Specimen source [Identifier] in Cervical or vaginal smear or scraping by Cyto stain">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Specimen source [Identifier] in Cervical or vaginal smear or scraping by Cyto stain">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19763-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19763-2">
			>
		>
	>
	adl_version = <"2.0.5">
