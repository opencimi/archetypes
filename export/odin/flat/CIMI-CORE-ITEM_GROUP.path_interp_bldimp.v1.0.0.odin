(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/21026-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Pathologist interpretation of Blood tests' concept">
				use = <"Use for Pathologist interpretation of Blood tests.">
				keywords = <"Path Interp", "Intrp", "Interpret", "Interpt", "Impression", "Impressions", "Point in time", "Random", "Blood", "WB", "Whole blood", "Nominal", "PATHOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.path_interp_bldimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"path_interp_bldimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Pathologist interpretation of Blood tests">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Pathologist interpretation of Blood tests">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/21026-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/21026-0">
			>
		>
	>
	adl_version = <"2.0.5">
