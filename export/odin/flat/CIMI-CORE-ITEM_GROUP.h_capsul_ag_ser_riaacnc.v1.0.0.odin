(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19107-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Histoplasma capsulatum Ag [Units/volume] in Serum by Radioimmunoassay (RIA)' concept">
				use = <"Use for Histoplasma capsulatum Ag [Units/volume] in Serum by Radioimmunoassay (RIA).">
				keywords = <"H capsul", "H capsulatum", "H farciminosum", "Histoplasma farciminosum", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "Radioimmunoassay", "Antigen", "Antigens", "Histo", "Histopl", "Histoplasmos", "Histoplasmosis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.h_capsul_ag_ser_riaacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"h_capsul_ag_ser_riaacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Histoplasma capsulatum Ag [Units/volume] in Serum by Radioimmunoassay (RIA)">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[arb'U]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19107-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19107-2">
			>
		>
	>
	adl_version = <"2.0.5">
