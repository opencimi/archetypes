(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.diff_pnl_vitf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"diff_pnl_vitf">
			...
			["1"] = <
				...
				children = <
					...
					["20"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.1">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.basophils_nfr_vitf_manual.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["21"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.2">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.eosinophil_nfr_vitf_manual.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["22"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.3">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.lymph_abn_nfr_vitf_manual.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["23"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.4">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.macrophages_nfr_vitf_manual.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["24"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.5">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.mesothl_cell_nfr_vitf_manual.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["25"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.6">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.monocytes_nfr_vitf_manual.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["26"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.7">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.neutrophils_nfr_vitf_manual.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["27"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.8">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.wbc_other_nfr_vitf_manual.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["28"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.9">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.lymphocytes_nfr_vitf_manual.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
				>
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.1"] = <
					text = <"Differential panel - Vitreous fluid">
				>
				["id0.1.1.1.1"] = <
					text = <"Basophils/100 leukocytes in Vitreous fluid by Manual count">
				>
				["id0.1.1.1.2"] = <
					text = <"Eosinophils/100 leukocytes in Vitreous fluid by Manual count">
				>
				["id0.1.1.1.3"] = <
					text = <"Lymphocytes Abnormal/100 leukocytes in Vitreous fluid by Manual count">
				>
				["id0.1.1.1.4"] = <
					text = <"Macrophages/100 leukocytes in Vitreous fluid by Manual count">
				>
				["id0.1.1.1.5"] = <
					text = <"Mesothelial cells/100 leukocytes in Vitreous fluid by Manual count">
				>
				["id0.1.1.1.6"] = <
					text = <"Monocytes/100 leukocytes in Vitreous fluid by Manual count">
				>
				["id0.1.1.1.7"] = <
					text = <"Neutrophils/100 leukocytes in Vitreous fluid by Manual count">
				>
				["id0.1.1.1.8"] = <
					text = <"Leukocytes other/100 leukocytes in Vitreous fluid by Manual count">
				>
				["id0.1.1.1.9"] = <
					text = <"Lymphocytes/100 leukocytes in Vitreous fluid by Manual count">
				>
				["id1.1.1.1.1"] = <
					text = <"Differential panel - Vitreous fluid">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/72395-7">
				["at0.0.0.0.1"] = <"http://loinc.org/id/72395-7">
				["id0.1.1.1.1"] = <"http://loinc.org/id/68396-1">
				["id0.1.1.1.2"] = <"http://loinc.org/id/68403-5">
				["id0.1.1.1.3"] = <"http://loinc.org/id/68406-8">
				["id0.1.1.1.4"] = <"http://loinc.org/id/68412-6">
				["id0.1.1.1.5"] = <"http://loinc.org/id/68418-3">
				["id0.1.1.1.6"] = <"http://loinc.org/id/68423-3">
				["id0.1.1.1.7"] = <"http://loinc.org/id/68426-6">
				["id0.1.1.1.8"] = <"http://loinc.org/id/68432-4">
				["id0.1.1.1.9"] = <"http://loinc.org/id/72364-3">
			>
		>
	>
	adl_version = <"2.0.5">
