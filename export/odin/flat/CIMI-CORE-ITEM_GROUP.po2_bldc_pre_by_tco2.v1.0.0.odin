(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33437-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oxygen [Partial pressure] in Capillary blood by Transcutaneous O2 monitor' concept">
				use = <"Use for Oxygen [Partial pressure] in Capillary blood by Transcutaneous O2 monitor.">
				keywords = <"tO2", "Partial pressure", "Point in time", "Random", "Cap blood", "Cap bld", "Capillary bld", "Capillary blood", "Finger stick", "Quantitative", "QNT", "Quant", "Quan", "TcO2", "PULMONARY", "O2 partial pressure", "PO2", "PTCO2", "TCPO2", "TCP", "PTC">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.po2_bldc_pre_by_tco2.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"po2_bldc_pre_by_tco2">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Oxygen [Partial pressure] in Capillary blood by Transcutaneous O2 monitor">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mm[Hg]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33437-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33437-5">
			>
		>
	>
	adl_version = <"2.0.5">
