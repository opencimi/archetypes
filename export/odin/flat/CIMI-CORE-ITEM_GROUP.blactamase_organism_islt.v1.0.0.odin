(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20423-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Beta lactamase organism identified in Isolate' concept">
				use = <"Use for Beta lactamase organism identified in Isolate.">
				keywords = <"B-Lactamase Organism", "Identity or presence", "Point in time", "Random", "Islt", "Isol", "Nominal", "Isolated", "B-Lactamase", "Betalactamase", "B", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.blactamase_organism_islt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"blactamase_organism_islt">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Beta lactamase organism identified in Isolate">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Beta lactamase organism identified in Isolate">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20423-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20423-0">
			>
		>
	>
	adl_version = <"2.0.5">
