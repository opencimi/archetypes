(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/35492-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Methicillin resistant Staphylococcus aureus (MRSA) DNA [Presence] by Probe and target amplification method' concept">
				use = <"Use for Methicillin resistant Staphylococcus aureus (MRSA) DNA [Presence] by Probe and target amplification method.">
				keywords = <"MRSA", "S aureus", "o71", "Dimethoxypenicillin", "Metacillin", "Celbenin", "Metin", "Staficyn", "Staphicillin", "Deoxyribonucleic acid", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "PCR", "Polymerase chain reaction", "Transcription mediated amplification", "NASBA", "Nucleic acid sequence based analysis", "SDA", "Strand Displacement Amplification", "LAT", "Ligation-activated transcription", "3SR SR", "3 Self-Sustaining Sequence Replication", "LCR", "Ligase chain reaction", "QBR", "Probe with target amplification", "NAAT", "TMA", "Amp Prb", "Probe with ampification", "DNA probe", "Amplified", "Staph", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.mrsa_dna_xxx_ql_pcr.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"mrsa_dna_xxx_ql_pcr">
		release_version = <"1.0.0">
		version_status = <0>
		build_count = <0>
	>
	parent_archetype_id = <"CIMI-CORE-ITEM_GROUP.laboratory_test_ordinal.v1">
	definition = <
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"LaboratoryOrdinalValues_VALUESET_CODE">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Methicillin resistant Staphylococcus aureus (MRSA) DNA [Presence] by Probe and target amplification method">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/35492-8">
			>
			["opencem"] = <
				["at0.0.0.0.0.1"] = <"http://opencem.org/id/LaboratoryOrdinalValues_VALUESET_CODE">
			>
		>
	>
	adl_version = <"2.0.5">
