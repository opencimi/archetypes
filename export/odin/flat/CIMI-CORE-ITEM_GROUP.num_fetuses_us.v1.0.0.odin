(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/11878-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Number of fetuses by US' concept">
				use = <"Use for Number of fetuses by US.">
				keywords = <"Fetal", "Number", "Count", "Cnt", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "Ultrasound", "ULS", "Sonogram", "Sonography", "Sonograph", "Echography", "OBSTERICAL.ULTRASOUND", "OBSTERICAL.ULTRASOUND", "Obstetrical", "Obstetrics">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.num_fetuses_us.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"num_fetuses_us">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/11878-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/11878-6">
			>
		>
	>
	adl_version = <"2.0.5">
