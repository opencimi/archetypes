(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/53320-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Casts [Presence] in Urine by Automated' concept">
				use = <"Use for Casts [Presence] in Urine by Automated.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.casts_ur_ql_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"casts_ur_ql_auto">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/53320-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/53320-8">
			>
		>
	>
	adl_version = <"2.0.5">
