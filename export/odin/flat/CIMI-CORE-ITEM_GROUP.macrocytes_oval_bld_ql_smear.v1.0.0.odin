(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/10376-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oval macrocytes [Presence] in Blood by Light microscopy' concept">
				use = <"Use for Oval macrocytes [Presence] in Blood by Light microscopy.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.macrocytes_oval_bld_ql_smear.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"macrocytes_oval_bld_ql_smear">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/10376-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/10376-2">
			>
		>
	>
	adl_version = <"2.0.5">
