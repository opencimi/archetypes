(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'clinical activity' concept">
				use = <"Use for clinical activity.">
				keywords = <"clinical", "activity">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.clinical_activity.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"clinical_activity">
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				["id1.1.1"] = <"http://snomed.info/id/71388002">
