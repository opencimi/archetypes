(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1986-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'C peptide [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for C peptide [Mass/volume] in Serum or Plasma.">
				keywords = <"Connecting peptide of insulin", "Pro-insulin c peptide", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Pept", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.c_peptide_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"c_peptide_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"C peptide [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1986-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1986-9">
			>
		>
	>
	adl_version = <"2.0.5">
