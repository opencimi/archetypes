(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/65754-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Skin Pathology biopsy report' concept">
				use = <"Use for Skin Pathology biopsy report.">
				keywords = <"Path Bx report", "Finding", "Findings", "Point in time", "Random", "Epidermis", "Skn", "Integument", "Dermatologic", "Narrative">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.skin_path_bx_report.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"skin_path_bx_report">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Skin Pathology biopsy report">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Skin Pathology biopsy report">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/65754-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/65754-4">
			>
		>
	>
	adl_version = <"2.0.5">
