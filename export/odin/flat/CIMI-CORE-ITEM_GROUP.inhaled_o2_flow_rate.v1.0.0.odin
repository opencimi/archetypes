(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3151-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Inhaled oxygen flow rate' concept">
				use = <"Use for Inhaled oxygen flow rate.">
				keywords = <"Inhaled O2", "tO2", "vRate", "Volume rate", "Flow", "Point in time", "Random", "IhG", "Inhaled Gas", "Inspired", "Quantitative", "QNT", "Quant", "Quan", "Gases">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.inhaled_o2_flow_rate.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"inhaled_o2_flow_rate">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3151-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3151-8">
			>
		>
	>
	adl_version = <"2.0.5">
