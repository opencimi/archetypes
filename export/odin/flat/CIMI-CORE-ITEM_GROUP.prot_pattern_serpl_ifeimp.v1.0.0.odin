(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/14895-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Protein Fractions [interpretation] in Serum or Plasma by Immunofixation' concept">
				use = <"Use for Protein Fractions [interpretation] in Serum or Plasma by Immunofixation.">
				keywords = <"Prot Pattern", "Protein fractions", "PR", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Nominal", "IFE", "Ifix", "Immunofixation electrophoresis", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.prot_pattern_serpl_ifeimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"prot_pattern_serpl_ifeimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Protein Fractions [interpretation] in Serum or Plasma by Immunofixation">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Protein Fractions [interpretation] in Serum or Plasma by Immunofixation">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/14895-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/14895-7">
			>
		>
	>
	adl_version = <"2.0.5">
