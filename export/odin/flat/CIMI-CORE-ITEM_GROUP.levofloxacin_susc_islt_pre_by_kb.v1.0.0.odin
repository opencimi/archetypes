(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/21367-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Levofloxacin [Susceptibility] by Disk diffusion (KB)' concept">
				use = <"Use for Levofloxacin [Susceptibility] by Disk diffusion (KB).">
				keywords = <"Susceptibility", "Susceptibilty", "Sus", "Suscept", "Susceptibilities", "AST", "Point in time", "Random", "Islt", "Isol", "KB", "Kirby-bauer", "Disk diffusion", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.levofloxacin_susc_islt_pre_by_kb.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"levofloxacin_susc_islt_pre_by_kb">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Levofloxacin [Susceptibility] by Disk diffusion (KB)">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Levofloxacin [Susceptibility] by Disk diffusion (KB)">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/21367-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/21367-8">
			>
		>
	>
	adl_version = <"2.0.5">
