(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/4538-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Erythrocyte sedimentation rate by Wintrobe method' concept">
				use = <"Use for Erythrocyte sedimentation rate by Wintrobe method.">
				keywords = <"ESR", "E.S.R.", "Sed rate", "Erythrocytes", "Red blood corpusles", "Red blood corpuscle", "Red blood cell", "Red cell", "Red cells", "Discocyte", "Erc", "Red blood cells", "RBC", "Velocity", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Wintr", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.esr_bld_qn_pre_by_wintrobe.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"esr_bld_qn_pre_by_wintrobe">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Erythrocyte sedimentation rate by Wintrobe method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mm/h">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/4538-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/4538-5">
			>
		>
	>
	adl_version = <"2.0.5">
