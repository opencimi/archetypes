(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5057-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Blastomyces dermatitidis Ab [Titer] in Serum by Complement fixation' concept">
				use = <"Use for Blastomyces dermatitidis Ab [Titer] in Serum by Complement fixation.">
				keywords = <"B dermatitidis", "Dilution factor", "Titer", "Titre", "Ttr", "Titered", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "CF", "Complement fixation", "Compfix", "Comp fixation", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Blasto", "Blastomycosis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.b_dermat_ab_titr_ser_pre_by_cf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"b_dermat_ab_titr_ser_pre_by_cf">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Blastomyces dermatitidis Ab [Titer] in Serum by Complement fixation">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{titer}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5057-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5057-5">
			>
		>
	>
	adl_version = <"2.0.5">
