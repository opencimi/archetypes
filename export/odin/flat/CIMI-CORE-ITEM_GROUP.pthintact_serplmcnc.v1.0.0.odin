(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2731-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Parathyrin.intact [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Parathyrin.intact [Mass/volume] in Serum or Plasma.">
				keywords = <"PTH-Intact", "intact parathyroid hormone", "iPTH", "Intact Parathormone", "PTH", "Parathyroid hormone", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pthintact_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pthintact_serplmcnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2731-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2731-8">
			>
		>
	>
	adl_version = <"2.0.5">
