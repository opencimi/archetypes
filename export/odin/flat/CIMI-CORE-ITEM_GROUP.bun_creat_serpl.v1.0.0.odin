(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3097-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Urea nitrogen/Creatinine [Mass Ratio] in Serum or Plasma' concept">
				use = <"Use for Urea nitrogen/Creatinine [Mass Ratio] in Serum or Plasma.">
				keywords = <"Urea nit", "UN", "Blood urea nitrogen", "N2", "Nit", "N", "Creat", "Crea", "CR", "Mass concentration ratio", "Mass ratio", "MCRto", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry", "BUN">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bun_creat_serpl.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bun_creat_serpl">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Urea nitrogen/Creatinine [Mass Ratio] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/mg{creat}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3097-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3097-3">
			>
		>
	>
	adl_version = <"2.0.5">
