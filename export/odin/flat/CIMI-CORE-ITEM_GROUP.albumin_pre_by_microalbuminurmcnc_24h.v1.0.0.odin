(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/30003-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Microalbumin [Mass/volume] in 24 hour Urine' concept">
				use = <"Use for Microalbumin [Mass/volume] in 24 hour Urine.">
				keywords = <"Protein.albumin", "Alb", "Mass concentration", "Level", "1 day", "24 hours", "24HR", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "DL=20 mg/L", "DL=20 mg/L", "Chemistry", "MA", "Malb", "Micro albumin", "Microalbumin">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.albumin_pre_by_microalbuminurmcnc_24h.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"albumin_pre_by_microalbuminurmcnc_24h">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Microalbumin [Mass/volume] in 24 hour Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/30003-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/30003-8">
			>
		>
	>
	adl_version = <"2.0.5">
