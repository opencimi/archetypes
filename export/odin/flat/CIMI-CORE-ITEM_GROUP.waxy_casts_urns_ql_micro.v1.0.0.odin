(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33862-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Waxy casts [Presence] in Urine sediment by Light microscopy' concept">
				use = <"Use for Waxy casts [Presence] in Urine sediment by Light microscopy.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.waxy_casts_urns_ql_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"waxy_casts_urns_ql_micro">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33862-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33862-4">
			>
		>
	>
	adl_version = <"2.0.5">
