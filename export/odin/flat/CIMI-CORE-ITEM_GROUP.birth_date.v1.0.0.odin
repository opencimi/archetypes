(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/21112-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Birth date' concept">
				use = <"Use for Birth date.">
				keywords = <"DOB", "Date of birth", "Birthdate", "Time stamp", "Date and time", "Timestamp", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.birth_date.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"birth_date">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/21112-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/21112-8">
			>
		>
	>
	adl_version = <"2.0.5">
