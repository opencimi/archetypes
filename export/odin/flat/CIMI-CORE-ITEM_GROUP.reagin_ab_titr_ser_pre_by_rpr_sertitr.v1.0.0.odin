(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/31147-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Reagin Ab [Titer] in Serum by RPR' concept">
				use = <"Use for Reagin Ab [Titer] in Serum by RPR.">
				keywords = <"Treponema", "Syphilis", "Neurosyphilis", "Dilution factor", "Titer", "Titre", "Ttr", "Titered", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "Charcoal flocculation", "Rapid plasma reagin", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.reagin_ab_titr_ser_pre_by_rpr_sertitr.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"reagin_ab_titr_ser_pre_by_rpr_sertitr">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Reagin Ab [Titer] in Serum by RPR">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{titer}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/31147-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/31147-2">
			>
		>
	>
	adl_version = <"2.0.5">
