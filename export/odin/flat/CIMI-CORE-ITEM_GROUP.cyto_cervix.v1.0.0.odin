(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/10524-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Microscopic observation [Identifier] in Cervix by Cyto stain' concept">
				use = <"Use for Microscopic observation [Identifier] in Cervix by Cyto stain.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cyto_cervix.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cyto_cervix">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/10524-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/10524-7">
			>
		>
	>
	adl_version = <"2.0.5">
