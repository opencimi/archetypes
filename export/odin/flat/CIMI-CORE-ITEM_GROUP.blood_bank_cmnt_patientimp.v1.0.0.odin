(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19066-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Blood bank comment' concept">
				use = <"Use for Blood bank comment.">
				keywords = <"Remarks", "Blood Bank Cmnt", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Nominal", "Com", "Comm", "Commt", "Comments", "cmnt", "cmmt">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.blood_bank_cmnt_patientimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"blood_bank_cmnt_patientimp">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19066-0">
			>
			["opencem"] = <
