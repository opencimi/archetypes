(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/50382-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Glutathione reductase [Enzymatic activity/mass] in Red Blood Cells' concept">
				use = <"Use for Glutathione reductase [Enzymatic activity/mass] in Red Blood Cells.">
				keywords = <"GR", "GSR", "Catalytic Content", "Point in time", "Random", "Erythrocytes", "Red blood corpusles", "Red blood cells", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.gr_rbcccnt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"gr_rbcccnt">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/50382-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/50382-1">
			>
		>
	>
	adl_version = <"2.0.5">
