(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/29539-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'HIV 1 RNA [Log #/volume] (viral load) in Plasma by Probe and signal amplification method' concept">
				use = <"Use for HIV 1 RNA [Log #/volume] (viral load) in Plasma by Probe and signal amplification method.">
				keywords = <"Ribonucleic acid", "HIV1", "HIV type 1", "HIV type I", "AIDS", "Human immunodeficiency virus", "Log#", "Log NCNC", "Point in time", "Random", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "bDNA", "HPA", "Hybidization Protection Assay", "Bdn-A", "Branched Chain DNA", "Hybrid Capture", "Probe with signal amplification", "Hybrid Capture nucleic acid hybridization", "HC", "Amp Prb", "Probe with ampification", "DNA probe", "Amplification", "Amplified", "Microbiology", "Viral load">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hiv1_rna_plas_bdnalog_num.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hiv1_rna_plas_bdnalog_num">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"HIV 1 RNA [Log #/volume] (viral load) in Plasma by Probe and signal amplification method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{log_copies}/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/29539-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/29539-4">
			>
		>
	>
	adl_version = <"2.0.5">
