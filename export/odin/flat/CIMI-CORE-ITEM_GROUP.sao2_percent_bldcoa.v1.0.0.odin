(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/28642-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oxygen saturation in Arterial cord blood' concept">
				use = <"Use for Oxygen saturation in Arterial cord blood.">
				keywords = <"SaO2", "SO2", "O2", "tO2", "Mass fraction", "Percent", "Point in time", "Random", "Bld cord", "Cord arterial blood", "Cord BldA", "Quantitative", "QNT", "Quant", "Quan", "Satn", "SAT", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.sao2_percent_bldcoa.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"sao2_percent_bldcoa">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Oxygen saturation in Arterial cord blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/28642-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/28642-7">
			>
		>
	>
	adl_version = <"2.0.5">
