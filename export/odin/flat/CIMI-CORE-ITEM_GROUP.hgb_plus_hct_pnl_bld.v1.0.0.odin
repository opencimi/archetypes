(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/24360-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemoglobin and Hematocrit panel - Blood' concept">
				use = <"Use for Hemoglobin and Hematocrit panel - Blood.">
				keywords = <"Hgb+Hct Pnl", "Hb", "Haemoglobin", "Hgb", "Hct", "PCV", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Pan", "Panl", "PANEL.HEMATOLOGY& CELL COUNTS", "PANEL.HEMATOLOGY& CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hgb_plus_hct_pnl_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hgb_plus_hct_pnl_bld">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/24360-0">
				["at0.0.0.0.1"] = <"http://loinc.org/id/24360-0">
				["id0.1.1.1.1"] = <"http://loinc.org/id/20570-8">
				["id0.1.1.1.2"] = <"http://loinc.org/id/718-7">
			>
		>
	>
	adl_version = <"2.0.5">
