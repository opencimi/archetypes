(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13992-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Albumin/Protein.total in Urine by Electrophoresis' concept">
				use = <"Use for Albumin/Protein.total in Urine by Electrophoresis.">
				keywords = <"Protein.albumin", "Alb", "Prot", "PR", "TP", "Mass fraction", "Percent", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Elph", "Elp", "Elect", "Electrophrs", "Electrophhrs", "Electr", "Elec", "Ep", "Electro", "Tot", "Totl", "Chemistry", "Albumin%", "Albumin fraction", "PEUR", "UPEP">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.albumin_mfr_ur_elph.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"albumin_mfr_ur_elph">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Albumin/Protein.total in Urine by Electrophoresis">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13992-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13992-3">
			>
		>
	>
	adl_version = <"2.0.5">
