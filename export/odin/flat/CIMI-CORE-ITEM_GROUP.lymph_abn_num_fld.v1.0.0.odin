(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/35046-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Lymphocytes Abnormal [#/volume] in Body fluid' concept">
				use = <"Use for Lymphocytes Abnormal [#/volume] in Body fluid.">
				keywords = <"Lymph Abn", "Atypical", "Lymphs", "Lymphocyte", "Lympho", "Lymphs%", "Lymp", "#", "Number concentration", "Count/volume", "Count", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "BF", "Fluid", "Body fluid", "B/F", "FLU", "Fl", "Quantitative", "QNT", "Quant", "Quan", "abn", "abnorm", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.lymph_abn_num_fld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"lymph_abn_num_fld">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/35046-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/35046-2">
			>
		>
	>
	adl_version = <"2.0.5">
