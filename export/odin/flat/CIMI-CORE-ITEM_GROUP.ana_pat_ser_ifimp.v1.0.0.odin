(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13068-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Nuclear Ab pattern [interpretation] in Serum by Immunofluorescence' concept">
				use = <"Use for Nuclear Ab pattern [interpretation] in Serum by Immunofluorescence.">
				keywords = <"ANA Pat", "Nuc", "ANF", "NA", "Antinuclear antibody", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Serum", "SR", "Nominal", "ACIF", "FA", "Fluorescent antibody", "Immune fluorescence", "Fluoresent", "Immunoflour", "Immunofluor", "Immunofluorescence", "IFA", "Time Resolved Fluorescence", "Anticomplement Immunofluorescence", "TRF", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Serology", "FANA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ana_pat_ser_ifimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ana_pat_ser_ifimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Nuclear Ab pattern [interpretation] in Serum by Immunofluorescence">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Nuclear Ab pattern [interpretation] in Serum by Immunofluorescence">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13068-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13068-2">
			>
		>
	>
	adl_version = <"2.0.5">
