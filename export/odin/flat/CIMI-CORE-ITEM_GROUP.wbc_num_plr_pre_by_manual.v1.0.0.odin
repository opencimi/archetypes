(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/808-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Leukocytes [#/volume] in Pleural fluid by Manual count' concept">
				use = <"Use for Leukocytes [#/volume] in Pleural fluid by Manual count.">
				keywords = <"WBC", "White blood cell", "Leuc", "Leuk", "Leukocyte", "Lkcs", "White blood cells", "WBCs", "#", "Number concentration", "Count/volume", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "thoracentesis fluid", "Pleural fluid", "Quantitative", "QNT", "Quant", "Quan", "Manl", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.wbc_num_plr_pre_by_manual.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"wbc_num_plr_pre_by_manual">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Leukocytes [#/volume] in Pleural fluid by Manual count">
				>
				["at0.0.0.0.0.2"] = <
					text = <"10*3/uL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/808-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/808-6">
			>
		>
	>
	adl_version = <"2.0.5">
