(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13337-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'CD8+HLA-DR+ cells/100 cells in Blood' concept">
				use = <"Use for CD8+HLA-DR+ cells/100 cells in Blood.">
				keywords = <"CD8+HLA-DR+ Cells", "I3", "Human Leukocyte Antigen", "CD8+HLA-DR+ Cells", "CD8 Cells", "Cell", "Cellularity", "Gated cells", "Number fraction", "Percent", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Leu-2", "T-8", "Leu2", "Suppressor T cells", "T8", "Tsuppressor", "CELL MARKERS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cd8_plus_hladr_plus_cells_nfr_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cd8_plus_hladr_plus_cells_nfr_bld">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"CD8+HLA-DR+ cells/100 cells in Blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13337-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13337-1">
			>
		>
	>
	adl_version = <"2.0.5">
