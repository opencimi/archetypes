(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/54910-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'DNA double strand Ab [Units/volume] in Serum by Immunofluorescence' concept">
				use = <"Use for DNA double strand Ab [Units/volume] in Serum by Immunofluorescence.">
				keywords = <"dsnda", "DNA binding ab", "dsDNA", "Native DNA", "N-DNA", "Deoxyribonucleic acid", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "ACIF", "FA", "Fluorescent antibody", "Immune fluorescence", "Fluoresent", "Immunoflour", "Immunofluor", "Immunofluorescence", "IFA", "Time Resolved Fluorescence", "Anticomplement Immunofluorescence", "TRF", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Strnd", "Stranded", "ds", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.dsdna_ab_seracnc_pre_by_ser_ifacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"dsdna_ab_seracnc_pre_by_ser_ifacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"DNA double strand Ab [Units/volume] in Serum by Immunofluorescence">
				>
				["at0.0.0.0.0.2"] = <
					text = <"">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/54910-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/54910-5">
			>
		>
	>
	adl_version = <"2.0.5">
