(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1922-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Base deficit in Arterial blood' concept">
				use = <"Use for Base deficit in Arterial blood.">
				keywords = <"Base ex neg", "BSE", "Substance concentration", "Level", "Point in time", "Random", "Arterial blood", "ART", "Art blood", "Art bld", "ABG", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.base_deficit_bldascnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"base_deficit_bldascnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1922-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1922-4">
			>
		>
	>
	adl_version = <"2.0.5">
