(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1925-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Base excess in Arterial blood by calculation' concept">
				use = <"Use for Base excess in Arterial blood by calculation.">
				keywords = <"Base ex", "BSE", "BE", "Substance concentration", "Level", "Point in time", "Random", "Arterial blood", "ART", "Art blood", "Art bld", "ABG", "Quantitative", "QNT", "Quant", "Quan", "Calc", "Calculation", "EXS", "Chemistry", "ABE">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.base_excess_blda_calcscnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"base_excess_blda_calcscnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1925-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1925-7">
			>
		>
	>
	adl_version = <"2.0.5">
