(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19296-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Opiates tested for in Urine by Screen method Nominal' concept">
				use = <"Use for Opiates tested for in Urine by Screen method Nominal.">
				keywords = <"Opi", "Opiate", "OP", "Heroin", "Identity or presence", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Nominal", "Scn", "Scr", "Scrn", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.opiates_tested_ur_scn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"opiates_tested_ur_scn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Opiates tested for in Urine by Screen method Nominal">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Opiates tested for in Urine by Screen method Nominal">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19296-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19296-3">
			>
		>
	>
	adl_version = <"2.0.5">
