(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/4621-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemoglobin S [Presence] in Blood' concept">
				use = <"Use for Hemoglobin S [Presence] in Blood.">
				keywords = <"Hgb S", "Sickle cell", "Sickle cells", "HbS", "Hb", "Haemoglobin", "Arbitrary concentration", "Point in time", "Random", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "S prime", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS", "Sickle cell screen", "Sicklequik", "Sickledex">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hgb_s_bld_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hgb_s_bld_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Hemoglobin S [Presence] in Blood">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/4621-9">
			>
			["opencem"] = <
