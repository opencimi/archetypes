(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13458-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cholesterol in VLDL [Mass/volume] in Serum or Plasma by calculation' concept">
				use = <"Use for Cholesterol in VLDL [Mass/volume] in Serum or Plasma by calculation.">
				keywords = <"VLDLc", "Very low density lipoprotein cholesterols", "Chol", "Choles", "Cholest", "Lipid", "Cholesterol total", "Cholesterols", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Calc", "Calculation", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.vldlc_serpl_calcmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"vldlc_serpl_calcmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cholesterol in VLDL [Mass/volume] in Serum or Plasma by calculation">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13458-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13458-5">
			>
		>
	>
	adl_version = <"2.0.5">
