(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/44533-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'HIV 1+2 Ab [Presence] in Serum from donor' concept">
				use = <"Use for HIV 1+2 Ab [Presence] in Serum from donor.">
				keywords = <"HIV 1 and 2 Ab", "HIV1+2", "HIV1", "HIV type 1", "HIV type I", "AIDS", "Human immunodeficiency virus", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Donr", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "II", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hiv1_plus_2_ab_ser_donr_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hiv1_plus_2_ab_ser_donr_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"HIV 1+2 Ab [Presence] in Serum from donor">
				>
				["id1.1.1.1.1.1"] = <
					text = <"HIV 1+2 Ab [Presence] in Serum from donor">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/44533-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/44533-8">
			>
		>
	>
	adl_version = <"2.0.5">
