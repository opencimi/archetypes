(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/15014-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Alkaline phosphatase.intestinal/Alkaline phosphatase.total in Serum or Plasma' concept">
				use = <"Use for Alkaline phosphatase.intestinal/Alkaline phosphatase.total in Serum or Plasma.">
				keywords = <"ALP Intest", "Alkaline phosphatase.GI", "ALPI", "ALP-3", "IAP", "Alk phos", "Alkaline phos", "ALKP", "AP", "Catalytic Fraction", "Percent", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Tot", "Totl", "Phos", "Phosphtase", "Intestine", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.alp_intest_cfr_serpl.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"alp_intest_cfr_serpl">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Alkaline phosphatase.intestinal/Alkaline phosphatase.total in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/15014-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/15014-4">
			>
		>
	>
	adl_version = <"2.0.5">
