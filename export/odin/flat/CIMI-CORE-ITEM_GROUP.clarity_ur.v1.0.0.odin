(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32167-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Clarity of Urine' concept">
				use = <"Use for Clarity of Urine.">
				keywords = <"Typ", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Nominal">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.clarity_ur.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"clarity_ur">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32167-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32167-9">
			>
		>
	>
	adl_version = <"2.0.5">
