(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/41274-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Alpha-1-Fetoprotein interpretation [interpretation] in Serum or Plasma' concept">
				use = <"Use for Alpha-1-Fetoprotein interpretation [interpretation] in Serum or Plasma.">
				keywords = <"Interp", "Intrp", "Interpret", "Interpt", "AFP Interp", "Alphafetoprotein", "Alpha fetoprotein", "Impression", "Impressions", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Nominal", "Feto", "A1", "Alfa", "I", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.afp_interp_serplimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"afp_interp_serplimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Alpha-1-Fetoprotein interpretation [interpretation] in Serum or Plasma">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/41274-2">
			>
			["opencem"] = <
