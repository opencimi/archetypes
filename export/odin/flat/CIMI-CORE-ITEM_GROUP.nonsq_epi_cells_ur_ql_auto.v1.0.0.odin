(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/50225-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Epithelial cells.non-squamous [Presence] in Urine by Automated' concept">
				use = <"Use for Epithelial cells.non-squamous [Presence] in Urine by Automated.">
				keywords = <"Non-sq Epi Cells", "Small epithelial cells", "Round epithelial cells", "Cell", "Cellularity", "Arbitrary concentration", "Point in time", "Random", "Ur", "UR", "Urn", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Auto", "Sq", "Epith", "Epithelia", "URINALYSIS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.nonsq_epi_cells_ur_ql_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"nonsq_epi_cells_ur_ql_auto">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/50225-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/50225-2">
			>
		>
	>
	adl_version = <"2.0.5">
