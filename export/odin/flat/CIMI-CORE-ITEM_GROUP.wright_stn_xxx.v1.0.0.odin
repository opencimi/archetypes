(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/681-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Microscopic observation [Identifier] in Unspecified specimen by Wright stain' concept">
				use = <"Use for Microscopic observation [Identifier] in Unspecified specimen by Wright stain.">
				keywords = <"Identity or presence", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Nominal", "Wright Stn", "Wrights", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.wright_stn_xxx.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"wright_stn_xxx">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Microscopic observation [Identifier] in Unspecified specimen by Wright stain">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Microscopic observation [Identifier] in Unspecified specimen by Wright stain">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/681-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/681-7">
			>
		>
	>
	adl_version = <"2.0.5">
