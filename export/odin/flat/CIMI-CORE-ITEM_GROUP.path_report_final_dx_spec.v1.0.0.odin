(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/34574-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Pathology report final diagnosis' concept">
				use = <"Use for Pathology report final diagnosis.">
				keywords = <"Path report.final Dx", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Spec", "Nominal", "TUMOR REGISTRY(NAACCR)", "TUMOR REGISTRY(NAACCR)">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.path_report_final_dx_spec.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"path_report_final_dx_spec">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/34574-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/34574-4">
			>
		>
	>
	adl_version = <"2.0.5">
