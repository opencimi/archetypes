(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13046-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Lymphocytes Variant/100 leukocytes in Blood' concept">
				use = <"Use for Lymphocytes Variant/100 leukocytes in Blood.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.variant_lymphs_nfr_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"variant_lymphs_nfr_bld">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13046-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13046-8">
			>
		>
	>
	adl_version = <"2.0.5">
