(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/29967-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Neutrophil cytoplasmic IgG Ab [Titer] in Serum by Immunofluorescence' concept">
				use = <"Use for Neutrophil cytoplasmic IgG Ab [Titer] in Serum by Immunofluorescence.">
				keywords = <"Granulocyte nucleus ab", "ANCA", "ACPA", "Granulocyte ab", "ACNA", "PNM", "Neutrophils", "Neutr", "PMN", "Neut", "Immune globulin G", "Immunoglobulin G", "Cytopl", "Cytoplas", "Dilution factor", "Titer", "Titre", "Ttr", "Titered", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "ACIF", "FA", "Fluorescent antibody", "Immune fluorescence", "Fluoresent", "Immunoflour", "Immunofluor", "Immunofluorescence", "IFA", "Time Resolved Fluorescence", "Anticomplement Immunofluorescence", "TRF", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.anca_igg_titr_ser_if.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"anca_igg_titr_ser_if">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Neutrophil cytoplasmic IgG Ab [Titer] in Serum by Immunofluorescence">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{titer}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/29967-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/29967-7">
			>
		>
	>
	adl_version = <"2.0.5">
