(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1305-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'D Ag [Presence] in Blood' concept">
				use = <"Use for D Ag [Presence] in Blood.">
				keywords = <"Rhesus", "Rh", "Point in time", "Random", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Antigen", "Antigens", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.d_ag_bld_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"d_ag_bld_ql">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1305-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1305-2">
			>
		>
	>
	adl_version = <"2.0.5">
