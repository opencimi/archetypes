(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/16982-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'HTLV 1+2 Ab [Presence] in Serum by Immunoblot (IB)' concept">
				use = <"Use for HTLV 1+2 Ab [Presence] in Serum by Immunoblot (IB).">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.htlv1_plus_2_ab_ser_ql_ib.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"htlv1_plus_2_ab_ser_ql_ib">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"HTLV 1+2 Ab [Presence] in Serum by Immunoblot (IB)">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/16982-1">
			>
			["opencem"] = <
