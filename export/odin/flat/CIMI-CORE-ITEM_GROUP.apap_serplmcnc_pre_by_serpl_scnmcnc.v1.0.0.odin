(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/35595-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Acetaminophen [Mass/volume] in Serum or Plasma by Screen method' concept">
				use = <"Use for Acetaminophen [Mass/volume] in Serum or Plasma by Screen method.">
				keywords = <"APAP", "Acetaminoph", "ACET", "Paracetamol", "Acetamidophenol", "Hydroxyacetanilide", "Acetominophen", "p-Hydroxyacetanilide", "p-Acetamidophenol", "N-Acetyl-p-aminophenol", "N-(4-Hydroxyphenyl)acetanilide", "c209", "C55", "u209", "Tylenol", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Scn", "Scr", "Scrn", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.apap_serplmcnc_pre_by_serpl_scnmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"apap_serplmcnc_pre_by_serpl_scnmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Acetaminophen [Mass/volume] in Serum or Plasma by Screen method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/35595-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/35595-8">
			>
		>
	>
	adl_version = <"2.0.5">
