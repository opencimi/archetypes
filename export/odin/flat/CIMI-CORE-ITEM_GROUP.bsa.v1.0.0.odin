(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/8277-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Body surface area' concept">
				use = <"Use for Body surface area.">
				keywords = <"Bdy surface", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "Surf", "bod", "Bodies", "BODY SURFACE AREA.ATOM", "BODY SURFACE AREA.ATOM", "BSA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bsa.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bsa">
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/278077005">
				["at0.0.0.0.0.3"] = <"http://snomed.org/id/intentional_blank">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/8277-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/8277-6">
			>
		>
	>
	adl_version = <"2.0.5">
