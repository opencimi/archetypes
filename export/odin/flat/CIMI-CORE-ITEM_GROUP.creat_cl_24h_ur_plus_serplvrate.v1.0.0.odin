(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2164-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Creatinine renal clearance in 24 hour' concept">
				use = <"Use for Creatinine renal clearance in 24 hour.">
				keywords = <"Creat", "Crea", "CR", "vRate", "Volume rate", "Flow", "1 day", "24 hours", "24HR", "Ur+SerPl", "Ur+SerPl", "UR", "Urn", "UA", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Cl", "Kidney", "Clear", "Clearanc", "Clearances", "Clr", "Chemistry", "UCr">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.creat_cl_24h_ur_plus_serplvrate.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"creat_cl_24h_ur_plus_serplvrate">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2164-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2164-2">
			>
		>
	>
	adl_version = <"2.0.5">
