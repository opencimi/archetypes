(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3150-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Inhaled oxygen concentration' concept">
				use = <"Use for Inhaled oxygen concentration.">
				keywords = <"Inhaled O2", "tO2", "Volume fraction", "Volfr", "Percent", "Point in time", "Random", "IhG", "Inhaled Gas", "Inspired", "Quantitative", "QNT", "Quant", "Quan", "Gases">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.inhaled_o2_concentration.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"inhaled_o2_concentration">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3150-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3150-0">
			>
		>
	>
	adl_version = <"2.0.5">
