(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49220-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Prolactin [Mass/volume] in Serum or Plasma by 3rd IS' concept">
				use = <"Use for Prolactin [Mass/volume] in Serum or Plasma by 3rd IS.">
				keywords = <"Mammatropic hormone", "Lactotropic hormone", "Lactotropin", "PRL", "Prol", "Mammotropin", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "3rd International Standard", "3IS", "3rdIS", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.prolactin_serplmcnc_pre_by_serpl_3rd_ismcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"prolactin_serplmcnc_pre_by_serpl_3rd_ismcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Prolactin [Mass/volume] in Serum or Plasma by 3rd IS">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49220-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49220-7">
			>
		>
	>
	adl_version = <"2.0.5">
