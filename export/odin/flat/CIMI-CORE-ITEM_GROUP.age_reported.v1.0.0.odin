(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/21612-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Age - Reported' concept">
				use = <"Use for Age - Reported.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.age_reported.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"age_reported">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/21612-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/21612-7">
			>
		>
	>
	adl_version = <"2.0.5">
