(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/14278-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Neutrophil cytoplasmic Ab.perinuclear [Titer] in Serum by Immunofluorescence' concept">
				use = <"Use for Neutrophil cytoplasmic Ab.perinuclear [Titer] in Serum by Immunofluorescence.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.panca_titr_ser_if.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"panca_titr_ser_if">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Neutrophil cytoplasmic Ab.perinuclear [Titer] in Serum by Immunofluorescence">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{titer}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/14278-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/14278-6">
			>
		>
	>
	adl_version = <"2.0.5">
