(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6788-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Immunoglobulin light chains.kappa/Immunoglobulin light chains.lambda [Mass Ratio] in Serum by Immunoassay' concept">
				use = <"Use for Immunoglobulin light chains.kappa/Immunoglobulin light chains.lambda [Mass Ratio] in Serum by Immunoassay.">
				keywords = <"Kappa LC", "Lambda LC", "BJ Protein", "BJP", "Bence Jones protein", "Kappa/Lambda", "Mass concentration ratio", "Mass ratio", "MCRto", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.kappa_lc_lambda_ser_pre_by_eia.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"kappa_lc_lambda_ser_pre_by_eia">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Immunoglobulin light chains.kappa/Immunoglobulin light chains.lambda [Mass Ratio] in Serum by Immunoassay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6788-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6788-4">
			>
		>
	>
	adl_version = <"2.0.5">
