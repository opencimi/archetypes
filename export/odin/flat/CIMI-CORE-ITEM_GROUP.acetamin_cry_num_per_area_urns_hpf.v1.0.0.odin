(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/51213-7.html>">
			["tool"] = <"cimi-gen v0.0.1">
			["time"] = <"2015-08-05T22:27:33">
		>
		details = <
			["en"] = <
				language = <[ISO_639-1::en]>
				purpose = <"Archetype for CIMI 'Acetaminophen crystals [#/area] in Urine sediment by Microscopy high power field' concept">
				use = <"Use for Acetaminophen crystals [#/area] in Urine sediment by Microscopy high power field.">
				keywords = <"Cryst", "Crys", "Crystal", "Acetamin Cry", "APAP", "Acetaminoph", "ACET", "Paracetamol", "Acetamidophenol", "Hydroxyacetanilide", "Acetominophen", "p-Hydroxyacetanilide", "p-Acetamidophenol", "N-Acetyl-p-aminophenol", "N-(4-Hydroxyphenyl)acetanilide", "c209", "C55", "u209", "Tylenol", "#/area", "Number areic", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Micro", "LM", "Micros", "Microscopic", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.acetamin_cry_num_per_area_urns_hpf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"acetamin_cry_num_per_area_urns_hpf">
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/259034003">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/51213-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/51213-7">
			>
		>
	>
	adl_version = <"2.0.5">
