(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2532-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Lactate dehydrogenase [Enzymatic activity/volume] in Serum or Plasma' concept">
				use = <"Use for Lactate dehydrogenase [Enzymatic activity/volume] in Serum or Plasma.">
				keywords = <"LDH", "L.D.H", "Lactic acid dehydrogenase", "LD", "L-lactate dehydrogenase", "Lact", "2-Hydroxypropanoic acid", "2-hydroxy-propionic acid", "2-hydroxy-propionate", "Catalytic Concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Dehydrog", "Dehyrdogenase", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ldh_serplccnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ldh_serplccnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2532-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2532-0">
			>
		>
	>
	adl_version = <"2.0.5">
