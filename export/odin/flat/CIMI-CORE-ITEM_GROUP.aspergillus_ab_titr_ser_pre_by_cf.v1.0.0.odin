(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5053-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Aspergillus sp Ab [Titer] in Serum by Complement fixation' concept">
				use = <"Use for Aspergillus sp Ab [Titer] in Serum by Complement fixation.">
				keywords = <"Farmers lung", "Dilution factor", "Titer", "Titre", "Ttr", "Titered", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "CF", "Complement fixation", "Compfix", "Comp fixation", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "species", "spp", "Aspergil", "Asperg", "Aspergils", "Aspergilus", "Aspergilis", "Aspergilla", "Aspergillin", "Aspergillosis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.aspergillus_ab_titr_ser_pre_by_cf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"aspergillus_ab_titr_ser_pre_by_cf">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Aspergillus sp Ab [Titer] in Serum by Complement fixation">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{titer}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5053-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5053-4">
			>
		>
	>
	adl_version = <"2.0.5">
