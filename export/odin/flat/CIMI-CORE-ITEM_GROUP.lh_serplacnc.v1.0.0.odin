(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/10501-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Lutropin [Units/volume] in Serum or Plasma' concept">
				use = <"Use for Lutropin [Units/volume] in Serum or Plasma.">
				keywords = <"LH", "Interstitual cell stimulating hormone", "Leutinizing hormone", "Lutenizing hormone", "Lutenin", "Luteinizing hormone", "ICSH", "Interstitial cell-stimulating hormone", "Ovulation test", "Arbitrary concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.lh_serplacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"lh_serplacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Lutropin [Units/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"m[IU]/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/10501-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/10501-5">
			>
		>
	>
	adl_version = <"2.0.5">
