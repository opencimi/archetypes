(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33825-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'WBC casts [Presence] in Urine sediment by Light microscopy' concept">
				use = <"Use for WBC casts [Presence] in Urine sediment by Light microscopy.">
				keywords = <"WBC Casts", "Cast", "Arbitrary concentration", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Micro", "LM", "Micros", "Microscopic", "White blood cell", "Leuc", "Leuk", "Lkcs", "Leukocytes", "White blood cells", "WBCs", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.wbc_casts_urns_ql_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"wbc_casts_urns_ql_micro">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33825-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33825-1">
			>
		>
	>
	adl_version = <"2.0.5">
