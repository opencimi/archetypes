(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5789-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fatty casts [#/area] in Urine sediment by Microscopy low power field' concept">
				use = <"Use for Fatty casts [#/area] in Urine sediment by Microscopy low power field.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fatty_casts_num_per_area_urns_lpf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fatty_casts_num_per_area_urns_lpf">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5789-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5789-3">
			>
		>
	>
	adl_version = <"2.0.5">
