(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/47441-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hepatitis C virus Ab [Presence] in Serum from donor' concept">
				use = <"Use for Hepatitis C virus Ab [Presence] in Serum from donor.">
				keywords = <"HCVAB", "Hep C", "HCV", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Donr", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Hepatit", "Hepatis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hcv_ab_ser_donr_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hcv_ab_ser_donr_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hepatitis C virus Ab [Presence] in Serum from donor">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Hepatitis C virus Ab [Presence] in Serum from donor">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/47441-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/47441-1">
			>
		>
	>
	adl_version = <"2.0.5">
