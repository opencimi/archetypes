(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6299-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Urea nitrogen [Mass/volume] in Blood' concept">
				use = <"Use for Urea nitrogen [Mass/volume] in Blood.">
				keywords = <"Urea nit", "UN", "Blood urea nitrogen", "N2", "Nit", "N", "Mass concentration", "Level", "Point in time", "Random", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Chemistry", "BUN">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bun_bldmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bun_bldmcnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6299-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6299-2">
			>
		>
	>
	adl_version = <"2.0.5">
