(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.laboratory_test_request_summary.v2.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"laboratory_test_request_summary">
		release_version = <"2.0.0">
		version_status = <0>
		build_count = <0>
	>
	parent_archetype_id = <"CIMI-CORE-ITEM_GROUP.observation_request.v2">
	definition = <
			...
			["1"] = <
				...
				children = <
					...
					["7"] = (P_C_ARCHETYPE_ROOT) <
						rm_type_name = <"ITEM_GROUP">
						node_id = <"id0.0.0.1.1.1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.laboratory_test_request_action.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
				>
