(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13362-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Collection duration of Urine' concept">
				use = <"Use for Collection duration of Urine.">
				keywords = <"Durat", "Collect duration", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Coll", "Collected">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.collect_duration_time_ur.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"collect_duration_time_ur">
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258702006">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13362-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13362-9">
			>
		>
	>
	adl_version = <"2.0.5">
