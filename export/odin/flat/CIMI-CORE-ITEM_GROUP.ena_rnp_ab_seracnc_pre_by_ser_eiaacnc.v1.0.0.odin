(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/51928-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Ribonucleoprotein extractable nuclear Ab [Units/volume] in Serum by Immunoassay' concept">
				use = <"Use for Ribonucleoprotein extractable nuclear Ab [Units/volume] in Serum by Immunoassay.">
				keywords = <"Ro", "ENA RNP", "ANA", "Nuc", "ANF", "NA", "Antinuclear antibody", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Ribonuclear protein", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ena_rnp_ab_seracnc_pre_by_ser_eiaacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ena_rnp_ab_seracnc_pre_by_ser_eiaacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Ribonucleoprotein extractable nuclear Ab [Units/volume] in Serum by Immunoassay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[arb'U]">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258766007">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/51928-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/51928-0">
			>
		>
	>
	adl_version = <"2.0.5">
