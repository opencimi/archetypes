(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5191-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hepatitis B virus e Ag [Units/volume] in Serum by Immunoassay' concept">
				use = <"Use for Hepatitis B virus e Ag [Units/volume] in Serum by Immunoassay.">
				keywords = <"HBV e Ag", "HBEAG", "Hbe", "Hep Be", "HepB", "Hep B", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "Antigen", "Antigens", "Hepatit", "Hepatis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hbv_e_ag_seracnc_pre_by_ser_eiaacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hbv_e_ag_seracnc_pre_by_ser_eiaacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hepatitis B virus e Ag [Units/volume] in Serum by Immunoassay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[IU]/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5191-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5191-2">
			>
		>
	>
	adl_version = <"2.0.5">
