(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1988-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'C reactive protein [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for C reactive protein [Mass/volume] in Serum or Plasma.">
				keywords = <"Prot", "PR", "CRP", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Reac", "React", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.crp_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"crp_serplmcnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1988-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1988-5">
			>
		>
	>
	adl_version = <"2.0.5">
