(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/27071-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'CD45 (Lymphs) cells [#/volume] in Blood' concept">
				use = <"Use for CD45 (Lymphs) cells [#/volume] in Blood.">
				keywords = <"CD45 Cells", "Cell", "Cellularity", "CD45RO", "CD45RB", "CD45RA", "LCA", "B220", "CD45R", "CD45RC", "Leukocyte common antigen", "T200", "Ly5", "#", "Number concentration", "Count/volume", "Count", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "CELL MARKERS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cd45_cells_num_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cd45_cells_num_bld">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"CD45 (Lymphs) cells [#/volume] in Blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"/uL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/27071-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/27071-0">
			>
		>
	>
	adl_version = <"2.0.5">
