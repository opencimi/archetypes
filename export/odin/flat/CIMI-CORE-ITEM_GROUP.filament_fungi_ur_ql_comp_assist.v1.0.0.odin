(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33242-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fungi.filamentous [Presence] in Urine by Computer assisted method' concept">
				use = <"Use for Fungi.filamentous [Presence] in Urine by Computer assisted method.">
				keywords = <"Filament Fungi", "Fungal hyphae", "Arbitrary concentration", "Point in time", "Random", "Ur", "UR", "Urn", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Comp Assist", "Automated detection", "URINALYSIS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.filament_fungi_ur_ql_comp_assist.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"filament_fungi_ur_ql_comp_assist">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Fungi.filamentous [Presence] in Urine by Computer assisted method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Fungi.filamentous [Presence] in Urine by Computer assisted method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33242-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33242-9">
			>
		>
	>
	adl_version = <"2.0.5">
