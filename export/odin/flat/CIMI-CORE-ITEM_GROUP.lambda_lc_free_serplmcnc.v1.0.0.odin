(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33944-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Immunoglobulin light chains.lambda.free [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Immunoglobulin light chains.lambda.free [Mass/volume] in Serum or Plasma.">
				keywords = <"Lambda LC Free", "BJ Protein", "BJP", "Bence Jones protein", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Immune globulin", "Imunoglbon", "Immuno", "Imunoglobn", "Immunoglobin", "Immunoglob", "FR", "Non-protein bound", "Chain", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.lambda_lc_free_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"lambda_lc_free_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Immunoglobulin light chains.lambda.free [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/L">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258796002">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33944-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33944-0">
			>
		>
	>
	adl_version = <"2.0.5">
