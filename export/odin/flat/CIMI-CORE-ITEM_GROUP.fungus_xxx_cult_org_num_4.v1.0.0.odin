(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/17949-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fungus # 4 identified in Unspecified specimen by Culture' concept">
				use = <"Use for Fungus # 4 identified in Unspecified specimen by Culture.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fungus_xxx_cult_org_num_4.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fungus_xxx_cult_org_num_4">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Fungus # 4 identified in Unspecified specimen by Culture">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Fungus # 4 identified in Unspecified specimen by Culture">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/17949-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/17949-9">
			>
		>
	>
	adl_version = <"2.0.5">
