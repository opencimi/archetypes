(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/58441-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Other elements in Urine sediment' concept">
				use = <"Use for Other elements in Urine sediment.">
				keywords = <"Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Othr", "PANEL.URINALYSIS", "URINALYSIS", "PANEL.URINALYSIS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.other_elements_urns.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"other_elements_urns">
		release_version = <"1.0.0">
		version_status = <0>
		build_count = <0>
	>
	parent_archetype_id = <"CIMI-CORE-ITEM_GROUP.laboratory_test_other.v1">
	definition = <
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/58441-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/58441-7">
			>
		>
	>
	adl_version = <"2.0.5">
