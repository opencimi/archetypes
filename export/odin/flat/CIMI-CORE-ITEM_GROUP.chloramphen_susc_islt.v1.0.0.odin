(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/18903-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Chloramphenicol [Susceptibility]' concept">
				use = <"Use for Chloramphenicol [Susceptibility].">
				keywords = <"Chloramphen", "c225", "Mychel", "Amphicol", "Biophenicol", "Paraxin", "Chloromycetin", "Susceptibility", "Susceptibilty", "Sus", "Suscept", "Susceptibilities", "AST", "Point in time", "Random", "Islt", "Isol", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.chloramphen_susc_islt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"chloramphen_susc_islt">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Chloramphenicol [Susceptibility]">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Chloramphenicol [Susceptibility]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/18903-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/18903-5">
			>
		>
	>
	adl_version = <"2.0.5">
