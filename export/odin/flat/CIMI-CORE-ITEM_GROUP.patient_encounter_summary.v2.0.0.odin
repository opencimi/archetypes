(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'patient encounter summary' concept">
				use = <"Use for patient encounter summary.">
				keywords = <"patient", "encounter", "summary">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.patient_encounter_summary.v2.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"patient_encounter_summary">
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["id1.1.1.1"] = <"http://snomed.info/id/308335008">
			>
		>
	>
	adl_version = <"2.0.5">
