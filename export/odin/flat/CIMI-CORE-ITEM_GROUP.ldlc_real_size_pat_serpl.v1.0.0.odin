(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/47213-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cholesterol in LDL real size pattern [Identifier] in Serum or Plasma' concept">
				use = <"Use for Cholesterol in LDL real size pattern [Identifier] in Serum or Plasma.">
				keywords = <"LDLc real size Pat", "LDL-C", "Low density lipoprotein cholesterols", "Low density lipoprotein cholesterol", "Chol", "Choles", "Cholest", "Lipid", "Cholesterol total", "Cholesterols", "Identity or presence", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Nominal", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ldlc_real_size_pat_serpl.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ldlc_real_size_pat_serpl">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cholesterol in LDL real size pattern [Identifier] in Serum or Plasma">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Cholesterol in LDL real size pattern [Identifier] in Serum or Plasma">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/47213-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/47213-4">
			>
		>
	>
	adl_version = <"2.0.5">
