(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3050-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Triiodothyronine resin uptake (T3RU) in Serum or Plasma' concept">
				use = <"Use for Triiodothyronine resin uptake (T3RU) in Serum or Plasma.">
				keywords = <"T3uptake", "T3 uptake", "T3 binding ratio", "RT3U", "Triiodothyroinine uptake", "T3 RU", "T uptake", "Triodothyrne", "Total T3", "thyroid hormone", "T-3", "Number fraction", "Percent", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.t3ru_nfr_serpl.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"t3ru_nfr_serpl">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Triiodothyronine resin uptake (T3RU) in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3050-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3050-2">
			>
		>
	>
	adl_version = <"2.0.5">
