(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3175-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Antithrombin Ag [Units/volume] in Platelet poor plasma by Immunologic method' concept">
				use = <"Use for Antithrombin Ag [Units/volume] in Platelet poor plasma by Immunologic method.">
				keywords = <"AT III", "ATIII", "Antithrombn", "Antithrm", "Anti thrombin", "Antithrombin III", "Heparin cofactor I", "Thrombin inhibitor I", "Arbitrary concentration", "Point in time", "Random", "Platelet poor plasma", "Plas", "Quantitative", "QNT", "Quant", "Quan", "Immunology", "Immunol", "Antigen", "Antigens", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.at_iii_ag_ppp_immacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"at_iii_ag_ppp_immacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Antithrombin Ag [Units/volume] in Platelet poor plasma by Immunologic method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[arb'U]/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3175-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3175-7">
			>
		>
	>
	adl_version = <"2.0.5">
