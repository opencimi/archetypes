(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.g6pd_rbcccnt_post_by_rbc_glock_and_mcleanccnt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"g6pd_rbcccnt_post_by_rbc_glock_and_mcleanccnt">
