(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49048-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Protein feed time' concept">
				use = <"Use for Protein feed time.">
				keywords = <"Prot", "PR", "Time stamp", "Date and time", "Timestamp", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.protein_feed_time_patient.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"protein_feed_time_patient">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49048-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49048-2">
			>
		>
	>
	adl_version = <"2.0.5">
