(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3141-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Body weight Measured' concept">
				use = <"Use for Body weight Measured.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.weight_pre_by_measured.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"weight_pre_by_measured">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3141-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3141-9">
			>
		>
	>
	adl_version = <"2.0.5">
