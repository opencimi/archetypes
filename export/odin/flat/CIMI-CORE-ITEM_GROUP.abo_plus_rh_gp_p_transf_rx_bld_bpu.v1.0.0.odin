(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/46268-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'ABO + Rh group [Type] in Blood from Blood product unit--after transfusion reaction' concept">
				use = <"Use for ABO + Rh group [Type] in Blood from Blood product unit--after transfusion reaction.">
				keywords = <"Transf React", "Rh typing", "D typing", "Rh phenotyping", "D phenotyping", "ABO+Rh Gp", "ABO group and Rh type", "p transf rx", "Typ", "Point in time", "Random", "Blood", "WB", "Whole blood", "Blood product unit", "Nominal", "Rxn", "Tx", "PST", "After", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.abo_plus_rh_gp_p_transf_rx_bld_bpu.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"abo_plus_rh_gp_p_transf_rx_bld_bpu">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"ABO + Rh group [Type] in Blood from Blood product unit--after transfusion reaction">
				>
				["id1.1.1.1.1.1"] = <
					text = <"ABO + Rh group [Type] in Blood from Blood product unit--after transfusion reaction">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/46268-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/46268-9">
			>
		>
	>
	adl_version = <"2.0.5">
