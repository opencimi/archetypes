(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33006-8.html>">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cmv_dna_num_xxx_pcr.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cmv_dna_num_xxx_pcr">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cytomegalovirus DNA [#/volume] (viral load) in Unspecified specimen by Probe and target amplification method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{copies}/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33006-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33006-8">
			>
		>
	>
	adl_version = <"2.0.5">
