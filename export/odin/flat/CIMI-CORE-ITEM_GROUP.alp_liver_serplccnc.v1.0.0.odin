(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1779-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Alkaline phosphatase.liver [Enzymatic activity/volume] in Serum or Plasma' concept">
				use = <"Use for Alkaline phosphatase.liver [Enzymatic activity/volume] in Serum or Plasma.">
				keywords = <"ALP Liver", "ALP-1", "Alk phos", "Alkaline phos", "ALKP", "AP", "Alkaline phosphatase.total", "Catalytic Concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Phos", "Phosphtase", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.alp_liver_serplccnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"alp_liver_serplccnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Alkaline phosphatase.liver [Enzymatic activity/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"U/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1779-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1779-8">
			>
		>
	>
	adl_version = <"2.0.5">
