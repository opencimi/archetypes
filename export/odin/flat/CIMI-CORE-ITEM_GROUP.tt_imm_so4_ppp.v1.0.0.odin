(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33673-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Thrombin time.factor substitution in Platelet poor plasma by Coagulation assay --immediately after addition of protamine sulfate' concept">
				use = <"Use for Thrombin time.factor substitution in Platelet poor plasma by Coagulation assay --immediately after addition of protamine sulfate.">
				keywords = <"SO4-2", "Sulf", "SO4", "c10", "Rc207", "c207", "TT", "Thrombin time", "Thrombin clotting time", "TCT", "imm SO4", "Point in time", "Random", "Platelet poor plasma", "Plas", "Quantitative", "QNT", "Quant", "Quan", "Coagulation assay", "Clot", "Tilt tube", "Clottable", "Throm", "Protamine SO4", "PSO4", "Immediatedly after 1:1 addition of", "Fac", "Fact">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.tt_imm_so4_ppp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"tt_imm_so4_ppp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Thrombin time.factor substitution in Platelet poor plasma by Coagulation assay --immediately after addition of protamine sulfate">
				>
				["at0.0.0.0.0.2"] = <
					text = <"s">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33673-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33673-5">
			>
		>
	>
	adl_version = <"2.0.5">
