(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/7018-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Gentamicin.high potency [Susceptibility] by Minimum inhibitory concentration (MIC)' concept">
				use = <"Use for Gentamicin.high potency [Susceptibility] by Minimum inhibitory concentration (MIC).">
				keywords = <"Gentamicin Synergy", "Gentamicin synergy", "c213", "Gent", "Garamycin", "Genj", "Genirr", "Susceptibility", "Susceptibilty", "Sus", "Suscept", "Susceptibilities", "AST", "Point in time", "Random", "Islt", "Isol", "Minimum inhibitory concentration", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.gentamicin_synergy_susc_islt_pre_by_mic.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"gentamicin_synergy_susc_islt_pre_by_mic">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/7018-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/7018-5">
			>
		>
	>
	adl_version = <"2.0.5">
