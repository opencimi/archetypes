(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2335-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemoglobin.gastrointestinal [Presence] in Stool' concept">
				use = <"Use for Hemoglobin.gastrointestinal [Presence] in Stool.">
				keywords = <"Hemoccult", "Gastrocult", "Hemocult", "Fecal occult blood", "FOB", "Occult blood", "Guiac", "Gastrointest blood", "Occult blood in stool", "Hgb", "Hb", "Haemoglobin", "GI", "Arbitrary concentration", "Point in time", "Random", "Stl", "Feces", "Faeces", "Bowel movement", "Faecal", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hemoccult_stl_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hemoccult_stl_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Hemoglobin.gastrointestinal [Presence] in Stool">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2335-8">
			>
			["opencem"] = <
