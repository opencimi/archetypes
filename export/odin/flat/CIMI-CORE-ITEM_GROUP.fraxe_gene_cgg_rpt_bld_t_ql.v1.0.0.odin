(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/21760-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'FRAXE gene CGG repeats [Presence] in Blood or Tissue by Molecular genetics method' concept">
				use = <"Use for FRAXE gene CGG repeats [Presence] in Blood or Tissue by Molecular genetics method.">
				keywords = <"FRAXE gene CGG Rpt", "Arbitrary", "Point in time", "Random", "Bld/T", "Tissue", "Bld/T", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "PCR", "Molecular genetics", "Repeat", "Fragile X", "Fragile X mental retardation 2", "MRX2", "FRAXF", "FMR2", "MOLPATH.TRINUCLEOTIDE REPEATS", "MOLPATH.TRINUCLEOTIDE REPEATS", "Molecular pathology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fraxe_gene_cgg_rpt_bld_t_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fraxe_gene_cgg_rpt_bld_t_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"FRAXE gene CGG repeats [Presence] in Blood or Tissue by Molecular genetics method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"FRAXE gene CGG repeats [Presence] in Blood or Tissue by Molecular genetics method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/21760-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/21760-4">
			>
		>
	>
	adl_version = <"2.0.5">
