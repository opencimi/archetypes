(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/48642-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Glomerular filtration rate/1.73 sq M predicted among non-blacks by Creatinine-based formula (MDRD)' concept">
				use = <"Use for Glomerular filtration rate/1.73 sq M predicted among non-blacks by Creatinine-based formula (MDRD).">
				keywords = <"GFR", "Pred GFR.non Black", "Estimated GFR", "eGFR", "BSA pred.non black", "Volume rate/area", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Modification of Diet in Renal Disease", "Square Meter", "Glom", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.gfr_bsa_pred_non_black_serpl_mdrdarvrat.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"gfr_bsa_pred_non_black_serpl_mdrdarvrat">
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/419236008">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/48642-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/48642-3">
			>
		>
	>
	adl_version = <"2.0.5">
