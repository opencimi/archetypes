(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/8124-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'CD3 cells/100 cells in Blood' concept">
				use = <"Use for CD3 cells/100 cells in Blood.">
				keywords = <"CD3 Cells", "Cell", "Cellularity", "Leu-4", "Leu4", "T3", "Gated cells", "Number fraction", "Percent", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "CELL MARKERS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cd3_cells_nfr_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cd3_cells_nfr_bld">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"CD3 cells/100 cells in Blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/8124-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/8124-0">
			>
		>
	>
	adl_version = <"2.0.5">
