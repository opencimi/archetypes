(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49572-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Second trimester triple maternal screen [interpretation] in Serum or Plasma Narrative' concept">
				use = <"Use for Second trimester triple maternal screen [interpretation] in Serum or Plasma Narrative.">
				keywords = <"2nd trimester 3 screen", "Alpha-1-fetoprotein & Choriogonadotropin & Estriol.unconjugated", "Triple marker screen", "AFP X-tra", "Maternal screen 3", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Narrative", "Report", "Scr", "Scn", "Scrn", "Trip", "Tri", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.2nd_trimester_3_screen_serplimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"2nd_trimester_3_screen_serplimp">
		release_version = <"1.0.0">
		version_status = <0>
		build_count = <0>
	>
	parent_archetype_id = <"CIMI-CORE-ITEM_GROUP.laboratory_test_narrative.v1">
	definition = <
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1"] = <
					text = <"Laboratory test narrative">
				>
				["id5.0.8.0.1"] = <
					text = <"Result value">
				>
				["at0.0.0.0.0.1"] = <
					text = <"Second trimester triple maternal screen [interpretation] in Serum or Plasma Narrative">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Second trimester triple maternal screen [interpretation] in Serum or Plasma Narrative">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49572-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49572-1">
			>
		>
	>
	adl_version = <"2.0.5">
