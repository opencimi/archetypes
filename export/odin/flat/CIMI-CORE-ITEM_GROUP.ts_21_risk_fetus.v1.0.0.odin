(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/43995-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Trisomy 21 risk in Fetus' concept">
				use = <"Use for Trisomy 21 risk in Fetus.">
				keywords = <"Ts 21 risk", "Downs", "Down's syndrome", "ds", "Finding", "Findings", "Point in time", "Random", "Fetal", "Quantitative", "QNT", "Quant", "Quan", "Down syndrome", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ts_21_risk_fetus.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ts_21_risk_fetus">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/43995-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/43995-0">
			>
		>
	>
	adl_version = <"2.0.5">
