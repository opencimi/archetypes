(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/18487-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Broad casts [#/area] in Urine sediment by Microscopy low power field' concept">
				use = <"Use for Broad casts [#/area] in Urine sediment by Microscopy low power field.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.broad_casts_num_per_area_urns_lpf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"broad_casts_num_per_area_urns_lpf">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/18487-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/18487-9">
			>
		>
	>
	adl_version = <"2.0.5">
