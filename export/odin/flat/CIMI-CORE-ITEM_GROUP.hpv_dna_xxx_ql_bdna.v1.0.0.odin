(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/44547-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Human papilloma virus DNA [Presence] in Unspecified specimen by Probe and signal amplification method' concept">
				use = <"Use for Human papilloma virus DNA [Presence] in Unspecified specimen by Probe and signal amplification method.">
				keywords = <"HPV", "Human papillomavirus", "Genital warts", "Deoxyribonucleic acid", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "bDNA", "HPA", "Hybidization Protection Assay", "Bdn-A", "Branched Chain DNA", "Hybrid Capture", "Probe with signal amplification", "Hybrid Capture nucleic acid hybridization", "HC", "Amp Prb", "Probe with ampification", "DNA probe", "Amplification", "Amplified", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hpv_dna_xxx_ql_bdna.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hpv_dna_xxx_ql_bdna">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Human papilloma virus DNA [Presence] in Unspecified specimen by Probe and signal amplification method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Human papilloma virus DNA [Presence] in Unspecified specimen by Probe and signal amplification method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/44547-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/44547-8">
			>
		>
	>
	adl_version = <"2.0.5">
