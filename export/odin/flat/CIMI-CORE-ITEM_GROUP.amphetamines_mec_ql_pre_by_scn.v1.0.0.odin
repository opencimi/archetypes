(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/8146-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Amphetamines [Presence] in Meconium by Screen method' concept">
				use = <"Use for Amphetamines [Presence] in Meconium by Screen method.">
				keywords = <"Amphetam", "Amph", "Amphetamine", "Speed", "Point in time", "Random", "Mec", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Scn", "Scr", "Scrn", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.amphetamines_mec_ql_pre_by_scn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"amphetamines_mec_ql_pre_by_scn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Amphetamines [Presence] in Meconium by Screen method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Amphetamines [Presence] in Meconium by Screen method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/8146-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/8146-3">
			>
		>
	>
	adl_version = <"2.0.5">
