(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/57734-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Ketones [Presence] in Urine by Automated test strip' concept">
				use = <"Use for Ketones [Presence] in Urine by Automated test strip.">
				keywords = <"Acetoacetate", "Acetest", "Ketone", "Acetoacetates", "Acetone bodies", "Ketone bodies", "Arbitrary concentration", "Point in time", "Random", "Ur", "UR", "Urn", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Strip.auto", "Strip.auto", "Dipstick", "Dip stick", "Auto", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ketones_ur_ql_pre_by_strip_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ketones_ur_ql_pre_by_strip_auto">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Ketones [Presence] in Urine by Automated test strip">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Ketones [Presence] in Urine by Automated test strip">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/57734-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/57734-6">
			>
		>
	>
	adl_version = <"2.0.5">
