(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/42216-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Reference lab name [Identifier]' concept">
				use = <"Use for Reference lab name [Identifier].">
				keywords = <"Ref Lab Name", "Identifier", "Ident", "?Tm", "Ref Lab Test", "Narrative", "Report">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ref_lab_name.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ref_lab_name">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Reference lab name [Identifier]">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Reference lab name [Identifier]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/42216-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/42216-2">
			>
		>
	>
	adl_version = <"2.0.5">
