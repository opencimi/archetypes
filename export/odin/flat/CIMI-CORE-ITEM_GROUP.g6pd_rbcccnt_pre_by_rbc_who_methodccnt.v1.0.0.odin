(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49926-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Glucose-6-Phosphate dehydrogenase [Enzymatic activity/mass] in Red Blood Cells by WHO method' concept">
				use = <"Use for Glucose-6-Phosphate dehydrogenase [Enzymatic activity/mass] in Red Blood Cells by WHO method.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.g6pd_rbcccnt_pre_by_rbc_who_methodccnt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"g6pd_rbcccnt_pre_by_rbc_who_methodccnt">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Glucose-6-Phosphate dehydrogenase [Enzymatic activity/mass] in Red Blood Cells by WHO method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"U/g{Hb}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49926-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49926-9">
			>
		>
	>
	adl_version = <"2.0.5">
