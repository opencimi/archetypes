(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/16268-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Calcium phosphate crystals [Presence] in Stone by Infrared spectroscopy' concept">
				use = <"Use for Calcium phosphate crystals [Presence] in Stone by Infrared spectroscopy.">
				keywords = <"Phos", "Phosphrous", "Phosphorous", "Pi", "i Phos", "PO4", "Phosphorus", "Inorganic phosphate", "Phosphate total", "Cryst", "Crys", "Crystal", "Ca Phos Cry", "CaP", "Cal", "Point in time", "Random", "Stone", "Calc", "Stn", "Stones", "Calculi", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "IR", "Infared spectoscopy", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ca_phos_cry_stone_ql_ir.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ca_phos_cry_stone_ql_ir">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Calcium phosphate crystals [Presence] in Stone by Infrared spectroscopy">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Calcium phosphate crystals [Presence] in Stone by Infrared spectroscopy">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/16268-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/16268-5">
			>
		>
	>
	adl_version = <"2.0.5">
