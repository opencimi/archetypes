(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/22110-1.html>">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.b_henselae_igg_titr_ser.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"b_henselae_igg_titr_ser">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Bartonella henselae IgG Ab [Titer] in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{titer}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/22110-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/22110-1">
			>
		>
	>
	adl_version = <"2.0.5">
