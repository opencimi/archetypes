(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1751-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Albumin [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Albumin [Mass/volume] in Serum or Plasma.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.albumin_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"albumin_serplmcnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1751-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1751-7">
			>
		>
	>
	adl_version = <"2.0.5">
