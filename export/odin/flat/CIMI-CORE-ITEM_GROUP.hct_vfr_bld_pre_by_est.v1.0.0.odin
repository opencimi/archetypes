(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/48703-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hematocrit [Volume Fraction] of Blood by Estimated' concept">
				use = <"Use for Hematocrit [Volume Fraction] of Blood by Estimated.">
				keywords = <"Hct", "PCV", "Volume fraction", "Volfr", "Percent", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Est", "estimation", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hct_vfr_bld_pre_by_est.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hct_vfr_bld_pre_by_est">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hematocrit [Volume Fraction] of Blood by Estimated">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/48703-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/48703-3">
			>
		>
	>
	adl_version = <"2.0.5">
