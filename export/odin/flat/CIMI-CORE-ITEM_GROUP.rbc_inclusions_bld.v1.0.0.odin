(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49121-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Erythrocyte inclusion bodies [Identifier] in Blood' concept">
				use = <"Use for Erythrocyte inclusion bodies [Identifier] in Blood.">
				keywords = <"RBC inclusions", "Erythrocytes", "Red blood corpusles", "Red blood corpuscle", "Red blood cell", "Red cell", "Red cells", "Discocyte", "Erc", "Red blood cells", "Identity or presence", "Point in time", "Random", "Blood", "WB", "Whole blood", "Nominal", "Body", "bod", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.rbc_inclusions_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"rbc_inclusions_bld">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49121-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49121-7">
			>
		>
	>
	adl_version = <"2.0.5">
