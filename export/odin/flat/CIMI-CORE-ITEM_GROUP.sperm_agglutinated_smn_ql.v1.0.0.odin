(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33217-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Spermatozoa Agglutinated [Presence] in Semen' concept">
				use = <"Use for Spermatozoa Agglutinated [Presence] in Semen.">
				keywords = <"Sperm Agglutinated", "Arbitrary concentration", "Point in time", "Random", "Smn", "Ejaculate", "Seminal fluid", "SMPLS", "Sem", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "FERTILITY TESTING">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.sperm_agglutinated_smn_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"sperm_agglutinated_smn_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Spermatozoa Agglutinated [Presence] in Semen">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Spermatozoa Agglutinated [Presence] in Semen">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33217-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33217-1">
			>
		>
	>
	adl_version = <"2.0.5">
