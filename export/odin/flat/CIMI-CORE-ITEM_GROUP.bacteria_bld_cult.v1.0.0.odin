(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/600-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Bacteria identified in Blood by Culture' concept">
				use = <"Use for Bacteria identified in Blood by Culture.">
				keywords = <"Bact", "Identity or presence", "Point in time", "Random", "Blood", "WB", "Whole blood", "Nominal", "Cult", "Cultures", "C&S", "Isolated", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bacteria_bld_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bacteria_bld_cult">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/600-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/600-7">
			>
		>
	>
	adl_version = <"2.0.5">
