(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/25144-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Ammonium urate crystals [#/area] in Urine sediment by Microscopy high power field' concept">
				use = <"Use for Ammonium urate crystals [#/area] in Urine sediment by Microscopy high power field.">
				keywords = <"Urate Cry", "Urates", "Uric acid", "Cryst", "Crys", "Crystal", "Amm Urate Cry", "Ammonium biurate", "NH4U", "Ammonium acid urate", "Ammon", "NH4", "#/area", "Number areic", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Micro", "LM", "Micros", "Microscopic", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.amm_urate_cry_num_per_area_urns_hpf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"amm_urate_cry_num_per_area_urns_hpf">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/25144-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/25144-7">
			>
		>
	>
	adl_version = <"2.0.5">
