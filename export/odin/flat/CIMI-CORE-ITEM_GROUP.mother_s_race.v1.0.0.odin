(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/21484-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Mother's race' concept">
				use = <"Use for Mother's race.">
				keywords = <"Ethnicity", "Typ", "Point in time", "Random", "Mat", "Maternal", "Matnl", "Nominal">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.mother_s_race.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"mother_s_race">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/21484-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/21484-1">
			>
		>
	>
	adl_version = <"2.0.5">
