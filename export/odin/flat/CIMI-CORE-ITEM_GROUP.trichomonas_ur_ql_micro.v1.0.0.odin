(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32724-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Trichomonas sp [Presence] in Urine by Light microscopy' concept">
				use = <"Use for Trichomonas sp [Presence] in Urine by Light microscopy.">
				keywords = <"Trichomoniasis", "Arbitrary concentration", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "LM", "Micros", "Microscopic", "Trich", "Tric", "Trichomonad", "Trichomonads", "Trichimoniasis", "species", "spp", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.trichomonas_ur_ql_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"trichomonas_ur_ql_micro">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32724-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32724-7">
			>
		>
	>
	adl_version = <"2.0.5">
