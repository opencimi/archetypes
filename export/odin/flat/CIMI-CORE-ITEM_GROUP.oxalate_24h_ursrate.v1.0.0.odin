(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/14862-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oxalate [Moles/time] in 24 hour Urine' concept">
				use = <"Use for Oxalate [Moles/time] in 24 hour Urine.">
				keywords = <"Oxal", "Ethanedioic acid", "Ethanedioate", "Oxalic acid", "sRate", "Substance rate", "1 day", "24 hours", "24HR", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.oxalate_24h_ursrate.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"oxalate_24h_ursrate">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Oxalate [Moles/time] in 24 hour Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"umol/(24.h)">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258850001">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/14862-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/14862-7">
			>
		>
	>
	adl_version = <"2.0.5">
