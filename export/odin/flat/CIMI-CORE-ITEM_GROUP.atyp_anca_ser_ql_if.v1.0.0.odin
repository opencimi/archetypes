(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/29641-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Neutrophil Cytoplasmic Ab atypical [Presence] in Serum by Immunofluorescence' concept">
				use = <"Use for Neutrophil Cytoplasmic Ab atypical [Presence] in Serum by Immunofluorescence.">
				keywords = <"Atyp ANCA", "UC-ANCA", "X-ANCA", "ACPA", "Granulocyte ab", "Granulocyte nucleus ab", "ACNA", "PNM", "Neutrophils", "Neutr", "PMN", "Neut", "Cytopl", "Cytoplas", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ACIF", "FA", "Fluorescent antibody", "Immune fluorescence", "Fluoresent", "Immunoflour", "Immunofluor", "Immunofluorescence", "IFA", "Time Resolved Fluorescence", "Anticomplement Immunofluorescence", "TRF", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Reactive", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.atyp_anca_ser_ql_if.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"atyp_anca_ser_ql_if">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Neutrophil Cytoplasmic Ab atypical [Presence] in Serum by Immunofluorescence">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Neutrophil Cytoplasmic Ab atypical [Presence] in Serum by Immunofluorescence">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/29641-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/29641-8">
			>
		>
	>
	adl_version = <"2.0.5">
