(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/40665-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Reticulocytes [#/volume] in Blood by Manual' concept">
				use = <"Use for Reticulocytes [#/volume] in Blood by Manual.">
				keywords = <"Retics", "Retic", "Reticulocyte", "Polychromatophilic red cells", "#", "Number concentration", "Count/volume", "Count", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Manl", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.retics_num_pre_by_manual.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"retics_num_pre_by_manual">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Reticulocytes [#/volume] in Blood by Manual">
				>
				["at0.0.0.0.0.2"] = <
					text = <"10*3/uL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/40665-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/40665-2">
			>
		>
	>
	adl_version = <"2.0.5">
