(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49323-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemoglobin pattern [interpretation] in Blood by Electrophesis citrate agar' concept">
				use = <"Use for Hemoglobin pattern [interpretation] in Blood by Electrophesis citrate agar.">
				keywords = <"Hgb Fract", "Hb", "Haemoglobin", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Blood", "WB", "Whole blood", "Nominal", "Elph Citrate", "Elp", "Elect", "Electrophrs", "Electrophhrs", "Electr", "Elec", "Ep", "Electro", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hgb_fract_bldimp_pre_by_bld_elph_citrateimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hgb_fract_bldimp_pre_by_bld_elph_citrateimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hemoglobin pattern [interpretation] in Blood by Electrophesis citrate agar">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Hemoglobin pattern [interpretation] in Blood by Electrophesis citrate agar">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49323-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49323-9">
			>
		>
	>
	adl_version = <"2.0.5">
