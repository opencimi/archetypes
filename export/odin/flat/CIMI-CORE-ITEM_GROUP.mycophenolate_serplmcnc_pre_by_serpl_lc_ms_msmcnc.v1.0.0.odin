(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/55806-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Mycophenolate [Mass/volume] in Serum or Plasma by LC/MS/MS' concept">
				use = <"Use for Mycophenolate [Mass/volume] in Serum or Plasma by LC/MS/MS.">
				keywords = <"MMF", "Mycophenolic acid", "MPA", "Cellcept", "Mycophenolate mofetil", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.mycophenolate_serplmcnc_pre_by_serpl_lc_ms_msmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"mycophenolate_serplmcnc_pre_by_serpl_lc_ms_msmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Mycophenolate [Mass/volume] in Serum or Plasma by LC/MS/MS">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/55806-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/55806-4">
			>
		>
	>
	adl_version = <"2.0.5">
