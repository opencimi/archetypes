(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49049-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Collection time of Unspecified specimen' concept">
				use = <"Use for Collection time of Unspecified specimen.">
				keywords = <"Collect Tme", "Time stamp", "Date and time", "Timestamp", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Quantitative", "QNT", "Quant", "Quan", "Coll", "Collected">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.collect_tme_xxx.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"collect_tme_xxx">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Collection time of Unspecified specimen">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{clock_time}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49049-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49049-0">
			>
		>
	>
	adl_version = <"2.0.5">
