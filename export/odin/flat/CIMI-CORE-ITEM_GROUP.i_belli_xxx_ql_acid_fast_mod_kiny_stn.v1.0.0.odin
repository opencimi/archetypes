(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/10853-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Isospora belli [Presence] in Unspecified specimen by Acid fast stain.Kinyoun modified' concept">
				use = <"Use for Isospora belli [Presence] in Unspecified specimen by Acid fast stain.Kinyoun modified.">
				keywords = <"I belli", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Acid fast Mod Kiny Stn", "Acid fast Kiny Stn", "Acid fast Stn", "AFB stain", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.i_belli_xxx_ql_acid_fast_mod_kiny_stn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"i_belli_xxx_ql_acid_fast_mod_kiny_stn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Isospora belli [Presence] in Unspecified specimen by Acid fast stain.Kinyoun modified">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Isospora belli [Presence] in Unspecified specimen by Acid fast stain.Kinyoun modified">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/10853-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/10853-0">
			>
		>
	>
	adl_version = <"2.0.5">
