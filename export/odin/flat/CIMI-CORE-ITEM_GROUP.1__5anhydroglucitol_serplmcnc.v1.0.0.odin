(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/53835-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI '1,5-Anhydroglucitol [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for 1,5-Anhydroglucitol [Mass/volume] in Serum or Plasma.">
				keywords = <"1,5-AG", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "I", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.1__5anhydroglucitol_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"1__5anhydroglucitol_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"1,5-Anhydroglucitol [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/53835-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/53835-5">
			>
		>
	>
	adl_version = <"2.0.5">
