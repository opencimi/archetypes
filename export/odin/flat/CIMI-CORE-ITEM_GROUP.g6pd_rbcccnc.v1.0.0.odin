(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2357-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Glucose-6-Phosphate dehydrogenase [Enzymatic activity/volume] in Red Blood Cells' concept">
				use = <"Use for Glucose-6-Phosphate dehydrogenase [Enzymatic activity/volume] in Red Blood Cells.">
				keywords = <"Phos", "Phosphrous", "Phosphorous", "Pi", "i Phos", "PO4", "Phosphorus", "Inorganic phosphate", "Phosphate total", "G6PD", "G-6-PD", "Glucose-6-PD", "GPD", "G6PDH", "Glucose-6-PDH", "Glu", "Gluc", "Glucoseur", "Catalytic Concentration", "Point in time", "Random", "Erythrocytes", "Red blood corpusles", "Red blood cells", "Quantitative", "QNT", "Quant", "Quan", "Dehydrog", "Dehyrdogenase", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.g6pd_rbcccnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"g6pd_rbcccnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Glucose-6-Phosphate dehydrogenase [Enzymatic activity/volume] in Red Blood Cells">
				>
				["at0.0.0.0.0.2"] = <
					text = <"U/mL{RBCs}">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258903009">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2357-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2357-2">
			>
		>
	>
	adl_version = <"2.0.5">
