(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1668-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI '17-Hydroxyprogesterone [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for 17-Hydroxyprogesterone [Mass/volume] in Serum or Plasma.">
				keywords = <"17OHP", "Hydroxyproges", "17-P", "17-OHP", "17-hydroxy-progest", "17-OH Progesterone", "17-Hydroxypregn-4-en-3,20-dione", "17-alpha-hydroxyprogesterone", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Hydroxyprogstron", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.17ohp_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"17ohp_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"17-Hydroxyprogesterone [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1668-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1668-3">
			>
		>
	>
	adl_version = <"2.0.5">
