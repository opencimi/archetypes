(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5808-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Erythrocytes [#/volume] in Urine sediment by Microscopy high power field' concept">
				use = <"Use for Erythrocytes [#/volume] in Urine sediment by Microscopy high power field.">
				keywords = <"RBC", "Red blood corpusles", "Red blood corpuscle", "Erthrocyte", "Erythrocyte", "Red blood cell", "Red cell", "Red cells", "Discocytes", "Red blood cells", "RBCS", "#", "Number concentration", "Count/volume", "Count", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Micro", "LM", "Micros", "Microscopic", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.rbc_num_urns_hpf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"rbc_num_urns_hpf">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Erythrocytes [#/volume] in Urine sediment by Microscopy high power field">
				>
				["at0.0.0.0.0.2"] = <
					text = <"/mL">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/259035002">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5808-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5808-1">
			>
		>
	>
	adl_version = <"2.0.5">
