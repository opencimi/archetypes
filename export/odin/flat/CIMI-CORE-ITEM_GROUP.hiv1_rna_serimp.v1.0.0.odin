(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/24013-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'HIV 1 RNA [interpretation] in Serum' concept">
				use = <"Use for HIV 1 RNA [interpretation] in Serum.">
				keywords = <"Ribonucleic acid", "HIV1", "HIV type 1", "HIV type I", "AIDS", "Human immunodeficiency virus", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Serum", "SR", "Nominal", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hiv1_rna_serimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hiv1_rna_serimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"HIV 1 RNA [interpretation] in Serum">
				>
				["id1.1.1.1.1.1"] = <
					text = <"HIV 1 RNA [interpretation] in Serum">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/24013-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/24013-5">
			>
		>
	>
	adl_version = <"2.0.5">
