(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19087-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Collection of urine specimen end time' concept">
				use = <"Use for Collection of urine specimen end time.">
				keywords = <"Collect End Tme", "Time stamp", "Date and time", "Timestamp", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Coll", "Collected">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.collect_end_tme_ur.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"collect_end_tme_ur">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Collection of urine specimen end time">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{clock_time}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19087-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19087-6">
			>
		>
	>
	adl_version = <"2.0.5">
