(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/10728-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Trichomonas sp identified in Genital specimen by Organism specific culture' concept">
				use = <"Use for Trichomonas sp identified in Genital specimen by Organism specific culture.">
				keywords = <"Trichomoniasis", "Identity or presence", "Point in time", "Random", "Gen", "Genital tract", "Urogenit", "Urogenital", "Nominal", "Cult", "Cultures", "C&S", "Isolated", "Trich", "Tric", "Trichomonad", "Trichomonads", "Trichimoniasis", "species", "spp", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.trichomonas_genital_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"trichomonas_genital_cult">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Trichomonas sp identified in Genital specimen by Organism specific culture">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Trichomonas sp identified in Genital specimen by Organism specific culture">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/10728-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/10728-4">
			>
		>
	>
	adl_version = <"2.0.5">
