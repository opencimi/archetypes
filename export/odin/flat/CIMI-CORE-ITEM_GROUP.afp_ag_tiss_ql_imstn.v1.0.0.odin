(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/10459-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Alpha-1-Fetoprotein Ag [Presence] in Tissue by Immune stain' concept">
				use = <"Use for Alpha-1-Fetoprotein Ag [Presence] in Tissue by Immune stain.">
				keywords = <"AFP", "Alphafetoprotein", "Alpha fetoprotein", "Arbitrary concentration", "Point in time", "Random", "Tissue", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ImStn", "Immunostain", "Immunohistochemical stain", "IHC", "Antigen", "Antigens", "Imun", "Imune", "Imm", "Feto", "A1", "Alfa", "I", "PATHOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.afp_ag_tiss_ql_imstn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"afp_ag_tiss_ql_imstn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Alpha-1-Fetoprotein Ag [Presence] in Tissue by Immune stain">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Alpha-1-Fetoprotein Ag [Presence] in Tissue by Immune stain">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/10459-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/10459-6">
			>
		>
	>
	adl_version = <"2.0.5">
