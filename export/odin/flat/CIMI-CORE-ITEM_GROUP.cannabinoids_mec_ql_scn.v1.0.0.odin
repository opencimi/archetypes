(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/31080-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cannabinoids [Presence] in Meconium by Screen method' concept">
				use = <"Use for Cannabinoids [Presence] in Meconium by Screen method.">
				keywords = <"Cannabinoid", "THC", "Delta-9-tetrahydrocannabinol", "Marijuana", "Point in time", "Random", "Mec", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Scn", "Scr", "Scrn", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cannabinoids_mec_ql_scn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cannabinoids_mec_ql_scn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cannabinoids [Presence] in Meconium by Screen method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Cannabinoids [Presence] in Meconium by Screen method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/31080-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/31080-5">
			>
		>
	>
	adl_version = <"2.0.5">
