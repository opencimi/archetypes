(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/44891-0.html>">
			["tool"] = <"cimi-gen v0.0.1">
			["time"] = <"2015-08-05T22:27:23">
		>
		details = <
			["en"] = <
				language = <[ISO_639-1::en]>
				purpose = <"Archetype for CIMI 'Malignant cells [#/volume] in Pericardial fluid' concept">
				use = <"Use for Malignant cells [#/volume] in Pericardial fluid.">
				keywords = <"Cell", "Cellularity", "#", "Number concentration", "Count/volume", "Count", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Pcar", "PCAR", "Pericardial fluid", "Quantitative", "QNT", "Quant", "Quan", "Malig", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.malignant_cells_num_pcar.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"malignant_cells_num_pcar">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/44891-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/44891-0">
			>
		>
	>
	adl_version = <"2.0.5">
