(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/29541-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'HIV 1 RNA [Log #/volume] (viral load) in Plasma by Probe and target amplification method' concept">
				use = <"Use for HIV 1 RNA [Log #/volume] (viral load) in Plasma by Probe and target amplification method.">
				keywords = <"Ribonucleic acid", "HIV1", "HIV type 1", "HIV type I", "AIDS", "Human immunodeficiency virus", "Log#", "Log NCNC", "Point in time", "Random", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "PCR", "Polymerase chain reaction", "Transcription mediated amplification", "NASBA", "Nucleic acid sequence based analysis", "SDA", "Strand Displacement Amplification", "LAT", "Ligation-activated transcription", "3SR SR", "3 Self-Sustaining Sequence Replication", "LCR", "Ligase chain reaction", "QBR", "Probe with target amplification", "NAAT", "TMA", "Amp Prb", "Probe with ampification", "DNA probe", "Amplified", "Microbiology", "Viral load">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hiv1_rna_plas_pcrlog_num.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hiv1_rna_plas_pcrlog_num">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"HIV 1 RNA [Log #/volume] (viral load) in Plasma by Probe and target amplification method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{log_copies}/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/29541-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/29541-0">
			>
		>
	>
	adl_version = <"2.0.5">
