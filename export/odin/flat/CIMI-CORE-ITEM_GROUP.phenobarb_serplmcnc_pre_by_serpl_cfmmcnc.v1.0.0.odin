(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/60468-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Phenobarbital [Mass/volume] in Serum or Plasma by Confirmatory method' concept">
				use = <"Use for Phenobarbital [Mass/volume] in Serum or Plasma by Confirmatory method.">
				keywords = <"Phenobarb", "c417", "PHBR", "Nirvonal", "Luminal", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Cfm", "CNFR", "CNFRM", "Conf", "Confirmation", "GCMS", "Confirmatory", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.phenobarb_serplmcnc_pre_by_serpl_cfmmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"phenobarb_serplmcnc_pre_by_serpl_cfmmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Phenobarbital [Mass/volume] in Serum or Plasma by Confirmatory method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/60468-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/60468-6">
			>
		>
	>
	adl_version = <"2.0.5">
