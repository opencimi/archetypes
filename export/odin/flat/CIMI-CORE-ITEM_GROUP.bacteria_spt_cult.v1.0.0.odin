(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6460-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Bacteria identified in Sputum by Culture' concept">
				use = <"Use for Bacteria identified in Sputum by Culture.">
				keywords = <"Bact", "Identity or presence", "Point in time", "Random", "Spt", "Lower respiratory", "Nominal", "Cult", "Cultures", "C&S", "Isolated", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bacteria_spt_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bacteria_spt_cult">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Bacteria identified in Sputum by Culture">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Bacteria identified in Sputum by Culture">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6460-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6460-0">
			>
		>
	>
	adl_version = <"2.0.5">
