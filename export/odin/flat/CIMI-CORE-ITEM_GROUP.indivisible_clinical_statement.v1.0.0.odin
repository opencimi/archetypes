(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		details = <
			["en"] = <
				...
				purpose = <"Top-level reference archetype for CIMI 'indivisible clinical statement' concept">
				use = <"Use as a specialisation precursor for other high-level reference archetypes.">
				keywords = <"indivisible", "clinical", "statement">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.indivisible_clinical_statement.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"indivisible_clinical_statement">
