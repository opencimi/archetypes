(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/11111-2.html>">
			["tool"] = <"cimi-gen v0.0.1">
			["time"] = <"2015-08-05T22:26:43">
		>
		details = <
			["en"] = <
				language = <[ISO_639-1::en]>
				purpose = <"Archetype for CIMI 'Metamyelocytes/100 cells in Bone marrow by Manual count' concept">
				use = <"Use for Metamyelocytes/100 cells in Bone marrow by Manual count.">
				keywords = <"Metamyelocyte", "Metamyelocyte%", "Metas", "Meta", "Metamyelo", "Cell", "Cellularity", "Gated cells", "Number fraction", "Percent", "Point in time", "Random", "BM", "Bone marrow", "BON", "Quantitative", "QNT", "Quant", "Quan", "Manl", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.metamyelocytes_nfr_mar_manual.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"metamyelocytes_nfr_mar_manual">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/11111-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/11111-2">
			>
		>
	>
	adl_version = <"2.0.5">
