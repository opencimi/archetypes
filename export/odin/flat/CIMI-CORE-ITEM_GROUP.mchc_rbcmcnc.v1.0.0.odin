(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/28540-3.html>">
			["tool"] = <"cimi-gen v0.0.1">
			["time"] = <"2015-08-05T22:26:59">
		>
		details = <
			["en"] = <
				language = <[ISO_639-1::en]>
				purpose = <"Archetype for CIMI 'Erythrocyte mean corpuscular hemoglobin concentration [Mass/volume]' concept">
				use = <"Use for Erythrocyte mean corpuscular hemoglobin concentration [Mass/volume].">
				keywords = <"Hgb", "Hb", "Haemoglobin", "MCHC", "MCH", "Erythrocytes", "Red blood corpusles", "Red blood corpuscle", "Red blood cell", "Red cell", "Red cells", "Discocyte", "Erc", "Red blood cells", "Mass concentration", "Level", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "Average", "Avg", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.mchc_rbcmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"mchc_rbcmcnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/28540-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/28540-3">
			>
		>
	>
	adl_version = <"2.0.5">
