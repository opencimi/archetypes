(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/47320-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Baker's yeast IgA Ab [Units/volume] in Serum by Immunoassay' concept">
				use = <"Use for Baker's yeast IgA Ab [Units/volume] in Serum by Immunoassay.">
				keywords = <"Baker's yeast", "f045", "f45", "Yeast", "SCA", "ASCA", "Baker's yeast", "f403", "Immune globulin A", "Immunoglobulin A", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "ALLERGY TESTING", "Allergens", "Allergen">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.baker_s_yeast_iga_qn_pre_by_eia.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"baker_s_yeast_iga_qn_pre_by_eia">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Baker's yeast IgA Ab [Units/volume] in Serum by Immunoassay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[arb'U]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/47320-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/47320-7">
			>
		>
	>
	adl_version = <"2.0.5">
