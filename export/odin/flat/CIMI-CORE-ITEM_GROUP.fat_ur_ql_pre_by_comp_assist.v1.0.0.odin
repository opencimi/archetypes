(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/50227-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fat [Presence] in Urine by Computer assisted method' concept">
				use = <"Use for Fat [Presence] in Urine by Computer assisted method.">
				keywords = <"Arbitrary concentration", "Point in time", "Random", "Ur", "UR", "Urn", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Comp Assist", "Automated detection", "URINALYSIS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fat_ur_ql_pre_by_comp_assist.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fat_ur_ql_pre_by_comp_assist">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Fat [Presence] in Urine by Computer assisted method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Fat [Presence] in Urine by Computer assisted method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/50227-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/50227-8">
			>
		>
	>
	adl_version = <"2.0.5">
