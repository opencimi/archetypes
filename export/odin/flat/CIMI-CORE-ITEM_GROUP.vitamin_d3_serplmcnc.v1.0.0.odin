(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1990-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cholecalciferol (Vit D3) [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Cholecalciferol (Vit D3) [Mass/volume] in Serum or Plasma.">
				keywords = <"Vitamin D3", "Vit D3", "Colecalciferol", "Calciol", "C27H43OH", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.vitamin_d3_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"vitamin_d3_serplmcnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1990-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1990-1">
			>
		>
	>
	adl_version = <"2.0.5">
