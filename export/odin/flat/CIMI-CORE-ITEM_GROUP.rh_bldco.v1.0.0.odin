(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/14906-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Rh [Type] in Cord blood' concept">
				use = <"Use for Rh [Type] in Cord blood.">
				keywords = <"Rh typing", "D typing", "Rh phenotyping", "D phenotyping", "Typ", "Point in time", "Random", "Cord (umbilical) blood", "Cord bld", "Cord blood", "Nominal", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.rh_bldco.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"rh_bldco">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/14906-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/14906-2">
			>
		>
	>
	adl_version = <"2.0.5">
