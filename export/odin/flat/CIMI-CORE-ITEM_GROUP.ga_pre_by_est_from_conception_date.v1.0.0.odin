(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/53693-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Gestational age Estimated from conception date' concept">
				use = <"Use for Gestational age Estimated from conception date.">
				keywords = <"GA", "Point in time", "Random", "Fetal", "Quantitative", "QNT", "Quant", "Quan", "Est from conception date", "predicted", "estimation", "Gest", "Gestation", "Prenatal", "OBSTERICAL.ULTRASOUND", "OBSTERICAL.ULTRASOUND", "Obstetrical", "Obstetrics">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ga_pre_by_est_from_conception_date.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ga_pre_by_est_from_conception_date">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Gestational age Estimated from conception date">
				>
				["at0.0.0.0.0.2"] = <
					text = <"d">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/53693-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/53693-8">
			>
		>
	>
	adl_version = <"2.0.5">
