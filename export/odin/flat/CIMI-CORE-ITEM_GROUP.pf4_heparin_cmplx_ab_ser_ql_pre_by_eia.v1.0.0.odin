(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/57761-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Heparin induced platelet Ab [Presence] in Serum by Immunoassay' concept">
				use = <"Use for Heparin induced platelet Ab [Presence] in Serum by Immunoassay.">
				keywords = <"PF4-heparin Ab", "Heparin dependent antibodies", "Heparin induced thromocytopenia", "Heparin associated thrombycytopenia", "HAT", "HITA", "Platelet Ab.heparin induced", "HIT", "PF4 heparin cmplx", "PI-factor 4", "Platelet type heparin inactivator", "PF", "Plt", "Pl", "Platelets", "Thrombocytes", "Platelt", "Thrombocyte", "Hep", "Heparn", "Hepar", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Fac", "Fact", "Compx", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pf4_heparin_cmplx_ab_ser_ql_pre_by_eia.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pf4_heparin_cmplx_ab_ser_ql_pre_by_eia">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Heparin induced platelet Ab [Presence] in Serum by Immunoassay">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Heparin induced platelet Ab [Presence] in Serum by Immunoassay">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/57761-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/57761-9">
			>
		>
	>
	adl_version = <"2.0.5">
