(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/43113-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemoglobin electrophoresis panel in Blood' concept">
				use = <"Use for Hemoglobin electrophoresis panel in Blood.">
				keywords = <"Hgb Pnl", "Hb", "Haemoglobin", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Elph", "Elp", "Elect", "Electrophrs", "Electrophhrs", "Electr", "Elec", "Ep", "Electro", "Pan", "Panl", "PANEL.HEMATOLOGY& CELL COUNTS", "PANEL.HEMATOLOGY& CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hgb_pnl_bld_elph.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hgb_pnl_bld_elph">
			...
			["1"] = <
				...
				children = <
					...
					["20"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.1">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.hgb_fract_bld_elphimp.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["21"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.2">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.hgb_a_mfr_bld_elph.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["22"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.3">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.hgb_a1_mfr_bld.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["23"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.4">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.hgb_a2_mfr_bld.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["24"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.5">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.hgb_c_mfr_bld.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["25"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.6">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.hgb_f_mfr_bld.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["26"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.7">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.hgb_s_mfr_bld.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["27"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.8">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.hgb_fract_bldimp_pre_by_bld_elphimp.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
				>
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id0.1.1.1.1"] = <
					text = <"Hemoglobin pattern [interpretation] in Blood by Electrophoresis Narrative">
				>
				["id0.1.1.1.2"] = <
					text = <"Hemoglobin A/Hemoglobin.total in Blood by Electrophoresis">
				>
				["id0.1.1.1.3"] = <
					text = <"Hemoglobin A1/Hemoglobin.total in Blood">
				>
				["id0.1.1.1.4"] = <
					text = <"Hemoglobin A2/Hemoglobin.total in Blood">
				>
				["id0.1.1.1.5"] = <
					text = <"Hemoglobin C/Hemoglobin.total in Blood">
				>
				["id0.1.1.1.6"] = <
					text = <"Hemoglobin F/Hemoglobin.total in Blood">
				>
				["id0.1.1.1.7"] = <
					text = <"Hemoglobin S/Hemoglobin.total in Blood">
				>
				["id0.1.1.1.8"] = <
					text = <"Hemoglobin pattern [interpretation] in Blood by Electrophoresis">
				>
				["id1.1.1.1.1"] = <
					text = <"Hemoglobin electrophoresis panel in Blood">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/43113-0">
				["at0.0.0.0.1"] = <"http://loinc.org/id/43113-0">
				["id0.1.1.1.1"] = <"http://loinc.org/id/13514-5">
				["id0.1.1.1.2"] = <"http://loinc.org/id/20572-4">
				["id0.1.1.1.3"] = <"http://loinc.org/id/4547-6">
				["id0.1.1.1.4"] = <"http://loinc.org/id/4551-8">
				["id0.1.1.1.5"] = <"http://loinc.org/id/4563-3">
				["id0.1.1.1.6"] = <"http://loinc.org/id/4576-5">
				["id0.1.1.1.7"] = <"http://loinc.org/id/4625-0">
				["id0.1.1.1.8"] = <"http://loinc.org/id/49316-3">
			>
		>
	>
	adl_version = <"2.0.5">
