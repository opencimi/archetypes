(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3256-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fibrinogen Ag [Mass/volume] in Platelet poor plasma by Immunologic method' concept">
				use = <"Use for Fibrinogen Ag [Mass/volume] in Platelet poor plasma by Immunologic method.">
				keywords = <"FGN", "Coagulation factor I", "Mass concentration", "Level", "Point in time", "Random", "Platelet poor plasma", "Plas", "Quantitative", "QNT", "Quant", "Quan", "Immunology", "Immunol", "Antigen", "Antigens">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fibrinogen_ag_ppp_immmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fibrinogen_ag_ppp_immmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Fibrinogen Ag [Mass/volume] in Platelet poor plasma by Immunologic method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3256-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3256-5">
			>
		>
	>
	adl_version = <"2.0.5">
