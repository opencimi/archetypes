(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19258-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oxygen [Partial pressure] adjusted to patients actual temperature in Venous blood' concept">
				use = <"Use for Oxygen [Partial pressure] adjusted to patients actual temperature in Venous blood.">
				keywords = <"Temp", "O2", "tO2", "temp adj", "Partial pressure", "Point in time", "Random", "Blood - venous", "Bld ven", "Bld venous", "Blood venus", "Blood ven", "Venous", "Quantitative", "QNT", "Quant", "Quan", "Chemistry", "O2 partial pressure", "PO2">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.po2_temp_adj_bldv.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"po2_temp_adj_bldv">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19258-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19258-3">
			>
		>
	>
	adl_version = <"2.0.5">
