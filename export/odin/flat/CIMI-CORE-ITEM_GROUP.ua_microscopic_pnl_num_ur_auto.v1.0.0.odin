(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ua_microscopic_pnl_num_ur_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ua_microscopic_pnl_num_ur_auto">
			...
			["1"] = <
				...
				children = <
					...
					["20"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.1">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.wbc_clumps_num_ur_auto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["21"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.2">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.mucous_threads_num_ur_auto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["22"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.3">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.sperm_num_ur_auto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["23"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.4">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.bacteria_num_ur_auto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["24"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.5">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.crystals_num_ur_auto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["25"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.6">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.casts_num_ur_auto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["26"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.7">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.hyaline_casts_num_ur_auto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["27"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.8">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.nonsq_epi_cells_num_ur_auto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["28"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.9">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.squamous_num_ur_auto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["29"] = (P_C_ARCHETYPE_ROOT) <
						...
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.wbc_num_ur_pre_by_auto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["30"] = (P_C_ARCHETYPE_ROOT) <
						...
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.rbc_num_ur_pre_by_auto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
				>
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.1"] = <
					text = <"Urinalysis microscopic panel [#/volume] - Urine by Automated count">
				>
				["id0.1.1.1.1"] = <
					text = <"Leukocyte clumps [#/volume] in Urine by Automated count">
				>
				["id0.1.1.1.10"] = <
					text = <"Leukocytes [#/volume] in Urine by Automated count">
				>
				["id0.1.1.1.11"] = <
					text = <"Erythrocytes [#/volume] in Urine by Automated count">
				>
				["id0.1.1.1.2"] = <
					text = <"Mucus [#/volume] in Urine by Automated count">
				>
				["id0.1.1.1.3"] = <
					text = <"Spermatozoa [#/volume] in Urine by Automated count">
				>
				["id0.1.1.1.4"] = <
					text = <"Bacteria [#/volume] in Urine by Automated count">
				>
				["id0.1.1.1.5"] = <
					text = <"Crystals [#/volume] in Urine by Automated count">
				>
				["id0.1.1.1.6"] = <
					text = <"Casts [#/volume] in Urine by Automated count">
				>
				["id0.1.1.1.7"] = <
					text = <"Hyaline casts [#/volume] in Urine by Automated count">
				>
				["id0.1.1.1.8"] = <
					text = <"Epithelial cells.non-squamous [#/volume] in Urine by Automated count">
				>
				["id0.1.1.1.9"] = <
					text = <"Epithelial cells.squamous [#/volume] in Urine by Automated count">
				>
				["id1.1.1.1.1"] = <
					text = <"Urinalysis microscopic panel [#/volume] - Urine by Automated count">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/50554-5">
				["at0.0.0.0.1"] = <"http://loinc.org/id/50554-5">
				["id0.1.1.1.1"] = <"http://loinc.org/id/33768-3">
				["id0.1.1.1.2"] = <"http://loinc.org/id/51478-6">
				["id0.1.1.1.3"] = <"http://loinc.org/id/51479-4">
				["id0.1.1.1.4"] = <"http://loinc.org/id/51480-2">
				["id0.1.1.1.5"] = <"http://loinc.org/id/51482-8">
				["id0.1.1.1.6"] = <"http://loinc.org/id/51483-6">
				["id0.1.1.1.7"] = <"http://loinc.org/id/51484-4">
				["id0.1.1.1.8"] = <"http://loinc.org/id/51485-1">
				["id0.1.1.1.9"] = <"http://loinc.org/id/51486-9">
				["id0.1.1.1.10"] = <"http://loinc.org/id/51487-7">
				["id0.1.1.1.11"] = <"http://loinc.org/id/798-9">
			>
		>
	>
	adl_version = <"2.0.5">
