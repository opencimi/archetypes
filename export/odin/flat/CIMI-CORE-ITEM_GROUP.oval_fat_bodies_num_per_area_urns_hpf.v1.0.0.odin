(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5788-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oval fat bodies (globules) [#/area] in Urine sediment by Microscopy high power field' concept">
				use = <"Use for Oval fat bodies (globules) [#/area] in Urine sediment by Microscopy high power field.">
				keywords = <"Fat bodies.oval", "Fat droplets", "#/area", "Number areic", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Micro", "LM", "Micros", "Microscopic", "Body", "bod", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.oval_fat_bodies_num_per_area_urns_hpf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"oval_fat_bodies_num_per_area_urns_hpf">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Oval fat bodies (globules) [#/area] in Urine sediment by Microscopy high power field">
				>
				["at0.0.0.0.0.2"] = <
					text = <"/[HPF]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5788-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5788-5">
			>
		>
	>
	adl_version = <"2.0.5">
