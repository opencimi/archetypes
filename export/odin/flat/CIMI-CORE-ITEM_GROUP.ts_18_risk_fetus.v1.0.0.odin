(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/43994-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Trisomy 18 risk in Fetus' concept">
				use = <"Use for Trisomy 18 risk in Fetus.">
				keywords = <"Ts 18 risk", "Edward syndrome", "T18 risk", "Finding", "Findings", "Point in time", "Random", "Fetal", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ts_18_risk_fetus.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ts_18_risk_fetus">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/43994-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/43994-3">
			>
		>
	>
	adl_version = <"2.0.5">
