(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/18482-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Yeast [Presence] in Unspecified specimen by Organism specific culture' concept">
				use = <"Use for Yeast [Presence] in Unspecified specimen by Organism specific culture.">
				keywords = <"Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Cult", "Cultures", "C&S", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.yeast_xxx_ql_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"yeast_xxx_ql_cult">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Yeast [Presence] in Unspecified specimen by Organism specific culture">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Yeast [Presence] in Unspecified specimen by Organism specific culture">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/18482-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/18482-0">
			>
		>
	>
	adl_version = <"2.0.5">
