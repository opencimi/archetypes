(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/788-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Erythrocyte distribution width [Ratio] by Automated count' concept">
				use = <"Use for Erythrocyte distribution width [Ratio] by Automated count.">
				keywords = <"RDW", "Erythrocyte morphology index", "RCMI", "Erythrocytes", "Red blood corpusles", "Red blood corpuscle", "Red blood cell", "Red cell", "Red cells", "Discocyte", "Erc", "Red blood cells", "Rto", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "Auto", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS", "RDW-CV">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.rdw_rbcrto_pre_by_rbc_autorto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"rdw_rbcrto_pre_by_rbc_autorto">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/788-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/788-0">
			>
		>
	>
	adl_version = <"2.0.5">
