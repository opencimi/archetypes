(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5371-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Streptolysin O Ab [Titer] in Serum by Latex agglutination' concept">
				use = <"Use for Streptolysin O Ab [Titer] in Serum by Latex agglutination.">
				keywords = <"ASOT", "ASO", "Dilution factor", "Titer", "Titre", "Ttr", "Titered", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "Latex agglutination", "LAT", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Strep", "Strept", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.aso_ab_titr_ser_pre_by_la.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"aso_ab_titr_ser_pre_by_la">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Streptolysin O Ab [Titer] in Serum by Latex agglutination">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{titer}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5371-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5371-0">
			>
		>
	>
	adl_version = <"2.0.5">
