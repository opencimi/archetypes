(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/29280-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fibrin D-dimer [Presence] in Platelet poor plasma by Latex agglutination' concept">
				use = <"Use for Fibrin D-dimer [Presence] in Platelet poor plasma by Latex agglutination.">
				keywords = <"Fragment D-dimer", "Rhesus", "Rh", "Arbitrary concentration", "Point in time", "Random", "Platelet poor plasma", "Plas", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Latex agglutination", "LAT", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.d_dimer_ppp_ql_pre_by_la.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"d_dimer_ppp_ql_pre_by_la">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Fibrin D-dimer [Presence] in Platelet poor plasma by Latex agglutination">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Fibrin D-dimer [Presence] in Platelet poor plasma by Latex agglutination">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/29280-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/29280-5">
			>
		>
	>
	adl_version = <"2.0.5">
