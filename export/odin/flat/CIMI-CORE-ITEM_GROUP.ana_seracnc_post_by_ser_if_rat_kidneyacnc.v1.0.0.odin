(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ana_seracnc_post_by_ser_if_rat_kidneyacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ana_seracnc_post_by_ser_if_rat_kidneyacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.3"] = <
					text = <"Immunofluorescence (IF) rat kidney">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Nuclear Ab [Units/volume] in Serum">
				>
