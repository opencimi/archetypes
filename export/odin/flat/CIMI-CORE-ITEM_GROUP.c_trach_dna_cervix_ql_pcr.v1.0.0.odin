(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/21190-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Chlamydia trachomatis DNA [Presence] in Cervix by Probe and target amplification method' concept">
				use = <"Use for Chlamydia trachomatis DNA [Presence] in Cervix by Probe and target amplification method.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.c_trach_dna_cervix_ql_pcr.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"c_trach_dna_cervix_ql_pcr">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Chlamydia trachomatis DNA [Presence] in Cervix by Probe and target amplification method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Chlamydia trachomatis DNA [Presence] in Cervix by Probe and target amplification method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/21190-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/21190-4">
			>
		>
	>
	adl_version = <"2.0.5">
