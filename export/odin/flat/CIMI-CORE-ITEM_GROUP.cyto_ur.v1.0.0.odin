(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/11070-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Microscopic observation [Identifier] in Urine by Cyto stain' concept">
				use = <"Use for Microscopic observation [Identifier] in Urine by Cyto stain.">
				keywords = <"Micro", "Identity or presence", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Nominal", "Pap Smear", "Pap Stain", "Cytostain", "Cytology stain", "Papanicolaou smear">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cyto_ur.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cyto_ur">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Microscopic observation [Identifier] in Urine by Cyto stain">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Microscopic observation [Identifier] in Urine by Cyto stain">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/11070-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/11070-0">
			>
		>
	>
	adl_version = <"2.0.5">
