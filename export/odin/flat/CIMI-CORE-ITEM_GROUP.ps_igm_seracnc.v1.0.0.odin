(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/14246-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Phosphatidylserine IgM Ab [Units/volume] in Serum' concept">
				use = <"Use for Phosphatidylserine IgM Ab [Units/volume] in Serum.">
				keywords = <"PS", "aPS", "Phosphatidyl serine", "Immune globulin M", "Immunoglobulin M", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ps_igm_seracnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ps_igm_seracnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Phosphatidylserine IgM Ab [Units/volume] in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{MPS'U}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/14246-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/14246-3">
			>
		>
	>
	adl_version = <"2.0.5">
