(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1989-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Calcidiol [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Calcidiol [Mass/volume] in Serum or Plasma.">
				keywords = <"25(OH)D3", "25-hydroxycholecalciferol", "Vitamin D 25 hydroxy", "25-hydroxyvitamin D 3", "Calciderol", "25-hydroxyvitamin D3", "Calcifediol", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.25ohd3_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"25ohd3_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Calcidiol [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1989-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1989-3">
			>
		>
	>
	adl_version = <"2.0.5">
