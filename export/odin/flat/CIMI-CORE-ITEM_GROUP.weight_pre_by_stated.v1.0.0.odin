(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3142-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Body weight Stated' concept">
				use = <"Use for Body weight Stated.">
				keywords = <"Wt", "Bdy weight", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "bod", "Bodies", "BODY WEIGHT.ATOM", "BODY WEIGHT.ATOM">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.weight_pre_by_stated.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"weight_pre_by_stated">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3142-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3142-7">
			>
		>
	>
	adl_version = <"2.0.5">
