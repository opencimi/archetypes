(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/798-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Erythrocytes [#/volume] in Urine by Automated count' concept">
				use = <"Use for Erythrocytes [#/volume] in Urine by Automated count.">
				keywords = <"RBC", "Red blood corpusles", "Red blood corpuscle", "Erthrocyte", "Erythrocyte", "Red blood cell", "Red cell", "Red cells", "Discocytes", "Red blood cells", "RBCS", "#", "Number concentration", "Count/volume", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Ur", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Auto", "URINALYSIS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.rbc_num_ur_pre_by_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"rbc_num_ur_pre_by_auto">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/798-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/798-9">
			>
		>
	>
	adl_version = <"2.0.5">
