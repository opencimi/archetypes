(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/14907-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Rh [Type] in Blood from Blood product unit' concept">
				use = <"Use for Rh [Type] in Blood from Blood product unit.">
				keywords = <"Rh typing", "D typing", "Rh phenotyping", "D phenotyping", "Typ", "Point in time", "Random", "Blood", "WB", "Whole blood", "Blood product unit", "Nominal", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.rh_bld_bpu.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"rh_bld_bpu">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Rh [Type] in Blood from Blood product unit">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Rh [Type] in Blood from Blood product unit">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/14907-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/14907-0">
			>
		>
	>
	adl_version = <"2.0.5">
