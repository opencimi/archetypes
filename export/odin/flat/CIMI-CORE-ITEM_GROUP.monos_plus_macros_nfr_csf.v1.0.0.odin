(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/30436-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Monocytes+Macrophages/100 leukocytes in Cerebral spinal fluid' concept">
				use = <"Use for Monocytes+Macrophages/100 leukocytes in Cerebral spinal fluid.">
				keywords = <"Monos+Macros", "Monos+Macros", "Monos", "Mono", "Monocyte", "Macros", "Macrphg", "Macrophage", "Macrop", "WBC", "White blood cell", "Leuc", "Leuk", "Leukocyte", "Lkcs", "White blood cells", "WBCs", "100WBC", "Number fraction", "Percent", "Point in time", "Random", "Cerebral spinal fluid", "Spinal Fluid", "Cerebrospinal Fl", "Spinal Flu", "Spinal Fld", "Quantitative", "QNT", "Quant", "Quan", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.monos_plus_macros_nfr_csf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"monos_plus_macros_nfr_csf">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/30436-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/30436-0">
			>
		>
	>
	adl_version = <"2.0.5">
