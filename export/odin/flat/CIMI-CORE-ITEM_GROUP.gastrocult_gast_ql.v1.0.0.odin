(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2334-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemoglobin.gastrointestinal [Presence] in Gastric fluid' concept">
				use = <"Use for Hemoglobin.gastrointestinal [Presence] in Gastric fluid.">
				keywords = <"Hemoccult", "Gastrocult", "Hemocult", "Fecal occult blood", "FOB", "Occult blood", "Guiac", "Gastrointest blood", "Occult blood in stool", "Hgb", "Hb", "Haemoglobin", "GI", "Arbitrary concentration", "Point in time", "Random", "Gastric contents", "Gastric fluid", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.gastrocult_gast_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"gastrocult_gast_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Hemoglobin.gastrointestinal [Presence] in Gastric fluid">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2334-1">
			>
			["opencem"] = <
