(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6012-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'von Willebrand factor (vWf) Ag [Units/volume] in Platelet poor plasma by Immunologic method' concept">
				use = <"Use for von Willebrand factor (vWf) Ag [Units/volume] in Platelet poor plasma by Immunologic method.">
				keywords = <"vWF:Ag", "vWf", "Arbitrary concentration", "Point in time", "Random", "Platelet poor plasma", "Plas", "Quantitative", "QNT", "Quant", "Quan", "Immunology", "Immunol", "Antigen", "Antigens", "Vonwillebrand", "Von will", "Fac", "Fact", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.vwf_ag_pppacnc_pre_by_ppp_immacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"vwf_ag_pppacnc_pre_by_ppp_immacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"von Willebrand factor (vWf) Ag [Units/volume] in Platelet poor plasma by Immunologic method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[IU]/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6012-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6012-9">
			>
		>
	>
	adl_version = <"2.0.5">
