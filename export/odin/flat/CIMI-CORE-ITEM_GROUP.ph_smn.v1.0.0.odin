(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2752-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'pH of Semen' concept">
				use = <"Use for pH of Semen.">
				keywords = <"Log molar concentration", "Point in time", "Random", "Smn", "Ejaculate", "Seminal fluid", "SMPLS", "Sem", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ph_smn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ph_smn">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2752-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2752-4">
			>
		>
	>
	adl_version = <"2.0.5">
