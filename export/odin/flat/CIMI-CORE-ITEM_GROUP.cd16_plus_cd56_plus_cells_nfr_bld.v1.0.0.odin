(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/18267-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'CD16+CD56+ cells/100 cells in Blood' concept">
				use = <"Use for CD16+CD56+ cells/100 cells in Blood.">
				keywords = <"CD16+CD56+ Cells", "CD16+CD56+ Cells", "CD16 Cells", "Cell", "Cellularity", "Leu19", "Leu-19", "NKH1", "Neural cell adhesion molecule", "NCAM", "Leu-11", "Leu11", "Leu11b", "Leu-11B", "Gated cells", "Number fraction", "Percent", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "CELL MARKERS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cd16_plus_cd56_plus_cells_nfr_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cd16_plus_cd56_plus_cells_nfr_bld">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"CD16+CD56+ cells/100 cells in Blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/18267-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/18267-5">
			>
		>
	>
	adl_version = <"2.0.5">
