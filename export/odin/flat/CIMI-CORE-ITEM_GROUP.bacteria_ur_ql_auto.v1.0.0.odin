(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/50221-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Bacteria [Presence] in Urine by Automated' concept">
				use = <"Use for Bacteria [Presence] in Urine by Automated.">
				keywords = <"Bact", "Arbitrary concentration", "Point in time", "Random", "Ur", "UR", "Urn", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Auto", "URINALYSIS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bacteria_ur_ql_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bacteria_ur_ql_auto">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/50221-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/50221-1">
			>
		>
	>
	adl_version = <"2.0.5">
