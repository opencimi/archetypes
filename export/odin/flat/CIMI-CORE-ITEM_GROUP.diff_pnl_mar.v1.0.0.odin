(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/47286-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Differential panel - Bone marrow' concept">
				use = <"Use for Differential panel - Bone marrow.">
				keywords = <"Diff Pnl", "Point in time", "Random", "BM", "Bone marrow", "BON", "Quantitative", "QNT", "Quant", "Quan", "Pan", "Panl", "Differl", "Differn", "PANEL.HEMATOLOGY& CELL COUNTS", "PANEL.HEMATOLOGY& CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.diff_pnl_mar.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"diff_pnl_mar">
			...
			["1"] = <
				...
				children = <
					...
					["20"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.1">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.metamyelocytes_nfr_mar_manual.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["21"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.2">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.rbc_mar.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["22"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.3">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.nrbc_total_cells_nfr_mar_manual.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
				>
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.1"] = <
					text = <"Differential panel - Bone marrow">
				>
				["id0.1.1.1.1"] = <
					text = <"Metamyelocytes/100 cells in Bone marrow by Manual count">
				>
				["id0.1.1.1.2"] = <
					text = <"Erythrocytes [Morphology] in Bone marrow">
				>
				["id0.1.1.1.3"] = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/47286-0">
				["at0.0.0.0.1"] = <"http://loinc.org/id/47286-0">
				["id0.1.1.1.1"] = <"http://loinc.org/id/11111-2">
				["id0.1.1.1.2"] = <"http://loinc.org/id/11127-8">
				["id0.1.1.1.3"] = <"http://loinc.org/id/42215-4">
			>
		>
	>
	adl_version = <"2.0.5">
