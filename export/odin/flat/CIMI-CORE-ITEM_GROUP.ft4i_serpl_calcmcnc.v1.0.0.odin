(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32215-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Thyroxine (T4) free index in Serum or Plasma by calculation' concept">
				use = <"Use for Thyroxine (T4) free index in Serum or Plasma by calculation.">
				keywords = <"FT4I", "thyroid hormone", "T7", "FTI", "T4 Free", "T-4", "FreeT4", "Thyrox", "Thyrx", "TT4", "Total T4", "Thyroxin", "Levothyroxine", "Levo-thyroxine", "L-thyroxine", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Calc", "Calculation", "FT4", "FR", "Non-protein bound", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ft4i_serpl_calcmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ft4i_serpl_calcmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Thyroxine (T4) free index in Serum or Plasma by calculation">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{Index_val}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32215-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32215-6">
			>
		>
	>
	adl_version = <"2.0.5">
