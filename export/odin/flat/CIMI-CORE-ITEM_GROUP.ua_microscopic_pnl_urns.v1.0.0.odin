(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ua_microscopic_pnl_urns.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ua_microscopic_pnl_urns">
			...
			["1"] = <
				...
				children = <
					...
					["20"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.1">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.urns_cmnt_micro.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["21"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.2">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.micro_urns.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["22"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.3">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.other_elements_urns.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["23"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.2.1.1">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.casts_pnl_urns.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["24"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.2.1.2">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.crystals_pnl_urns.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["25"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.2.1.3">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.cells_pnl_urns.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["26"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.2.1.4">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.microrganisms_pnl_urns.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
				>
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.1"] = <
					text = <"Urinalysis microscopic panel - Urine sediment">
				>
				["id0.1.1.1.1"] = <
					text = <"Urine sediment comments by Light microscopy Narrative">
				>
				["id0.1.1.1.2"] = <
					text = <"Microscopic observation [Identifier] in Urine sediment by Light microscopy">
				>
				["id0.1.1.1.3"] = <
					text = <"Other elements in Urine sediment">
				>
				["id0.1.2.1.1"] = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/24365-9">
				["at0.0.0.0.1"] = <"http://loinc.org/id/24365-9">
				["id0.1.1.1.1"] = <"http://loinc.org/id/11279-7">
				["id0.1.1.1.2"] = <"http://loinc.org/id/12235-8">
				["id0.1.1.1.3"] = <"http://loinc.org/id/58441-7">
				["id0.1.2.1.1"] = <"http://loinc.org/id/58432-6">
				["id0.1.2.1.2"] = <"http://loinc.org/id/58433-4">
				["id0.1.2.1.3"] = <"http://loinc.org/id/58434-2">
				["id0.1.2.1.4"] = <"http://loinc.org/id/58435-9">
			>
		>
	>
	adl_version = <"2.0.5">
