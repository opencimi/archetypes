(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/7057-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Trimethoprim+Sulfamethoxazole [Susceptibility] by Gradient strip (E-test)' concept">
				use = <"Use for Trimethoprim+Sulfamethoxazole [Susceptibility] by Gradient strip (E-test).">
				keywords = <"TMP SMX", "Cotrimoxazole", "SXT", "Bactrim", "Septra", "SMX-TMP", "Co-trimoxazole", "Cotrim", "Trimpex", "Trimeth", "c202", "C62", "c242", "Proloprim", "Polytrim", "Sulfa", "Sulfamethox", "c203", "Acetylsulfamethoxazole", "C61", "c223", "Gantanol", "Susceptibility", "Susceptibilty", "Sus", "Suscept", "Susceptibilities", "AST", "Point in time", "Random", "Islt", "Isol", "E-test", "E-strip", "Etest", "Estrip", "E-test", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.tmp_smx_susc_islt_pre_by_etest.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"tmp_smx_susc_islt_pre_by_etest">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Trimethoprim+Sulfamethoxazole [Susceptibility] by Gradient strip (E-test)">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Trimethoprim+Sulfamethoxazole [Susceptibility] by Gradient strip (E-test)">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/7057-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/7057-3">
			>
		>
	>
	adl_version = <"2.0.5">
