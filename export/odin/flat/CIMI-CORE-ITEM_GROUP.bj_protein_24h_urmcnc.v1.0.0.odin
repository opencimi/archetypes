(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/17793-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Immunoglobulin light chains [Mass/volume] in 24 hour Urine' concept">
				use = <"Use for Immunoglobulin light chains [Mass/volume] in 24 hour Urine.">
				keywords = <"BJ Protein", "BJP", "Bence Jones protein", "Mass concentration", "Level", "1 day", "24 hours", "24HR", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Immune globulin", "Imunoglbon", "Immuno", "Imunoglobn", "Immunoglobin", "Immunoglob", "Chain", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bj_protein_24h_urmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bj_protein_24h_urmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Immunoglobulin light chains [Mass/volume] in 24 hour Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"g/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/17793-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/17793-1">
			>
		>
	>
	adl_version = <"2.0.5">
