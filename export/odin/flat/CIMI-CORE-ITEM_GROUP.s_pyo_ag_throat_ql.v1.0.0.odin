(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/18481-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Streptococcus pyogenes Ag [Presence] in Throat' concept">
				use = <"Use for Streptococcus pyogenes Ag [Presence] in Throat.">
				keywords = <"S pyo", "S pyogenes", "GAS", "Steptococcus Group A", "Group A Strep", "Streptococci group A", "Streptococcus group A", "Arbitrary concentration", "Point in time", "Random", "Throat", "Upper respiratory", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Antigen", "Antigens", "Strept", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.s_pyo_ag_throat_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"s_pyo_ag_throat_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Streptococcus pyogenes Ag [Presence] in Throat">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/18481-2">
			>
			["opencem"] = <
