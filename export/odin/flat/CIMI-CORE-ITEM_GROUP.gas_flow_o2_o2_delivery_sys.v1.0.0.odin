(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19941-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oxygen gas flow Oxygen delivery system' concept">
				use = <"Use for Oxygen gas flow Oxygen delivery system.">
				keywords = <"O2", "tO2", "Gas flow.O2", "vRate", "Volume rate", "Point in time", "Random", "O2 delivery sys", "Quantitative", "QNT", "Quant", "Quan", "Gases", "Dynamic", "PULMONARY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.gas_flow_o2_o2_delivery_sys.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"gas_flow_o2_o2_delivery_sys">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Oxygen gas flow Oxygen delivery system">
				>
				["at0.0.0.0.0.2"] = <
					text = <"L/min">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258994006">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19941-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19941-4">
			>
		>
	>
	adl_version = <"2.0.5">
