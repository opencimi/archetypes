(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2502-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Iron saturation [Mass Fraction] in Serum or Plasma' concept">
				use = <"Use for Iron saturation [Mass Fraction] in Serum or Plasma.">
				keywords = <"Iron Satn", "Iron/Iron binding capacity.total", "FE/TIBC", "Transferrin saturation", "Fe", "Mass fraction", "Percent", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "SAT", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.iron_satn_mfr_serpl.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"iron_satn_mfr_serpl">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Iron saturation [Mass Fraction] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2502-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2502-3">
			>
		>
	>
	adl_version = <"2.0.5">
