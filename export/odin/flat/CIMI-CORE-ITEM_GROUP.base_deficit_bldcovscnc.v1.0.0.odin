(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/28637-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Base deficit in Venous cord blood' concept">
				use = <"Use for Base deficit in Venous cord blood.">
				keywords = <"Base ex neg", "BSE", "Substance concentration", "Level", "Point in time", "Random", "Bld cord", "Cord venous blood", "Cord BldV", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.base_deficit_bldcovscnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"base_deficit_bldcovscnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Base deficit in Venous cord blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mmol/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/28637-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/28637-7">
			>
		>
	>
	adl_version = <"2.0.5">
