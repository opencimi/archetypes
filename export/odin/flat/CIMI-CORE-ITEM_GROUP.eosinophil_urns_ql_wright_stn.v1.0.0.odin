(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49839-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Eosinophils [Presence] in Urine sediment by Wright stain' concept">
				use = <"Use for Eosinophils [Presence] in Urine sediment by Wright stain.">
				keywords = <"Eosinophil", "Eos", "Eosins", "Eosin", "Eosino", "Arbitrary concentration", "Point in time", "Random", "UrnS", "Urine sediment", "UA", "UR", "Urn", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Wright Stn", "Wrights", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.eosinophil_urns_ql_wright_stn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"eosinophil_urns_ql_wright_stn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Eosinophils [Presence] in Urine sediment by Wright stain">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Eosinophils [Presence] in Urine sediment by Wright stain">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49839-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49839-4">
			>
		>
	>
	adl_version = <"2.0.5">
