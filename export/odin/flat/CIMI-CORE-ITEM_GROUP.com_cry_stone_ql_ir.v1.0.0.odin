(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/16264-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Calcium oxalate monohydrate crystals [Presence] in Stone by Infrared spectroscopy' concept">
				use = <"Use for Calcium oxalate monohydrate crystals [Presence] in Stone by Infrared spectroscopy.">
				keywords = <"Oxal", "Ethanedioic acid", "Ethanedioate", "Oxalic acid", "Cryst", "Crys", "Crystal", "COM Cry", "CaC2O4.H2O", "Whewellite", "Whewelite", "CaOx", "CaC2O4", "Cal", "Ca", "Point in time", "Random", "Stone", "Calc", "Stn", "Stones", "Calculi", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "IR", "Infared spectoscopy", "Monohydrt", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.com_cry_stone_ql_ir.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"com_cry_stone_ql_ir">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Calcium oxalate monohydrate crystals [Presence] in Stone by Infrared spectroscopy">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Calcium oxalate monohydrate crystals [Presence] in Stone by Infrared spectroscopy">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/16264-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/16264-4">
			>
		>
	>
	adl_version = <"2.0.5">
