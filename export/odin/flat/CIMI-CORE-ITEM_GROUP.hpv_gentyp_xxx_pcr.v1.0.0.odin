(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/48560-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Human papilloma virus genotype [Identifier] in Unspecified specimen by Probe and target amplification method' concept">
				use = <"Use for Human papilloma virus genotype [Identifier] in Unspecified specimen by Probe and target amplification method.">
				keywords = <"HPV", "Human papillomavirus", "Genital warts", "Identity or presence", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Nominal", "PCR", "Polymerase chain reaction", "Transcription mediated amplification", "NASBA", "Nucleic acid sequence based analysis", "SDA", "Strand Displacement Amplification", "LAT", "Ligation-activated transcription", "3SR SR", "3 Self-Sustaining Sequence Replication", "LCR", "Ligase chain reaction", "QBR", "Probe with target amplification", "NAAT", "TMA", "Amp Prb", "Probe with ampification", "DNA probe", "Gentyp", "Amplified", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hpv_gentyp_xxx_pcr.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hpv_gentyp_xxx_pcr">
		release_version = <"1.0.0">
		version_status = <0>
		build_count = <0>
	>
	parent_archetype_id = <"CIMI-CORE-ITEM_GROUP.laboratory_test_nominal.v1">
	definition = <
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1"] = <
					text = <"Laboratory test nominal">
				>
				["id5.0.8.0.1"] = <
					text = <"Result value">
				>
				["at0.0.0.0.0.1"] = <
					text = <"Human papilloma virus genotype [Identifier] in Unspecified specimen by Probe and target amplification method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Human papilloma virus genotype [Identifier] in Unspecified specimen by Probe and target amplification method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/48560-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/48560-7">
			>
		>
	>
	adl_version = <"2.0.5">
