(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6410-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Gardnerella vaginalis rRNA [Presence] in Genital specimen by DNA probe' concept">
				use = <"Use for Gardnerella vaginalis rRNA [Presence] in Genital specimen by DNA probe.">
				keywords = <"G vaginalis", "Arbitrary concentration", "Point in time", "Random", "Gen", "Genital tract", "Urogenit", "Urogenital", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Prb", "DNA probe", "ribosomal RNA", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.g_vaginalis_rrna_genital_ql_prb.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"g_vaginalis_rrna_genital_ql_prb">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Gardnerella vaginalis rRNA [Presence] in Genital specimen by DNA probe">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Gardnerella vaginalis rRNA [Presence] in Genital specimen by DNA probe">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6410-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6410-5">
			>
		>
	>
	adl_version = <"2.0.5">
