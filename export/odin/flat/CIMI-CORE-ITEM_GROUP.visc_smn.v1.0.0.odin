(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/9631-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Viscosity of Semen' concept">
				use = <"Use for Viscosity of Semen.">
				keywords = <"Vicos", "Viscos", "Point in time", "Random", "Smn", "Ejaculate", "Seminal fluid", "SMPLS", "Sem", "Quantitative", "QNT", "Quant", "Quan">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.visc_smn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"visc_smn">
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/259040005">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/9631-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/9631-3">
			>
		>
	>
	adl_version = <"2.0.5">
