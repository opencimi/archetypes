(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13943-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fructose [Presence] in Semen' concept">
				use = <"Use for Fructose [Presence] in Semen.">
				keywords = <"Levulose", "Revulose", "Arbitrary concentration", "Point in time", "Random", "Smn", "Ejaculate", "Seminal fluid", "SMPLS", "Sem", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fructose_smn_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fructose_smn_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Fructose [Presence] in Semen">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Fructose [Presence] in Semen">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13943-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13943-6">
			>
		>
	>
	adl_version = <"2.0.5">
