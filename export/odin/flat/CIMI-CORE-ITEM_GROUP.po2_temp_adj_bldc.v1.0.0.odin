(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19256-7.html>">
			["tool"] = <"cimi-gen v0.0.1">
			["time"] = <"2015-08-05T22:26:49">
		>
		details = <
			["en"] = <
				language = <[ISO_639-1::en]>
				purpose = <"Archetype for CIMI 'Oxygen [Partial pressure] adjusted to patients actual temperature in Capillary blood' concept">
				use = <"Use for Oxygen [Partial pressure] adjusted to patients actual temperature in Capillary blood.">
				keywords = <"Temp", "O2", "tO2", "temp adj", "Partial pressure", "Point in time", "Random", "Cap blood", "Cap bld", "Capillary bld", "Capillary blood", "Finger stick", "Quantitative", "QNT", "Quant", "Quan", "Chemistry", "O2 partial pressure", "PO2">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.po2_temp_adj_bldc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"po2_temp_adj_bldc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19256-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19256-7">
			>
		>
	>
	adl_version = <"2.0.5">
