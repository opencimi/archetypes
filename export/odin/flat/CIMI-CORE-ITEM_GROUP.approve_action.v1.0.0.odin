(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'approve action' concept">
				use = <"Use for approve action.">
				keywords = <"approve", "action">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.approve_action.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"approve_action">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id0.109.3"] = <
					text = <"Location of approver">
				>
				["id1.1.1"] = <
					text = <"Approve action">
				>
				["id2.3.1"] = <
					text = <"Approval datetime">
				>
				["id2.4.1"] = <
					text = <"Approval datetime range">
				>
				["id2.5.1"] = <
					text = <"Approval duration">
				>
				["id2.6.1"] = <
					text = <"Approval timing offset">
				>
				["id2.7.1"] = <
					text = <"Approval timing offset origin">
				>
			>
		>
		term_bindings = <
