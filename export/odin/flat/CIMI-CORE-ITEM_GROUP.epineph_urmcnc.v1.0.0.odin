(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/11046-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Epinephrine [Mass/volume] in Urine' concept">
				use = <"Use for Epinephrine [Mass/volume] in Urine.">
				keywords = <"Epineph", "Epinep", "Epinphrine", "Eppi", "Epin", "Adrenaline", "E", "Adrenalin", "Adreneline", "Epi", "Mass concentration", "Level", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.epineph_urmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"epineph_urmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Epinephrine [Mass/volume] in Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"pg/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/11046-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/11046-0">
			>
		>
	>
	adl_version = <"2.0.5">
