(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2006-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cancer Ag 125 [Presence] in Serum or Plasma' concept">
				use = <"Use for Cancer Ag 125 [Presence] in Serum or Plasma.">
				keywords = <"Cancer Ag125", "Carbohydrate antigen 125", "OC125", "CA 125", "Cancer antigen 125", "Arbitrary concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Antigen", "Antigens", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cancer_ag125_serpl_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cancer_ag125_serpl_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cancer Ag 125 [Presence] in Serum or Plasma">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Cancer Ag 125 [Presence] in Serum or Plasma">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2006-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2006-5">
			>
		>
	>
	adl_version = <"2.0.5">
