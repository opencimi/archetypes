(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/21422-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Normetanephrine [Mass/volume] in 24 hour Urine' concept">
				use = <"Use for Normetanephrine [Mass/volume] in 24 hour Urine.">
				keywords = <"Normetanephrn", "Normeta", "Normetaneph", "Mass concentration", "Level", "1 day", "24 hours", "24HR", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.normetanephrine_24h_urmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"normetanephrine_24h_urmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Normetanephrine [Mass/volume] in 24 hour Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/21422-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/21422-1">
			>
		>
	>
	adl_version = <"2.0.5">
