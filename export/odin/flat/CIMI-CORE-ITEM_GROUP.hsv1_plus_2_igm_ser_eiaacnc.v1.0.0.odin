(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/41399-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Herpes simplex virus 1+2 IgM Ab [Units/volume] in Serum by Immunoassay' concept">
				use = <"Use for Herpes simplex virus 1+2 IgM Ab [Units/volume] in Serum by Immunoassay.">
				keywords = <"Immune globulin M", "Immunoglobulin M", "Herpes simplex virus type 1+2", "Herpes simplex virus type I+II", "HSV1+2", "HSV 1 and 2", "HSV1", "Herpes simplex virus type 1", "Herpes simplex virus type I", "Herp splx", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "II", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hsv1_plus_2_igm_ser_eiaacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hsv1_plus_2_igm_ser_eiaacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Herpes simplex virus 1+2 IgM Ab [Units/volume] in Serum by Immunoassay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{Index_val}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/41399-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/41399-7">
			>
		>
	>
	adl_version = <"2.0.5">
