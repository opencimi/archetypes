(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/35591-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Creatinine renal clearance predicted by Cockcroft-Gault formula' concept">
				use = <"Use for Creatinine renal clearance predicted by Cockcroft-Gault formula.">
				keywords = <"Creat", "Crea", "CR", "vRate", "Volume rate", "Flow", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "C-G", "Cockroft-Gault formula", "C-G", "Cl predicted", "Kidney", "Clear", "Clearanc", "Clearances", "Clr", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.creat_cl_predicted_serpl_cgvrate.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"creat_cl_predicted_serpl_cgvrate">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Creatinine renal clearance predicted by Cockcroft-Gault formula">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mL/min">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258859000">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/35591-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/35591-7">
			>
		>
	>
	adl_version = <"2.0.5">
