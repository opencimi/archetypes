(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5234-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Jo-1 extractable nuclear Ab [Presence] in Serum by Immunoassay' concept">
				use = <"Use for Jo-1 extractable nuclear Ab [Presence] in Serum by Immunoassay.">
				keywords = <"ANA", "Nuc", "ANF", "NA", "Antinuclear antibody", "Histidyl-tRNA synthease", "ENA Jo1", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "I", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ena_jo1_ab_ser_ql_eia.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ena_jo1_ab_ser_ql_eia">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Jo-1 extractable nuclear Ab [Presence] in Serum by Immunoassay">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Jo-1 extractable nuclear Ab [Presence] in Serum by Immunoassay">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5234-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5234-0">
			>
		>
	>
	adl_version = <"2.0.5">
