(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2505-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Iron/Iron binding capacity.total [Mass Ratio] in Serum or Plasma' concept">
				use = <"Use for Iron/Iron binding capacity.total [Mass Ratio] in Serum or Plasma.">
				keywords = <"Fe", "TIBC", "dTIBC", "Total iron binding", "IBC", "TC", "Iron/TIBC", "FE/TIBC", "Mass concentration ratio", "Mass ratio", "MCRto", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.iron_tibc_serpl.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"iron_tibc_serpl">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Iron/Iron binding capacity.total [Mass Ratio] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{ratio}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2505-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2505-6">
			>
		>
	>
	adl_version = <"2.0.5">
