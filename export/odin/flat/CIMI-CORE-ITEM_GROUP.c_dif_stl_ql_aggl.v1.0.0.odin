(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20761-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Clostridium difficile [Presence] in Stool by Agglutination' concept">
				use = <"Use for Clostridium difficile [Presence] in Stool by Agglutination.">
				keywords = <"C dif", "C diff", "C difficile", "Arbitrary concentration", "Point in time", "Random", "Stl", "Feces", "Faeces", "Bowel movement", "Fecal", "Faecal", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Agglutination", "Agg", "Agglut", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.c_dif_stl_ql_aggl.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"c_dif_stl_ql_aggl">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Clostridium difficile [Presence] in Stool by Agglutination">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Clostridium difficile [Presence] in Stool by Agglutination">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20761-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20761-3">
			>
		>
	>
	adl_version = <"2.0.5">
