(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/29463-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Body weight' concept">
				use = <"Use for Body weight.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.weight.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"weight">
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258683005">
				["at0.0.0.0.0.3"] = <"http://snomed.org/id/intentional_blank">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/29463-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/29463-7">
			>
		>
	>
	adl_version = <"2.0.5">
