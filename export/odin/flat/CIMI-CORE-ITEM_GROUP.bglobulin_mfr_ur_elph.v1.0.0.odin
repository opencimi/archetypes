(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13994-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Beta globulin/Protein.total in Urine by Electrophoresis' concept">
				use = <"Use for Beta globulin/Protein.total in Urine by Electrophoresis.">
				keywords = <"B-Globulin", "Protein beta globulin", "Prot", "PR", "GLB", "Globulins", "Glob", "Glob%", "Globul", "B-Globulin", "TP", "Mass fraction", "Percent", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Elph", "Elp", "Elect", "Electrophrs", "Electrophhrs", "Electr", "Elec", "Ep", "Electro", "Tot", "Totl", "B", "Chemistry", "PEUR", "UPEP">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bglobulin_mfr_ur_elph.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bglobulin_mfr_ur_elph">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Beta globulin/Protein.total in Urine by Electrophoresis">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13994-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13994-9">
			>
		>
	>
	adl_version = <"2.0.5">
