(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5052-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Aspergillus sp Ab [Presence] in Serum by Immune diffusion (ID)' concept">
				use = <"Use for Aspergillus sp Ab [Presence] in Serum by Immune diffusion (ID).">
				keywords = <"Farmers lung", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ID", "Immunodiff", "Immunodiffusion", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Imun", "Imune", "Imm", "species", "spp", "Aspergil", "Asperg", "Aspergils", "Aspergilus", "Aspergilis", "Aspergilla", "Aspergillin", "Aspergillosis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.aspergillus_ab_ser_ql_id.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"aspergillus_ab_ser_ql_id">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Aspergillus sp Ab [Presence] in Serum by Immune diffusion (ID)">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5052-6">
			>
			["opencem"] = <
