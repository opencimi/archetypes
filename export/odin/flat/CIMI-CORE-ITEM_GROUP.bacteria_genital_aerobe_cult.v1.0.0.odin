(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/10352-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Bacteria identified in Genital specimen by Aerobe culture' concept">
				use = <"Use for Bacteria identified in Genital specimen by Aerobe culture.">
				keywords = <"Bact", "Identity or presence", "Point in time", "Random", "Gen", "Genital tract", "Urogenit", "Urogenital", "Nominal", "Aerobe Cult", "Aerobed", "Cultures", "C&S", "Isolated", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bacteria_genital_aerobe_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bacteria_genital_aerobe_cult">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Bacteria identified in Genital specimen by Aerobe culture">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Bacteria identified in Genital specimen by Aerobe culture">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/10352-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/10352-3">
			>
		>
	>
	adl_version = <"2.0.5">
