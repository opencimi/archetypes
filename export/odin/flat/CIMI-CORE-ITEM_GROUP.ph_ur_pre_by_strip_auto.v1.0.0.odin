(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/50560-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'pH of Urine by Automated test strip' concept">
				use = <"Use for pH of Urine by Automated test strip.">
				keywords = <"Log molar concentration", "Point in time", "Random", "Ur", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Strip.auto", "Strip.auto", "Dipstick", "Dip stick", "Auto", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ph_ur_pre_by_strip_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ph_ur_pre_by_strip_auto">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"pH of Urine by Automated test strip">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[pH]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/50560-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/50560-2">
			>
		>
	>
	adl_version = <"2.0.5">
