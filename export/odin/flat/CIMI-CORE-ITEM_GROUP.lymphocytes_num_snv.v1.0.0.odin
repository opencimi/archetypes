(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/35049-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Lymphocytes [#/volume] in Synovial fluid' concept">
				use = <"Use for Lymphocytes [#/volume] in Synovial fluid.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.lymphocytes_num_snv.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"lymphocytes_num_snv">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/35049-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/35049-6">
			>
		>
	>
	adl_version = <"2.0.5">
