(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/17842-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cancer Ag 27-29 [Units/volume] in Serum or Plasma' concept">
				use = <"Use for Cancer Ag 27-29 [Units/volume] in Serum or Plasma.">
				keywords = <"Cancer Ag27-29", "CA27.29", "Carbohydrate antigen 27-29", "B27.9", "CA 27-29", "MUC-1 gene associated AG CA 27-29", "Arbitrary concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Antigen", "Antigens", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cancer_ag2729_serplacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cancer_ag2729_serplacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cancer Ag 27-29 [Units/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[arb'U]/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/17842-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/17842-6">
			>
		>
	>
	adl_version = <"2.0.5">
