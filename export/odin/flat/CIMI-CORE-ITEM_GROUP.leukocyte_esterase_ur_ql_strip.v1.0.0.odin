(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5799-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Leukocyte esterase [Presence] in Urine by Test strip' concept">
				use = <"Use for Leukocyte esterase [Presence] in Urine by Test strip.">
				keywords = <"Est", "Arbitrary concentration", "Point in time", "Random", "Ur", "UR", "Urn", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Dipstick", "Dip stick", "WBC", "White blood cell", "Leuc", "Leuk", "Lkcs", "Leukocytes", "White blood cells", "WBCs", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.leukocyte_esterase_ur_ql_strip.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"leukocyte_esterase_ur_ql_strip">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Leukocyte esterase [Presence] in Urine by Test strip">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5799-2">
			>
			["opencem"] = <
