(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49133-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cholesterol in VLDL [Mass/volume] in Serum or Plasma by Electrophoresis' concept">
				use = <"Use for Cholesterol in VLDL [Mass/volume] in Serum or Plasma by Electrophoresis.">
				keywords = <"VLDLc", "Very low density lipoprotein cholesterols", "Chol", "Choles", "Cholest", "Lipid", "Cholesterol total", "Cholesterols", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Elph", "Elp", "Elect", "Electrophrs", "Electrophhrs", "Electr", "Elec", "Ep", "Electro", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.vldlc_serplmcnc_pre_by_serpl_elphmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"vldlc_serplmcnc_pre_by_serpl_elphmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cholesterol in VLDL [Mass/volume] in Serum or Plasma by Electrophoresis">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49133-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49133-2">
			>
		>
	>
	adl_version = <"2.0.5">
