(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/76-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cefazolin [Susceptibility] by Minimum inhibitory concentration (MIC)' concept">
				use = <"Use for Cefazolin [Susceptibility] by Minimum inhibitory concentration (MIC).">
				keywords = <"C32", "Kefzol", "Ancef", "Totacef", "Zolicef", "Kefj", "Cefamezin", "Susceptibility", "Susceptibilty", "Sus", "Suscept", "Susceptibilities", "AST", "Point in time", "Random", "Islt", "Isol", "Minimum inhibitory concentration", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cefazolin_susc_islt_pre_by_mic.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cefazolin_susc_islt_pre_by_mic">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cefazolin [Susceptibility] by Minimum inhibitory concentration (MIC)">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Cefazolin [Susceptibility] by Minimum inhibitory concentration (MIC)">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/76-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/76-0">
			>
		>
	>
	adl_version = <"2.0.5">
