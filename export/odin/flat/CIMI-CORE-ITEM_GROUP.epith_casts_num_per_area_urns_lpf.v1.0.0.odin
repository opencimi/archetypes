(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5786-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Epithelial casts [#/area] in Urine sediment by Microscopy low power field' concept">
				use = <"Use for Epithelial casts [#/area] in Urine sediment by Microscopy low power field.">
				keywords = <"Epith Casts", "Cast", "#/area", "Number areic", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Micro", "LM", "Micros", "Microscopic", "Epithelia", "Epi", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.epith_casts_num_per_area_urns_lpf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"epith_casts_num_per_area_urns_lpf">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5786-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5786-9">
			>
		>
	>
	adl_version = <"2.0.5">
