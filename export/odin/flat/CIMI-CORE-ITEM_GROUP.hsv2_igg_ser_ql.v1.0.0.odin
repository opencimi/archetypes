(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/17851-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Herpes simplex virus 2 IgG Ab [Presence] in Serum' concept">
				use = <"Use for Herpes simplex virus 2 IgG Ab [Presence] in Serum.">
				keywords = <"Immune globulin G", "Immunoglobulin G", "HSV2", "Herpes simplex virus type 2", "Herpes simplex virus type II", "Herp splx", "HSV", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hsv2_igg_ser_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hsv2_igg_ser_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Herpes simplex virus 2 IgG Ab [Presence] in Serum">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Herpes simplex virus 2 IgG Ab [Presence] in Serum">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/17851-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/17851-7">
			>
		>
	>
	adl_version = <"2.0.5">
