(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5782-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Crystals [type] in Urine sediment by Light microscopy' concept">
				use = <"Use for Crystals [type] in Urine sediment by Light microscopy.">
				keywords = <"Cryst", "Crys", "Crystal", "Identity or presence", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Nominal", "Micro", "LM", "Micros", "Microscopic", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.crystals_urns_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"crystals_urns_micro">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5782-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5782-8">
			>
		>
	>
	adl_version = <"2.0.5">
