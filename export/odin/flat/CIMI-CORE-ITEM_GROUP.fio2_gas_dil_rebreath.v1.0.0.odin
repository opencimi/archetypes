(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19993-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oxygen/Inspired gas Inhaled gas by Gas dilution.rebreath' concept">
				use = <"Use for Oxygen/Inspired gas Inhaled gas by Gas dilution.rebreath.">
				keywords = <"O2", "tO2", "Volume fraction", "Volfr", "Percent", "Point in time", "Random", "IhG", "Inhaled Gas", "Quantitative", "QNT", "Quant", "Quan", "Gas Dil.rebreath", "Rebreath", "Gas Dil.rebreath", "Dil", "Dilut", "Gases", "FIO2", "PULMONARY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fio2_gas_dil_rebreath.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fio2_gas_dil_rebreath">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Oxygen/Inspired gas Inhaled gas by Gas dilution.rebreath">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19993-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19993-5">
			>
		>
	>
	adl_version = <"2.0.5">
