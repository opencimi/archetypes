(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/609-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Bacteria identified in Eye by Aerobe culture' concept">
				use = <"Use for Bacteria identified in Eye by Aerobe culture.">
				keywords = <"Bact", "Identity or presence", "Point in time", "Random", "Occular", "Optic globe", "Oculis", "Eyeball", "Ophthalmologic", "Vision", "Visual", "Nominal", "Aerobe Cult", "Aerobed", "Cultures", "C&S", "Isolated", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bacteria_eye_aerobe_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bacteria_eye_aerobe_cult">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Bacteria identified in Eye by Aerobe culture">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Bacteria identified in Eye by Aerobe culture">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/609-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/609-8">
			>
		>
	>
	adl_version = <"2.0.5">
