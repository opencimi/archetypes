(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/14563-1.html>">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hemoccult_sp1_stl_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hemoccult_sp1_stl_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hemoglobin.gastrointestinal [Presence] in Stool --1st specimen">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Hemoglobin.gastrointestinal [Presence] in Stool --1st specimen">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/14563-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/14563-1">
			>
		>
	>
	adl_version = <"2.0.5">
