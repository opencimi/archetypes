(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49042-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Testosterone Free [Mass/volume] in Serum or Plasma by Detection limit <= 1.0 ng/dL' concept">
				use = <"Use for Testosterone Free [Mass/volume] in Serum or Plasma by Detection limit <= 1.0 ng/dL.">
				keywords = <"Testost Free", "Testosterone.unconjugated", "Testo", "Testos", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "DL<=1.0 ng/dL", "DL<=1.0 ng/dL", "FR", "Non-protein bound", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.testost_free_serplmcnc_pre_by_serpl_dl_lte_1_0_ng_dlmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"testost_free_serplmcnc_pre_by_serpl_dl_lte_1_0_ng_dlmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Testosterone Free [Mass/volume] in Serum or Plasma by Detection limit <= 1.0 ng/dL">
				>
				["at0.0.0.0.0.2"] = <
					text = <"pg/mL">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258808001">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49042-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49042-5">
			>
		>
	>
	adl_version = <"2.0.5">
