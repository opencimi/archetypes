(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1251-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Major crossmatch [interpretation] by Immediate spin' concept">
				use = <"Use for Major crossmatch [interpretation] by Immediate spin.">
				keywords = <"Maj XM", "Compatability testing", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Nominal", "Imm Spin", "IS", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.maj_xm_serplimp_pre_by_serpl_imm_spinimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"maj_xm_serplimp_pre_by_serpl_imm_spinimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Major crossmatch [interpretation] by Immediate spin">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Major crossmatch [interpretation] by Immediate spin">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1251-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1251-8">
			>
		>
	>
	adl_version = <"2.0.5">
