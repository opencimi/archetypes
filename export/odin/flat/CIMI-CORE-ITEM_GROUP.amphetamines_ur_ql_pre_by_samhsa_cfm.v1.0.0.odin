(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/8151-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Amphetamines [Presence] in Urine by SAMHSA confirm method' concept">
				use = <"Use for Amphetamines [Presence] in Urine by SAMHSA confirm method.">
				keywords = <"Amphetam", "Amph", "Amphetamine", "Speed", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "SAMHSA Cfm", "SAMSHA", "CNFR", "CNFRM", "Conf", "Confirmation", "GCMS", "Confirmatory", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.amphetamines_ur_ql_pre_by_samhsa_cfm.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"amphetamines_ur_ql_pre_by_samhsa_cfm">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Amphetamines [Presence] in Urine by SAMHSA confirm method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Amphetamines [Presence] in Urine by SAMHSA confirm method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/8151-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/8151-3">
			>
		>
	>
	adl_version = <"2.0.5">
