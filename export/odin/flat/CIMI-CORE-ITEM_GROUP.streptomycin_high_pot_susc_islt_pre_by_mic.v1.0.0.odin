(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6933-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Streptomycin.high potency [Susceptibility] by Minimum inhibitory concentration (MIC)' concept">
				use = <"Use for Streptomycin.high potency [Susceptibility] by Minimum inhibitory concentration (MIC).">
				keywords = <"Streptomycin High Pot", "Streptomycin synergy", "Streptomyc", "c232", "Cidam est", "Novostrep", "Solustrep", "Strepto-fatol", "Streptocol", "Susceptibility", "Susceptibilty", "Sus", "Suscept", "Susceptibilities", "AST", "Point in time", "Random", "Islt", "Isol", "Minimum inhibitory concentration", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.streptomycin_high_pot_susc_islt_pre_by_mic.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"streptomycin_high_pot_susc_islt_pre_by_mic">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6933-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6933-6">
			>
		>
	>
	adl_version = <"2.0.5">
