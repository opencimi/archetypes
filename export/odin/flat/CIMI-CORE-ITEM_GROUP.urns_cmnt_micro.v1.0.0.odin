(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/11279-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Urine sediment comments by Light microscopy Narrative' concept">
				use = <"Use for Urine sediment comments by Light microscopy Narrative.">
				keywords = <"UrnS Cmnt", "Finding", "Findings", "Point in time", "Random", "UR", "Urn", "Narrative", "Report", "Micro", "LM", "Micros", "Microscopic", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.urns_cmnt_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"urns_cmnt_micro">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/11279-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/11279-7">
			>
		>
	>
	adl_version = <"2.0.5">
