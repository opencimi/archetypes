(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/43305-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Neisseria gonorrhoeae rRNA [Presence] in Unspecified specimen by Probe and target amplification method' concept">
				use = <"Use for Neisseria gonorrhoeae rRNA [Presence] in Unspecified specimen by Probe and target amplification method.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.n_gonorrhoea_rrna_xxx_ql_pcr.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"n_gonorrhoea_rrna_xxx_ql_pcr">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Neisseria gonorrhoeae rRNA [Presence] in Unspecified specimen by Probe and target amplification method">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/43305-2">
			>
			["opencem"] = <
