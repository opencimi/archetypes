(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/51731-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oxygen saturation Calculated from oxygen partial pressure in Venous blood' concept">
				use = <"Use for Oxygen saturation Calculated from oxygen partial pressure in Venous blood.">
				keywords = <"SaO2", "SO2", "O2", "tO2", "Mass fraction", "Percent", "Point in time", "Random", "Blood - venous", "Bld ven", "Bld venous", "Blood venus", "Blood ven", "Venous", "Quantitative", "QNT", "Quant", "Quan", "from pO2", "calc from oxygen partial pressure", "Calc", "Calculation", "Satn", "SAT", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.sao2_percent_bldv_pre_by_from_po2.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"sao2_percent_bldv_pre_by_from_po2">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Oxygen saturation Calculated from oxygen partial pressure in Venous blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/51731-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/51731-8">
			>
		>
	>
	adl_version = <"2.0.5">
