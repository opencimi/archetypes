(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/9490-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Aspergillus flavus Ab [Presence] in Serum' concept">
				use = <"Use for Aspergillus flavus Ab [Presence] in Serum.">
				keywords = <"A flavus", "m54", "Farmers lung", "m228", "m311", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Aspergil", "Asperg", "Aspergils", "Aspergilus", "Aspergilis", "Aspergilla", "Aspergillin", "Aspergillosis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.a_flavus_ab_ser_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"a_flavus_ab_ser_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Aspergillus flavus Ab [Presence] in Serum">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Aspergillus flavus Ab [Presence] in Serum">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/9490-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/9490-4">
			>
		>
	>
	adl_version = <"2.0.5">
