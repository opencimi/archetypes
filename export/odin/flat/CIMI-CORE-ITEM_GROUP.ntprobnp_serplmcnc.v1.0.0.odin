(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33762-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Natriuretic peptide.B prohormone N-Terminal [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Natriuretic peptide.B prohormone N-Terminal [Mass/volume] in Serum or Plasma.">
				keywords = <"NT-proBNP", "NTproBNP", "BNP", "proBNP", "Pro-brain natriuretic peptide", "B-type natriuretic peptide", "Brain Natriuretic Peptide", "Natriutietic peptide.B", "Beta Natriuretic Peptide", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Pept", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ntprobnp_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ntprobnp_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Natriuretic peptide.B prohormone N-Terminal [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"pg/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33762-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33762-6">
			>
		>
	>
	adl_version = <"2.0.5">
