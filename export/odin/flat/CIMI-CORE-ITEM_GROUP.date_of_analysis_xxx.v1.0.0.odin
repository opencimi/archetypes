(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/45353-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Date of analysis of unspecified specimen' concept">
				use = <"Use for Date of analysis of unspecified specimen.">
				keywords = <"Time stamp", "Date and time", "Timestamp", "Point in time", "Random", "Miscellaneous", "Unspecified", "Other", "Quantitative", "QNT", "Quant", "Quan">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.date_of_analysis_xxx.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"date_of_analysis_xxx">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Date of analysis of unspecified specimen">
				>
				["at0.0.0.0.0.2"] = <
					text = <"">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/45353-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/45353-0">
			>
		>
	>
	adl_version = <"2.0.5">
