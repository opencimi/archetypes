(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/40464-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Drugs identified in Urine by Confirmatory method' concept">
				use = <"Use for Drugs identified in Urine by Confirmatory method.">
				keywords = <"Identity or presence", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Nominal", "Cfm", "CNFR", "CNFRM", "Conf", "Confirmation", "GCMS", "Confirmatory", "Isolated", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.drugs_ur_cfm.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"drugs_ur_cfm">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Drugs identified in Urine by Confirmatory method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Drugs identified in Urine by Confirmatory method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/40464-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/40464-0">
			>
		>
	>
	adl_version = <"2.0.5">
