(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/35572-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Phenylalanine/Tyrosine [Molar ratio] in Dried blood spot' concept">
				use = <"Use for Phenylalanine/Tyrosine [Molar ratio] in Dried blood spot.">
				keywords = <"Phe", "PPA", "Tyr", "Phe+Tyr", "Phe/Tyr", "Substance concentration ratio", "Substance ratio", "Scrto", "Point in time", "Random", "DBS", "Filter paper", "FP", "Dried blood spot", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Chemistry", "PKU">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.phe_tyr_dbssrto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"phe_tyr_dbssrto">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Phenylalanine/Tyrosine [Molar ratio] in Dried blood spot">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{Ratio}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/35572-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/35572-7">
			>
		>
	>
	adl_version = <"2.0.5">
