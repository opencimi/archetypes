(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/18319-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Neutrophils.vacuolated [Presence] in Blood by Light microscopy' concept">
				use = <"Use for Neutrophils.vacuolated [Presence] in Blood by Light microscopy.">
				keywords = <"Neuts Vac", "PNM", "Neutrophil", "Neutr", "PMN", "Neut", "Arbitrary concentration", "Point in time", "Random", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Micro", "LM", "Micros", "Microscopic", "Vaculated", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.neuts_vac_bld_ql_smear.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"neuts_vac_bld_ql_smear">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/18319-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/18319-4">
			>
		>
	>
	adl_version = <"2.0.5">
