(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'cancel action' concept">
				use = <"Use for cancel action.">
				keywords = <"cancel", "action">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cancel_action.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cancel_action">
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["id1.1.1"] = <"http://snomed.info/id/364713004">
				["id2.3.1"] = <"http://snomed.info/id/48176007">
				["id2.4.1"] = <"http://snomed.info/id/308916002">
