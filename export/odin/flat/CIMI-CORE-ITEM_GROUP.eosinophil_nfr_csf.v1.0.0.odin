(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/26451-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Eosinophils/100 leukocytes in Cerebral spinal fluid' concept">
				use = <"Use for Eosinophils/100 leukocytes in Cerebral spinal fluid.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.eosinophil_nfr_csf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"eosinophil_nfr_csf">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/26451-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/26451-5">
			>
		>
	>
	adl_version = <"2.0.5">
