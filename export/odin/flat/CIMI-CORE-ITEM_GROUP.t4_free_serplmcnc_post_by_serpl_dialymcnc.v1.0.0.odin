(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.t4_free_serplmcnc_post_by_serpl_dialymcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"t4_free_serplmcnc_post_by_serpl_dialymcnc">
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.3"] = <"http://snomed.org/id/108241001">
			>
			["loinc"] = <
