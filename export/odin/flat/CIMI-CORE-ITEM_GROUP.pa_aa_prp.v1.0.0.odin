(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5993-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Platelet aggregation arachidonate induced [Substance threshold] in Platelet rich plasma' concept">
				use = <"Use for Platelet aggregation arachidonate induced [Substance threshold] in Platelet rich plasma.">
				keywords = <"PA AA", "Asprin Assay", "Aspirin Assay", "Plt", "Pl", "Platelets", "Thrombocytes", "Platelt", "Thrombocyte", "Arch acid", "5,8,11,14 Eicosatetraenoic acid", "Eicosatetraenoate", "C20:4w6", "Arachidonic acid", "Threshold substance concentration", "Point in time", "Random", "Platelet rich plasma", "Quantitative", "QNT", "Quant", "Quan", "Agg", "Aggr", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pa_aa_prp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pa_aa_prp">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5993-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5993-1">
			>
		>
	>
	adl_version = <"2.0.5">
