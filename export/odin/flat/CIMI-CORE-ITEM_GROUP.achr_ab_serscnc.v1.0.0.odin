(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20427-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Acetylcholine receptor Ab [Moles/volume] in Serum' concept">
				use = <"Use for Acetylcholine receptor Ab [Moles/volume] in Serum.">
				keywords = <"AChR", "ACRA", "ACH", "Acetylch", "Substance concentration", "Level", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Recep", "Recp", "Rec", "Receptors", "Recept", "Recptr", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.achr_ab_serscnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"achr_ab_serscnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Acetylcholine receptor Ab [Moles/volume] in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"nmol/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20427-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20427-1">
			>
		>
	>
	adl_version = <"2.0.5">
