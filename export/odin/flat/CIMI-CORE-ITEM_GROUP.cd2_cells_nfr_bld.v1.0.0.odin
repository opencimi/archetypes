(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/8118-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'CD2 cells/100 cells in Blood' concept">
				use = <"Use for CD2 cells/100 cells in Blood.">
				keywords = <"CD2 Cells", "Cell", "Cellularity", "Gated cells", "Number fraction", "Percent", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Leu-5", "Leu5", "CD2R", "E-rosette receptor", "T11", "Lymphocyte-function antigen-2", "LFA-2", "CELL MARKERS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cd2_cells_nfr_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cd2_cells_nfr_bld">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"CD2 cells/100 cells in Blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/8118-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/8118-2">
			>
		>
	>
	adl_version = <"2.0.5">
