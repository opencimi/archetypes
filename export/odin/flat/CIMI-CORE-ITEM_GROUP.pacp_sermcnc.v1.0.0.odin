(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20420-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Prostatic acid phosphatase [Mass/volume] in Serum' concept">
				use = <"Use for Prostatic acid phosphatase [Mass/volume] in Serum.">
				keywords = <"PACP", "Prostatic ac phos", "PAP", "ACP", "Ac Phos", "Acid phosphatase.total", "Mass concentration", "Level", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "Prostate", "Prost", "Prostati", "Phosphtase", "Acd", "Acids", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pacp_sermcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pacp_sermcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Prostatic acid phosphatase [Mass/volume] in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20420-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20420-6">
			>
		>
	>
	adl_version = <"2.0.5">
