(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1649-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Calcitriol [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Calcitriol [Mass/volume] in Serum or Plasma.">
				keywords = <"1,25(OH)2D3", "1,25-Calcitriol", "1,25-Dihydroxyvitamin D3", "1,25-Dihydroxycholecalciferol", "1,25-Dihydroxyvitamin D", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.1__25oh2d3_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"1__25oh2d3_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Calcitriol [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"pg/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1649-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1649-3">
			>
		>
	>
	adl_version = <"2.0.5">
