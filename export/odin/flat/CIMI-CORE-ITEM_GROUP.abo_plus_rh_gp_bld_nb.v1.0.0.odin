(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19057-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'ABO + Rh group [Type] in Blood from newborn' concept">
				use = <"Use for ABO + Rh group [Type] in Blood from newborn.">
				keywords = <"Rh typing", "D typing", "Rh phenotyping", "D phenotyping", "ABO+Rh Gp", "ABO group and Rh type", "Typ", "Point in time", "Random", "Blood", "WB", "Whole blood", "NB", "New born", "Nominal", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.abo_plus_rh_gp_bld_nb.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"abo_plus_rh_gp_bld_nb">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"ABO + Rh group [Type] in Blood from newborn">
				>
				["id1.1.1.1.1.1"] = <
					text = <"ABO + Rh group [Type] in Blood from newborn">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19057-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19057-9">
			>
		>
	>
	adl_version = <"2.0.5">
