(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/68396-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Basophils/100 leukocytes in Vitreous fluid by Manual count' concept">
				use = <"Use for Basophils/100 leukocytes in Vitreous fluid by Manual count.">
				keywords = <"Baso", "Basos", "Basophil", "Bph", "WBC", "White blood cell", "Leuc", "Leuk", "Leukocyte", "Lkcs", "White blood cells", "WBCs", "100WBC", "Number fraction", "Percent", "Point in time", "Random", "Vitf", "Vitreous fluid", "VitF", "Vitreous humor", "Vitreous humour", "Quantitative", "QNT", "Quant", "Quan", "Manl", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.basophils_nfr_vitf_manual.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"basophils_nfr_vitf_manual">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/68396-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/68396-1">
			>
		>
	>
	adl_version = <"2.0.5">
