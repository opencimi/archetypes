(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19075-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cells Counted Total [#] in Cerebral spinal fluid' concept">
				use = <"Use for Cells Counted Total [#] in Cerebral spinal fluid.">
				keywords = <"Total Cells Counted", "Total cells", "Cell", "Cellularity", "Number", "Count", "Cnt", "Point in time", "Random", "Cerebral spinal fluid", "Spinal Fluid", "Cerebrospinal Fl", "Spinal Flu", "Spinal Fld", "Quantitative", "QNT", "Quant", "Quan", "Tot", "Totl", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.total_cells_counted_csf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"total_cells_counted_csf">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19075-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19075-1">
			>
		>
	>
	adl_version = <"2.0.5">
