(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33570-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Sjogrens syndrome-B extractable nuclear Ab [Units/volume] in Serum by Immunoblot (IB)' concept">
				use = <"Use for Sjogrens syndrome-B extractable nuclear Ab [Units/volume] in Serum by Immunoblot (IB).">
				keywords = <"Sjogren", "SSB", "La AB", "HA", "SS-B", "Ha AB", "ENA SS-B", "ANA", "Nuc", "ANF", "NA", "Antinuclear antibody", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "Western blot", "WB", "Immune blot", "Immunobl", "Blt", "WBLOT", "West blt", "West blot", "RIBA", "Immunoblot", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "SS", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ena_ssb_ab_seracnc_pre_by_ser_ibacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ena_ssb_ab_seracnc_pre_by_ser_ibacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Sjogrens syndrome-B extractable nuclear Ab [Units/volume] in Serum by Immunoblot (IB)">
				>
				["at0.0.0.0.0.2"] = <
					text = <"">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33570-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33570-3">
			>
		>
	>
	adl_version = <"2.0.5">
