(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/9317-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Platelet adequacy [Presence] in Blood by Light microscopy' concept">
				use = <"Use for Platelet adequacy [Presence] in Blood by Light microscopy.">
				keywords = <"Platelet", "Plt", "Thrombocytes", "Platelt", "Thrb", "Thrombocyte", "Arbitrary concentration", "Point in time", "Random", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Micro", "LM", "Micros", "Microscopic", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS", "Platelet adequacy", "Platelet estimate">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.platelet_bld_ql_smear.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"platelet_bld_ql_smear">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"PlateletEstimate_VALUESET_CODE">
				>
				["id1.1.1.1.1.1"] = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/9317-9">
			>
			["opencem"] = <
				["at0.0.0.0.0.1"] = <"http://opencem.org/id/PlateletEstimate_VALUESET_CODE">
			>
		>
	>
	adl_version = <"2.0.5">
