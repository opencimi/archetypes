(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19108-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Histoplasma capsulatum Ag [Presence] in Serum' concept">
				use = <"Use for Histoplasma capsulatum Ag [Presence] in Serum.">
				keywords = <"H capsul", "H capsulatum", "H farciminosum", "Histoplasma farciminosum", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Antigen", "Antigens", "Histo", "Histopl", "Histoplasmos", "Histoplasmosis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.h_capsul_ag_ser_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"h_capsul_ag_ser_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Histoplasma capsulatum Ag [Presence] in Serum">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Histoplasma capsulatum Ag [Presence] in Serum">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19108-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19108-0">
			>
		>
	>
	adl_version = <"2.0.5">
