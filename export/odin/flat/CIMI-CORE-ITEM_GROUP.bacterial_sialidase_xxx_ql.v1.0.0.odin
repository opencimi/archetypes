(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/41477-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Bacterial sialidase [Presence] in Unspecified specimen' concept">
				use = <"Use for Bacterial sialidase [Presence] in Unspecified specimen.">
				keywords = <"Sialidosis", "Galactosialidosis", "Alpha neuraminidase", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Bact", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bacterial_sialidase_xxx_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bacterial_sialidase_xxx_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Bacterial sialidase [Presence] in Unspecified specimen">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Bacterial sialidase [Presence] in Unspecified specimen">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/41477-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/41477-1">
			>
		>
	>
	adl_version = <"2.0.5">
