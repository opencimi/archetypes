(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49051-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Gestational age in weeks' concept">
				use = <"Use for Gestational age in weeks.">
				keywords = <"GA (weeks)", "Point in time", "Random", "Fetal", "Quantitative", "QNT", "Quant", "Quan", "Gest", "Gestation", "Prenatal", "OBSTERICAL.ULTRASOUND", "OBSTERICAL.ULTRASOUND", "Obstetrical", "Obstetrics">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ga_weeks.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ga_weeks">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49051-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49051-6">
			>
		>
	>
	adl_version = <"2.0.5">
