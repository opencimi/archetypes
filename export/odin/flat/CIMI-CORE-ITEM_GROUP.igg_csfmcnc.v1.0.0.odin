(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2464-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'IgG [Mass/volume] in Cerebral spinal fluid' concept">
				use = <"Use for IgG [Mass/volume] in Cerebral spinal fluid.">
				keywords = <"Immune globulin G", "Immunoglobulin G", "Mass concentration", "Level", "Point in time", "Random", "Cerebral spinal fluid", "Spinal Fluid", "Cerebrospinal Fl", "Spinal Flu", "Spinal Fld", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.igg_csfmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"igg_csfmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"IgG [Mass/volume] in Cerebral spinal fluid">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2464-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2464-6">
			>
		>
	>
	adl_version = <"2.0.5">
