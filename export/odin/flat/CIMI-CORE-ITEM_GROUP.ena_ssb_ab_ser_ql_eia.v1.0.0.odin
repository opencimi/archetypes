(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5353-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Sjogrens syndrome-B extractable nuclear Ab [Presence] in Serum by Immunoassay' concept">
				use = <"Use for Sjogrens syndrome-B extractable nuclear Ab [Presence] in Serum by Immunoassay.">
				keywords = <"Sjogren", "SSB", "La AB", "HA", "SS-B", "Ha AB", "ENA SS-B", "ANA", "Nuc", "ANF", "NA", "Antinuclear antibody", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "SS", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ena_ssb_ab_ser_ql_eia.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ena_ssb_ab_ser_ql_eia">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Sjogrens syndrome-B extractable nuclear Ab [Presence] in Serum by Immunoassay">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Sjogrens syndrome-B extractable nuclear Ab [Presence] in Serum by Immunoassay">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5353-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5353-8">
			>
		>
	>
	adl_version = <"2.0.5">
