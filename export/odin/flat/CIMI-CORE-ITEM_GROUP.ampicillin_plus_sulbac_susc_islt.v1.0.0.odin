(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/18865-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Ampicillin+Sulbactam [Susceptibility]' concept">
				use = <"Use for Ampicillin+Sulbactam [Susceptibility].">
				keywords = <"Sulb", "Sulbact", "Ampicillin+Sulbac", "Unasyn", "Amp", "c203", "Ampicilloyl", "c5", "Polycillin", "Amcil", "Omnipen", "Penbritin", "Amicil", "Susceptibility", "Susceptibilty", "Sus", "Suscept", "Susceptibilities", "AST", "Point in time", "Random", "Islt", "Isol", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ampicillin_plus_sulbac_susc_islt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ampicillin_plus_sulbac_susc_islt">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Ampicillin+Sulbactam [Susceptibility]">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Ampicillin+Sulbactam [Susceptibility]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/18865-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/18865-6">
			>
		>
	>
	adl_version = <"2.0.5">
