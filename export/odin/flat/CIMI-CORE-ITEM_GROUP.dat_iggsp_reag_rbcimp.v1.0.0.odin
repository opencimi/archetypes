(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1006-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Direct antiglobulin test.IgG specific reagent [interpretation] on Red Blood Cells' concept">
				use = <"Use for Direct antiglobulin test.IgG specific reagent [interpretation] on Red Blood Cells.">
				keywords = <"Immune globulin G", "Immunoglobulin G", "DAT IgG-Sp Reag", "Direct coombs test", "DCT", "DAGT", "Direct Coomb", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Erythrocytes", "Red blood corpusles", "Red blood cells", "Nominal", "Dir", "Antiglob", "Spec", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.dat_iggsp_reag_rbcimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"dat_iggsp_reag_rbcimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"NegativePositive_VALUESET_CODE">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Direct antiglobulin test.IgG specific reagent [interpretation] on Red Blood Cells">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1006-6">
			>
			["opencem"] = <
				["at0.0.0.0.0.1"] = <"http://opencem.org/id/NegativePositive_VALUESET_CODE">
			>
		>
	>
	adl_version = <"2.0.5">
