(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1521-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Glucose [Mass/volume] in Serum or Plasma --2 hours post meal' concept">
				use = <"Use for Glucose [Mass/volume] in Serum or Plasma --2 hours post meal.">
				keywords = <"Glu", "Gluc", "Glucoseur", "2h p meal", "Post Pran", "PC", "Post prandial", "PP", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "PST", "After", "2 hours", "120 minutes", "120 min", "120min", "CHEMISTRY.CHALLENGE TESTING", "CHEMISTRY.CHALLENGE TESTING", "GTT", "Glu tol", "Glucose tolerance">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.glucose_2h_p_meal_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"glucose_2h_p_meal_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Glucose [Mass/volume] in Serum or Plasma --2 hours post meal">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1521-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1521-4">
			>
		>
	>
	adl_version = <"2.0.5">
