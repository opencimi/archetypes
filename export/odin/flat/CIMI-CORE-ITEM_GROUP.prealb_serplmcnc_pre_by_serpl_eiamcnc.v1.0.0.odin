(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6793-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Prealbumin [Mass/volume] in Serum or Plasma by Immunoassay' concept">
				use = <"Use for Prealbumin [Mass/volume] in Serum or Plasma by Immunoassay.">
				keywords = <"Prealb", "Pre albumin", "PALB", "Transthyretin", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.prealb_serplmcnc_pre_by_serpl_eiamcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"prealb_serplmcnc_pre_by_serpl_eiamcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Prealbumin [Mass/volume] in Serum or Plasma by Immunoassay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6793-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6793-4">
			>
		>
	>
	adl_version = <"2.0.5">
