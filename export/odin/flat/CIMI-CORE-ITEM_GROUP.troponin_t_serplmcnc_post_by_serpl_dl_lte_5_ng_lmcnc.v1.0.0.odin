(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.troponin_t_serplmcnc_post_by_serpl_dl_lte_5_ng_lmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"troponin_t_serplmcnc_post_by_serpl_dl_lte_5_ng_lmcnc">
