(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/936-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Blood product unit [Identifier]' concept">
				use = <"Use for Blood product unit [Identifier].">
				keywords = <"Bld Unit Id", "Ident", "Point in time", "Random", "Nominal", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bld_unit_id_bpu.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bld_unit_id_bpu">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/936-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/936-5">
			>
		>
	>
	adl_version = <"2.0.5">
