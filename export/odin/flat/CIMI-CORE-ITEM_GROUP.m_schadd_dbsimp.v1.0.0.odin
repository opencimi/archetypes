(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/46779-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Medium/Short chain acyl-CoA dehydrogenase deficiency newborn screen interpretation' concept">
				use = <"Use for Medium/Short chain acyl-CoA dehydrogenase deficiency newborn screen interpretation.">
				keywords = <"SCAD deficiency", "M/SCHADD", "M/SCHAD", "Acyl CoA dehydrog", "AcdA", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "DBS", "Filter paper", "FP", "Dried blood spot", "Blood", "WB", "Whole blood", "Nominal", "Dehydrog", "Dehyrdogenase", "Chn", "Chains", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.m_schadd_dbsimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"m_schadd_dbsimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Medium/Short chain acyl-CoA dehydrogenase deficiency newborn screen interpretation">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Medium/Short chain acyl-CoA dehydrogenase deficiency newborn screen interpretation">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/46779-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/46779-5">
			>
		>
	>
	adl_version = <"2.0.5">
