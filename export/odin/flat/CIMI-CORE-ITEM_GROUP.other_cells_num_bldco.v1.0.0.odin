(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/74450-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Other cells [#/volume] in Cord blood' concept">
				use = <"Use for Other cells [#/volume] in Cord blood.">
				keywords = <"Cell", "Cellularity", "#", "Number concentration", "Count/volume", "Count", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Cord (umbilical) blood", "Cord bld", "Cord blood", "Quantitative", "QNT", "Quant", "Quan", "Othr", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.other_cells_num_bldco.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"other_cells_num_bldco">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/74450-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/74450-8">
			>
		>
	>
	adl_version = <"2.0.5">
