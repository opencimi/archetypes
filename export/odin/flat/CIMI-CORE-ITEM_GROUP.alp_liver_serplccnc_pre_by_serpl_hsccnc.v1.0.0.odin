(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32135-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Alkaline phosphatase.liver [Enzymatic activity/volume] in Serum or Plasma by Heat stability' concept">
				use = <"Use for Alkaline phosphatase.liver [Enzymatic activity/volume] in Serum or Plasma by Heat stability.">
				keywords = <"ALP Liver", "ALP-1", "Alk phos", "Alkaline phos", "ALKP", "AP", "Alkaline phosphatase.total", "Catalytic Concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "HS", "Phos", "Phosphtase", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.alp_liver_serplccnc_pre_by_serpl_hsccnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"alp_liver_serplccnc_pre_by_serpl_hsccnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Alkaline phosphatase.liver [Enzymatic activity/volume] in Serum or Plasma by Heat stability">
				>
				["at0.0.0.0.0.2"] = <
					text = <"U/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32135-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32135-6">
			>
		>
	>
	adl_version = <"2.0.5">
