(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/59408-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oxygen saturation in Arterial blood by Pulse oximetry' concept">
				use = <"Use for Oxygen saturation in Arterial blood by Pulse oximetry.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.sao2_percent_blda_pre_by_pulseox.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"sao2_percent_blda_pre_by_pulseox">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/59408-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/59408-5">
			>
		>
	>
	adl_version = <"2.0.5">
