(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/15174-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cryocrit of Serum by Spun Westergren' concept">
				use = <"Use for Cryocrit of Serum by Spun Westergren.">
				keywords = <"Cryoglob", "Cryoglobulins", "Cryo", "Cryoprecipitate", "Cryocrit", "Volume fraction", "Volfr", "Percent", "Point in time", "Random", "SR", "Quantitative", "QNT", "Quant", "Quan", "Westrgrn", "Westerg", "Centrifuged", "Post centrifugation", "Centrifugation", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cryocrit_ser_spun_westergren.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cryocrit_ser_spun_westergren">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cryocrit of Serum by Spun Westergren">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/15174-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/15174-6">
			>
		>
	>
	adl_version = <"2.0.5">
