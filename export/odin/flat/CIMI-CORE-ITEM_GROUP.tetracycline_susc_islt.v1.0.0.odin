(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/18993-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Tetracycline [Susceptibility]' concept">
				use = <"Use for Tetracycline [Susceptibility].">
				keywords = <"C18", "c211", "C75", "Achromycin V", "Chemiciclina", "Panmycin", "Tetrabioptal", "Susceptibility", "Susceptibilty", "Sus", "Suscept", "Susceptibilities", "AST", "Point in time", "Random", "Islt", "Isol", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.tetracycline_susc_islt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"tetracycline_susc_islt">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Tetracycline [Susceptibility]">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Tetracycline [Susceptibility]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/18993-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/18993-6">
			>
		>
	>
	adl_version = <"2.0.5">
