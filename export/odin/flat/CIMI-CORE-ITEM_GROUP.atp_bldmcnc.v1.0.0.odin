(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1721-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Adenosine triphosphate [Mass/volume] in Blood' concept">
				use = <"Use for Adenosine triphosphate [Mass/volume] in Blood.">
				keywords = <"ATP", "Adenosine 5'-triphosphate", "ADO", "Mass concentration", "Level", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "ANED", "Medication stress", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.atp_bldmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"atp_bldmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Adenosine triphosphate [Mass/volume] in Blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1721-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1721-0">
			>
		>
	>
	adl_version = <"2.0.5">
