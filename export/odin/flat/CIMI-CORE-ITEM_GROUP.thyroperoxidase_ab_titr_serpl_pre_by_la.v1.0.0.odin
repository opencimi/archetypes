(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5383-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Thyroperoxidase Ab [Titer] in Serum or Plasma by Latex agglutination' concept">
				use = <"Use for Thyroperoxidase Ab [Titer] in Serum or Plasma by Latex agglutination.">
				keywords = <"Thyroid Microsomal", "Thyroid microsomes", "Thyroid peroxidase", "Iodide peroxidase", "TPO", "Dilution factor", "Titer", "Titre", "Ttr", "Titered", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Latex agglutination", "LAT", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.thyroperoxidase_ab_titr_serpl_pre_by_la.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"thyroperoxidase_ab_titr_serpl_pre_by_la">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Thyroperoxidase Ab [Titer] in Serum or Plasma by Latex agglutination">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{titer}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5383-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5383-5">
			>
		>
	>
	adl_version = <"2.0.5">
