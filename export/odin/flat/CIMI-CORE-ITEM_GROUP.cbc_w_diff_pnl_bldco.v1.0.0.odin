(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cbc_w_diff_pnl_bldco.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cbc_w_diff_pnl_bldco">
			...
			["1"] = <
				...
				children = <
					...
					["29"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.2.1.1">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.diff_pnl_bldco.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
				>
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.1"] = <
					text = <"CBC W Differential panel - Cord blood">
				>
				["id0.1.1.1.1"] = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/74412-8">
				["at0.0.0.0.1"] = <"http://loinc.org/id/74412-8">
				...
				["id0.1.1.1.7"] = <"http://loinc.org/id/47282-9">
				["id0.1.1.1.8"] = <"http://loinc.org/id/47283-7">
				["id0.1.1.1.9"] = <"http://loinc.org/id/47284-5">
				["id0.1.2.1.1"] = <"http://loinc.org/id/74413-6">
			>
		>
	>
	adl_version = <"2.0.5">
