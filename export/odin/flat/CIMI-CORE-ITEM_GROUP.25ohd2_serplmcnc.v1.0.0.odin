(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49054-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI '25-Hydroxycalciferol [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for 25-Hydroxycalciferol [Mass/volume] in Serum or Plasma.">
				keywords = <"25(OH)D2", "25 Hydroxyvitamin D 2", "25 Hydroxyvitamin D2", "25-Hydroxy calciferol", "25-Hydroxyvitamin D 2", "25-Hydroxyergocalciferol", "25-Hydroxyvitamin D2", "9,10-Secoergosta-5,7,10(19),22-tetraene-3 beta,25-diol", "Ercalcidiol", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.25ohd2_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"25ohd2_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"25-Hydroxycalciferol [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49054-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49054-0">
			>
		>
	>
	adl_version = <"2.0.5">
