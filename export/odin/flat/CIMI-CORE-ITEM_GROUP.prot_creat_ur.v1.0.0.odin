(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2890-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Protein/Creatinine [Mass Ratio] in Urine' concept">
				use = <"Use for Protein/Creatinine [Mass Ratio] in Urine.">
				keywords = <"Prot", "PR", "Creat", "Crea", "CR", "Mass concentration ratio", "Mass ratio", "MCRto", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Chemistry", "UCr">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.prot_creat_ur.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"prot_creat_ur">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Protein/Creatinine [Mass Ratio] in Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/g{creat}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2890-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2890-2">
			>
		>
	>
	adl_version = <"2.0.5">
