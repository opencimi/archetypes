(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33219-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Epithelial cells.squamous [#/area] in Urine sediment by Automated count' concept">
				use = <"Use for Epithelial cells.squamous [#/area] in Urine sediment by Automated count.">
				keywords = <"Squamous epithelial cells", "Squamous epithelial cell", "Squamous cell", "SEC", "Epi Cells", "Cell", "Cellularity", "#/area", "Number areic", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Auto", "Sq", "Epith", "Epithelia", "URINALYSIS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.squamous_num_per_area_urns_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"squamous_num_per_area_urns_auto">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33219-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33219-7">
			>
		>
	>
	adl_version = <"2.0.5">
