(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/10704-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Ova and parasites identified in Stool by Light microscopy' concept">
				use = <"Use for Ova and parasites identified in Stool by Light microscopy.">
				keywords = <"Parasite", "O+P", "Ova and parasite", "O&P", "Identity or presence", "Point in time", "Random", "Stl", "Feces", "Faeces", "Bowel movement", "Fecal", "Faecal", "Nominal", "LM", "Micros", "Microscopic", "Isolated", "Ovum", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.o_plus_p_stl_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"o_plus_p_stl_micro">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Ova and parasites identified in Stool by Light microscopy">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Ova and parasites identified in Stool by Light microscopy">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/10704-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/10704-5">
			>
		>
	>
	adl_version = <"2.0.5">
