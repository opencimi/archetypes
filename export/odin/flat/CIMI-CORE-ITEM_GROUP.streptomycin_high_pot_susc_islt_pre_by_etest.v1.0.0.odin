(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/35841-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Streptomycin.high potency [Susceptibility] by Gradient strip (E-test)' concept">
				use = <"Use for Streptomycin.high potency [Susceptibility] by Gradient strip (E-test).">
				keywords = <"Streptomycin High Pot", "Streptomycin synergy", "Streptomyc", "c232", "Cidam est", "Novostrep", "Solustrep", "Strepto-fatol", "Streptocol", "Susceptibility", "Susceptibilty", "Sus", "Suscept", "Susceptibilities", "AST", "Point in time", "Random", "Islt", "Isol", "E-test", "E-strip", "Etest", "Estrip", "E-test", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.streptomycin_high_pot_susc_islt_pre_by_etest.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"streptomycin_high_pot_susc_islt_pre_by_etest">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Streptomycin.high potency [Susceptibility] by Gradient strip (E-test)">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Streptomycin.high potency [Susceptibility] by Gradient strip (E-test)">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/35841-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/35841-6">
			>
		>
	>
	adl_version = <"2.0.5">
