(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33768-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Leukocyte clumps [#/volume] in Urine by Automated count' concept">
				use = <"Use for Leukocyte clumps [#/volume] in Urine by Automated count.">
				keywords = <"WBC clumps", "#", "Number concentration", "Count/volume", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Ur", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Auto", "White blood cell", "Leuc", "Leuk", "Lkcs", "Leukocytes", "White blood cells", "WBCs", "URINALYSIS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.wbc_clumps_num_ur_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"wbc_clumps_num_ur_auto">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33768-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33768-3">
			>
		>
	>
	adl_version = <"2.0.5">
