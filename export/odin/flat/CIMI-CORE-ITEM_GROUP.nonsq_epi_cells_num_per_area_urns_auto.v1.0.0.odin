(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/53294-5.html>">
			["tool"] = <"cimi-gen v0.0.1">
			["time"] = <"2015-08-05T22:27:37">
		>
		details = <
			["en"] = <
				language = <[ISO_639-1::en]>
				purpose = <"Archetype for CIMI 'Epithelial cells.non-squamous [#/area] in Urine sediment by Automated count' concept">
				use = <"Use for Epithelial cells.non-squamous [#/area] in Urine sediment by Automated count.">
				keywords = <"Non-sq Epi Cells", "Small epithelial cells", "Round epithelial cells", "Cell", "Cellularity", "#/area", "Number areic", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Auto", "Sq", "Epith", "Epithelia", "URINALYSIS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.nonsq_epi_cells_num_per_area_urns_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"nonsq_epi_cells_num_per_area_urns_auto">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/53294-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/53294-5">
			>
		>
	>
	adl_version = <"2.0.5">
