(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/23905-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Mycophenolate [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Mycophenolate [Mass/volume] in Serum or Plasma.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.mycophenolate_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"mycophenolate_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Mycophenolate [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/23905-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/23905-3">
			>
		>
	>
	adl_version = <"2.0.5">
