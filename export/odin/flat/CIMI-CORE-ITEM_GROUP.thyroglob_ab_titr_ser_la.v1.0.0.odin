(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5381-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Thyroglobulin Ab [Titer] in Serum by Latex agglutination' concept">
				use = <"Use for Thyroglobulin Ab [Titer] in Serum by Latex agglutination.">
				keywords = <"Thyglobulin", "Thyroglbn", "Antithyroglob", "Thyroglob", "Tg", "TgAbs", "Dilution factor", "Titer", "Titre", "Ttr", "Titered", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "Latex agglutination", "LAT", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.thyroglob_ab_titr_ser_la.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"thyroglob_ab_titr_ser_la">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Thyroglobulin Ab [Titer] in Serum by Latex agglutination">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{titer}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5381-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5381-9">
			>
		>
	>
	adl_version = <"2.0.5">
