(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/8041-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Treponema pallidum Ab [Presence] in Serum by Hemagglutination' concept">
				use = <"Use for Treponema pallidum Ab [Presence] in Serum by Hemagglutination.">
				keywords = <"T pallidum", "Syphilis", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "IHA", "Hemagglutination", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Treponemal", "Microbiology", "MHA-TP", "TPHA", "HATTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.t_pallidum_ab_ser_ql_pre_by_ha.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"t_pallidum_ab_ser_ql_pre_by_ha">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Treponema pallidum Ab [Presence] in Serum by Hemagglutination">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/8041-6">
			>
			["opencem"] = <
