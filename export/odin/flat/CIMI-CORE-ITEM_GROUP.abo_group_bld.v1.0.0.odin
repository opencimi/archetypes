(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/883-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'ABO group [Type] in Blood' concept">
				use = <"Use for ABO group [Type] in Blood.">
				keywords = <"Typ", "Point in time", "Random", "Blood", "WB", "Whole blood", "Nominal", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.abo_group_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"abo_group_bld">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/883-9">
			>
			["opencem"] = <
