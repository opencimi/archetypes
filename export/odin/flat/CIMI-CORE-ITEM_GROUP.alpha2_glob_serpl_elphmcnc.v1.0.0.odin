(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2868-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Alpha 2 globulin [Mass/volume] in Serum or Plasma by Electrophoresis' concept">
				use = <"Use for Alpha 2 globulin [Mass/volume] in Serum or Plasma by Electrophoresis.">
				keywords = <"GLB", "Globulins", "Glob", "Glob%", "Globul", "Alpha2 Glob", "Protein.alpha 2 globulin", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Elph", "Elp", "Elect", "Electrophrs", "Electrophhrs", "Electr", "Elec", "Ep", "Electro", "A2", "Alfa", "II", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.alpha2_glob_serpl_elphmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"alpha2_glob_serpl_elphmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Alpha 2 globulin [Mass/volume] in Serum or Plasma by Electrophoresis">
				>
				["at0.0.0.0.0.2"] = <
					text = <"g/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2868-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2868-8">
			>
		>
	>
	adl_version = <"2.0.5">
