(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/18862-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Amoxicillin+Clavulanate [Susceptibility]' concept">
				use = <"Use for Amoxicillin+Clavulanate [Susceptibility].">
				keywords = <"Clav", "Clavu", "Clavulanic", "Clavul", "Clavate", "c305", "Clavulanic acid", "Amoxicillin+Clav", "Augmentin", "Amoxicillin+clavulanic acid", "Moxicillin+clavulanic acid", "Amox", "c204", "Amoxicilloyl", "c6", "Larotid", "Bristamox", "Moxalin", "Polymox", "Trimox", "Wymox", "Sumox", "Amoxil", "Susceptibility", "Susceptibilty", "Sus", "Suscept", "Susceptibilities", "AST", "Point in time", "Random", "Islt", "Isol", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.amoxicillin_plus_clav_susc_islt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"amoxicillin_plus_clav_susc_islt">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Amoxicillin+Clavulanate [Susceptibility]">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Amoxicillin+Clavulanate [Susceptibility]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/18862-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/18862-3">
			>
		>
	>
	adl_version = <"2.0.5">
