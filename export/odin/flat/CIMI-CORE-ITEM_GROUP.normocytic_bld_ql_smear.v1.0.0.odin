(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33363-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Normocytic [Presence] in Blood by Light microscopy' concept">
				use = <"Use for Normocytic [Presence] in Blood by Light microscopy.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.normocytic_bld_ql_smear.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"normocytic_bld_ql_smear">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33363-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33363-3">
			>
		>
	>
	adl_version = <"2.0.5">
