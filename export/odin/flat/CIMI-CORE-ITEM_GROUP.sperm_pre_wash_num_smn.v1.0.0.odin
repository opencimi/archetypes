(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/38544-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Spermatozoa [#/volume] in Semen --pre washing' concept">
				use = <"Use for Spermatozoa [#/volume] in Semen --pre washing.">
				keywords = <"Sperm", "Before", "Pre Wash", "#", "Number concentration", "Count/volume", "Count", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Smn", "Ejaculate", "Seminal fluid", "SMPLS", "Sem", "Quantitative", "QNT", "Quant", "Quan", "FERTILITY TESTING">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.sperm_pre_wash_num_smn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"sperm_pre_wash_num_smn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Spermatozoa [#/volume] in Semen --pre washing">
				>
				["at0.0.0.0.0.2"] = <
					text = <"10*6/mL">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/426960000">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/38544-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/38544-3">
			>
		>
	>
	adl_version = <"2.0.5">
