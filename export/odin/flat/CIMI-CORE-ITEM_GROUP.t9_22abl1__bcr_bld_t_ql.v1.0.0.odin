(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/21821-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 't(9;22)(q34.1;q11)(ABL1,BCR) fusion transcript [Presence] in Blood or Tissue by Molecular genetics method' concept">
				use = <"Use for t(9;22)(q34.1;q11)(ABL1,BCR) fusion transcript [Presence] in Blood or Tissue by Molecular genetics method.">
				keywords = <"t(9;22)(ABL1,BCR)", "Philadelphia chromosome", "bcr-abl1", "bcr/abl", "t(9,22)(ABL1,BCR) gene translocation", "t(9,22)(ABL1,BCR) Translocation", "t(9,22)(q34,q11)", "Ph chromosome", "Arbitrary", "Point in time", "Random", "Bld/T", "Tissue", "Bld/T", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "PCR", "Molecular genetics", "gene fusion", "RNA", "DNA", "T prime", "ALL", "BCR1", "Chronic myeloid leukemia", "CML", "Breakpoint cluster region", "D22S11", "D22S662", "PHL", "v-abl Abelson murine leukemia viral oncogene homolog 1", "ABL", "JTK7", "p150", "MOLPATH.TRANSLOCATION", "MOLPATH.TRANSLOCATION", "Molecular pathology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.t9_22abl1__bcr_bld_t_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"t9_22abl1__bcr_bld_t_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"t(9;22)(q34.1;q11)(ABL1,BCR) fusion transcript [Presence] in Blood or Tissue by Molecular genetics method">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/21821-4">
			>
			["opencem"] = <
