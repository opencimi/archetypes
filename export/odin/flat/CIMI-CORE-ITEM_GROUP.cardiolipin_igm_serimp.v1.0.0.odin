(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20425-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cardiolipin IgM Ab [interpretation] in Serum' concept">
				use = <"Use for Cardiolipin IgM Ab [interpretation] in Serum.">
				keywords = <"Immune globulin M", "Immunoglobulin M", "Cardiolip", "Cardio", "Cardiolipn", "Cardiolpn", "ACA", "aCL", "Anticardiolipin", "CL", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Serum", "SR", "Nominal", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cardiolipin_igm_serimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cardiolipin_igm_serimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cardiolipin IgM Ab [interpretation] in Serum">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Cardiolipin IgM Ab [interpretation] in Serum">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20425-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20425-5">
			>
		>
	>
	adl_version = <"2.0.5">
