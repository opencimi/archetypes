(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20454-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Protein [Presence] in Urine by Test strip' concept">
				use = <"Use for Protein [Presence] in Urine by Test strip.">
				keywords = <"Prot", "PR", "Arbitrary concentration", "Point in time", "Random", "Ur", "UR", "Urn", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Dipstick", "Dip stick", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.prot_ur_ql_strip.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"prot_ur_ql_strip">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Protein [Presence] in Urine by Test strip">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Protein [Presence] in Urine by Test strip">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20454-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20454-5">
			>
		>
	>
	adl_version = <"2.0.5">
