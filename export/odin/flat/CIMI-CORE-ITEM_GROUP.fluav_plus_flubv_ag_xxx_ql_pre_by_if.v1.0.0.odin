(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6438-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Influenza virus A+B Ag [Presence] in Unspecified specimen by Immunofluorescence' concept">
				use = <"Use for Influenza virus A+B Ag [Presence] in Unspecified specimen by Immunofluorescence.">
				keywords = <"FLUAV+FLUBV", "FLUAV and FLUBV", "Avian influenza", "Fowl plague", "Influenza A virus", "FLUA", "Bird flu", "FLUV", "Influ", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ACIF", "FA", "Fluorescent antibody", "Immune fluorescence", "Fluoresent", "Immunoflour", "Immunofluor", "Immunofluorescence", "IFA", "Time Resolved Fluorescence", "Anticomplement Immunofluorescence", "TRF", "Antigen", "Antigens", "Microbiology", "DFA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fluav_plus_flubv_ag_xxx_ql_pre_by_if.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fluav_plus_flubv_ag_xxx_ql_pre_by_if">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Influenza virus A+B Ag [Presence] in Unspecified specimen by Immunofluorescence">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Influenza virus A+B Ag [Presence] in Unspecified specimen by Immunofluorescence">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6438-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6438-6">
			>
		>
	>
	adl_version = <"2.0.5">
