(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6222-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Queen Palm IgE Ab [Units/volume] in Serum' concept">
				use = <"Use for Queen Palm IgE Ab [Units/volume] in Serum.">
				keywords = <"Queen Palm", "Queen palm", "t072", "t72", "Arecastrum romanzoffianum", "Immune globulin E", "Immunoglobulin E", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "ALLERGY TESTING", "Allergens", "Allergen">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.queen_palm_ige_qn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"queen_palm_ige_qn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Queen Palm IgE Ab [Units/volume] in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"k[IU]/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6222-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6222-4">
			>
		>
	>
	adl_version = <"2.0.5">
