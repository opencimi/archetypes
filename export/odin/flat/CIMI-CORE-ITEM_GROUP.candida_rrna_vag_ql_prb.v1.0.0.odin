(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/47000-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Candida sp rRNA [Presence] in Vaginal fluid by DNA probe' concept">
				use = <"Use for Candida sp rRNA [Presence] in Vaginal fluid by DNA probe.">
				keywords = <"Monilia", "Thrush", "Arbitrary concentration", "Point in time", "Random", "Genital vaginal", "Vagina", "Vaginal fluid", "Vag fluid", "Vag fld", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Prb", "DNA probe", "species", "spp", "ribosomal RNA", "Cand", "Candidiasis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.candida_rrna_vag_ql_prb.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"candida_rrna_vag_ql_prb">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Candida sp rRNA [Presence] in Vaginal fluid by DNA probe">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Candida sp rRNA [Presence] in Vaginal fluid by DNA probe">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/47000-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/47000-5">
			>
		>
	>
	adl_version = <"2.0.5">
