(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/68406-8.html>">
			["tool"] = <"cimi-gen v0.0.1">
			["time"] = <"2015-08-05T22:28:07">
		>
		details = <
			["en"] = <
				language = <[ISO_639-1::en]>
				purpose = <"Archetype for CIMI 'Lymphocytes Abnormal/100 leukocytes in Vitreous fluid by Manual count' concept">
				use = <"Use for Lymphocytes Abnormal/100 leukocytes in Vitreous fluid by Manual count.">
				keywords = <"Lymph Abn", "Atypical", "Lymphs", "Lymphocyte", "Lympho", "Lymphs%", "Lymp", "WBC", "White blood cell", "Leuc", "Leuk", "Leukocyte", "Lkcs", "White blood cells", "WBCs", "100WBC", "Number fraction", "Percent", "Point in time", "Random", "Vitf", "Vitreous fluid", "VitF", "Vitreous humor", "Vitreous humour", "Quantitative", "QNT", "Quant", "Quan", "Manl", "abn", "abnorm", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.lymph_abn_nfr_vitf_manual.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"lymph_abn_nfr_vitf_manual">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/68406-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/68406-8">
			>
		>
	>
	adl_version = <"2.0.5">
