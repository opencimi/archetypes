(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/58448-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Microalbumin ug/min [Mass/time] in 24 hour Urine' concept">
				use = <"Use for Microalbumin ug/min [Mass/time] in 24 hour Urine.">
				keywords = <"Protein.albumin", "Alb", "mRate", "Mass rate", "1 day", "24 hours", "24HR", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "DL=20 mg/L", "DL=20 mg/L", "mcg", "minimum", "Minimal", "Chemistry", "MA", "Malb", "Micro albumin", "Microalbumin">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.microalbumin_ug_min_24h_urmrate.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"microalbumin_ug_min_24h_urmrate">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Microalbumin ug/min [Mass/time] in 24 hour Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/min">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/58448-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/58448-2">
			>
		>
	>
	adl_version = <"2.0.5">
