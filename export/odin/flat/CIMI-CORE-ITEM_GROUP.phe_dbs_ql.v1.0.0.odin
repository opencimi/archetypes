(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/29571-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Phenylalanine [Presence] in Dried blood spot' concept">
				use = <"Use for Phenylalanine [Presence] in Dried blood spot.">
				keywords = <"Phe", "PPA", "Arbitrary concentration", "Point in time", "Random", "DBS", "Filter paper", "FP", "Dried blood spot", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Chemistry", "PKU">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.phe_dbs_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"phe_dbs_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Phenylalanine [Presence] in Dried blood spot">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Phenylalanine [Presence] in Dried blood spot">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/29571-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/29571-7">
			>
		>
	>
	adl_version = <"2.0.5">
