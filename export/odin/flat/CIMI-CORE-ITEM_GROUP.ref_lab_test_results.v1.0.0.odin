(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19146-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Reference lab test results' concept">
				use = <"Use for Reference lab test results.">
				keywords = <"Ref Lab Test Results", "Finding", "Findings", "?Tm", "Narrative", "Report">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ref_lab_test_results.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ref_lab_test_results">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Reference lab test results">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Reference lab test results">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19146-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19146-0">
			>
		>
	>
	adl_version = <"2.0.5">
