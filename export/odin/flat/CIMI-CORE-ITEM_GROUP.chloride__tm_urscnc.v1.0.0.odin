(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/35676-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Chloride [Moles/volume] in unspecified time Urine' concept">
				use = <"Use for Chloride [Moles/volume] in unspecified time Urine.">
				keywords = <"Cl-", "Cl", "Substance concentration", "Level", "?Tm", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.chloride__tm_urscnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"chloride__tm_urscnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Chloride [Moles/volume] in unspecified time Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mmol/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/35676-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/35676-6">
			>
		>
	>
	adl_version = <"2.0.5">
