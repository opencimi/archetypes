(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/14976-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Lecithin/Sphingomyelin [Ratio] in Amniotic fluid' concept">
				use = <"Use for Lecithin/Sphingomyelin [Ratio] in Amniotic fluid.">
				keywords = <"Phosphatidylcholine", "c470", "Choline phosphoglyceride", "SPH", "L/S", "L/S ratio", "Fetal lung maturity", "Rto", "Point in time", "Random", "Amn", "Amniotic fluid", "Amn fl", "Amniotic flu", "AF", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.lecithin_sphingomyelin_amnrto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"lecithin_sphingomyelin_amnrto">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Lecithin/Sphingomyelin [Ratio] in Amniotic fluid">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{ratio}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/14976-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/14976-5">
			>
		>
	>
	adl_version = <"2.0.5">
