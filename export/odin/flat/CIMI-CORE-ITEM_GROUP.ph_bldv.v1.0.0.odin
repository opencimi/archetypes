(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2746-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'pH of Venous blood' concept">
				use = <"Use for pH of Venous blood.">
				keywords = <"Log molar concentration", "Point in time", "Random", "Blood - venous", "Bld ven", "Bld venous", "Blood venus", "Blood ven", "Venous", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ph_bldv.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ph_bldv">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2746-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2746-6">
			>
		>
	>
	adl_version = <"2.0.5">
