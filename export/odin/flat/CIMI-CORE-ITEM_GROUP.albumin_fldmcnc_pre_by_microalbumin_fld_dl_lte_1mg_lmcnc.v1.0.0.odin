(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/53529-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Microalbumin [Mass/volume] in Body fluid by Detection limit <= 1.0 mg/L' concept">
				use = <"Use for Microalbumin [Mass/volume] in Body fluid by Detection limit <= 1.0 mg/L.">
				keywords = <"Protein.albumin", "Alb", "Mass concentration", "Level", "Point in time", "Random", "BF", "Fluid", "Body fluid", "B/F", "FLU", "Fl", "Quantitative", "QNT", "Quant", "Quan", "DL<=1 mg/L", "DL<=1 mg/L", "Chemistry", "MA", "Malb", "Micro albumin", "Microalbumin">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.albumin_fldmcnc_pre_by_microalbumin_fld_dl_lte_1mg_lmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"albumin_fldmcnc_pre_by_microalbumin_fld_dl_lte_1mg_lmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Microalbumin [Mass/volume] in Body fluid by Detection limit <= 1.0 mg/L">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/53529-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/53529-4">
			>
		>
	>
	adl_version = <"2.0.5">
