(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/38996-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Neutrophils [Presence] in Urine by Light microscopy' concept">
				use = <"Use for Neutrophils [Presence] in Urine by Light microscopy.">
				keywords = <"PNM", "Neutrophil", "Neutr", "PMN", "Neut", "Arbitrary concentration", "Point in time", "Random", "Ur", "UR", "Urn", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Micro", "LM", "Micros", "Microscopic", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.neutrophils_ur_ql_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"neutrophils_ur_ql_micro">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Neutrophils [Presence] in Urine by Light microscopy">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Neutrophils [Presence] in Urine by Light microscopy">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/38996-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/38996-5">
			>
		>
	>
	adl_version = <"2.0.5">
