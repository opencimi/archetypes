(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1007-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Direct antiglobulin test.poly specific reagent [Presence] on Red Blood Cells' concept">
				use = <"Use for Direct antiglobulin test.poly specific reagent [Presence] on Red Blood Cells.">
				keywords = <"DAT Poly-Sp Reag", "Direct antiglobulin test.non specific reagent", "Direct coombs test", "DCT", "DAGT", "Direct Coomb", "Point in time", "Random", "Erythrocytes", "Red blood corpusles", "Red blood cells", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Dir", "Antiglob", "Spec", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.dat_polysp_reag_rbc_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"dat_polysp_reag_rbc_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Direct antiglobulin test.poly specific reagent [Presence] on Red Blood Cells">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1007-4">
			>
			["opencem"] = <
