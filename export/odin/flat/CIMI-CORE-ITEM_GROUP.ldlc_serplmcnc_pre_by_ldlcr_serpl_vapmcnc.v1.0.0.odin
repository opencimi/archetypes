(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/55440-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cholesterol.in LDL (real) [Mass/volume] in Serum or Plasma by VAP' concept">
				use = <"Use for Cholesterol.in LDL (real) [Mass/volume] in Serum or Plasma by VAP.">
				keywords = <"LDLc", "LDL-C", "Low density lipoprotein cholesterols", "Low density lipoprotein cholesterol", "Chol", "Choles", "Cholest", "Lipid", "Cholesterol total", "Cholesterols", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry", "Real LDL", "LDLc-R", "LDL-R">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ldlc_serplmcnc_pre_by_ldlcr_serpl_vapmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ldlc_serplmcnc_pre_by_ldlcr_serpl_vapmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cholesterol.in LDL (real) [Mass/volume] in Serum or Plasma by VAP">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/55440-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/55440-2">
			>
		>
	>
	adl_version = <"2.0.5">
