(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/9428-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Benzodiazepines [Mass/volume] in Urine' concept">
				use = <"Use for Benzodiazepines [Mass/volume] in Urine.">
				keywords = <"Benzodiaz", "Benz", "Benzodiazepine", "Mass concentration", "Level", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.benzodiaz_urmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"benzodiaz_urmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Benzodiazepines [Mass/volume] in Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/9428-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/9428-4">
			>
		>
	>
	adl_version = <"2.0.5">
