(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/41499-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Legionella pneumophila 1 Ag [Presence] in Urine by Immunoassay' concept">
				use = <"Use for Legionella pneumophila 1 Ag [Presence] in Urine by Immunoassay.">
				keywords = <"L pneumo1", "Philadelphia 1", "Legionella pneumophila serogroup 1", "L pneumonphila", "Arbitrary concentration", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "Antigen", "Antigens", "Pneumophilia", "pneum", "Pneu", "Legionela", "Legion", "I", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.l_pneumo1_ag_ur_ql_pre_by_eia.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"l_pneumo1_ag_ur_ql_pre_by_eia">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Legionella pneumophila 1 Ag [Presence] in Urine by Immunoassay">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Legionella pneumophila 1 Ag [Presence] in Urine by Immunoassay">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/41499-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/41499-5">
			>
		>
	>
	adl_version = <"2.0.5">
