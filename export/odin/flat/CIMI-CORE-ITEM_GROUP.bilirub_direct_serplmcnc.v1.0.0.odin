(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1968-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Bilirubin.direct [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Bilirubin.direct [Mass/volume] in Serum or Plasma.">
				keywords = <"Bilirub Direct", "TBIL-Bu", "Bilirubin direct", "Bilirub Conj", "Bc", "Bilirubin glucuronides", "Bilirubin conjugated", "Bilirub Delta", "Bili.delta", "DELB", "Deltab", "TBIL-(Bu+Bc)", "Bili-alb", "Delta bilirubin", "Bili", "TBIL", "Bilirubins", "Protein.albumin", "Alb", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "bnd", "Associated", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bilirub_direct_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bilirub_direct_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Bilirubin.direct [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1968-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1968-7">
			>
		>
	>
	adl_version = <"2.0.5">
