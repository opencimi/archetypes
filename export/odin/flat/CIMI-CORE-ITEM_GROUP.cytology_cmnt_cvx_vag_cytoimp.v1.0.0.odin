(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19774-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cytology study comment Cervical or vaginal smear or scraping Cyto stain' concept">
				use = <"Use for Cytology study comment Cervical or vaginal smear or scraping Cyto stain.">
				keywords = <"Study report", "Cytology Cmnt", "Remarks", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Genital tract", "Genital vaginal", "Vagina", "Vaginal fluid", "Vag fluid", "Vag fld", "Cervix", "Narrative", "Report", "Pap Smear", "Pap Stain", "Cytostain", "Cytology stain", "Papanicolaou smear", "Com", "Comm", "Commt", "Comments", "cmnt", "cmmt">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cytology_cmnt_cvx_vag_cytoimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cytology_cmnt_cvx_vag_cytoimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cytology study comment Cervical or vaginal smear or scraping Cyto stain">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Cytology study comment Cervical or vaginal smear or scraping Cyto stain">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19774-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19774-9">
			>
		>
	>
	adl_version = <"2.0.5">
