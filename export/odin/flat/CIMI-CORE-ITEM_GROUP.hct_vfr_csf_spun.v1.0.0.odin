(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13508-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hematocrit [Volume Fraction] of Cerebral spinal fluid by Centrifugation' concept">
				use = <"Use for Hematocrit [Volume Fraction] of Cerebral spinal fluid by Centrifugation.">
				keywords = <"Hct", "PCV", "Volume fraction", "Volfr", "Percent", "Point in time", "Random", "Cerebral spinal fluid", "Spinal Fluid", "Cerebrospinal Fl", "Spinal Flu", "Spinal Fld", "Quantitative", "QNT", "Quant", "Quan", "Centrifuged", "Post centrifugation", "Centrifugation", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS", "Microhematocrit">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hct_vfr_csf_spun.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hct_vfr_csf_spun">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hematocrit [Volume Fraction] of Cerebral spinal fluid by Centrifugation">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13508-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13508-7">
			>
		>
	>
	adl_version = <"2.0.5">
