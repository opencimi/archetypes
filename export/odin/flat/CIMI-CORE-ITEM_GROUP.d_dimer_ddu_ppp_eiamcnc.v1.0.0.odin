(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/48058-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fibrin D-dimer DDU [Mass/volume] in Platelet poor plasma by Immunoassay' concept">
				use = <"Use for Fibrin D-dimer DDU [Mass/volume] in Platelet poor plasma by Immunoassay.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.d_dimer_ddu_ppp_eiamcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"d_dimer_ddu_ppp_eiamcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Fibrin D-dimer DDU [Mass/volume] in Platelet poor plasma by Immunoassay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/L{DDU}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/48058-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/48058-2">
			>
		>
	>
	adl_version = <"2.0.5">
