(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/24358-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemogram without Platelets panel - Blood' concept">
				use = <"Use for Hemogram without Platelets panel - Blood.">
				keywords = <"Platelets Pnl", "Plt", "Platelet", "Thrombocytes", "Platelt", "Thrb", "Thrombocyte", "CBC WO Platelets", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Pan", "Panl", "Complete Blood Count", "PANEL.HEMATOLOGY& CELL COUNTS", "PANEL.HEMATOLOGY& CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cbc_wo_platelets_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cbc_wo_platelets_bld">
			...
			["1"] = <
				...
				children = <
					...
					["20"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.1">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.hct_vfr_bld.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["21"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.2">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.rbc_num_bld.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					...
					["23"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.4">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.mch_rbc_qn.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["24"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.5">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.mchc_rbcmcnc.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["25"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.6">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.rdw_rbc.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["26"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.7">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.rdw_rbcrto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["27"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.8">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.mcv_rbc.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.1"] = <
					text = <"Hemogram without Platelets panel - Blood">
				>
				["id0.1.1.1.1"] = <
					text = <"Hematocrit [Volume Fraction] of Blood">
				>
				["id0.1.1.1.2"] = <
					text = <"Erythrocytes [#/volume] in Blood">
				>
				["id0.1.1.1.3"] = <
					text = <"Leukocytes [#/volume] in Blood">
				>
				["id0.1.1.1.4"] = <
					text = <"Erythrocyte mean corpuscular hemoglobin [Entitic mass]">
				>
				["id0.1.1.1.5"] = <
					text = <"Erythrocyte mean corpuscular hemoglobin concentration [Mass/volume]">
				>
				["id0.1.1.1.6"] = <
					text = <"Erythrocyte distribution width [Entitic volume]">
				>
				["id0.1.1.1.7"] = <
					text = <"Erythrocyte distribution width [Ratio]">
				>
				["id0.1.1.1.8"] = <
					text = <"Erythrocyte mean corpuscular volume [Entitic volume]">
				>
				["id0.1.1.1.9"] = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/24358-4">
				["at0.0.0.0.1"] = <"http://loinc.org/id/24358-4">
				["id0.1.1.1.1"] = <"http://loinc.org/id/20570-8">
				["id0.1.1.1.2"] = <"http://loinc.org/id/26453-1">
				["id0.1.1.1.3"] = <"http://loinc.org/id/26464-8">
				["id0.1.1.1.4"] = <"http://loinc.org/id/28539-5">
				["id0.1.1.1.5"] = <"http://loinc.org/id/28540-3">
				["id0.1.1.1.6"] = <"http://loinc.org/id/30384-2">
				["id0.1.1.1.7"] = <"http://loinc.org/id/30385-9">
				["id0.1.1.1.8"] = <"http://loinc.org/id/30428-7">
				["id0.1.1.1.9"] = <"http://loinc.org/id/718-7">
			>
		>
	>
	adl_version = <"2.0.5">
