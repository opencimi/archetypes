(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/22634-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Pathology report gross observation Narrative' concept">
				use = <"Use for Pathology report gross observation Narrative.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.path_report_gross_spec.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"path_report_gross_spec">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Pathology report gross observation Narrative">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Pathology report gross observation Narrative">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/22634-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/22634-0">
			>
		>
	>
	adl_version = <"2.0.5">
