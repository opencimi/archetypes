(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/18919-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Erythromycin [Susceptibility]' concept">
				use = <"Use for Erythromycin [Susceptibility].">
				keywords = <"Erythromycn", "c212", "Iltycin", "Ilosone", "Erygel", "EES", "Ilotycin", "Susceptibility", "Susceptibilty", "Sus", "Suscept", "Susceptibilities", "AST", "Point in time", "Random", "Islt", "Isol", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.erythromycin_susc_islt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"erythromycin_susc_islt">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Erythromycin [Susceptibility]">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Erythromycin [Susceptibility]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/18919-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/18919-1">
			>
		>
	>
	adl_version = <"2.0.5">
