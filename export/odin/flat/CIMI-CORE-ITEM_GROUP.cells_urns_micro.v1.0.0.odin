(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/58438-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cells [Type] in Urine sediment by Light microscopy' concept">
				use = <"Use for Cells [Type] in Urine sediment by Light microscopy.">
				keywords = <"Cell", "Cellularity", "Typ", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Nominal", "Micro", "LM", "Micros", "Microscopic", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cells_urns_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cells_urns_micro">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/58438-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/58438-3">
			>
		>
	>
	adl_version = <"2.0.5">
