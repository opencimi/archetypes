(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20991-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Antithrombin [interpretation] in Platelet poor plasma' concept">
				use = <"Use for Antithrombin [interpretation] in Platelet poor plasma.">
				keywords = <"AT III", "ATIII", "Antithrombn", "Antithrm", "Anti thrombin", "Antithrombin III", "Heparin cofactor I", "Thrombin inhibitor I", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Platelet poor plasma", "Plas", "Nominal", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.at_iii_pppimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"at_iii_pppimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Antithrombin [interpretation] in Platelet poor plasma">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Antithrombin [interpretation] in Platelet poor plasma">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20991-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20991-6">
			>
		>
	>
	adl_version = <"2.0.5">
