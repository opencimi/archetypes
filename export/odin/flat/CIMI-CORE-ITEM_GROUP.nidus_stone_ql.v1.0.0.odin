(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/42192-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Nidus [Presence] in Stone' concept">
				use = <"Use for Nidus [Presence] in Stone.">
				keywords = <"Arbitrary concentration", "Point in time", "Random", "Stone", "Calc", "Stn", "Stones", "Calculi", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "PATHOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.nidus_stone_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"nidus_stone_ql">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/42192-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/42192-5">
			>
		>
	>
	adl_version = <"2.0.5">
