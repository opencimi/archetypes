(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/18500-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Microscopic observation [Identifier] in Cervix by Cyto stain.thin prep' concept">
				use = <"Use for Microscopic observation [Identifier] in Cervix by Cyto stain.thin prep.">
				keywords = <"Micro", "Identity or presence", "Point in time", "Random", "Cervix", "Genital tract", "Nominal", "Pap Smear", "Pap Stain", "Cytostain", "Cytology stain", "Papanicolaou smear">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.thin_prep_cervix.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"thin_prep_cervix">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Microscopic observation [Identifier] in Cervix by Cyto stain.thin prep">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Microscopic observation [Identifier] in Cervix by Cyto stain.thin prep">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/18500-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/18500-9">
			>
		>
	>
	adl_version = <"2.0.5">
