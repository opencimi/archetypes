(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/57922-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Carbon dioxide, total [Moles/volume] in Serum or Plasma by calculation' concept">
				use = <"Use for Carbon dioxide, total [Moles/volume] in Serum or Plasma by calculation.">
				keywords = <"CO2", "Carbonic anhydride", "Substance concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Calc", "Calculation", "Chemistry", "CO2 TOTAL", "cCO2", "tCO2", "ctCO2", "CO2CT">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.co2_serplscnc_pre_by_serpl_calcscnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"co2_serplscnc_pre_by_serpl_calcscnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Carbon dioxide, total [Moles/volume] in Serum or Plasma by calculation">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mmol/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/57922-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/57922-7">
			>
		>
	>
	adl_version = <"2.0.5">
