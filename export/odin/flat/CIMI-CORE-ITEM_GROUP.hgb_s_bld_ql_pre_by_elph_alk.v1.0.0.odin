(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/4623-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemoglobin S [Presence] in Blood by Electrophoresis alkaline (pH 8.9)' concept">
				use = <"Use for Hemoglobin S [Presence] in Blood by Electrophoresis alkaline (pH 8.9).">
				keywords = <"Hgb S", "Sickle cell", "Sickle cells", "HbS", "Hb", "Haemoglobin", "Arbitrary concentration", "Point in time", "Random", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Elph Alk", "Elp", "Elect", "Electrophrs", "Electrophhrs", "Electr", "Elec", "Ep", "Electro", "S prime", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS", "Sickle cell screen", "Sicklequik", "Sickledex">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hgb_s_bld_ql_pre_by_elph_alk.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hgb_s_bld_ql_pre_by_elph_alk">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hemoglobin S [Presence] in Blood by Electrophoresis alkaline (pH 8.9)">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Hemoglobin S [Presence] in Blood by Electrophoresis alkaline (pH 8.9)">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/4623-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/4623-5">
			>
		>
	>
	adl_version = <"2.0.5">
