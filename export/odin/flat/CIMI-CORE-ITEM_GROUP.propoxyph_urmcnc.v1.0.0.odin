(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3545-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Propoxyphene [Mass/volume] in Urine' concept">
				use = <"Use for Propoxyphene [Mass/volume] in Urine.">
				keywords = <"Propoxyph", "D-propoxyphene", "Cotonal-65", "Dextropropoxyphene", "Cosalgesic", "Dextrogesic", "Distalgesic", "Dolasan", "Napsalgesic", "Algaphan", "Depronal", "Doloxene", "Darvon", "Mass concentration", "Level", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.propoxyph_urmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"propoxyph_urmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Propoxyphene [Mass/volume] in Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3545-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3545-1">
			>
		>
	>
	adl_version = <"2.0.5">
