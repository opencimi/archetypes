(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/9804-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Weight of Stone' concept">
				use = <"Use for Weight of Stone.">
				keywords = <"Wt", "Point in time", "Random", "Stone", "Calc", "Stn", "Stones", "Calculi", "Quantitative", "QNT", "Quant", "Quan", "PATHOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.wt_stone.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"wt_stone">
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258682000">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/9804-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/9804-6">
			>
		>
	>
	adl_version = <"2.0.5">
