(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/53318-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Epithelial cells.squamous [Presence] in Urine by Automated' concept">
				use = <"Use for Epithelial cells.squamous [Presence] in Urine by Automated.">
				keywords = <"Squamous epithelial cells", "Squamous epithelial cell", "Squamous cell", "SEC", "Epi Cells", "Cell", "Cellularity", "Arbitrary concentration", "Point in time", "Random", "Ur", "UR", "Urn", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Auto", "Sq", "Epith", "Epithelia", "URINALYSIS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.squamous_ur_ql_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"squamous_ur_ql_auto">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/53318-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/53318-2">
			>
		>
	>
	adl_version = <"2.0.5">
