(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/8047-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Varicella zoster virus IgG Ab [Units/volume] in Serum' concept">
				use = <"Use for Varicella zoster virus IgG Ab [Units/volume] in Serum.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.vzv_igg_seracnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"vzv_igg_seracnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/8047-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/8047-3">
			>
		>
	>
	adl_version = <"2.0.5">
