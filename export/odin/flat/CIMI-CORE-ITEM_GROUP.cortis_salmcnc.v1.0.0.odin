(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2142-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cortisol [Mass/volume] in Saliva (oral fluid)' concept">
				use = <"Use for Cortisol [Mass/volume] in Saliva (oral fluid).">
				keywords = <"Cortis", "Coritsol", "F", "Cort", "hydrocortisone", "Compound F", "17-Hydroxycorticosterone", "Mass concentration", "Level", "Point in time", "Random", "Sal", "Oral fluid", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cortis_salmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cortis_salmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cortisol [Mass/volume] in Saliva (oral fluid)">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2142-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2142-8">
			>
		>
	>
	adl_version = <"2.0.5">
