(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49092-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Second trimester quad maternal screen [interpretation] in Serum or Plasma Narrative' concept">
				use = <"Use for Second trimester quad maternal screen [interpretation] in Serum or Plasma Narrative.">
				keywords = <"2nd trimester 4 screen", "Alpha-1-fetoprotein & Choriogonadotropin & Estriol.unconjugated & Inhibin A", "Maternal screen 4", "Tetra screen", "Quadruple screen", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Narrative", "Report", "Scr", "Scn", "Scrn", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.2nd_trimester_4_screen_serplimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"2nd_trimester_4_screen_serplimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Second trimester quad maternal screen [interpretation] in Serum or Plasma Narrative">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Second trimester quad maternal screen [interpretation] in Serum or Plasma Narrative">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49092-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49092-0">
			>
		>
	>
	adl_version = <"2.0.5">
