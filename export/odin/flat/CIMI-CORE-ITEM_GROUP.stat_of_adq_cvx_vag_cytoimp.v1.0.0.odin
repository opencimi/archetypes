(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19764-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Statement of adequacy [interpretation] of Cervical or vaginal smear or scraping by Cyto stain' concept">
				use = <"Use for Statement of adequacy [interpretation] of Cervical or vaginal smear or scraping by Cyto stain.">
				keywords = <"Stat of Adq", "Pap Smear", "Papinacolou Smear", "Pap Stain", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Genital tract", "Genital vaginal", "Vagina", "Vaginal fluid", "Vag fluid", "Vag fld", "Cervix", "Nominal", "Cytostain", "Cytology stain", "Papanicolaou smear">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.stat_of_adq_cvx_vag_cytoimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"stat_of_adq_cvx_vag_cytoimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Statement of adequacy [interpretation] of Cervical or vaginal smear or scraping by Cyto stain">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Statement of adequacy [interpretation] of Cervical or vaginal smear or scraping by Cyto stain">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19764-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19764-0">
			>
		>
	>
	adl_version = <"2.0.5">
