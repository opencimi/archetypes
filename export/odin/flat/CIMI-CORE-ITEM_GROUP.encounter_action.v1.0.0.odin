(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.encounter_action.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"encounter_action">
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["id2.2.1"] = <"http://snomed.info/id/423901009">
				["id2.3.1"] = <"http://snomed.info/id/364713004">
				["id2.4.1"] = <"http://snomed.info/id/364713004">
