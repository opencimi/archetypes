(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/47223-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Trisomy 18 risk based on maternal age in Fetus' concept">
				use = <"Use for Trisomy 18 risk based on maternal age in Fetus.">
				keywords = <"Ts 18 risk-Age", "Edward syndrome", "T18 risk", "Finding", "Findings", "Point in time", "Random", "Fetal", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ts_18_riskage_fetus.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ts_18_riskage_fetus">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Trisomy 18 risk based on maternal age in Fetus">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{risk}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/47223-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/47223-3">
			>
		>
	>
	adl_version = <"2.0.5">
