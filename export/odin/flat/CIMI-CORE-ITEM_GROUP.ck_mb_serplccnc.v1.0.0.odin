(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32673-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Creatine kinase.MB [Enzymatic activity/volume] in Serum or Plasma' concept">
				use = <"Use for Creatine kinase.MB [Enzymatic activity/volume] in Serum or Plasma.">
				keywords = <"CK MB", "CKMB", "CK 2", "Creatine phosphokinase", "CPK", "Catalytic Concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ck_mb_serplccnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ck_mb_serplccnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Creatine kinase.MB [Enzymatic activity/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"U/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32673-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32673-6">
			>
		>
	>
	adl_version = <"2.0.5">
