(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/53982-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Centromere protein B Ab [Units/volume] in Serum' concept">
				use = <"Use for Centromere protein B Ab [Units/volume] in Serum.">
				keywords = <"Prot", "PR", "CENP-B", "CENPB", "Centromere B", "CENP B", "Cen", "CRST syndrome", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.centromere_b_ab_seracnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"centromere_b_ab_seracnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Centromere protein B Ab [Units/volume] in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[arb'U]/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/53982-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/53982-5">
			>
		>
	>
	adl_version = <"2.0.5">
