(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/882-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'ABO + Rh group [Type] in Blood' concept">
				use = <"Use for ABO + Rh group [Type] in Blood.">
				keywords = <"Rh typing", "D typing", "Rh phenotyping", "D phenotyping", "ABO+Rh Gp", "ABO group and Rh type", "Typ", "Point in time", "Random", "Blood", "WB", "Whole blood", "Nominal", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.abo_plus_rh_gp_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"abo_plus_rh_gp_bld">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"BloodType_VALUESET_CODE">
				>
				["id1.1.1.1.1.1"] = <
					text = <"ABO + Rh group [Type] in Blood">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/882-1">
			>
			["opencem"] = <
				["at0.0.0.0.0.1"] = <"http://opencem.org/id/BloodType_VALUESET_CODE">
			>
		>
	>
	adl_version = <"2.0.5">
