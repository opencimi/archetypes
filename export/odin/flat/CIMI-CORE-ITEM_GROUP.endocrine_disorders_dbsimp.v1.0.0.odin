(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/46735-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Endocrine disorders newborn screen interpretation' concept">
				use = <"Use for Endocrine disorders newborn screen interpretation.">
				keywords = <"Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "DBS", "Filter paper", "FP", "Dried blood spot", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.endocrine_disorders_dbsimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"endocrine_disorders_dbsimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Endocrine disorders newborn screen interpretation">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Endocrine disorders newborn screen interpretation">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/46735-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/46735-7">
			>
		>
	>
	adl_version = <"2.0.5">
