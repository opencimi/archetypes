(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/30934-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Natriuretic peptide B [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Natriuretic peptide B [Mass/volume] in Serum or Plasma.">
				keywords = <"BNP", "B-type natriuretic peptide", "Brain Natriuretic Peptide", "Natriutietic peptide.B", "Beta Natriuretic Peptide", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Pept", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bnp_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bnp_serplmcnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/30934-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/30934-4">
			>
		>
	>
	adl_version = <"2.0.5">
