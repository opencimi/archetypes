(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/35041-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Lymphocytes Variant [#/volume] in Peritoneal fluid' concept">
				use = <"Use for Lymphocytes Variant [#/volume] in Peritoneal fluid.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.variant_lymphs_num_prt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"variant_lymphs_num_prt">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/35041-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/35041-3">
			>
		>
	>
	adl_version = <"2.0.5">
