(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.mycophenolate_serplmcnc_post_by_serpl_lc_ms_msmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"mycophenolate_serplmcnc_post_by_serpl_lc_ms_msmcnc">
