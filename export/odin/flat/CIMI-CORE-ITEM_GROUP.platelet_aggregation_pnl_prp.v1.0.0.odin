(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.platelet_aggregation_pnl_prp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"platelet_aggregation_pnl_prp">
			...
			["1"] = <
				...
				children = <
					...
					["20"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.1">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.pa_pppimp.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["21"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.2">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.pa_adp_prp.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["22"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.3">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.pa_aa_prp.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["23"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.4">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.pa_coll_prp.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["24"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.5">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.pa_rist_prp.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
				>
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.1"] = <
					text = <"Platelet aggregation panel - Platelet rich plasma">
				>
				["id0.1.1.1.1"] = <
					text = <"Platelet aggregation [interpretation] in Platelet poor plasma">
				>
				["id0.1.1.1.2"] = <
					text = <"Platelet aggregation ADP induced [Substance threshold] in Platelet rich plasma">
				>
				["id0.1.1.1.3"] = <
					text = <"Platelet aggregation arachidonate induced [Substance threshold] in Platelet rich plasma">
				>
				["id0.1.1.1.4"] = <
					text = <"Platelet aggregation collagen induced [Mass threshold] in Platelet rich plasma">
				>
				["id0.1.1.1.5"] = <
					text = <"Platelet aggregation ristocetin induced [Mass threshold] in Platelet rich plasma">
				>
				["id1.1.1.1.1"] = <
					text = <"Platelet aggregation panel - Platelet rich plasma">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/48805-6">
				["at0.0.0.0.1"] = <"http://loinc.org/id/48805-6">
				["id0.1.1.1.1"] = <"http://loinc.org/id/21027-8">
				["id0.1.1.1.2"] = <"http://loinc.org/id/5992-3">
				["id0.1.1.1.3"] = <"http://loinc.org/id/5993-1">
				["id0.1.1.1.4"] = <"http://loinc.org/id/5995-6">
				["id0.1.1.1.5"] = <"http://loinc.org/id/5998-0">
			>
		>
	>
	adl_version = <"2.0.5">
