(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/50562-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Specific gravity of Urine by Refractometry automated' concept">
				use = <"Use for Specific gravity of Urine by Refractometry automated.">
				keywords = <"Sp Gr", "Spec grav", "Den", "SG", "Conc", "Sp Grav", "Density", "Concentration", "Sp G", "Relative density", "Point in time", "Random", "Ur", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Refract.auto", "Refract.auto", "Refract", "Auto", "URINALYSIS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.sp_gr_ur_pre_by_refract_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"sp_gr_ur_pre_by_refract_auto">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Specific gravity of Urine by Refractometry automated">
				>
				["at0.0.0.0.0.2"] = <
					text = <"">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/50562-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/50562-8">
			>
		>
	>
	adl_version = <"2.0.5">
