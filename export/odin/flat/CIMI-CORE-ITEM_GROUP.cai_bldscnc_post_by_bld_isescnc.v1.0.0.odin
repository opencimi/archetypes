(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cai_bldscnc_post_by_bld_isescnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cai_bldscnc_post_by_bld_isescnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.3"] = <
					text = <"Ion-selective membrane electrode (ISE)">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Calcium.ionized [Moles/volume] in Blood">
				>
