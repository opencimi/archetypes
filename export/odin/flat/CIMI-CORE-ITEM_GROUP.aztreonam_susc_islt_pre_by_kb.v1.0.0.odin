(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/45-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Aztreonam [Susceptibility] by Disk diffusion (KB)' concept">
				use = <"Use for Aztreonam [Susceptibility] by Disk diffusion (KB).">
				keywords = <"azthreonam", "Azactam", "Azaj", "Susceptibility", "Susceptibilty", "Sus", "Suscept", "Susceptibilities", "AST", "Point in time", "Random", "Islt", "Isol", "KB", "Kirby-bauer", "Disk diffusion", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.aztreonam_susc_islt_pre_by_kb.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"aztreonam_susc_islt_pre_by_kb">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Aztreonam [Susceptibility] by Disk diffusion (KB)">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Aztreonam [Susceptibility] by Disk diffusion (KB)">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/45-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/45-5">
			>
		>
	>
	adl_version = <"2.0.5">
