(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/7984-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Parvovirus B19 IgM Ab [Units/volume] in Serum' concept">
				use = <"Use for Parvovirus B19 IgM Ab [Units/volume] in Serum.">
				keywords = <"B19V", "B19 virus", "Fifth Disease", "Parvo virus", "Parvov", "Immune globulin M", "Immunoglobulin M", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.b19v_igm_seracnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"b19v_igm_seracnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Parvovirus B19 IgM Ab [Units/volume] in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{Index_val}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/7984-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/7984-8">
			>
		>
	>
	adl_version = <"2.0.5">
