(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20404-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fibronectin.fetal [Presence] in Vaginal fluid' concept">
				use = <"Use for Fibronectin.fetal [Presence] in Vaginal fluid.">
				keywords = <"fFN", "Fn", "Arbitrary concentration", "Point in time", "Random", "Genital vaginal", "Vagina", "Vaginal fluid", "Vag fluid", "Vag fld", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fibronectin_fetal_vag_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fibronectin_fetal_vag_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Fibronectin.fetal [Presence] in Vaginal fluid">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20404-0">
			>
			["opencem"] = <
