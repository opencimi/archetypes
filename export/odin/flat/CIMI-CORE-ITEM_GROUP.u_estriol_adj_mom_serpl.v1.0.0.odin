(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/21264-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Estriol (E3).unconjugated [Multiple of the median] adjusted in Serum or Plasma' concept">
				use = <"Use for Estriol (E3).unconjugated [Multiple of the median] adjusted in Serum or Plasma.">
				keywords = <"u Estriol", "uE3", "Estriol free", "E3", "adj", "Multiple of the median", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Uncnj", "Unconj", "Unconjug", "Unconjugat", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.u_estriol_adj_mom_serpl.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"u_estriol_adj_mom_serpl">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Estriol (E3).unconjugated [Multiple of the median] adjusted in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{M.o.M}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/21264-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/21264-7">
			>
		>
	>
	adl_version = <"2.0.5">
