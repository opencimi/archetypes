(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/42247-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemoglobin pattern [interpretation] in Blood by HPLC Narrative' concept">
				use = <"Use for Hemoglobin pattern [interpretation] in Blood by HPLC Narrative.">
				keywords = <"Hgb Fract", "Hb", "Haemoglobin", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Blood", "WB", "Whole blood", "Narrative", "Report", "High pressure liquid chromatography", "High performance liquid chromatography", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hgb_fract_bld_hplcimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hgb_fract_bld_hplcimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hemoglobin pattern [interpretation] in Blood by HPLC Narrative">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Hemoglobin pattern [interpretation] in Blood by HPLC Narrative">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/42247-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/42247-7">
			>
		>
	>
	adl_version = <"2.0.5">
