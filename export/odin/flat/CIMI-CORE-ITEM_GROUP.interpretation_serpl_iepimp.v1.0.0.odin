(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13169-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Immunoelectrophoresis [interpretation] for Serum or Plasma' concept">
				use = <"Use for Immunoelectrophoresis [interpretation] for Serum or Plasma.">
				keywords = <"Interp", "Intrp", "Interpret", "Interpt", "Impression", "Impressions", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Nominal", "IEP", "Immunoelect", "Imm elect", "Chemistry", "SIEP", "SIE">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.interpretation_serpl_iepimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"interpretation_serpl_iepimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Immunoelectrophoresis [interpretation] for Serum or Plasma">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Immunoelectrophoresis [interpretation] for Serum or Plasma">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13169-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13169-8">
			>
		>
	>
	adl_version = <"2.0.5">
