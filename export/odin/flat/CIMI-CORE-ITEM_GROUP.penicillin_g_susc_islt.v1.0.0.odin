(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/18965-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Penicillin G [Susceptibility]' concept">
				use = <"Use for Penicillin G [Susceptibility].">
				keywords = <"c1", "Benzylpenicillin", "Penicilloyl", "Pen", "PCN", "Wycillin", "Susceptibility", "Susceptibilty", "Sus", "Suscept", "Susceptibilities", "AST", "Point in time", "Random", "Islt", "Isol", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.penicillin_g_susc_islt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"penicillin_g_susc_islt">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Penicillin G [Susceptibility]">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Penicillin G [Susceptibility]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/18965-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/18965-4">
			>
		>
	>
	adl_version = <"2.0.5">
