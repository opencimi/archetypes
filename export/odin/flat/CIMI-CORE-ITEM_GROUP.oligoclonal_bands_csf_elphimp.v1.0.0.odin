(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/12782-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Protein fractions.oligoclonal bands [interpretation] in Cerebral spinal fluid by Electrophoresis' concept">
				use = <"Use for Protein fractions.oligoclonal bands [interpretation] in Cerebral spinal fluid by Electrophoresis.">
				keywords = <"M-spikes", "Prot", "PR", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Cerebral spinal fluid", "Spinal Fluid", "Cerebrospinal Fl", "Spinal Flu", "Spinal Fld", "Nominal", "Elph", "Elp", "Elect", "Electrophrs", "Electrophhrs", "Electr", "Elec", "Ep", "Electro", "Frac", "Fract", "Fractionation", "Fraction", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.oligoclonal_bands_csf_elphimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"oligoclonal_bands_csf_elphimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Protein fractions.oligoclonal bands [interpretation] in Cerebral spinal fluid by Electrophoresis">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Protein fractions.oligoclonal bands [interpretation] in Cerebral spinal fluid by Electrophoresis">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/12782-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/12782-9">
			>
		>
	>
	adl_version = <"2.0.5">
