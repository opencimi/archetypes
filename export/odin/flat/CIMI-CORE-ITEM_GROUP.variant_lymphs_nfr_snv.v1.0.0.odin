(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33371-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Lymphocytes Variant/100 leukocytes in Synovial fluid' concept">
				use = <"Use for Lymphocytes Variant/100 leukocytes in Synovial fluid.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.variant_lymphs_nfr_snv.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"variant_lymphs_nfr_snv">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33371-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33371-6">
			>
		>
	>
	adl_version = <"2.0.5">
