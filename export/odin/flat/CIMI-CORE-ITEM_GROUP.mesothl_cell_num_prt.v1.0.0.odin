(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/35032-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Mesothelial cells [#/volume] in Peritoneal fluid' concept">
				use = <"Use for Mesothelial cells [#/volume] in Peritoneal fluid.">
				keywords = <"Mesothl Cell", "Cellularity", "#", "Number concentration", "Count/volume", "Count", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Prt", "Ascites", "Ascitic fluid", "Ascitis", "Peritoneal fluid", "Quantitative", "QNT", "Quant", "Quan", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.mesothl_cell_num_prt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"mesothl_cell_num_prt">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/35032-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/35032-2">
			>
		>
	>
	adl_version = <"2.0.5">
