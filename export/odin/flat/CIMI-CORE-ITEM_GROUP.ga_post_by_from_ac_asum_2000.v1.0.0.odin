(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ga_post_by_from_ac_asum_2000.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ga_post_by_from_ac_asum_2000">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.3"] = <
					text = <"method of Australian Society of Ultrasound Medicine 2000 (US)">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Gestational age">
				>
