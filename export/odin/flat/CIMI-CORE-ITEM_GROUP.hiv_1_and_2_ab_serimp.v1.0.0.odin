(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/42768-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'HIV 1 and 2 Ab [interpretation] in Serum Narrative' concept">
				use = <"Use for HIV 1 and 2 Ab [interpretation] in Serum Narrative.">
				keywords = <"HIV 1 and 2 Ab", "HIV1+2", "HIV1", "HIV type 1", "HIV type I", "AIDS", "Human immunodeficiency virus", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Serum", "SR", "Narrative", "Report", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "II", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hiv_1_and_2_ab_serimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hiv_1_and_2_ab_serimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"HIV 1 and 2 Ab [interpretation] in Serum Narrative">
				>
				["id1.1.1.1.1.1"] = <
					text = <"HIV 1 and 2 Ab [interpretation] in Serum Narrative">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/42768-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/42768-2">
			>
		>
	>
	adl_version = <"2.0.5">
