(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/30341-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Erythrocyte sedimentation rate' concept">
				use = <"Use for Erythrocyte sedimentation rate.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.esr_bld_qn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"esr_bld_qn">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/30341-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/30341-2">
			>
		>
	>
	adl_version = <"2.0.5">
