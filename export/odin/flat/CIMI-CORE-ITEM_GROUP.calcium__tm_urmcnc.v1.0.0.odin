(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/35675-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Calcium [Mass/volume] in unspecified time Urine' concept">
				use = <"Use for Calcium [Mass/volume] in unspecified time Urine.">
				keywords = <"Cal", "Ca", "Mass concentration", "Level", "?Tm", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.calcium__tm_urmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"calcium__tm_urmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Calcium [Mass/volume] in unspecified time Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/35675-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/35675-8">
			>
		>
	>
	adl_version = <"2.0.5">
