(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hemoccult_sp2_stl_ql_post_by_occult_bld_sp2_stl_ql_imm.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hemoccult_sp2_stl_ql_post_by_occult_bld_sp2_stl_ql_imm">
