(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/35384-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Estradiol (E2) [Mass/volume] in Serum or Plasma by High sensitivity method' concept">
				use = <"Use for Estradiol (E2) [Mass/volume] in Serum or Plasma by High sensitivity method.">
				keywords = <"Oestradiol", "E2", "17-beta estradiol", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "HS", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.estradiol_serplmcnc_pre_by_serpl_hsmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"estradiol_serplmcnc_pre_by_serpl_hsmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Estradiol (E2) [Mass/volume] in Serum or Plasma by High sensitivity method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"pg/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/35384-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/35384-7">
			>
		>
	>
	adl_version = <"2.0.5">
