(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33069-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fetal Neck.soft tissue Translucency width US' concept">
				use = <"Use for Fetal Neck.soft tissue Translucency width US.">
				keywords = <"Length", "Point in time", "Random", "Fetal", "Quantitative", "QNT", "Quant", "Quan", "US.meas", "US.meas", "Ultrasound", "ULS", "Sonogram", "Sonography", "Sonograph", "Echography", "OBSTERICAL.ULTRASOUND", "OBSTERICAL.ULTRASOUND", "Obstetrical", "Obstetrics">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fet_width_translucency_us_meas.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fet_width_translucency_us_meas">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Fetal Neck.soft tissue Translucency width US">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mm">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258673006">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33069-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33069-6">
			>
		>
	>
	adl_version = <"2.0.5">
