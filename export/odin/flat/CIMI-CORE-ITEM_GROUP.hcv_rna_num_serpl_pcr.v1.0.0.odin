(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20416-4.html>">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hcv_rna_num_serpl_pcr.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hcv_rna_num_serpl_pcr">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hepatitis C virus RNA [#/volume] (viral load) in Serum or Plasma by Probe and target amplification method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{copies}/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20416-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20416-4">
			>
		>
	>
	adl_version = <"2.0.5">
