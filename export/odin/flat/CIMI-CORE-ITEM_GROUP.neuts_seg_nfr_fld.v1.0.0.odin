(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/30453-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Neutrophils.segmented/100 leukocytes in Body fluid' concept">
				use = <"Use for Neutrophils.segmented/100 leukocytes in Body fluid.">
				keywords = <"Neuts Seg", "Segs", "N-Seg", "PNM", "Neutrophil", "Neutr", "PMN", "Neut", "WBC", "White blood cell", "Leuc", "Leuk", "Leukocyte", "Lkcs", "White blood cells", "WBCs", "100WBC", "Number fraction", "Percent", "Point in time", "Random", "BF", "Fluid", "Body fluid", "B/F", "FLU", "Fl", "Quantitative", "QNT", "Quant", "Quan", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.neuts_seg_nfr_fld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"neuts_seg_nfr_fld">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/30453-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/30453-5">
			>
		>
	>
	adl_version = <"2.0.5">
