(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/48035-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemoglobin [Presence] in Cerebral spinal fluid' concept">
				use = <"Use for Hemoglobin [Presence] in Cerebral spinal fluid.">
				keywords = <"Hgb", "Hb", "Haemoglobin", "Arbitrary concentration", "Point in time", "Random", "Cerebral spinal fluid", "Spinal Fluid", "Cerebrospinal Fl", "Spinal Flu", "Spinal Fld", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hgb_csf_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hgb_csf_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hemoglobin [Presence] in Cerebral spinal fluid">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Hemoglobin [Presence] in Cerebral spinal fluid">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/48035-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/48035-0">
			>
		>
	>
	adl_version = <"2.0.5">
