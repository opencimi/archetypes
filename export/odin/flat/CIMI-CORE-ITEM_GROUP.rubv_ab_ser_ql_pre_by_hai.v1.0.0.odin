(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5331-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Rubella virus Ab [Presence] in Serum by Hemagglutination inhibition' concept">
				use = <"Use for Rubella virus Ab [Presence] in Serum by Hemagglutination inhibition.">
				keywords = <"RUBV", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Hemagglutination inhibition", "HI", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.rubv_ab_ser_ql_pre_by_hai.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"rubv_ab_ser_ql_pre_by_hai">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Rubella virus Ab [Presence] in Serum by Hemagglutination inhibition">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Rubella virus Ab [Presence] in Serum by Hemagglutination inhibition">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5331-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5331-4">
			>
		>
	>
	adl_version = <"2.0.5">
