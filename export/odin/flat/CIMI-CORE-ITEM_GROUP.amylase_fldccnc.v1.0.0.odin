(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1795-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Amylase [Enzymatic activity/volume] in Body fluid' concept">
				use = <"Use for Amylase [Enzymatic activity/volume] in Body fluid.">
				keywords = <"Amyl", "k87", "Ams", "Diastase", "Alpha amylase", "Catalytic Concentration", "Point in time", "Random", "BF", "Fluid", "Body fluid", "B/F", "FLU", "Fl", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.amylase_fldccnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"amylase_fldccnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Amylase [Enzymatic activity/volume] in Body fluid">
				>
				["at0.0.0.0.0.2"] = <
					text = <"U/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1795-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1795-4">
			>
		>
	>
	adl_version = <"2.0.5">
