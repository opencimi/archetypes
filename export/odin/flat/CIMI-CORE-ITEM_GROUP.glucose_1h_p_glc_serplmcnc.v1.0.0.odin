(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20438-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Glucose [Mass/volume] in Serum or Plasma --1 hour post dose glucose' concept">
				use = <"Use for Glucose [Mass/volume] in Serum or Plasma --1 hour post dose glucose.">
				keywords = <"Glu", "Gluc", "Glucoseur", "1h p Glc", "p dose", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "PST", "After", "1 hour", "60 minutes", "60M", "1.0Hr", "60 min", "60min", "CHEMISTRY.CHALLENGE TESTING", "CHEMISTRY.CHALLENGE TESTING", "GTT", "Glu tol", "Glucose tolerance">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.glucose_1h_p_glc_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"glucose_1h_p_glc_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Glucose [Mass/volume] in Serum or Plasma --1 hour post dose glucose">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20438-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20438-8">
			>
		>
	>
	adl_version = <"2.0.5">
