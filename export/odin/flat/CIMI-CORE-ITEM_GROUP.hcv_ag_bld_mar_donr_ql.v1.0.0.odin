(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49846-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hepatitis C virus Ag [Presence] in Blood or Marrow from donor' concept">
				use = <"Use for Hepatitis C virus Ag [Presence] in Blood or Marrow from donor.">
				keywords = <"HCV", "Hep C", "Arbitrary concentration", "Point in time", "Random", "BM", "Bone marrow", "BON", "Bld/Mar", "Blood", "WB", "Whole blood", "Donr", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Antigen", "Antigens", "Hepatit", "Hepatis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hcv_ag_bld_mar_donr_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hcv_ag_bld_mar_donr_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hepatitis C virus Ag [Presence] in Blood or Marrow from donor">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Hepatitis C virus Ag [Presence] in Blood or Marrow from donor">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49846-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49846-9">
			>
		>
	>
	adl_version = <"2.0.5">
