(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5909-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Blood smear finding [Identifier] in Blood by Light microscopy' concept">
				use = <"Use for Blood smear finding [Identifier] in Blood by Light microscopy.">
				keywords = <"Bld Smear Interp", "Identity or presence", "Point in time", "Random", "WB", "Whole blood", "Nominal", "Micro", "LM", "Micros", "Microscopic", "smears", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bld_smear_interp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bld_smear_interp">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5909-7">
			>
			["opencem"] = <
