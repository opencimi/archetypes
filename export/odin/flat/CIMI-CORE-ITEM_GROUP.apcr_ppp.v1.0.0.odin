(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13590-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Activated protein C resistance [Time Ratio] in Platelet poor plasma by Coagulation assay' concept">
				use = <"Use for Activated protein C resistance [Time Ratio] in Platelet poor plasma by Coagulation assay.">
				keywords = <"Prot C", "PC", "Autoprothrombin II-a", "PR", "aPCR", "APCr", "APC-R", "Time ratio", "Point in time", "Random", "Platelet poor plasma", "Plas", "Quantitative", "QNT", "Quant", "Quan", "Coagulation assay", "Clot", "Tilt tube", "Clottable", "Resistanc", "Resist", "Resistent", "Resistant", "APC", "Activ">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.apcr_ppp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"apcr_ppp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Activated protein C resistance [Time Ratio] in Platelet poor plasma by Coagulation assay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{ratio}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13590-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13590-5">
			>
		>
	>
	adl_version = <"2.0.5">
