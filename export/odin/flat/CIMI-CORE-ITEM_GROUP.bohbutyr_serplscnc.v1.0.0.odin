(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6873-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Beta hydroxybutyrate [Moles/volume] in Serum or Plasma' concept">
				use = <"Use for Beta hydroxybutyrate [Moles/volume] in Serum or Plasma.">
				keywords = <"B-OH-Butyr", "BHB", "Beta hydroxy butyrate", "3-hydroxybutyrate", "BOHB", "Betahydroxybutyrate", "Betahydroxybutyric acid", "Beta hydroxybutyric acid", "3-hydroxybutyric acid", "Substance concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Hydroxybutyric acid", "B", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bohbutyr_serplscnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bohbutyr_serplscnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Beta hydroxybutyrate [Moles/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mmol/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6873-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6873-4">
			>
		>
	>
	adl_version = <"2.0.5">
