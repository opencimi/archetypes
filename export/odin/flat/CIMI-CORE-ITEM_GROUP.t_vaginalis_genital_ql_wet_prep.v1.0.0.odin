(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6565-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Trichomonas vaginalis [Presence] in Genital specimen by Wet preparation' concept">
				use = <"Use for Trichomonas vaginalis [Presence] in Genital specimen by Wet preparation.">
				keywords = <"T vaginalis", "Trichimoniasis", "Arbitrary concentration", "Point in time", "Random", "Gen", "Genital tract", "Urogenit", "Urogenital", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Wet Prep", "Wet mount", "Wet prep", "Trich", "Tric", "Trichomonad", "Trichomonads", "Trichomoniasis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.t_vaginalis_genital_ql_wet_prep.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"t_vaginalis_genital_ql_wet_prep">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Trichomonas vaginalis [Presence] in Genital specimen by Wet preparation">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Trichomonas vaginalis [Presence] in Genital specimen by Wet preparation">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6565-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6565-6">
			>
		>
	>
	adl_version = <"2.0.5">
