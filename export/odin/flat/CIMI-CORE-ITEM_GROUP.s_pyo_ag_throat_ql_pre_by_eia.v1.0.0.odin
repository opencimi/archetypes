(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6556-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Streptococcus pyogenes Ag [Presence] in Throat by Immunoassay' concept">
				use = <"Use for Streptococcus pyogenes Ag [Presence] in Throat by Immunoassay.">
				keywords = <"S pyo", "S pyogenes", "GAS", "Steptococcus Group A", "Group A Strep", "Streptococci group A", "Streptococcus group A", "Arbitrary concentration", "Point in time", "Random", "Throat", "Upper respiratory", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "Antigen", "Antigens", "Strept", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.s_pyo_ag_throat_ql_pre_by_eia.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"s_pyo_ag_throat_ql_pre_by_eia">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Streptococcus pyogenes Ag [Presence] in Throat by Immunoassay">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Streptococcus pyogenes Ag [Presence] in Throat by Immunoassay">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6556-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6556-5">
			>
		>
	>
	adl_version = <"2.0.5">
