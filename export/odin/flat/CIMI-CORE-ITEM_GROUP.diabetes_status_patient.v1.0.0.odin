(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33248-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Diabetes status [Identifier]' concept">
				use = <"Use for Diabetes status [Identifier].">
				keywords = <"Identity or presence", "Point in time", "Random", "Nominal">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.diabetes_status_patient.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"diabetes_status_patient">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Diabetes status [Identifier]">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Diabetes status [Identifier]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33248-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33248-6">
			>
		>
	>
	adl_version = <"2.0.5">
