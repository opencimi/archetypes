(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.wbc_morphology_pnl_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"wbc_morphology_pnl_bld">
			...
			["1"] = <
				...
				children = <
					...
					["20"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.1">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.wbc_morph_bld.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["21"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.2">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.auer_bodies_bld_ql_smear.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["22"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.3">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.sezary_cells_bld_ql_smear.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["23"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.4">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.pelger_huet_cells_bld_ql_smear.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["24"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.5">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.neuts_vac_bld_ql_smear.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["25"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.6">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.agran_neuts_bld_ql_smear.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["26"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.7">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.neuts_hyperseg_bld_ql_smear.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["27"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.8">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.dohle_bod_bld_ql_smear.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["28"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.9">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.smudge_cells_bld_ql_smear.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["29"] = (P_C_ARCHETYPE_ROOT) <
						...
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.toxic_granules_bld_ql_smear.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
				>
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.1"] = <
					text = <"Leukocyte morphology panel - Blood">
				>
				["id0.1.1.1.1"] = <
					text = <"Leukocyte morphology finding [Identifier] in Blood">
				>
				["id0.1.1.1.10"] = <
					text = <"Toxic granules [Presence] in Blood by Light microscopy">
				>
				["id0.1.1.1.2"] = <
					text = <"Auer rods [Presence] in Blood by Light microscopy">
				>
				["id0.1.1.1.3"] = <
					text = <"Sezary cells [Presence] in Blood by Light microscopy">
				>
				["id0.1.1.1.4"] = <
					text = <"Pelger Huet cells [Presence] in Blood by Light microscopy">
				>
				["id0.1.1.1.5"] = <
					text = <"Neutrophils.vacuolated [Presence] in Blood by Light microscopy">
				>
				["id0.1.1.1.6"] = <
					text = <"Neutrophils.agranular [Presence] in Blood by Light microscopy">
				>
				["id0.1.1.1.7"] = <
					text = <"Neutrophils.hypersegmented [Presence] in Blood by Light microscopy">
				>
				["id0.1.1.1.8"] = <
					text = <"Dohle body [Presence] in Blood by Light microscopy">
				>
				["id0.1.1.1.9"] = <
					text = <"Smudge cells [Presence] in Blood by Light microscopy">
				>
				["id1.1.1.1.1"] = <
					text = <"Leukocyte morphology panel - Blood">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/58407-8">
				["at0.0.0.0.1"] = <"http://loinc.org/id/58407-8">
				["id0.1.1.1.1"] = <"http://loinc.org/id/11156-7">
				["id0.1.1.1.2"] = <"http://loinc.org/id/11281-3">
				["id0.1.1.1.3"] = <"http://loinc.org/id/13048-4">
				["id0.1.1.1.4"] = <"http://loinc.org/id/18311-1">
				["id0.1.1.1.5"] = <"http://loinc.org/id/18319-4">
				["id0.1.1.1.6"] = <"http://loinc.org/id/33215-5">
				["id0.1.1.1.7"] = <"http://loinc.org/id/765-8">
				["id0.1.1.1.8"] = <"http://loinc.org/id/7792-5">
				["id0.1.1.1.9"] = <"http://loinc.org/id/7798-2">
				["id0.1.1.1.10"] = <"http://loinc.org/id/803-7">
			>
		>
	>
	adl_version = <"2.0.5">
