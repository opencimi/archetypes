(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.smear_morphology_pnl_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"smear_morphology_pnl_bld">
			...
			["1"] = <
				...
				children = <
					...
					["20"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.1">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.background_stn_bld_ql_smear.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["21"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.2">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.fibrin_strands_bld_ql_smear.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["22"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.3">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.bld_smear_interp.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["23"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.4">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.platelet_bld_ql_smear.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["24"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.2.1.1">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.platelet_morphology_pnl_bld.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["25"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.2.1.2">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.wbc_morphology_pnl_bld.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["26"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.2.1.3">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.rbc_morphology_pnl_bld.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
				>
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id0.1.1.1.1"] = <
					text = <"Background stain [Presence] in Blood by Light microscopy">
				>
				["id0.1.1.1.2"] = <
					text = <"Fibrin strands [Presence] in Blood by Light microscopy">
				>
				["id0.1.1.1.3"] = <
					text = <"Blood smear finding [Identifier] in Blood by Light microscopy">
				>
				["id0.1.1.1.4"] = <
					text = <"Platelet adequacy [Presence] in Blood by Light microscopy">
				>
				["id0.1.2.1.1"] = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/34994-4">
				["at0.0.0.0.1"] = <"http://loinc.org/id/34994-4">
				["id0.1.1.1.1"] = <"http://loinc.org/id/18280-8">
				["id0.1.1.1.2"] = <"http://loinc.org/id/32778-3">
				["id0.1.1.1.3"] = <"http://loinc.org/id/5909-7">
				["id0.1.1.1.4"] = <"http://loinc.org/id/9317-9">
				["id0.1.2.1.1"] = <"http://loinc.org/id/58406-0">
				["id0.1.2.1.2"] = <"http://loinc.org/id/58407-8">
				["id0.1.2.1.3"] = <"http://loinc.org/id/58408-6">
			>
		>
	>
	adl_version = <"2.0.5">
