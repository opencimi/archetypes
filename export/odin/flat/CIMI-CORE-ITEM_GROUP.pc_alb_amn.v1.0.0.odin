(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/30165-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Phosphatidylcholine/Albumin [Mass Ratio] in Amniotic fluid' concept">
				use = <"Use for Phosphatidylcholine/Albumin [Mass Ratio] in Amniotic fluid.">
				keywords = <"PC", "Phosphatidyl choline", "PtdCho", "Protein.albumin", "Alb", "PC/Alb", "FLM", "Fetal lung maturity", "Mass concentration ratio", "Mass ratio", "MCRto", "Point in time", "Random", "Amn", "Amniotic fluid", "Amn fl", "Amniotic flu", "AF", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pc_alb_amn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pc_alb_amn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Phosphatidylcholine/Albumin [Mass Ratio] in Amniotic fluid">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/g">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/408168009">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/30165-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/30165-5">
			>
		>
	>
	adl_version = <"2.0.5">
