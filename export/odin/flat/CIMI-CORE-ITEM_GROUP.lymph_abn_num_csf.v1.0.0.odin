(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/35047-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Lymphocytes Abnormal [#/volume] in Cerebral spinal fluid' concept">
				use = <"Use for Lymphocytes Abnormal [#/volume] in Cerebral spinal fluid.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.lymph_abn_num_csf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"lymph_abn_num_csf">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/35047-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/35047-0">
			>
		>
	>
	adl_version = <"2.0.5">
