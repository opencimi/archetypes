(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1504-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Glucose [Mass/volume] in Serum or Plasma --1 hour post 50 g glucose PO' concept">
				use = <"Use for Glucose [Mass/volume] in Serum or Plasma --1 hour post 50 g glucose PO.">
				keywords = <"Glu", "Gluc", "Glucoseur", "1h p 50 g Glc PO", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Oral", "PST", "After", "1 hour", "60 minutes", "60M", "1.0Hr", "60 min", "60min", "CHEMISTRY.CHALLENGE TESTING", "CHEMISTRY.CHALLENGE TESTING", "GTT", "Glu tol", "Glucose tolerance">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.glucose_1h_p_50_g_glc_po_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"glucose_1h_p_50_g_glc_po_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Glucose [Mass/volume] in Serum or Plasma --1 hour post 50 g glucose PO">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1504-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1504-0">
			>
		>
	>
	adl_version = <"2.0.5">
