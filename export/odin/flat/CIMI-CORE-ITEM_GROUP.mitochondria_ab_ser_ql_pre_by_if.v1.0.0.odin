(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/17284-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Mitochondria Ab [Presence] in Serum by Immunofluorescence' concept">
				use = <"Use for Mitochondria Ab [Presence] in Serum by Immunofluorescence.">
				keywords = <"Mitochondrial", "Mito", "Mitochond", "Mitochon", "M2", "S", "Antibodies to Microtubule Associated Protein 2", "Mitochondrial Ab", "MA", "AMA", "Antimitochondrial antibodies", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ACIF", "FA", "Fluorescent antibody", "Immune fluorescence", "Fluoresent", "Immunoflour", "Immunofluor", "Immunofluorescence", "IFA", "Time Resolved Fluorescence", "Anticomplement Immunofluorescence", "TRF", "ABS", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.mitochondria_ab_ser_ql_pre_by_if.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"mitochondria_ab_ser_ql_pre_by_if">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Mitochondria Ab [Presence] in Serum by Immunofluorescence">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Mitochondria Ab [Presence] in Serum by Immunofluorescence">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/17284-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/17284-1">
			>
		>
	>
	adl_version = <"2.0.5">
