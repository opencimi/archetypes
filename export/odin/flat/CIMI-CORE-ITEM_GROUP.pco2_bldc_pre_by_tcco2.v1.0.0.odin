(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33022-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Carbon dioxide [Partial pressure] in Capillary blood by Transcutaneous CO2 monitor' concept">
				use = <"Use for Carbon dioxide [Partial pressure] in Capillary blood by Transcutaneous CO2 monitor.">
				keywords = <"Carbonic anhydride", "Partial pressure", "Point in time", "Random", "Cap blood", "Cap bld", "Capillary bld", "Capillary blood", "Finger stick", "Quantitative", "QNT", "Quant", "Quan", "TcCo2", "PULMONARY", "PCO2", "PTCCO2", "TCPCO2", "TCP", "PTC">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pco2_bldc_pre_by_tcco2.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pco2_bldc_pre_by_tcco2">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Carbon dioxide [Partial pressure] in Capillary blood by Transcutaneous CO2 monitor">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mm[Hg]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33022-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33022-5">
			>
		>
	>
	adl_version = <"2.0.5">
