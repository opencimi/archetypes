(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13358-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Collection time of Semen' concept">
				use = <"Use for Collection time of Semen.">
				keywords = <"Collect Tme", "Time stamp", "Date and time", "Timestamp", "Point in time", "Random", "Smn", "Ejaculate", "Seminal fluid", "SMPLS", "Sem", "Quantitative", "QNT", "Quant", "Quan", "Coll", "Collected">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.collect_tme_smn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"collect_tme_smn">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13358-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13358-7">
			>
		>
	>
	adl_version = <"2.0.5">
