(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/12227-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Leukocytes [#/volume] corrected for nucleated erythrocytes in Blood' concept">
				use = <"Use for Leukocytes [#/volume] corrected for nucleated erythrocytes in Blood.">
				keywords = <"WBC", "White blood cell", "Leuc", "Leuk", "Leukocyte", "Lkcs", "White blood cells", "WBCs", "RBC", "Red blood corpusles", "Red blood corpuscle", "Erthrocyte", "Erythrocyte", "Red blood cell", "Red cell", "Red cells", "Discocytes", "Red blood cells", "RBCS", "nRBC cor", "#", "Number concentration", "Count/volume", "Count", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Nuc", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.wbc_nrbc_cor_num_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"wbc_nrbc_cor_num_bld">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Leukocytes [#/volume] corrected for nucleated erythrocytes in Blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"10*3/uL">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/418247005">
				["at0.0.0.0.0.3"] = <"http://snomed.org/id/intentional_blank">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/12227-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/12227-5">
			>
		>
	>
	adl_version = <"2.0.5">
