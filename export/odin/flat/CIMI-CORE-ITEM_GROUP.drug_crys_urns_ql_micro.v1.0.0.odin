(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/53975-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Drug crystals [Presence] in Urine sediment by Light microscopy' concept">
				use = <"Use for Drug crystals [Presence] in Urine sediment by Light microscopy.">
				keywords = <"Drug crys", "Cryst", "Crys", "Crystal", "Arbitrary concentration", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Micro", "LM", "Micros", "Microscopic", "Drugs", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.drug_crys_urns_ql_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"drug_crys_urns_ql_micro">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/53975-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/53975-9">
			>
		>
	>
	adl_version = <"2.0.5">
