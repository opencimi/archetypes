(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/53691-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Gestational age Estimated from patient reported estimated date of conception' concept">
				use = <"Use for Gestational age Estimated from patient reported estimated date of conception.">
				keywords = <"GA", "Point in time", "Random", "Fetal", "Quantitative", "QNT", "Quant", "Quan", "predicted", "Est", "estimation", "Gest", "Gestation", "Prenatal", "OBSTERICAL.ULTRASOUND", "OBSTERICAL.ULTRASOUND", "Obstetrical", "Obstetrics">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ga_pre_by_estimated_from_patient_reported_edc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ga_pre_by_estimated_from_patient_reported_edc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Gestational age Estimated from patient reported estimated date of conception">
				>
				["at0.0.0.0.0.2"] = <
					text = <"d">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/53691-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/53691-2">
			>
		>
	>
	adl_version = <"2.0.5">
