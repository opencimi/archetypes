(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/9589-3.html>">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.b_burgdor23kd_igg_ser_ql_ib.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"b_burgdor23kd_igg_ser_ql_ib">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Borrelia burgdorferi 23kD IgG Ab [Presence] in Serum by Immunoblot (IB)">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Borrelia burgdorferi 23kD IgG Ab [Presence] in Serum by Immunoblot (IB)">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/9589-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/9589-3">
			>
		>
	>
	adl_version = <"2.0.5">
