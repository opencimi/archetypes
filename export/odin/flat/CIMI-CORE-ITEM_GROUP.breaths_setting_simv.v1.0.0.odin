(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19835-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Breath rate setting Ventilator synchronized intermittent mandatory' concept">
				use = <"Use for Breath rate setting Ventilator synchronized intermittent mandatory.">
				keywords = <"nRate", "Number rate", "Count/time", "Point in time", "Random", "SIMV", "Vent", "Quantitative", "QNT", "Quant", "Quan", "PULMONARY", "Respiratory rate">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.breaths_setting_simv.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"breaths_setting_simv">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Breath rate setting Ventilator synchronized intermittent mandatory">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{breaths}/min">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19835-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19835-8">
			>
		>
	>
	adl_version = <"2.0.5">
