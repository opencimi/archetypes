(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6303-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Dilute Russell viper venom time (dRVVT) in Platelet poor plasma by Coagulation assay' concept">
				use = <"Use for Dilute Russell viper venom time (dRVVT) in Platelet poor plasma by Coagulation assay.">
				keywords = <"dRVVT", "Screening test for lupus anticoagulant", "Point in time", "Random", "Platelet poor plasma", "Plas", "Quantitative", "QNT", "Quant", "Quan", "Coagulation assay", "Clot", "Tilt tube", "Clottable", "RVV", "Rus", "dRVV", "Dil Russell Vip Ven", "Dilut", "DDRVTVT">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.drvvt_ppp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"drvvt_ppp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Dilute Russell viper venom time (dRVVT) in Platelet poor plasma by Coagulation assay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"s">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6303-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6303-2">
			>
		>
	>
	adl_version = <"2.0.5">
