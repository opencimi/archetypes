(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/14116-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'IgG synthesis rate [Mass/time] in Serum and CSF by calculation' concept">
				use = <"Use for IgG synthesis rate [Mass/time] in Serum and CSF by calculation.">
				keywords = <"IgG Synth Rate", "Immune globulin G", "Immunoglobulin G", "mRate", "Mass rate", "Point in time", "Random", "Serum", "SR", "Cerebral spinal fluid", "Spinal Fluid", "Cerebrospinal Fl", "Spinal Flu", "Spinal Fld", "Quantitative", "QNT", "Quant", "Quan", "Calc", "Calculation", "Systhesis", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.igg_synth_rate_ser_plus_csf_calcmrate.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"igg_synth_rate_ser_plus_csf_calcmrate">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"IgG synthesis rate [Mass/time] in Serum and CSF by calculation">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/(24.h)">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258836006">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/14116-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/14116-8">
			>
		>
	>
	adl_version = <"2.0.5">
