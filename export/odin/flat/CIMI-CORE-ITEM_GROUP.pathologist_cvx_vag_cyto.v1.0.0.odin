(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19769-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Pathologist who read Cyto stain of Cervical or vaginal smear or scraping' concept">
				use = <"Use for Pathologist who read Cyto stain of Cervical or vaginal smear or scraping.">
				keywords = <"Path", "Identifier", "Ident", "Point in time", "Random", "Genital tract", "Genital vaginal", "Vagina", "Vaginal fluid", "Vag fluid", "Vag fld", "Cervix", "Nominal", "Pap Smear", "Pap Stain", "Cytostain", "Cytology stain", "Papanicolaou smear">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pathologist_cvx_vag_cyto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pathologist_cvx_vag_cyto">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Pathologist who read Cyto stain of Cervical or vaginal smear or scraping">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Pathologist who read Cyto stain of Cervical or vaginal smear or scraping">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19769-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19769-9">
			>
		>
	>
	adl_version = <"2.0.5">
