(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/27227-8.html>">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.s_pneum1_igg_sermcnc_pre_by_ser_eiamcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"s_pneum1_igg_sermcnc_pre_by_ser_eiamcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Streptococcus pneumoniae 1 IgG Ab [Mass/volume] in Serum by Immunoassay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/27227-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/27227-8">
			>
		>
	>
	adl_version = <"2.0.5">
