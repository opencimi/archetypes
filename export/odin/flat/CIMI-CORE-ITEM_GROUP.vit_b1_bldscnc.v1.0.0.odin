(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32554-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Thiamine [Moles/volume] in Blood' concept">
				use = <"Use for Thiamine [Moles/volume] in Blood.">
				keywords = <"Vit B1", "c238", "Vitamin B-1", "Vit B-1", "Vitamin B1", "Substance concentration", "Level", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.vit_b1_bldscnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"vit_b1_bldscnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Thiamine [Moles/volume] in Blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"nmol/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32554-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32554-8">
			>
		>
	>
	adl_version = <"2.0.5">
