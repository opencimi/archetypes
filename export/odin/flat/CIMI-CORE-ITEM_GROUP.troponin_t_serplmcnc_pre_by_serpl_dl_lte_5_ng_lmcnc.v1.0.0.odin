(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/67151-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Troponin T.cardiac [Mass/volume] in Serum or Plasma by Detection limit <= 5 ng/L' concept">
				use = <"Use for Troponin T.cardiac [Mass/volume] in Serum or Plasma by Detection limit <= 5 ng/L.">
				keywords = <"TnT", "cTnT", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "DL <= 5 ng/L", "DL <= 5 ng/L", "T prime", "Chemistry", "High sensitivity troponin T", "hsTnT">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.troponin_t_serplmcnc_pre_by_serpl_dl_lte_5_ng_lmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"troponin_t_serplmcnc_pre_by_serpl_dl_lte_5_ng_lmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Troponin T.cardiac [Mass/volume] in Serum or Plasma by Detection limit <= 5 ng/L">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/L">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258804004">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/67151-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/67151-1">
			>
		>
	>
	adl_version = <"2.0.5">
