(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/9704-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Spermatozoa [Morphology] in Semen' concept">
				use = <"Use for Spermatozoa [Morphology] in Semen.">
				keywords = <"Sperm", "Morphology", "Point in time", "Random", "Smn", "Ejaculate", "Seminal fluid", "SMPLS", "Sem", "Nominal", "FERTILITY TESTING">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.sperm_smn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"sperm_smn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Spermatozoa [Morphology] in Semen">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Spermatozoa [Morphology] in Semen">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/9704-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/9704-8">
			>
		>
	>
	adl_version = <"2.0.5">
