(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/10333-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Appearance of Cerebral spinal fluid' concept">
				use = <"Use for Appearance of Cerebral spinal fluid.">
				keywords = <"Appr", "Appear", "Point in time", "Random", "Cerebral spinal fluid", "Spinal Fluid", "Cerebrospinal Fl", "Spinal Flu", "Spinal Fld", "Nominal">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.appearance_csf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"appearance_csf">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"CSFAppearance_VALUESET_CODE">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Appearance of Cerebral spinal fluid">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/10333-3">
			>
			["opencem"] = <
				["at0.0.0.0.0.1"] = <"http://opencem.org/id/CSFAppearance_VALUESET_CODE">
			>
		>
	>
	adl_version = <"2.0.5">
