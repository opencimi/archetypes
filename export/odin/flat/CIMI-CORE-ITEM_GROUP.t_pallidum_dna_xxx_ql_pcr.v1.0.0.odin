(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/41163-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Treponema pallidum DNA [Presence] in Unspecified specimen by Probe and target amplification method' concept">
				use = <"Use for Treponema pallidum DNA [Presence] in Unspecified specimen by Probe and target amplification method.">
				keywords = <"T pallidum", "Syphilis", "Deoxyribonucleic acid", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "PCR", "Polymerase chain reaction", "Transcription mediated amplification", "NASBA", "Nucleic acid sequence based analysis", "SDA", "Strand Displacement Amplification", "LAT", "Ligation-activated transcription", "3SR SR", "3 Self-Sustaining Sequence Replication", "LCR", "Ligase chain reaction", "QBR", "Probe with target amplification", "NAAT", "TMA", "Amp Prb", "Probe with ampification", "DNA probe", "Amplified", "Treponemal", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.t_pallidum_dna_xxx_ql_pcr.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"t_pallidum_dna_xxx_ql_pcr">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Treponema pallidum DNA [Presence] in Unspecified specimen by Probe and target amplification method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Treponema pallidum DNA [Presence] in Unspecified specimen by Probe and target amplification method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/41163-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/41163-7">
			>
		>
	>
	adl_version = <"2.0.5">
