(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/59833-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Other Antibiotic [Susceptibility] by Minimum lethal concentration (MLC)' concept">
				use = <"Use for Other Antibiotic [Susceptibility] by Minimum lethal concentration (MLC).">
				keywords = <"Other Antibiotic", "Susceptibility", "Susceptibilty", "Sus", "Suscept", "Susceptibilities", "AST", "Point in time", "Random", "Islt", "Isol", "MBC", "Minimum bactericidal concentration", "Minimum lethal concentration", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.other_antibiotic_susc_islt_pre_by_mlc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"other_antibiotic_susc_islt_pre_by_mlc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Other Antibiotic [Susceptibility] by Minimum lethal concentration (MLC)">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Other Antibiotic [Susceptibility] by Minimum lethal concentration (MLC)">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/59833-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/59833-4">
			>
		>
	>
	adl_version = <"2.0.5">
