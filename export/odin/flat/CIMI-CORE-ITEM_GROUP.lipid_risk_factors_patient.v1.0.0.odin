(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49062-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Lipid risk factors [Finding]' concept">
				use = <"Use for Lipid risk factors [Finding].">
				keywords = <"Finding", "Findings", "Point in time", "Random", "Nominal", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.lipid_risk_factors_patient.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"lipid_risk_factors_patient">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Lipid risk factors [Finding]">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Lipid risk factors [Finding]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49062-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49062-3">
			>
		>
	>
	adl_version = <"2.0.5">
