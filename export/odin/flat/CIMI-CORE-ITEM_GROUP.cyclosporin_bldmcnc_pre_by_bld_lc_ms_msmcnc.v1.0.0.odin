(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/55805-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cyclosporine [Mass/volume] in Blood by LC/MS/MS' concept">
				use = <"Use for Cyclosporine [Mass/volume] in Blood by LC/MS/MS.">
				keywords = <"Cyclosporin", "Cyclosporins", "CsA", "Ciclosporin", "Ciclosporine", "Neoral", "SangCya", "Cyclosporin a", "Sandimmune", "Mass concentration", "Level", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cyclosporin_bldmcnc_pre_by_bld_lc_ms_msmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cyclosporin_bldmcnc_pre_by_bld_lc_ms_msmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cyclosporine [Mass/volume] in Blood by LC/MS/MS">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/55805-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/55805-6">
			>
		>
	>
	adl_version = <"2.0.5">
