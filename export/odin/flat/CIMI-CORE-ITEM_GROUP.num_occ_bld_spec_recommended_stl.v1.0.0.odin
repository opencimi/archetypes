(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/57804-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Number of occult blood specimens recommended by testing kit protocol [#] in Stool' concept">
				use = <"Use for Number of occult blood specimens recommended by testing kit protocol [#] in Stool.">
				keywords = <"# Occ bld spec recommended", "No", "Count", "Cnt", "Point in time", "Random", "Stl", "Feces", "Faeces", "Bowel movement", "Fecal", "Faecal", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.num_occ_bld_spec_recommended_stl.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"num_occ_bld_spec_recommended_stl">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Number of occult blood specimens recommended by testing kit protocol [#] in Stool">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{#}">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/410681005">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/57804-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/57804-7">
			>
		>
	>
	adl_version = <"2.0.5">
