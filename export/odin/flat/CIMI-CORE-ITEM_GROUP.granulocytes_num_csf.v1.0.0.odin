(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/35059-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Granulocytes [#/volume] in Cerebral spinal fluid' concept">
				use = <"Use for Granulocytes [#/volume] in Cerebral spinal fluid.">
				keywords = <"Gran", "Granulocyte", "Grans", "#", "Number concentration", "Count/volume", "Count", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Cerebral spinal fluid", "Spinal Fluid", "Cerebrospinal Fl", "Spinal Flu", "Spinal Fld", "Quantitative", "QNT", "Quant", "Quan", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.granulocytes_num_csf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"granulocytes_num_csf">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/35059-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/35059-5">
			>
		>
	>
	adl_version = <"2.0.5">
