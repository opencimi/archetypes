(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/41037-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cocaine [Presence] in Meconium by Confirmatory method' concept">
				use = <"Use for Cocaine [Presence] in Meconium by Confirmatory method.">
				keywords = <"Coke", "Crack", "Snow", "Benzoylmethylecgonine", "Ecgonine methyl ester benzoate", "Point in time", "Random", "Mec", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Cfm", "CNFR", "CNFRM", "Conf", "Confirmation", "GCMS", "Confirmatory", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cocaine_mec_ql_pre_by_cfm.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cocaine_mec_ql_pre_by_cfm">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cocaine [Presence] in Meconium by Confirmatory method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Cocaine [Presence] in Meconium by Confirmatory method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/41037-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/41037-3">
			>
		>
	>
	adl_version = <"2.0.5">
