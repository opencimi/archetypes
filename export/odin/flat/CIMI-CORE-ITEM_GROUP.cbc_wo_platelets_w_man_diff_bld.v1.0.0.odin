(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/24359-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemogram without Platelets and with Manual Differential panel - Blood' concept">
				use = <"Use for Hemogram without Platelets and with Manual Differential panel - Blood.">
				keywords = <"Platelet", "Plt", "Thrombocytes", "Platelt", "Thrb", "Thrombocyte", "Manual diff", "CBC WO platelets W man diff", "Cell count w/ differential", "Diff Pnl", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Pan", "Panl", "Complete Blood Count", "Differl", "Differn", "PANEL.HEMATOLOGY& CELL COUNTS", "PANEL.HEMATOLOGY& CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cbc_wo_platelets_w_man_diff_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cbc_wo_platelets_w_man_diff_bld">
			...
			["1"] = <
				...
				children = <
					...
					["11"] = (P_C_ARCHETYPE_ROOT) <
						...
						is_frozen = <False>
					>
					["12"] = (P_C_ARCHETYPE_ROOT) <
						rm_type_name = <"ITEM_GROUP">
						node_id = <"id0.1.2.1">
						occurrences = <"0..*">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.laboratory_panel.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.1"] = <
					text = <"Hemogram without Platelets and with Manual Differential panel - Blood">
				>
				["id0.1.2.1.1"] = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/24359-2">
				["at0.0.0.0.1"] = <"http://loinc.org/id/24359-2">
				["id0.1.2.1.1"] = <"http://loinc.org/id/24318-8">
				["id0.1.2.1.2"] = <"http://loinc.org/id/24358-4">
			>
		>
	>
	adl_version = <"2.0.5">
