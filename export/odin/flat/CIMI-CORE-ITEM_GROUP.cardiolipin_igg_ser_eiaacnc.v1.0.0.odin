(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3181-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cardiolipin IgG Ab [Units/volume] in Serum by Immunoassay' concept">
				use = <"Use for Cardiolipin IgG Ab [Units/volume] in Serum by Immunoassay.">
				keywords = <"Immune globulin G", "Immunoglobulin G", "Cardiolip", "Cardio", "Cardiolipn", "Cardiolpn", "ACA", "aCL", "Anticardiolipin", "CL", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cardiolipin_igg_ser_eiaacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cardiolipin_igg_ser_eiaacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cardiolipin IgG Ab [Units/volume] in Serum by Immunoassay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[GPL'U]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3181-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3181-5">
			>
		>
	>
	adl_version = <"2.0.5">
