(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32546-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Glucose-6-Phosphate dehydrogenase [Enzymatic activity/mass] in Red Blood Cells' concept">
				use = <"Use for Glucose-6-Phosphate dehydrogenase [Enzymatic activity/mass] in Red Blood Cells.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.g6pd_rbcccnt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"g6pd_rbcccnt">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32546-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32546-4">
			>
		>
	>
	adl_version = <"2.0.5">
