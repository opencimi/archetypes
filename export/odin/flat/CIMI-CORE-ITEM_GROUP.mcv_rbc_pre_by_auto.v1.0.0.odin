(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/787-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Erythrocyte mean corpuscular volume [Entitic volume] by Automated count' concept">
				use = <"Use for Erythrocyte mean corpuscular volume [Entitic volume] by Automated count.">
				keywords = <"Vol", "MCV", "Erythrocytes", "Red blood corpusles", "Red blood corpuscle", "Red blood cell", "Red cell", "Red cells", "Discocyte", "Erc", "Red blood cells", "Entitic volume", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "Auto", "Average", "Avg", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.mcv_rbc_pre_by_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"mcv_rbc_pre_by_auto">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/787-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/787-2">
			>
		>
	>
	adl_version = <"2.0.5">
