(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/48053-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Turbidity of Synovial fluid Qualitative' concept">
				use = <"Use for Turbidity of Synovial fluid Qualitative.">
				keywords = <"Arbitrary concentration", "Point in time", "Random", "Snv", "Joint fluid", "Joint aspirate", "Synovial fluid", "Syn fl", "Joint fld", "Joint flu", "Synov", "SNV", "SF", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.turbidity_snv_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"turbidity_snv_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Turbidity of Synovial fluid Qualitative">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Turbidity of Synovial fluid Qualitative">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/48053-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/48053-3">
			>
		>
	>
	adl_version = <"2.0.5">
