(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/48818-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Karyotype [Identifier] in Blood or Tissue by High resolution Nominal' concept">
				use = <"Use for Karyotype [Identifier] in Blood or Tissue by High resolution Nominal.">
				keywords = <"Karyotyp", "Karyogram", "Genotype", "Chromosome analysis", "Identity or presence", "Point in time", "Random", "Bld/T", "Tissue", "Bld/T", "Blood", "WB", "Whole blood", "Nominal", "High Res", "Molecular pathology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.karyotyp_bld_t_pre_by_high_res.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"karyotyp_bld_t_pre_by_high_res">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Karyotype [Identifier] in Blood or Tissue by High resolution Nominal">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Karyotype [Identifier] in Blood or Tissue by High resolution Nominal">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/48818-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/48818-9">
			>
		>
	>
	adl_version = <"2.0.5">
