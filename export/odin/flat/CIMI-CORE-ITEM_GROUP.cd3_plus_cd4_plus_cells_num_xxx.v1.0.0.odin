(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32515-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'CD3+CD4+ (T4 helper) cells [#/volume] in Unspecified specimen' concept">
				use = <"Use for CD3+CD4+ (T4 helper) cells [#/volume] in Unspecified specimen.">
				keywords = <"CD3+CD4+ Cells", "T4 helper/inducer cells", "CD4+ T cells", "CD3 Cells", "Cell", "Cellularity", "Leu-4", "Leu4", "T3", "#", "Number concentration", "Count/volume", "Count", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Quantitative", "QNT", "Quant", "Quan", "Leu-3", "T-4", "Leu3", "W3/25", "Helper T cells", "Inducer T cells", "L3T4", "CELL MARKERS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cd3_plus_cd4_plus_cells_num_xxx.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cd3_plus_cd4_plus_cells_num_xxx">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"CD3+CD4+ (T4 helper) cells [#/volume] in Unspecified specimen">
				>
				["at0.0.0.0.0.2"] = <
					text = <"/uL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32515-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32515-9">
			>
		>
	>
	adl_version = <"2.0.5">
