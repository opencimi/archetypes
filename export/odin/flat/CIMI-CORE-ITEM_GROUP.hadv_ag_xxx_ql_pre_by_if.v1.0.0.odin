(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5834-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Adenovirus Ag [Presence] in Unspecified specimen by Immunofluorescence' concept">
				use = <"Use for Adenovirus Ag [Presence] in Unspecified specimen by Immunofluorescence.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hadv_ag_xxx_ql_pre_by_if.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hadv_ag_xxx_ql_pre_by_if">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Adenovirus Ag [Presence] in Unspecified specimen by Immunofluorescence">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Adenovirus Ag [Presence] in Unspecified specimen by Immunofluorescence">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5834-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5834-7">
			>
		>
	>
	adl_version = <"2.0.5">
