(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/27416-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'SCL-70 extractable nuclear Ab [Units/volume] in Serum' concept">
				use = <"Use for SCL-70 extractable nuclear Ab [Units/volume] in Serum.">
				keywords = <"Scleroderma ab", "ENA Scl70", "Topoisomerase I", "DNA-Topoisomerase I", "anti-topo I", "Topo I", "ANA", "Nuc", "ANF", "NA", "Antinuclear antibody", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ena_scl70_ab_seracnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ena_scl70_ab_seracnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"SCL-70 extractable nuclear Ab [Units/volume] in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[arb'U]/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/27416-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/27416-7">
			>
		>
	>
	adl_version = <"2.0.5">
