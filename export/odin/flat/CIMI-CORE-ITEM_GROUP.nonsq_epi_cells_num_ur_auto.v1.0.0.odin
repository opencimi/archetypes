(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/51485-1.html>">
			["tool"] = <"cimi-gen v0.0.1">
			["time"] = <"2015-08-05T22:27:34">
		>
		details = <
			["en"] = <
				language = <[ISO_639-1::en]>
				purpose = <"Archetype for CIMI 'Epithelial cells.non-squamous [#/volume] in Urine by Automated count' concept">
				use = <"Use for Epithelial cells.non-squamous [#/volume] in Urine by Automated count.">
				keywords = <"Non-sq Epi Cells", "Small epithelial cells", "Round epithelial cells", "Cell", "Cellularity", "#", "Number concentration", "Count/volume", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Ur", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Auto", "Sq", "Epith", "Epithelia", "URINALYSIS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.nonsq_epi_cells_num_ur_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"nonsq_epi_cells_num_ur_auto">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/51485-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/51485-1">
			>
		>
	>
	adl_version = <"2.0.5">
