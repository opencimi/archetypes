(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/21441-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Human papilloma virus 6+11+42+43+44 DNA [Presence] in Cervix by DNA probe' concept">
				use = <"Use for Human papilloma virus 6+11+42+43+44 DNA [Presence] in Cervix by DNA probe.">
				keywords = <"HPV Low Risk", "Papilloma virus low risk", "HPV6+11", "Human papillomavirus", "Genital warts", "Deoxyribonucleic acid", "Arbitrary concentration", "Point in time", "Random", "Cervix", "Genital tract", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Prb", "DNA probe", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hpv_low_risk_dna_cervix_ql_prb.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hpv_low_risk_dna_cervix_ql_prb">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Human papilloma virus 6+11+42+43+44 DNA [Presence] in Cervix by DNA probe">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Human papilloma virus 6+11+42+43+44 DNA [Presence] in Cervix by DNA probe">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/21441-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/21441-1">
			>
		>
	>
	adl_version = <"2.0.5">
