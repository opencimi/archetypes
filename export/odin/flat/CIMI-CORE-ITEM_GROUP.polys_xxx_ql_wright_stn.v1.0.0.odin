(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20473-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Polymorphonuclear cells [Presence] in Unspecified specimen by Wright stain' concept">
				use = <"Use for Polymorphonuclear cells [Presence] in Unspecified specimen by Wright stain.">
				keywords = <"Polys", "PMN", "Poly", "Segmented WBC", "Cell", "Cellularity", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Wright Stn", "Wrights", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.polys_xxx_ql_wright_stn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"polys_xxx_ql_wright_stn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Polymorphonuclear cells [Presence] in Unspecified specimen by Wright stain">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Polymorphonuclear cells [Presence] in Unspecified specimen by Wright stain">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20473-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20473-5">
			>
		>
	>
	adl_version = <"2.0.5">
