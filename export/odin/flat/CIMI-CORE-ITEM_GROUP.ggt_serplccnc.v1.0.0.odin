(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2324-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Gamma glutamyl transferase [Enzymatic activity/volume] in Serum or Plasma' concept">
				use = <"Use for Gamma glutamyl transferase [Enzymatic activity/volume] in Serum or Plasma.">
				keywords = <"GGT", "Gamma-GTP", "GGTP", "Gamma glutamyl transpeptidase", "Catalytic Concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "GT", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ggt_serplccnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ggt_serplccnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2324-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2324-2">
			>
		>
	>
	adl_version = <"2.0.5">
