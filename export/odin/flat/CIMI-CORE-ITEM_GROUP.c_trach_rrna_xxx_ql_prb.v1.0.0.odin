(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/4993-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Chlamydia trachomatis rRNA [Presence] in Unspecified specimen by DNA probe' concept">
				use = <"Use for Chlamydia trachomatis rRNA [Presence] in Unspecified specimen by DNA probe.">
				keywords = <"C trach", "C trac", "C trachomatis", "Chlam trac", "C tracho", "CT", "Trachoma", "Lymphogranuloma venereum", "LGV", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Prb", "DNA probe", "ribosomal RNA", "Chlamid", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.c_trach_rrna_xxx_ql_prb.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"c_trach_rrna_xxx_ql_prb">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Chlamydia trachomatis rRNA [Presence] in Unspecified specimen by DNA probe">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/4993-2">
			>
			["opencem"] = <
