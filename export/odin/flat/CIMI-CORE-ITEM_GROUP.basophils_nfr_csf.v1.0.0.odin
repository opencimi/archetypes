(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/30374-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Basophils/100 leukocytes in Cerebral spinal fluid' concept">
				use = <"Use for Basophils/100 leukocytes in Cerebral spinal fluid.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.basophils_nfr_csf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"basophils_nfr_csf">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/30374-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/30374-3">
			>
		>
	>
	adl_version = <"2.0.5">
