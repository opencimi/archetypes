(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/57796-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Reducing substances [Presence] in Stool by Post hydrolysis' concept">
				use = <"Use for Reducing substances [Presence] in Stool by Post hydrolysis.">
				keywords = <"Reducing Subs", "Reduc subs", "Reducing substance", "Arbitrary concentration", "Point in time", "Random", "Stl", "Feces", "Faeces", "Bowel movement", "Fecal", "Faecal", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.reducing_subs_stl_ql_pre_by_post_hydrolysis.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"reducing_subs_stl_ql_pre_by_post_hydrolysis">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Reducing substances [Presence] in Stool by Post hydrolysis">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Reducing substances [Presence] in Stool by Post hydrolysis">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/57796-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/57796-5">
			>
		>
	>
	adl_version = <"2.0.5">
