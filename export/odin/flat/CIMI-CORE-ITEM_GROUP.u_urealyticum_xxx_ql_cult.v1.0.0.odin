(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/17852-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Ureaplasma urealyticum [Presence] in Unspecified specimen by Organism specific culture' concept">
				use = <"Use for Ureaplasma urealyticum [Presence] in Unspecified specimen by Organism specific culture.">
				keywords = <"U urealyticum", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Cult", "Cultures", "C&S", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.u_urealyticum_xxx_ql_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"u_urealyticum_xxx_ql_cult">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Ureaplasma urealyticum [Presence] in Unspecified specimen by Organism specific culture">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Ureaplasma urealyticum [Presence] in Unspecified specimen by Organism specific culture">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/17852-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/17852-5">
			>
		>
	>
	adl_version = <"2.0.5">
