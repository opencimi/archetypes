(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/48051-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Erythrocytes [Presence] in Vaginal fluid' concept">
				use = <"Use for Erythrocytes [Presence] in Vaginal fluid.">
				keywords = <"RBC", "Red blood corpusles", "Red blood corpuscle", "Erthrocyte", "Erythrocyte", "Red blood cell", "Red cell", "Red cells", "Discocytes", "Red blood cells", "RBCS", "Arbitrary concentration", "Point in time", "Random", "Genital vaginal", "Vagina", "Vaginal fluid", "Vag fluid", "Vag fld", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.rbc_vag_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"rbc_vag_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Erythrocytes [Presence] in Vaginal fluid">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Erythrocytes [Presence] in Vaginal fluid">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/48051-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/48051-7">
			>
		>
	>
	adl_version = <"2.0.5">
