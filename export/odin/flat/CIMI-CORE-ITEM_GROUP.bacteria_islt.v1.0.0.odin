(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/42803-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Bacteria identified in Isolate' concept">
				use = <"Use for Bacteria identified in Isolate.">
				keywords = <"Bact", "Identity or presence", "Point in time", "Random", "Islt", "Isol", "Nominal", "Isolated", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bacteria_islt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bacteria_islt">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Bacteria identified in Isolate">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Bacteria identified in Isolate">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/42803-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/42803-7">
			>
		>
	>
	adl_version = <"2.0.5">
