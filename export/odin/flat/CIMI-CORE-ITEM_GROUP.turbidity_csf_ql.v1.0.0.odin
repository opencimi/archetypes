(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20512-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Turbidity of Cerebral spinal fluid Qualitative' concept">
				use = <"Use for Turbidity of Cerebral spinal fluid Qualitative.">
				keywords = <"Arbitrary concentration", "Point in time", "Random", "Cerebral spinal fluid", "Spinal Fluid", "Cerebrospinal Fl", "Spinal Flu", "Spinal Fld", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.turbidity_csf_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"turbidity_csf_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Turbidity of Cerebral spinal fluid Qualitative">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Turbidity of Cerebral spinal fluid Qualitative">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20512-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20512-0">
			>
		>
	>
	adl_version = <"2.0.5">
