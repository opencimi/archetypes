(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/29901-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'HTLV 1+2 Ab [Presence] in Serum by Immunoassay' concept">
				use = <"Use for HTLV 1+2 Ab [Presence] in Serum by Immunoassay.">
				keywords = <"HTLV type 1+2", "HTLV type I+II", "HTLV1+2", "HTLV1", "HTLVI", "HTLV-I", "HTLV type 1", "HTLV type I", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Human T-cell Lymphotrophic Virus", "Human T-cell Leukemia Virus", "II", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.htlv1_plus_2_ab_ser_ql_pre_by_eia.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"htlv1_plus_2_ab_ser_ql_pre_by_eia">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"HTLV 1+2 Ab [Presence] in Serum by Immunoassay">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/29901-6">
			>
			["opencem"] = <
