(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1920-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Aspartate aminotransferase [Enzymatic activity/volume] in Serum or Plasma' concept">
				use = <"Use for Aspartate aminotransferase [Enzymatic activity/volume] in Serum or Plasma.">
				keywords = <"AST", "Aspartate amino transferase", "Glutamic oxaloacetic transaminase", "Aspartate transaminase", "SGOT", "Asp", "Aspartic acid", "Catalytic Concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ast_serplccnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ast_serplccnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1920-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1920-8">
			>
		>
	>
	adl_version = <"2.0.5">
