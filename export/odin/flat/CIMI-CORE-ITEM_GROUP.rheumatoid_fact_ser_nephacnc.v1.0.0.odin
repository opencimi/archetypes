(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/15205-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Rheumatoid factor [Units/volume] in Serum by Nephlometry' concept">
				use = <"Use for Rheumatoid factor [Units/volume] in Serum by Nephlometry.">
				keywords = <"Rheumatoid fact", "RF", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "Neph", "Nephelom", "Light scattering", "Fac", "Fact", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.rheumatoid_fact_ser_nephacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"rheumatoid_fact_ser_nephacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Rheumatoid factor [Units/volume] in Serum by Nephlometry">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[IU]/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/15205-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/15205-8">
			>
		>
	>
	adl_version = <"2.0.5">
