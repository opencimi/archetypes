(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/64117-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Most predominant hemoglobin in Dried blood spot' concept">
				use = <"Use for Most predominant hemoglobin in Dried blood spot.">
				keywords = <"Most predominant Hb", "Hgb", "Haemoglobin", "Finding", "Findings", "Point in time", "Random", "DBS", "Filter paper", "FP", "Dried blood spot", "Blood", "WB", "Whole blood", "Nominal", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.most_predominant_hb_dbs.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"most_predominant_hb_dbs">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/64117-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/64117-5">
			>
		>
	>
	adl_version = <"2.0.5">
