(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5352-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Sjogrens syndrome-A extractable nuclear Ab [Presence] in Serum by Immune diffusion (ID)' concept">
				use = <"Use for Sjogrens syndrome-A extractable nuclear Ab [Presence] in Serum by Immune diffusion (ID).">
				keywords = <"Sjogren", "SSA", "Ro", "SS-A", "Ro AB", "ENA SS-A", "ANA", "Nuc", "ANF", "NA", "Antinuclear antibody", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ID", "Immunodiff", "Immunodiffusion", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Imun", "Imune", "Imm", "SS", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ena_ssa_ab_ser_ql_id.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ena_ssa_ab_ser_ql_id">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Sjogrens syndrome-A extractable nuclear Ab [Presence] in Serum by Immune diffusion (ID)">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Sjogrens syndrome-A extractable nuclear Ab [Presence] in Serum by Immune diffusion (ID)">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5352-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5352-0">
			>
		>
	>
	adl_version = <"2.0.5">
