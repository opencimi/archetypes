(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/15359-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Dilute Russell viper venom time (dRVVT) actual/normal in Platelet poor plasma by Coagulation assay' concept">
				use = <"Use for Dilute Russell viper venom time (dRVVT) actual/normal in Platelet poor plasma by Coagulation assay.">
				keywords = <"dRVVT", "Screening test for lupus anticoagulant", "Nor", "RlTm", "Point in time", "Random", "Platelet poor plasma", "Plas", "Quantitative", "QNT", "Quant", "Quan", "Coagulation assay", "Clot", "Tilt tube", "Clottable", "Act/Nor", "RVV", "Rus", "Control", "dRVV", "Dil Russell Vip Ven", "Dilut">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.drvvt_act_nor_ppp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"drvvt_act_nor_ppp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Dilute Russell viper venom time (dRVVT) actual/normal in Platelet poor plasma by Coagulation assay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/15359-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/15359-3">
			>
		>
	>
	adl_version = <"2.0.5">
