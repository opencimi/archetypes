(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32854-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI '17-Hydroxyprogesterone [Presence] in Dried blood spot' concept">
				use = <"Use for 17-Hydroxyprogesterone [Presence] in Dried blood spot.">
				keywords = <"17OHP", "Hydroxyproges", "17-P", "17-OHP", "17-hydroxy-progest", "17-OH Progesterone", "17-Hydroxypregn-4-en-3,20-dione", "17-alpha-hydroxyprogesterone", "Arbitrary concentration", "Point in time", "Random", "DBS", "Filter paper", "FP", "Dried blood spot", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Hydroxyprogstron", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.17ohp_dbs_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"17ohp_dbs_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"17-Hydroxyprogesterone [Presence] in Dried blood spot">
				>
				["id1.1.1.1.1.1"] = <
					text = <"17-Hydroxyprogesterone [Presence] in Dried blood spot">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32854-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32854-2">
			>
		>
	>
	adl_version = <"2.0.5">
