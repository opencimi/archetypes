(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/588-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Legionella pneumophila Ag [Presence] in Unspecified specimen by Immunofluorescence' concept">
				use = <"Use for Legionella pneumophila Ag [Presence] in Unspecified specimen by Immunofluorescence.">
				keywords = <"L pneumo", "L pneumonphila", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ACIF", "FA", "Fluorescent antibody", "Immune fluorescence", "Fluoresent", "Immunoflour", "Immunofluor", "Immunofluorescence", "IFA", "Time Resolved Fluorescence", "Anticomplement Immunofluorescence", "TRF", "Antigen", "Antigens", "Pneumophilia", "pneum", "Pneu", "Legionela", "Legion", "Microbiology", "DFA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.l_pneumo_ag_xxx_ql_pre_by_if.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"l_pneumo_ag_xxx_ql_pre_by_if">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Legionella pneumophila Ag [Presence] in Unspecified specimen by Immunofluorescence">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/588-4">
			>
			["opencem"] = <
