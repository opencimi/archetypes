(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3095-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Urea nitrogen [Mass/volume] in Urine' concept">
				use = <"Use for Urea nitrogen [Mass/volume] in Urine.">
				keywords = <"Urea nit", "UN", "Blood urea nitrogen", "N2", "Nit", "N", "Mass concentration", "Level", "Point in time", "Random", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Chemistry", "UUN">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.uun_urmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"uun_urmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Urea nitrogen [Mass/volume] in Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3095-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3095-7">
			>
		>
	>
	adl_version = <"2.0.5">
