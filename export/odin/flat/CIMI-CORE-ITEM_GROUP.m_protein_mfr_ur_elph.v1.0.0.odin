(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/42483-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Protein.monoclonal/Protein.total in Urine by Electrophoresis' concept">
				use = <"Use for Protein.monoclonal/Protein.total in Urine by Electrophoresis.">
				keywords = <"M Protein", "M-spike", "M-band", "Monoclonal band", "Monoclonal spike", "M-protein", "Para protein", "Paraprotein", "Prot", "PR", "TP", "Mass fraction", "Percent", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Elph", "Elp", "Elect", "Electrophrs", "Electrophhrs", "Electr", "Elec", "Ep", "Electro", "Tot", "Totl", "Chemistry", "PEUR", "UPEP">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.m_protein_mfr_ur_elph.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"m_protein_mfr_ur_elph">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Protein.monoclonal/Protein.total in Urine by Electrophoresis">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/42483-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/42483-8">
			>
		>
	>
	adl_version = <"2.0.5">
