(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/45371-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Multiple pregnancy' concept">
				use = <"Use for Multiple pregnancy.">
				keywords = <"Multiple gestations", "Finding", "Findings", "Point in time", "Random", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Gestation", "Gravida", "Gestations", "Pregnancies", "Multi", "Mult">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.multiple_pregnancy.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"multiple_pregnancy">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/45371-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/45371-2">
			>
		>
	>
	adl_version = <"2.0.5">
