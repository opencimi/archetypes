(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/9796-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Color of Stone' concept">
				use = <"Use for Color of Stone.">
				keywords = <"Colour", "Appearance", "Typ", "Point in time", "Random", "Stone", "Calc", "Stn", "Stones", "Calculi", "Nominal">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.color_stone.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"color_stone">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/9796-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/9796-4">
			>
		>
	>
	adl_version = <"2.0.5">
