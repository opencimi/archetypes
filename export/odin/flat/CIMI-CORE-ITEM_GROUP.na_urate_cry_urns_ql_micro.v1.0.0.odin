(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/53788-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Sodium urate crystals [Presence] in Urine sediment by Light microscopy' concept">
				use = <"Use for Sodium urate crystals [Presence] in Urine sediment by Light microscopy.">
				keywords = <"Urate Cry", "Urates", "Uric acid", "Na Urate Cry", "NaU", "Monosodium Urate", "Na+", "Cryst", "Crys", "Crystal", "Arbitrary concentration", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Micro", "LM", "Micros", "Microscopic", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.na_urate_cry_urns_ql_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"na_urate_cry_urns_ql_micro">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/53788-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/53788-6">
			>
		>
	>
	adl_version = <"2.0.5">
