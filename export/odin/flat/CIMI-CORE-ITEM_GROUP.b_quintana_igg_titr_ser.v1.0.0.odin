(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/9360-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Bartonella quintana IgG Ab [Titer] in Serum' concept">
				use = <"Use for Bartonella quintana IgG Ab [Titer] in Serum.">
				keywords = <"Immune globulin G", "Immunoglobulin G", "B quintana", "Rochalimaea quintana", "R quintana", "CSD", "Trench fever", "Cat Scratch Disease", "Rochalimae quintana", "Cat Scratch Fever", "Dilution factor", "Titer", "Titre", "Ttr", "Titered", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.b_quintana_igg_titr_ser.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"b_quintana_igg_titr_ser">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Bartonella quintana IgG Ab [Titer] in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{titer}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/9360-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/9360-9">
			>
		>
	>
	adl_version = <"2.0.5">
