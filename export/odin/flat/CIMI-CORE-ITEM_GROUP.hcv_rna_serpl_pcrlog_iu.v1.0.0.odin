(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/38180-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hepatitis C virus RNA [log units/volume] (viral load) in Serum or Plasma by Probe and target amplification method' concept">
				use = <"Use for Hepatitis C virus RNA [log units/volume] (viral load) in Serum or Plasma by Probe and target amplification method.">
				keywords = <"Ribonucleic acid", "HCV", "Hep C", "Log IU", "Log ACNC", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "PCR", "Polymerase chain reaction", "Transcription mediated amplification", "NASBA", "Nucleic acid sequence based analysis", "SDA", "Strand Displacement Amplification", "LAT", "Ligation-activated transcription", "3SR SR", "3 Self-Sustaining Sequence Replication", "LCR", "Ligase chain reaction", "QBR", "Probe with target amplification", "NAAT", "TMA", "Amp Prb", "Probe with ampification", "DNA probe", "Amplified", "Hepatit", "Hepatis", "Microbiology", "Viral load">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hcv_rna_serpl_pcrlog_iu.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hcv_rna_serpl_pcrlog_iu">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hepatitis C virus RNA [log units/volume] (viral load) in Serum or Plasma by Probe and target amplification method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{Log_IU}/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/38180-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/38180-6">
			>
		>
	>
	adl_version = <"2.0.5">
