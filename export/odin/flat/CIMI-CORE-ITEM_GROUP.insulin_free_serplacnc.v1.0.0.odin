(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6901-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Insulin Free [Units/volume] in Serum or Plasma' concept">
				use = <"Use for Insulin Free [Units/volume] in Serum or Plasma.">
				keywords = <"Insul", "Humulin", "HUM", "IH7", "Lente", "NPH", "Semilente", "Ultralente", "Sliding", "Arbitrary concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "FR", "Non-protein bound", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.insulin_free_serplacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"insulin_free_serplacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Insulin Free [Units/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"u[IU]/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6901-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6901-3">
			>
		>
	>
	adl_version = <"2.0.5">
