(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/666-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Microscopic observation [Identifier] in Unspecified specimen by India ink prep' concept">
				use = <"Use for Microscopic observation [Identifier] in Unspecified specimen by India ink prep.">
				keywords = <"Identity or presence", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Nominal", "India Ink Prep", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.india_ink_prep_xxx.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"india_ink_prep_xxx">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Microscopic observation [Identifier] in Unspecified specimen by India ink prep">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Microscopic observation [Identifier] in Unspecified specimen by India ink prep">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/666-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/666-8">
			>
		>
	>
	adl_version = <"2.0.5">
