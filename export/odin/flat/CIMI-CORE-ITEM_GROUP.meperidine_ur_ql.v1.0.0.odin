(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3746-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Meperidine [Presence] in Urine' concept">
				use = <"Use for Meperidine [Presence] in Urine.">
				keywords = <"Pethidine", "Centralgine", "Demerol", "Dolantin", "Dolosal", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.meperidine_ur_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"meperidine_ur_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Meperidine [Presence] in Urine">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Meperidine [Presence] in Urine">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3746-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3746-5">
			>
		>
	>
	adl_version = <"2.0.5">
