(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/21020-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Bacteria identified in Unspecified specimen by Anaerobe+Aerobe culture' concept">
				use = <"Use for Bacteria identified in Unspecified specimen by Anaerobe+Aerobe culture.">
				keywords = <"Bact", "Identity or presence", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Nominal", "Anaerobe+Aerobe Cult", "Cultures", "C&S", "Anaerobe+Aerobe Cult", "Aerobe Cult", "Aerobed", "Isolated", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bacteria_xxx_anaerobe_plus_aerobe_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bacteria_xxx_anaerobe_plus_aerobe_cult">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Bacteria identified in Unspecified specimen by Anaerobe+Aerobe culture">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Bacteria identified in Unspecified specimen by Anaerobe+Aerobe culture">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/21020-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/21020-3">
			>
		>
	>
	adl_version = <"2.0.5">
