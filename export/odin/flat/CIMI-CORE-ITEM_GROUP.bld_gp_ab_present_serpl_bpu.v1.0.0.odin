(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/14604-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Blood group antibodies present [Identifier] in Serum or Plasma from Blood product unit' concept">
				use = <"Use for Blood group antibodies present [Identifier] in Serum or Plasma from Blood product unit.">
				keywords = <"Bld gp Ab present", "Identity or presence", "Point in time", "Random", "SerPl^bpu", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Blood product unit", "Nominal", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bld_gp_ab_present_serpl_bpu.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bld_gp_ab_present_serpl_bpu">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Blood group antibodies present [Identifier] in Serum or Plasma from Blood product unit">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Blood group antibodies present [Identifier] in Serum or Plasma from Blood product unit">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/14604-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/14604-3">
			>
		>
	>
	adl_version = <"2.0.5">
