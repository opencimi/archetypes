(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2236-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Calciferol (Vit D2) [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Calciferol (Vit D2) [Mass/volume] in Serum or Plasma.">
				keywords = <"Vitamin D2", "Vit D2", "Vit D 1 25 hydroxy", "Pro vitamin D", "Viosterol", "Ergocalciferol", "C28H43OH", "Activated ergosterol", "Ercalciol", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.vitamin_d2_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"vitamin_d2_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Calciferol (Vit D2) [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"pg/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2236-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2236-8">
			>
		>
	>
	adl_version = <"2.0.5">
