(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/50552-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Clarity in Urine by Refractometry automated' concept">
				use = <"Use for Clarity in Urine by Refractometry automated.">
				keywords = <"Typ", "Point in time", "Random", "Ur", "UR", "Urn", "Nominal", "Refract.auto", "Refract.auto", "Refract", "Auto", "URINALYSIS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.clarity_ur_pre_by_refract_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"clarity_ur_pre_by_refract_auto">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Clarity in Urine by Refractometry automated">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Clarity in Urine by Refractometry automated">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/50552-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/50552-9">
			>
		>
	>
	adl_version = <"2.0.5">
