(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19125-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Meconium [Presence] in Amniotic fluid' concept">
				use = <"Use for Meconium [Presence] in Amniotic fluid.">
				keywords = <"Arbitrary concentration", "Point in time", "Random", "Amn", "Amniotic fluid", "Amn fl", "Amniotic flu", "AF", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.meconium_amn_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"meconium_amn_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Meconium [Presence] in Amniotic fluid">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Meconium [Presence] in Amniotic fluid">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19125-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19125-4">
			>
		>
	>
	adl_version = <"2.0.5">
