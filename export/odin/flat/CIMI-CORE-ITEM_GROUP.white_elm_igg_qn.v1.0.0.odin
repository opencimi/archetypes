(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13183-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'White Elm IgG Ab [Units/volume] in Serum' concept">
				use = <"Use for White Elm IgG Ab [Units/volume] in Serum.">
				keywords = <"Elm", "White elm", "t008", "t8", "American elm", "Immune globulin G", "Immunoglobulin G", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "ALLERGY TESTING", "Allergens", "Allergen">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.white_elm_igg_qn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"white_elm_igg_qn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"White Elm IgG Ab [Units/volume] in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13183-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13183-9">
			>
		>
	>
	adl_version = <"2.0.5">
