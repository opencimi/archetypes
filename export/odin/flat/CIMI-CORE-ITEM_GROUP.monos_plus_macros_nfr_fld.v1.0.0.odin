(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/30437-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Monocytes+Macrophages/100 leukocytes in Body fluid' concept">
				use = <"Use for Monocytes+Macrophages/100 leukocytes in Body fluid.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.monos_plus_macros_nfr_fld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"monos_plus_macros_nfr_fld">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/30437-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/30437-8">
			>
		>
	>
	adl_version = <"2.0.5">
