(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/30166-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Thyroid stimulating immunoglobulins actual/normal in Serum' concept">
				use = <"Use for Thyroid stimulating immunoglobulins actual/normal in Serum.">
				keywords = <"TSI", "Human Thyroid Stimulator", "HTS", "Long-acting thyroid stimulator", "Thyroid stimulating antibody", "TSAb", "LATS", "Nor", "Relative mass concentration", "RLMCNC", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "Act/Nor", "Control", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.tsi_act_nor_ser.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"tsi_act_nor_ser">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Thyroid stimulating immunoglobulins actual/normal in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%{basal_activity}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/30166-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/30166-3">
			>
		>
	>
	adl_version = <"2.0.5">
