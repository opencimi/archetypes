(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6473-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Microscopic observation [Identifier] in Tissue by Trichrome stain' concept">
				use = <"Use for Microscopic observation [Identifier] in Tissue by Trichrome stain.">
				keywords = <"Identity or presence", "Point in time", "Random", "Tissue", "Nominal", "Tri Stn", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.tri_stn_tiss.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"tri_stn_tiss">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Microscopic observation [Identifier] in Tissue by Trichrome stain">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Microscopic observation [Identifier] in Tissue by Trichrome stain">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6473-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6473-3">
			>
		>
	>
	adl_version = <"2.0.5">
