(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.troponin_i_serplmcnc_post_by_serpl_dl_lte_0_01_ng_mlmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"troponin_i_serplmcnc_post_by_serpl_dl_lte_0_01_ng_mlmcnc">
