(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/46736-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fatty acid oxidation defects newborn screen interpretation' concept">
				use = <"Use for Fatty acid oxidation defects newborn screen interpretation.">
				keywords = <"FOD", "FAODS", "FA Oxidation", "FAO", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "DBS", "Filter paper", "FP", "Dried blood spot", "Blood", "WB", "Whole blood", "Nominal", "Acd", "Acids", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fod_dbsimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fod_dbsimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Fatty acid oxidation defects newborn screen interpretation">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Fatty acid oxidation defects newborn screen interpretation">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/46736-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/46736-5">
			>
		>
	>
	adl_version = <"2.0.5">
