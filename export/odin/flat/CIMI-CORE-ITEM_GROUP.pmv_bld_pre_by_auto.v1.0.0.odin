(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32623-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Platelet mean volume [Entitic volume] in Blood by Automated count' concept">
				use = <"Use for Platelet mean volume [Entitic volume] in Blood by Automated count.">
				keywords = <"Vol", "PMV", "MPV", "Plt", "Pl", "Platelets", "Thrombocytes", "Platelt", "Thrombocyte", "Entitic volume", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Auto", "Average", "Avg", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pmv_bld_pre_by_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pmv_bld_pre_by_auto">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32623-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32623-1">
			>
		>
	>
	adl_version = <"2.0.5">
