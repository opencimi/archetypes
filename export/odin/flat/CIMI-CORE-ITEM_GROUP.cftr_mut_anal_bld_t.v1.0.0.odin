(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/38404-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'CFTR gene mutation analysis in Blood or Tissue by Molecular genetics method Narrative' concept">
				use = <"Use for CFTR gene mutation analysis in Blood or Tissue by Molecular genetics method Narrative.">
				keywords = <"Cystic fibrosis transmembrane conductance regulator", "CFA", "ABC35", "ABCC7", "CBAVD", "MRP7", "Identity or presence", "Point in time", "Random", "Bld/T", "Tissue", "Bld/T", "Blood", "WB", "Whole blood", "Narrative", "Report", "PCR", "Molecular genetics", "Mut Anal", "Mutations", "MOLPATH.MUTATIONS", "MOLPATH.MUTATIONS", "Molecular pathology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cftr_mut_anal_bld_t.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cftr_mut_anal_bld_t">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"CFTR gene mutation analysis in Blood or Tissue by Molecular genetics method Narrative">
				>
				["id1.1.1.1.1.1"] = <
					text = <"CFTR gene mutation analysis in Blood or Tissue by Molecular genetics method Narrative">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/38404-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/38404-0">
			>
		>
	>
	adl_version = <"2.0.5">
