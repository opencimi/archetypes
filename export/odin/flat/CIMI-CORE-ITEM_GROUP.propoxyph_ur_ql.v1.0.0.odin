(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19141-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Propoxyphene [Presence] in Urine' concept">
				use = <"Use for Propoxyphene [Presence] in Urine.">
				keywords = <"Propoxyph", "D-propoxyphene", "Cotonal-65", "Dextropropoxyphene", "Cosalgesic", "Dextrogesic", "Distalgesic", "Dolasan", "Napsalgesic", "Algaphan", "Depronal", "Doloxene", "Darvon", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.propoxyph_ur_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"propoxyph_ur_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Propoxyphene [Presence] in Urine">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Propoxyphene [Presence] in Urine">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19141-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19141-1">
			>
		>
	>
	adl_version = <"2.0.5">
