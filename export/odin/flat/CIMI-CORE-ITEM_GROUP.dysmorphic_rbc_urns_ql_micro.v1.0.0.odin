(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/58444-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Erythrocytes.dysmorphic [Presence] in Urine sediment by Light microscopy' concept">
				use = <"Use for Erythrocytes.dysmorphic [Presence] in Urine sediment by Light microscopy.">
				keywords = <"Dysmorphic RBC", "D cells", "DE", "Glomerular erythrocytes", "Red blood corpusles", "Red blood corpuscle", "Erthrocyte", "Erythrocyte", "Red blood cell", "Red cell", "Red cells", "Discocytes", "Red blood cells", "RBCS", "Arbitrary concentration", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Micro", "LM", "Micros", "Microscopic", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.dysmorphic_rbc_urns_ql_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"dysmorphic_rbc_urns_ql_micro">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/58444-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/58444-1">
			>
		>
	>
	adl_version = <"2.0.5">
