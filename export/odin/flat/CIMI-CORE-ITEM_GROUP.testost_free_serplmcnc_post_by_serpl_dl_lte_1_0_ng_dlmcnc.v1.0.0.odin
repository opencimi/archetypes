(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.testost_free_serplmcnc_post_by_serpl_dl_lte_1_0_ng_dlmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"testost_free_serplmcnc_post_by_serpl_dl_lte_1_0_ng_dlmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.3"] = <
					text = <"Detection limit <= 1.0 ng/dL">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Testosterone Free [Mass/volume] in Serum or Plasma">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.3"] = <"http://snomed.org/id/703439009">
			>
			["loinc"] = <
