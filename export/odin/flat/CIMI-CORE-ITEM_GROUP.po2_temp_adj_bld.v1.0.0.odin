(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19254-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oxygen [Partial pressure] adjusted to patients actual temperature in Blood' concept">
				use = <"Use for Oxygen [Partial pressure] adjusted to patients actual temperature in Blood.">
				keywords = <"Temp", "O2", "tO2", "temp adj", "Partial pressure", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Chemistry", "O2 partial pressure", "PO2">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.po2_temp_adj_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"po2_temp_adj_bld">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19254-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19254-2">
			>
		>
	>
	adl_version = <"2.0.5">
