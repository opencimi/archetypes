(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/47528-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cytology report of Cervical or vaginal smear or scraping Cyto stain' concept">
				use = <"Use for Cytology report of Cervical or vaginal smear or scraping Cyto stain.">
				keywords = <"Finding", "Findings", "Point in time", "Random", "Genital tract", "Genital vaginal", "Vagina", "Vaginal fluid", "Vag fluid", "Vag fld", "Cervix", "Pap Smear", "Pap Stain", "Cytostain", "Cytology stain", "Papanicolaou smear">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cytology_cvx_vag_doc_cyto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cytology_cvx_vag_doc_cyto">
		release_version = <"1.0.0">
		version_status = <0>
		build_count = <0>
	>
	parent_archetype_id = <"CIMI-CORE-ITEM_GROUP.laboratory_test_document.v1">
	definition = <
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1"] = <
					text = <"Laboratory test document">
				>
				["id5.0.8.0.1"] = <
					text = <"Result value">
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cytology report of Cervical or vaginal smear or scraping Cyto stain">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Cytology report of Cervical or vaginal smear or scraping Cyto stain">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/47528-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/47528-5">
			>
		>
	>
	adl_version = <"2.0.5">
