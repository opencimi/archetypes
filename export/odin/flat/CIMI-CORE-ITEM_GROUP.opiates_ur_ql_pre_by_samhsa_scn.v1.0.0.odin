(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/8222-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Opiates [Presence] in Urine by SAMHSA screen method' concept">
				use = <"Use for Opiates [Presence] in Urine by SAMHSA screen method.">
				keywords = <"Opi", "Opiate", "OP", "Heroin", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "SAMHSA Scn", "SAMSHA", "Scr", "Scrn", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.opiates_ur_ql_pre_by_samhsa_scn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"opiates_ur_ql_pre_by_samhsa_scn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Opiates [Presence] in Urine by SAMHSA screen method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Opiates [Presence] in Urine by SAMHSA screen method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/8222-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/8222-2">
			>
		>
	>
	adl_version = <"2.0.5">
