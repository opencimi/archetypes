(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3174-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Antithrombin [Units/volume] in Platelet poor plasma by Chromogenic method' concept">
				use = <"Use for Antithrombin [Units/volume] in Platelet poor plasma by Chromogenic method.">
				keywords = <"AT III", "ATIII", "Antithrombn", "Antithrm", "Anti thrombin", "Antithrombin III", "Heparin cofactor I", "Thrombin inhibitor I", "Arbitrary concentration", "Point in time", "Random", "Platelet poor plasma", "Plas", "Quantitative", "QNT", "Quant", "Quan", "Chro", "Enzymatic assay", "Chromogenic assay", "ENZY", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.at_iii_ppp_chroacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"at_iii_ppp_chroacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Antithrombin [Units/volume] in Platelet poor plasma by Chromogenic method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[IU]/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3174-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3174-0">
			>
		>
	>
	adl_version = <"2.0.5">
