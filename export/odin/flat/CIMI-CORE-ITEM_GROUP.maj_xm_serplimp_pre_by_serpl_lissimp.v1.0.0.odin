(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/38168-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Major crossmatch [interpretation] by Low ionic strength saline (LISS)' concept">
				use = <"Use for Major crossmatch [interpretation] by Low ionic strength saline (LISS).">
				keywords = <"Maj XM", "Compatability testing", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Nominal", "Low ionic strength saline", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.maj_xm_serplimp_pre_by_serpl_lissimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"maj_xm_serplimp_pre_by_serpl_lissimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Major crossmatch [interpretation] by Low ionic strength saline (LISS)">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Major crossmatch [interpretation] by Low ionic strength saline (LISS)">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/38168-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/38168-1">
			>
		>
	>
	adl_version = <"2.0.5">
