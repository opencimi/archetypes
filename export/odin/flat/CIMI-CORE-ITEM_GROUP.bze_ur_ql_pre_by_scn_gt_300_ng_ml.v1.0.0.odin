(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/43985-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Benzoylecgonine [Presence] in Urine by Screen method >300 ng/mL' concept">
				use = <"Use for Benzoylecgonine [Presence] in Urine by Screen method >300 ng/mL.">
				keywords = <"BZE", "Benz", "BEC", "Benzoylec", "Cocaine degradation production", "BEG", "Crack metabolite", "Cocaine metabolite", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Scn>300 ng/mL", "Scn>300 ng/mL", "Scr", "Scn", "Scrn", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bze_ur_ql_pre_by_scn_gt_300_ng_ml.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bze_ur_ql_pre_by_scn_gt_300_ng_ml">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Benzoylecgonine [Presence] in Urine by Screen method >300 ng/mL">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Benzoylecgonine [Presence] in Urine by Screen method >300 ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/43985-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/43985-1">
			>
		>
	>
	adl_version = <"2.0.5">
