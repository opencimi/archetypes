(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/17948-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fungus # 3 identified in Unspecified specimen by Culture' concept">
				use = <"Use for Fungus # 3 identified in Unspecified specimen by Culture.">
				keywords = <"Fungal", "Fung", "Fungi", "Identity or presence", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Nominal", "Cult", "Cultures", "C&S", "Isolated", "III", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fungus_xxx_cult_org_num_3.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fungus_xxx_cult_org_num_3">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Fungus # 3 identified in Unspecified specimen by Culture">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Fungus # 3 identified in Unspecified specimen by Culture">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/17948-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/17948-1">
			>
		>
	>
	adl_version = <"2.0.5">
