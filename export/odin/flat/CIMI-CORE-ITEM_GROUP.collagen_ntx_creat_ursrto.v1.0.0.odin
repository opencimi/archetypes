(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/14115-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Collagen crosslinked N-telopeptide/Creatinine [Molar ratio] in Urine' concept">
				use = <"Use for Collagen crosslinked N-telopeptide/Creatinine [Molar ratio] in Urine.">
				keywords = <"Collagen NTx", "N-Telopeptide of Type I Collagen", "Aminoterminal cross-linking telopeptide of bone collagen", "Creat", "Crea", "CR", "Substance concentration ratio", "Substance ratio", "Scrto", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Chemistry", "UCr">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.collagen_ntx_creat_ursrto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"collagen_ntx_creat_ursrto">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Collagen crosslinked N-telopeptide/Creatinine [Molar ratio] in Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"nmol/mmol{creat}">
				>
				["at0.0.0.0.0.3"] = <
					text = <"">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/14115-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/14115-0">
			>
		>
	>
	adl_version = <"2.0.5">
