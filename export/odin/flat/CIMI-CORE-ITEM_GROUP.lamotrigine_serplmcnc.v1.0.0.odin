(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6948-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Lamotrigine [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Lamotrigine [Mass/volume] in Serum or Plasma.">
				keywords = <"Lamictal", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.lamotrigine_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"lamotrigine_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Lamotrigine [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6948-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6948-4">
			>
		>
	>
	adl_version = <"2.0.5">
