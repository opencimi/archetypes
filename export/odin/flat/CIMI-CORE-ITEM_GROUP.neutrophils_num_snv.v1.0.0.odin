(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/26504-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Neutrophils [#/volume] in Synovial fluid' concept">
				use = <"Use for Neutrophils [#/volume] in Synovial fluid.">
				keywords = <"PNM", "Neutrophil", "Neutr", "PMN", "Neut", "#", "Number concentration", "Count/volume", "Count", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Snv", "Joint fluid", "Joint aspirate", "Synovial fluid", "Syn fl", "Joint fld", "Joint flu", "Synov", "SNV", "SF", "Quantitative", "QNT", "Quant", "Quan", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.neutrophils_num_snv.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"neutrophils_num_snv">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/26504-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/26504-1">
			>
		>
	>
	adl_version = <"2.0.5">
