(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/30426-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Macrophages/100 leukocytes in Cerebral spinal fluid' concept">
				use = <"Use for Macrophages/100 leukocytes in Cerebral spinal fluid.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.macrophages_nfr_csf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"macrophages_nfr_csf">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/30426-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/30426-1">
			>
		>
	>
	adl_version = <"2.0.5">
