(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/34165-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Immature granulocytes [Presence] in Blood by Automated count' concept">
				use = <"Use for Immature granulocytes [Presence] in Blood by Automated count.">
				keywords = <"Imm Granulocytes", "Gran", "Granulocyte", "Grans", "Arbitrary concentration", "Point in time", "Random", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Auto", "Immat", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.imm_granulocytes_bld_ql_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"imm_granulocytes_bld_ql_auto">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Immature granulocytes [Presence] in Blood by Automated count">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Immature granulocytes [Presence] in Blood by Automated count">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/34165-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/34165-1">
			>
		>
	>
	adl_version = <"2.0.5">
