(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/8116-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'CD19 cells [#/volume] in Blood' concept">
				use = <"Use for CD19 cells [#/volume] in Blood.">
				keywords = <"CD19 Cells", "Cell", "Cellularity", "Leu-12", "B-4", "HD-37", "B4", "Leu12", "#", "Number concentration", "Count/volume", "Count", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "CELL MARKERS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cd19_cells_num_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cd19_cells_num_bld">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"CD19 cells [#/volume] in Blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"/uL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/8116-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/8116-6">
			>
		>
	>
	adl_version = <"2.0.5">
