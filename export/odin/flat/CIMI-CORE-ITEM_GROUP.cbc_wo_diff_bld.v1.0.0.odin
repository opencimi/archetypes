(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/24317-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemogram and platelets WO differential panel - Blood' concept">
				use = <"Use for Hemogram and platelets WO differential panel - Blood.">
				keywords = <"Platelet", "Plt", "Thrombocytes", "Platelt", "Thrb", "Thrombocyte", "CBC WO diff", "Diff Pnl", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Pan", "Panl", "Complete Blood Count", "Differl", "Differn", "PANEL.HEMATOLOGY& CELL COUNTS", "PANEL.HEMATOLOGY& CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cbc_wo_diff_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cbc_wo_diff_bld">
			...
			["1"] = <
				...
				children = <
					...
					["22"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.2.1.1">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.cbc_wo_platelets_bld.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
				>
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.1"] = <
					text = <"Hemogram and platelets WO differential panel - Blood">
				>
				["id0.1.1.1.1"] = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/24317-0">
				["at0.0.0.0.1"] = <"http://loinc.org/id/24317-0">
				["id0.1.1.1.1"] = <"http://loinc.org/id/26515-7">
				["id0.1.1.1.2"] = <"http://loinc.org/id/28542-9">
				["id0.1.2.1.1"] = <"http://loinc.org/id/24358-4">
			>
		>
	>
	adl_version = <"2.0.5">
