(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/70970-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cryoglobulin [Presence] in Serum by Hypotonic dilution' concept">
				use = <"Use for Cryoglobulin [Presence] in Serum by Hypotonic dilution.">
				keywords = <"Cryoglob", "Cryoglobulins", "Cryo", "Cryoprecipitate", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Dil", "Dilut", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cryoglob_ser_ql_pre_by_hypotonic_dilution.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cryoglob_ser_ql_pre_by_hypotonic_dilution">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cryoglobulin [Presence] in Serum by Hypotonic dilution">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Cryoglobulin [Presence] in Serum by Hypotonic dilution">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/70970-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/70970-9">
			>
		>
	>
	adl_version = <"2.0.5">
