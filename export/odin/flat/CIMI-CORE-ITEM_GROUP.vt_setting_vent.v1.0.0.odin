(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20112-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Tidal volume setting Ventilator' concept">
				use = <"Use for Tidal volume setting Ventilator.">
				keywords = <"VT setting", "Point in time", "Random", "Vent", "Quantitative", "QNT", "Quant", "Quan", "TV", "PULMONARY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.vt_setting_vent.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"vt_setting_vent">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20112-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20112-9">
			>
		>
	>
	adl_version = <"2.0.5">
