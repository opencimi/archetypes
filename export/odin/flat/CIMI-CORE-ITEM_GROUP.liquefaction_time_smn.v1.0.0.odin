(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/10580-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Liquefaction [Time] in Semen' concept">
				use = <"Use for Liquefaction [Time] in Semen.">
				keywords = <"Liquifaction", "Point in time", "Random", "Smn", "Ejaculate", "Seminal fluid", "SMPLS", "Sem", "Quantitative", "QNT", "Quant", "Quan", "FERTILITY TESTING">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.liquefaction_time_smn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"liquefaction_time_smn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Liquefaction [Time] in Semen">
				>
				["at0.0.0.0.0.2"] = <
					text = <"min">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258701004">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/10580-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/10580-9">
			>
		>
	>
	adl_version = <"2.0.5">
