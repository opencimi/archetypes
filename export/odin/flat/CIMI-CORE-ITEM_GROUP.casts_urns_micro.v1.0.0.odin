(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/58436-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Casts [Type] in Urine sediment by Light microscopy' concept">
				use = <"Use for Casts [Type] in Urine sediment by Light microscopy.">
				keywords = <"Cast", "Typ", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Nominal", "Micro", "LM", "Micros", "Microscopic", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.casts_urns_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"casts_urns_micro">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/58436-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/58436-7">
			>
		>
	>
	adl_version = <"2.0.5">
