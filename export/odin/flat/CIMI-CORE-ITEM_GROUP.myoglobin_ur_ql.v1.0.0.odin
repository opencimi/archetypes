(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2640-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Myoglobin [Presence] in Urine' concept">
				use = <"Use for Myoglobin [Presence] in Urine.">
				keywords = <"Myog", "Mb", "Arbitrary concentration", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.myoglobin_ur_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"myoglobin_ur_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Myoglobin [Presence] in Urine">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Myoglobin [Presence] in Urine">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2640-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2640-1">
			>
		>
	>
	adl_version = <"2.0.5">
