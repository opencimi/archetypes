(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33903-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Ketones [Presence] in Urine' concept">
				use = <"Use for Ketones [Presence] in Urine.">
				keywords = <"Acetoacetate", "Acetest", "Ketone", "Acetoacetates", "Acetone bodies", "Ketone bodies", "Arbitrary concentration", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ketones_ur_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ketones_ur_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Ketones [Presence] in Urine">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Ketones [Presence] in Urine">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33903-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33903-6">
			>
		>
	>
	adl_version = <"2.0.5">
