(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/43371-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Salmonella sp/Shigella sp identified in Stool by Organism specific culture' concept">
				use = <"Use for Salmonella sp/Shigella sp identified in Stool by Organism specific culture.">
				keywords = <"Salm/Shig", "Identity or presence", "Point in time", "Random", "Stl", "Feces", "Faeces", "Bowel movement", "Fecal", "Faecal", "Nominal", "Cult", "Cultures", "C&S", "Isolated", "species", "spp", "Shigellosis", "Sal", "Salmonel", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.salm_shig_stl_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"salm_shig_stl_cult">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Salmonella sp/Shigella sp identified in Stool by Organism specific culture">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Salmonella sp/Shigella sp identified in Stool by Organism specific culture">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/43371-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/43371-4">
			>
		>
	>
	adl_version = <"2.0.5">
