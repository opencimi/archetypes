(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3861-2.html>">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.nordiazepam_ur_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"nordiazepam_ur_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Nordiazepam [Presence] in Urine">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Nordiazepam [Presence] in Urine">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3861-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3861-2">
			>
		>
	>
	adl_version = <"2.0.5">
