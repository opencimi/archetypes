(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/48148-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Osmolality of Urine by calculation' concept">
				use = <"Use for Osmolality of Urine by calculation.">
				keywords = <"Osmo", "osmolarity", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Calc", "Calculation", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.osmolality_ur_pre_by_calc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"osmolality_ur_pre_by_calc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Osmolality of Urine by calculation">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mosm/kg">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/48148-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/48148-1">
			>
		>
	>
	adl_version = <"2.0.5">
