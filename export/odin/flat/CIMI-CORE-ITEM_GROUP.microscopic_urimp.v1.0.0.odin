(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/27045-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Microscopic exam [interpretation] of Urine by Cytology' concept">
				use = <"Use for Microscopic exam [interpretation] of Urine by Cytology.">
				keywords = <"Micro", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Nominal">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.microscopic_urimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"microscopic_urimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Microscopic exam [interpretation] of Urine by Cytology">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Microscopic exam [interpretation] of Urine by Cytology">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/27045-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/27045-4">
			>
		>
	>
	adl_version = <"2.0.5">
