(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/8310-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Body temperature' concept">
				use = <"Use for Body temperature.">
				keywords = <"Bdy temp", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "bod", "Bodies", "BODY TEMPERATURE.ATOM", "BODY TEMPERATURE.ATOM">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.body_temperature.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"body_temperature">
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258710007">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/8310-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/8310-5">
			>
		>
	>
	adl_version = <"2.0.5">
