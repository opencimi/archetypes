(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/30339-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Epstein Barr virus capsid IgG Ab [Presence] in Serum' concept">
				use = <"Use for Epstein Barr virus capsid IgG Ab [Presence] in Serum.">
				keywords = <"Immune globulin G", "Immunoglobulin G", "VCA", "Viral capsid", "EBV VCA", "Mono", "HHV-4", "human herpesvirus 4", "Mononucleosis", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Epstn", "Cap", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ebv_vca_igg_ser_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ebv_vca_igg_ser_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Epstein Barr virus capsid IgG Ab [Presence] in Serum">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Epstein Barr virus capsid IgG Ab [Presence] in Serum">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/30339-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/30339-6">
			>
		>
	>
	adl_version = <"2.0.5">
