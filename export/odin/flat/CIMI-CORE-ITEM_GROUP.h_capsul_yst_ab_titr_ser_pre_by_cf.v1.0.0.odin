(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20574-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Histoplasma capsulatum yeast phase Ab [Titer] in Serum by Complement fixation' concept">
				use = <"Use for Histoplasma capsulatum yeast phase Ab [Titer] in Serum by Complement fixation.">
				keywords = <"H capsul Yst", "H capsulatum", "H farciminosum", "Histoplasma farciminosum", "Dilution factor", "Titer", "Titre", "Ttr", "Titered", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "CF", "Complement fixation", "Compfix", "Comp fixation", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Histo", "Histopl", "Histoplasmos", "Histoplasmosis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.h_capsul_yst_ab_titr_ser_pre_by_cf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"h_capsul_yst_ab_titr_ser_pre_by_cf">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Histoplasma capsulatum yeast phase Ab [Titer] in Serum by Complement fixation">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{titer}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20574-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20574-0">
			>
		>
	>
	adl_version = <"2.0.5">
