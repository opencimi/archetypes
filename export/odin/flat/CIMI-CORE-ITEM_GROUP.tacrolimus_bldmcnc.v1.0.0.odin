(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/11253-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Tacrolimus [Mass/volume] in Blood' concept">
				use = <"Use for Tacrolimus [Mass/volume] in Blood.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.tacrolimus_bldmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"tacrolimus_bldmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Tacrolimus [Mass/volume] in Blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/11253-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/11253-2">
			>
		>
	>
	adl_version = <"2.0.5">
