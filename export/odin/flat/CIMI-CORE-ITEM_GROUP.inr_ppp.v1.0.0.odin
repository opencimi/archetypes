(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6301-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'INR in Platelet poor plasma by Coagulation assay' concept">
				use = <"Use for INR in Platelet poor plasma by Coagulation assay.">
				keywords = <"PT INR", "Prothrombin time INR", "Protime INR", "Pro time", "RlTm", "Point in time", "Random", "Platelet poor plasma", "Plas", "Quantitative", "QNT", "Quant", "Quan", "Coagulation assay", "Clot", "Tilt tube", "Clottable", "International normal ratio", "Internat norm ratio", "International normalization ratio", "International normalized ratio", "Fac", "Fact">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.inr_ppp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"inr_ppp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"INR in Platelet poor plasma by Coagulation assay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{INR}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6301-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6301-6">
			>
		>
	>
	adl_version = <"2.0.5">
