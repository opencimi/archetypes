(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/41222-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Yeast [Presence] in Body fluid by Light microscopy' concept">
				use = <"Use for Yeast [Presence] in Body fluid by Light microscopy.">
				keywords = <"Arbitrary concentration", "Point in time", "Random", "BF", "Fluid", "Body fluid", "B/F", "FLU", "Fl", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "LM", "Micros", "Microscopic", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.yeast_fld_ql_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"yeast_fld_ql_micro">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Yeast [Presence] in Body fluid by Light microscopy">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Yeast [Presence] in Body fluid by Light microscopy">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/41222-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/41222-1">
			>
		>
	>
	adl_version = <"2.0.5">
