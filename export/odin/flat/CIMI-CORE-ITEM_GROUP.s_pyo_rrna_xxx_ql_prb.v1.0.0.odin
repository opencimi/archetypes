(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5036-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Streptococcus pyogenes rRNA [Presence] in Unspecified specimen by DNA probe' concept">
				use = <"Use for Streptococcus pyogenes rRNA [Presence] in Unspecified specimen by DNA probe.">
				keywords = <"S pyo", "S pyogenes", "GAS", "Steptococcus Group A", "Group A Strep", "Streptococci group A", "Streptococcus group A", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Prb", "DNA probe", "Strept", "ribosomal RNA", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.s_pyo_rrna_xxx_ql_prb.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"s_pyo_rrna_xxx_ql_prb">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Streptococcus pyogenes rRNA [Presence] in Unspecified specimen by DNA probe">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Streptococcus pyogenes rRNA [Presence] in Unspecified specimen by DNA probe">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5036-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5036-9">
			>
		>
	>
	adl_version = <"2.0.5">
