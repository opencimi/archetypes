(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/11064-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Urea nitrogen [Mass/volume] in Serum or Plasma --post dialysis' concept">
				use = <"Use for Urea nitrogen [Mass/volume] in Serum or Plasma --post dialysis.">
				keywords = <"Urea nit", "UN", "Blood urea nitrogen", "N2", "Nit", "N", "p dialysis", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "PST", "After", "Dialy", "Chemistry", "BUN">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bun_p_dialysis_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bun_p_dialysis_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Urea nitrogen [Mass/volume] in Serum or Plasma --post dialysis">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/11064-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/11064-3">
			>
		>
	>
	adl_version = <"2.0.5">
