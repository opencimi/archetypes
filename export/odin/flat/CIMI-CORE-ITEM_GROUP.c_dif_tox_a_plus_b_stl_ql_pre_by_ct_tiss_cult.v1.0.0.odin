(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6362-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Clostridium difficile toxin A+B [Presence] in Stool by Cytotoxin tissue culture assay' concept">
				use = <"Use for Clostridium difficile toxin A+B [Presence] in Stool by Cytotoxin tissue culture assay.">
				keywords = <"C dif Tox A+B", "C diff", "C difficile", "Arbitrary concentration", "Point in time", "Random", "Stl", "Feces", "Faeces", "Bowel movement", "Fecal", "Faecal", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "CT Tiss Cult", "Cultures", "C&S", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.c_dif_tox_a_plus_b_stl_ql_pre_by_ct_tiss_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"c_dif_tox_a_plus_b_stl_ql_pre_by_ct_tiss_cult">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Clostridium difficile toxin A+B [Presence] in Stool by Cytotoxin tissue culture assay">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6362-8">
			>
			["opencem"] = <
