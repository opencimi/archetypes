(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/65752-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Liver Pathology biopsy report' concept">
				use = <"Use for Liver Pathology biopsy report.">
				keywords = <"Path Bx report", "Finding", "Findings", "Point in time", "Random", "Hepatic", "Hepar", "Narrative">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.liver_path_bx_report.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"liver_path_bx_report">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Liver Pathology biopsy report">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Liver Pathology biopsy report">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/65752-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/65752-8">
			>
		>
	>
	adl_version = <"2.0.5">
