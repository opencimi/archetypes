(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/56491-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemoglobin.gastrointestinal [Presence] in Stool by Immunologic method --3rd specimen' concept">
				use = <"Use for Hemoglobin.gastrointestinal [Presence] in Stool by Immunologic method --3rd specimen.">
				keywords = <"Hemoccult", "Gastrocult", "Hemocult", "Fecal occult blood", "FOB", "Occult blood", "Guiac", "Gastrointest blood", "Occult blood in stool", "Hgb", "Hb", "Haemoglobin", "GI", "sp3", "Arbitrary concentration", "Point in time", "Random", "Stl", "Feces", "Faeces", "Bowel movement", "Faecal", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Immunology", "Immunol", "Spec", "Chemistry", "FIT", "Fecal immunochemical test", "Quick test", "HFH test">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hemoccult_sp3_stl_ql_pre_by_occult_bld_sp3_stl_ql_imm.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hemoccult_sp3_stl_ql_pre_by_occult_bld_sp3_stl_ql_imm">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hemoglobin.gastrointestinal [Presence] in Stool by Immunologic method --3rd specimen">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Hemoglobin.gastrointestinal [Presence] in Stool by Immunologic method --3rd specimen">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/56491-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/56491-4">
			>
		>
	>
	adl_version = <"2.0.5">
