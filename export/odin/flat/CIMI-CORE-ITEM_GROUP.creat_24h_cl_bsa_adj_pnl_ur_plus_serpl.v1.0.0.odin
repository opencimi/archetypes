(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/58446-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Creatinine 24H renal clearance adjusted for body surface area panel' concept">
				use = <"Use for Creatinine 24H renal clearance adjusted for body surface area panel.">
				keywords = <"Creat Cl BSA adj Pnl", "Crea", "CR", "Bdy surface", "1 day", "24 hours", "24HR", "Ur+SerPl", "Ur+SerPl", "UR", "Urn", "UA", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Surf", "Kidney", "Pan", "Panl", "Clear", "Clearanc", "Clearances", "Clr", "bod", "Bodies", "PANEL.CHEMISTRY", "PANEL.CHEMISTRY", "Chemistry", "UCr">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.creat_24h_cl_bsa_adj_pnl_ur_plus_serpl.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"creat_24h_cl_bsa_adj_pnl_ur_plus_serpl">
			...
			["1"] = <
				...
				children = <
					...
					["20"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.1">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.creat_cl_1_73_sq_m_24h_ur_plus_serplarvrat.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					...
					["25"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.6">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.weight_pre_by_stated.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					...
					["32"] = (P_C_ARCHETYPE_ROOT) <
						...
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.bsa.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["33"] = (P_C_ARCHETYPE_ROOT) <
						...
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.bdy_height.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
				>
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.1"] = <
					text = <"Creatinine 24H renal clearance adjusted for body surface area panel">
				>
				["id0.1.1.1.1"] = <
					text = <"Creatinine renal clearance/1.73 sq M in 24 hour">
				>
				["id0.1.1.1.10"] = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/58446-6">
				["at0.0.0.0.1"] = <"http://loinc.org/id/58446-6">
				["id0.1.1.1.1"] = <"http://loinc.org/id/12195-4">
				["id0.1.1.1.2"] = <"http://loinc.org/id/13362-9">
				["id0.1.1.1.3"] = <"http://loinc.org/id/20624-3">
				["id0.1.1.1.4"] = <"http://loinc.org/id/2160-0">
				["id0.1.1.1.5"] = <"http://loinc.org/id/2162-6">
				["id0.1.1.1.6"] = <"http://loinc.org/id/3142-7">
				["id0.1.1.1.7"] = <"http://loinc.org/id/3167-4">
				["id0.1.1.1.8"] = <"http://loinc.org/id/33914-3">
				["id0.1.1.1.9"] = <"http://loinc.org/id/48642-3">
				["id0.1.1.1.10"] = <"http://loinc.org/id/48643-1">
				["id0.1.1.1.11"] = <"http://loinc.org/id/50044-7">
				["id0.1.1.1.12"] = <"http://loinc.org/id/50210-4">
				["id0.1.1.1.13"] = <"http://loinc.org/id/8277-6">
				["id0.1.1.1.14"] = <"http://loinc.org/id/8302-2">
			>
		>
	>
	adl_version = <"2.0.5">
