(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32146-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Platelets Large [Presence] in Blood by Light microscopy' concept">
				use = <"Use for Platelets Large [Presence] in Blood by Light microscopy.">
				keywords = <"Lg Platelets", "Plt", "Platelet", "Thrombocytes", "Platelt", "Thrb", "Thrombocyte", "Arbitrary concentration", "Point in time", "Random", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Micro", "LM", "Micros", "Microscopic", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS", "Platelet adequacy", "Platelet estimate">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.lg_platelets_bld_ql_smear.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"lg_platelets_bld_ql_smear">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32146-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32146-3">
			>
		>
	>
	adl_version = <"2.0.5">
