(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/48038-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Pathologist interpretation of Synovial fluid tests' concept">
				use = <"Use for Pathologist interpretation of Synovial fluid tests.">
				keywords = <"Path Interp", "Intrp", "Interpret", "Interpt", "Impression", "Impressions", "Point in time", "Random", "Snv", "Joint fluid", "Joint aspirate", "Synovial fluid", "Syn fl", "Joint fld", "Joint flu", "Synov", "SNV", "SF", "Nominal", "PATHOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.path_interp_snvimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"path_interp_snvimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Pathologist interpretation of Synovial fluid tests">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Pathologist interpretation of Synovial fluid tests">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/48038-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/48038-4">
			>
		>
	>
	adl_version = <"2.0.5">
