(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13955-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hepatitis C virus Ab [Presence] in Serum or Plasma by Immunoassay' concept">
				use = <"Use for Hepatitis C virus Ab [Presence] in Serum or Plasma by Immunoassay.">
				keywords = <"HCVAB", "Hep C", "HCV", "Arbitrary concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Hepatit", "Hepatis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hcv_ab_serpl_ql_eia.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hcv_ab_serpl_ql_eia">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hepatitis C virus Ab [Presence] in Serum or Plasma by Immunoassay">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Hepatitis C virus Ab [Presence] in Serum or Plasma by Immunoassay">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13955-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13955-0">
			>
		>
	>
	adl_version = <"2.0.5">
