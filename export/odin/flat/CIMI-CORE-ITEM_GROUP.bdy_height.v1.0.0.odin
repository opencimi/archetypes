(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/8302-2.html>">
			["tool"] = <"cimi-gen v0.0.1">
			["time"] = <"2015-08-05T22:28:39">
		>
		details = <
			["en"] = <
				language = <[ISO_639-1::en]>
				purpose = <"Archetype for CIMI 'Body height' concept">
				use = <"Use for Body height.">
				keywords = <"Bdy height", "Body length", "Axial length", "Length", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "bod", "Bodies", "BODY HEIGHT(LENGTH).ATOM", "BODY HEIGHT(LENGTH).ATOM">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bdy_height.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bdy_height">
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258677007">
				["at0.0.0.0.0.3"] = <"http://snomed.org/id/intentional_blank">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/8302-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/8302-2">
			>
		>
	>
	adl_version = <"2.0.5">
