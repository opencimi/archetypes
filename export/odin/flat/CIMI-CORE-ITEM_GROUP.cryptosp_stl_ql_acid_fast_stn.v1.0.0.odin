(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20781-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cryptosporidium sp [Presence] in Stool by Acid fast stain' concept">
				use = <"Use for Cryptosporidium sp [Presence] in Stool by Acid fast stain.">
				keywords = <"Cryptosp", "Arbitrary concentration", "Point in time", "Random", "Stl", "Feces", "Faeces", "Bowel movement", "Fecal", "Faecal", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Acid fast Stn", "AFB stain", "species", "spp", "Crypt", "Crypto", "Cryptosporidiosis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cryptosp_stl_ql_acid_fast_stn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cryptosp_stl_ql_acid_fast_stn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cryptosporidium sp [Presence] in Stool by Acid fast stain">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Cryptosporidium sp [Presence] in Stool by Acid fast stain">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20781-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20781-1">
			>
		>
	>
	adl_version = <"2.0.5">
