(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19255-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oxygen [Partial pressure] adjusted to patients actual temperature in Arterial blood' concept">
				use = <"Use for Oxygen [Partial pressure] adjusted to patients actual temperature in Arterial blood.">
				keywords = <"Temp", "O2", "tO2", "temp adj", "Partial pressure", "Point in time", "Random", "Arterial blood", "ART", "Art blood", "Art bld", "ABG", "Quantitative", "QNT", "Quant", "Quan", "Chemistry", "O2 partial pressure", "PO2", "PaO2">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.po2_temp_adj_blda.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"po2_temp_adj_blda">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19255-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19255-9">
			>
		>
	>
	adl_version = <"2.0.5">
