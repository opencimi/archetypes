(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19942-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oxygen gas flow setting Oxymiser' concept">
				use = <"Use for Oxygen gas flow setting Oxymiser.">
				keywords = <"O2 setting", "tO2", "Gas flow.O2 setting", "Gas flow.O2", "vRate", "Volume rate", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "Gases", "Dynamic", "PULMONARY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.gas_flow_o2_setting_oxymiser.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"gas_flow_o2_setting_oxymiser">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Oxygen gas flow setting Oxymiser">
				>
				["at0.0.0.0.0.2"] = <
					text = <"L/min">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19942-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19942-2">
			>
		>
	>
	adl_version = <"2.0.5">
