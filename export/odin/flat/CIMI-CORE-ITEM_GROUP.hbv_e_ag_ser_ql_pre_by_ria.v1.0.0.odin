(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5192-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hepatitis B virus e Ag [Presence] in Serum by Radioimmunoassay (RIA)' concept">
				use = <"Use for Hepatitis B virus e Ag [Presence] in Serum by Radioimmunoassay (RIA).">
				keywords = <"HBV e Ag", "HBEAG", "Hbe", "Hep Be", "HepB", "Hep B", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Radioimmunoassay", "Antigen", "Antigens", "Hepatit", "Hepatis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hbv_e_ag_ser_ql_pre_by_ria.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hbv_e_ag_ser_ql_pre_by_ria">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hepatitis B virus e Ag [Presence] in Serum by Radioimmunoassay (RIA)">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Hepatitis B virus e Ag [Presence] in Serum by Radioimmunoassay (RIA)">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5192-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5192-0">
			>
		>
	>
	adl_version = <"2.0.5">
