(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2742-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Angiotensin converting enzyme [Enzymatic activity/volume] in Serum or Plasma' concept">
				use = <"Use for Angiotensin converting enzyme [Enzymatic activity/volume] in Serum or Plasma.">
				keywords = <"ACE", "Angio convert enzy", "Peptidyl dipeptidase A", "PDPA", "Proangiotensin", "Angiotensin I converting enzyme", "Carboxycathepsin", "Kininase II", "Dipeptidylcarboxypeptidase", "Peptidase P", "Catalytic Concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Enzymes", "Enz", "AGT", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ace_serplccnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ace_serplccnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Angiotensin converting enzyme [Enzymatic activity/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"U/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2742-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2742-5">
			>
		>
	>
	adl_version = <"2.0.5">
