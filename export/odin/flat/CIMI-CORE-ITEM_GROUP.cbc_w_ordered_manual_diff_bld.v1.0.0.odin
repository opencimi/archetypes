(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/57782-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'CBC with Ordered Manual Differential panel - Blood' concept">
				use = <"Use for CBC with Ordered Manual Differential panel - Blood.">
				keywords = <"Manual diff", "Diff Pnl", "CBC W ordered manual diff", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Pan", "Panl", "Differl", "Differn", "Hemogram", "Complete Blood Count", "PANEL.HEMATOLOGY& CELL COUNTS", "PANEL.HEMATOLOGY& CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cbc_w_ordered_manual_diff_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cbc_w_ordered_manual_diff_bld">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.1"] = <
					text = <"CBC with Ordered Manual Differential panel - Blood">
				>
				["id0.1.2.1.1"] = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/57782-5">
				["at0.0.0.0.1"] = <"http://loinc.org/id/57782-5">
				["id0.1.2.1.1"] = <"http://loinc.org/id/24318-8">
				["id0.1.2.1.2"] = <"http://loinc.org/id/58410-2">
			>
		>
	>
	adl_version = <"2.0.5">
