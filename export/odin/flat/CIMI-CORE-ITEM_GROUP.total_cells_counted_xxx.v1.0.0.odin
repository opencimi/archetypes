(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19076-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cells Counted Total [#] in Unspecified specimen' concept">
				use = <"Use for Cells Counted Total [#] in Unspecified specimen.">
				keywords = <"Total Cells Counted", "Total cells", "Cell", "Cellularity", "Number", "Count", "Cnt", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Quantitative", "QNT", "Quant", "Quan", "Tot", "Totl", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.total_cells_counted_xxx.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"total_cells_counted_xxx">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cells Counted Total [#] in Unspecified specimen">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{#}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19076-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19076-9">
			>
		>
	>
	adl_version = <"2.0.5">
