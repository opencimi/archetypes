(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/53978-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Epithelial cells.non-squamous [Presence] in Urine sediment by Light microscopy' concept">
				use = <"Use for Epithelial cells.non-squamous [Presence] in Urine sediment by Light microscopy.">
				keywords = <"Non-sq Epi Cells", "Small epithelial cells", "Round epithelial cells", "Cell", "Cellularity", "Arbitrary concentration", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Micro", "LM", "Micros", "Microscopic", "Sq", "Epith", "Epithelia", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.nonsq_epi_cells_urns_ql_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"nonsq_epi_cells_urns_ql_micro">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/53978-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/53978-3">
			>
		>
	>
	adl_version = <"2.0.5">
