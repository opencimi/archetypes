(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/584-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Streptococcus agalactiae [Presence] in Vaginal fluid by Organism specific culture' concept">
				use = <"Use for Streptococcus agalactiae [Presence] in Vaginal fluid by Organism specific culture.">
				keywords = <"Gp B Strep", "Strep group B", "Strep B", "S agalactiae", "Group B", "GBS", "Steptococcus Group B", "Group B Strep", "Streptococci group B", "Arbitrary concentration", "Point in time", "Random", "Genital vaginal", "Vagina", "Vaginal fluid", "Vag fluid", "Vag fld", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Cult", "Cultures", "C&S", "Strept", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.gp_b_strep_vag_ql_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"gp_b_strep_vag_ql_cult">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Streptococcus agalactiae [Presence] in Vaginal fluid by Organism specific culture">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Streptococcus agalactiae [Presence] in Vaginal fluid by Organism specific culture">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/584-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/584-3">
			>
		>
	>
	adl_version = <"2.0.5">
