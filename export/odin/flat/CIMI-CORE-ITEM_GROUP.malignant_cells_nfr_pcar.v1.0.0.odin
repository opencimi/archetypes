(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/44904-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Malignant cells/100 cells in Pericardial fluid' concept">
				use = <"Use for Malignant cells/100 cells in Pericardial fluid.">
				keywords = <"Cell", "Cellularity", "Gated cells", "Number fraction", "Percent", "Point in time", "Random", "Pcar", "PCAR", "Pericardial fluid", "Quantitative", "QNT", "Quant", "Quan", "Malig", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.malignant_cells_nfr_pcar.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"malignant_cells_nfr_pcar">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/44904-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/44904-1">
			>
		>
	>
	adl_version = <"2.0.5">
