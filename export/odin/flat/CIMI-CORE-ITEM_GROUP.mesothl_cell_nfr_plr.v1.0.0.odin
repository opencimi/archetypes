(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/30431-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Mesothelial cells/100 leukocytes in Pleural fluid' concept">
				use = <"Use for Mesothelial cells/100 leukocytes in Pleural fluid.">
				keywords = <"Mesothl Cell", "WBC", "White blood cell", "Leuc", "Leuk", "Leukocyte", "Lkcs", "White blood cells", "WBCs", "Cellularity", "100WBC", "Number fraction", "Percent", "Point in time", "Random", "thoracentesis fluid", "Pleural fluid", "Quantitative", "QNT", "Quant", "Quan", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.mesothl_cell_nfr_plr.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"mesothl_cell_nfr_plr">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/30431-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/30431-1">
			>
		>
	>
	adl_version = <"2.0.5">
