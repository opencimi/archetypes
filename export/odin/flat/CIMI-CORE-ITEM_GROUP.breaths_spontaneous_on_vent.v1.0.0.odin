(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19839-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Breath rate spontaneous --on ventilator' concept">
				use = <"Use for Breath rate spontaneous --on ventilator.">
				keywords = <"on vent", "nRate", "Number rate", "Count/time", "Point in time", "Random", "Lungs", "Breathing", "RS", "Quantitative", "QNT", "Quant", "Quan", "PULMONARY", "Respiratory rate">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.breaths_spontaneous_on_vent.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"breaths_spontaneous_on_vent">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Breath rate spontaneous --on ventilator">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{breaths}/min">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19839-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19839-0">
			>
		>
	>
	adl_version = <"2.0.5">
