(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/29771-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemoglobin.gastrointestinal [Presence] in Stool by Immunologic method' concept">
				use = <"Use for Hemoglobin.gastrointestinal [Presence] in Stool by Immunologic method.">
				keywords = <"Hemoccult", "Gastrocult", "Hemocult", "Fecal occult blood", "FOB", "Occult blood", "Guiac", "Gastrointest blood", "Occult blood in stool", "Hgb", "Hb", "Haemoglobin", "GI", "Arbitrary concentration", "Point in time", "Random", "Stl", "Feces", "Faeces", "Bowel movement", "Faecal", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Immunology", "Immunol", "Chemistry", "FIT", "Fecal immunochemical test", "Quick test", "HFH test">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hemoccult_stl_ql_pre_by_occult_bld_stl_ql_imm.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hemoccult_stl_ql_pre_by_occult_bld_stl_ql_imm">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/29771-3">
			>
			["opencem"] = <
