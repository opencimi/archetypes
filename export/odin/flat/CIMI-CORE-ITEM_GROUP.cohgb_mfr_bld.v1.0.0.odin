(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20563-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Carboxyhemoglobin/Hemoglobin.total in Blood' concept">
				use = <"Use for Carboxyhemoglobin/Hemoglobin.total in Blood.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cohgb_mfr_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cohgb_mfr_bld">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20563-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20563-3">
			>
		>
	>
	adl_version = <"2.0.5">
