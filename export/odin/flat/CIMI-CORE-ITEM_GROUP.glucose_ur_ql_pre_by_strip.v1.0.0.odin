(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/25428-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Glucose [Presence] in Urine by Test strip' concept">
				use = <"Use for Glucose [Presence] in Urine by Test strip.">
				keywords = <"Glu", "Gluc", "Glucoseur", "Arbitrary concentration", "Point in time", "Random", "Ur", "UR", "Urn", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Dipstick", "Dip stick", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.glucose_ur_ql_pre_by_strip.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"glucose_ur_ql_pre_by_strip">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Glucose [Presence] in Urine by Test strip">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Glucose [Presence] in Urine by Test strip">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/25428-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/25428-4">
			>
		>
	>
	adl_version = <"2.0.5">
