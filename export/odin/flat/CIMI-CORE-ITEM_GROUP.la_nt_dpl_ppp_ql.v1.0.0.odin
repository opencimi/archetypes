(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/15191-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Lupus anticoagulant neutralization dilute phospholipid [Presence] in Platelet poor plasma' concept">
				use = <"Use for Lupus anticoagulant neutralization dilute phospholipid [Presence] in Platelet poor plasma.">
				keywords = <"Pl", "Phoslpd", "Phospholipids", "Lipid", "LA Nt dPL", "TTIT", "Dilute prothrombin time", "dPT", "TTI", "Tissue thromboplastin inhibition", "dRVVT", "LAC", "Lupus inhibitor", "Coagulation inhibiting antibody", "Anti-phospholipid antibody", "Arbitrary concentration", "Point in time", "Random", "Platelet poor plasma", "Plas", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Neutr", "Neut", "Dil", "Dilut", "Anticoag">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.la_nt_dpl_ppp_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"la_nt_dpl_ppp_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Lupus anticoagulant neutralization dilute phospholipid [Presence] in Platelet poor plasma">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Lupus anticoagulant neutralization dilute phospholipid [Presence] in Platelet poor plasma">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/15191-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/15191-0">
			>
		>
	>
	adl_version = <"2.0.5">
