(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'next of kin relationship' concept">
				use = <"Use for next of kin relationship.">
				keywords = <"next", "kin", "relationship">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-PARTY_RELATIONSHIP.next_of_kin_relationship.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"PARTY_RELATIONSHIP">
		concept_id = <"next_of_kin_relationship">
