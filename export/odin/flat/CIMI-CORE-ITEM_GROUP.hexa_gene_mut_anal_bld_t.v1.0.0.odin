(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32632-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'HEXA gene mutations found [Identifier] in Blood or Tissue by Molecular genetics method Nominal' concept">
				use = <"Use for HEXA gene mutations found [Identifier] in Blood or Tissue by Molecular genetics method Nominal.">
				keywords = <"Tay-Sachs disease", "GM2-gangliosidosis", "hexosaminidase A (alpha polypeptide) gene", "N-acetyl-beta-glucosaminidase gene", "TSD", "beta-N-acetylhexosaminidase gene", "Identity or presence", "Point in time", "Random", "Bld/T", "Tissue", "Bld/T", "Blood", "WB", "Whole blood", "Nominal", "PCR", "Molecular genetics", "Mut Anal", "Mutations", "MOLPATH.MUTATIONS", "MOLPATH.MUTATIONS", "Molecular pathology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hexa_gene_mut_anal_bld_t.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hexa_gene_mut_anal_bld_t">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"HEXA gene mutations found [Identifier] in Blood or Tissue by Molecular genetics method Nominal">
				>
				["id1.1.1.1.1.1"] = <
					text = <"HEXA gene mutations found [Identifier] in Blood or Tissue by Molecular genetics method Nominal">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32632-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32632-2">
			>
		>
	>
	adl_version = <"2.0.5">
