(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13462-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Apolipoprotein A-I/Apolipoprotein B [Mass Ratio] in Serum or Plasma' concept">
				use = <"Use for Apolipoprotein A-I/Apolipoprotein B [Mass Ratio] in Serum or Plasma.">
				keywords = <"Apo A-I", "ApoA1", "Apolipoprotein A1", "Apo B", "ApoB", "Apo A-I", "Apo A-I/Apo B", "Mass concentration ratio", "Mass ratio", "MCRto", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.apo_ai_apo_b_serpl.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"apo_ai_apo_b_serpl">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Apolipoprotein A-I/Apolipoprotein B [Mass Ratio] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{ratio}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13462-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13462-7">
			>
		>
	>
	adl_version = <"2.0.5">
