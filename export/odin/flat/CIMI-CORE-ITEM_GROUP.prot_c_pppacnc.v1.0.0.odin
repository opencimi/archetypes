(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6007-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Protein C [Units/volume] in Platelet poor plasma by Coagulation assay' concept">
				use = <"Use for Protein C [Units/volume] in Platelet poor plasma by Coagulation assay.">
				keywords = <"Prot C", "PC", "Autoprothrombin II-a", "PR", "Arbitrary concentration", "Point in time", "Random", "Platelet poor plasma", "Plas", "Quantitative", "QNT", "Quant", "Quan", "Coagulation assay", "Clot", "Tilt tube", "Clottable">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.prot_c_pppacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"prot_c_pppacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Protein C [Units/volume] in Platelet poor plasma by Coagulation assay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[IU]/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6007-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6007-9">
			>
		>
	>
	adl_version = <"2.0.5">
