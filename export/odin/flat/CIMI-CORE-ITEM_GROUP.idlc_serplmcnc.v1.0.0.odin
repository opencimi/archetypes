(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2087-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cholesterol in IDL [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Cholesterol in IDL [Mass/volume] in Serum or Plasma.">
				keywords = <"IDLc", "Beta VLDL", "Intermediate density lipoprotein cholesterols", "Chol", "Choles", "Cholest", "Lipid", "Cholesterol total", "Cholesterols", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.idlc_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"idlc_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cholesterol in IDL [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2087-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2087-5">
			>
		>
	>
	adl_version = <"2.0.5">
