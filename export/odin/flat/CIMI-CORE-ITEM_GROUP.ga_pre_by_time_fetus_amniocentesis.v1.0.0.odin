(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33901-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Gestational age of fetus by Amniocentesis' concept">
				use = <"Use for Gestational age of fetus by Amniocentesis.">
				keywords = <"GA", "Point in time", "Random", "Fetal", "Quantitative", "QNT", "Quant", "Quan", "Gest", "Gestation", "Prenatal">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ga_pre_by_time_fetus_amniocentesis.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ga_pre_by_time_fetus_amniocentesis">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Gestational age of fetus by Amniocentesis">
				>
				["at0.0.0.0.0.2"] = <
					text = <"wk">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258705008">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33901-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33901-0">
			>
		>
	>
	adl_version = <"2.0.5">
