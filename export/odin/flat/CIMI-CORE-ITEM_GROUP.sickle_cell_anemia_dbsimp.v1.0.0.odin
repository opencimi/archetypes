(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/46765-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Sickle cell anemia newborn screen interpretation' concept">
				use = <"Use for Sickle cell anemia newborn screen interpretation.">
				keywords = <"HBSS", "HbSߺ Thalassemia", "SS", "Hb S/S", "Falciform anemia", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "DBS", "Filter paper", "FP", "Dried blood spot", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.sickle_cell_anemia_dbsimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"sickle_cell_anemia_dbsimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Sickle cell anemia newborn screen interpretation">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Sickle cell anemia newborn screen interpretation">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/46765-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/46765-4">
			>
		>
	>
	adl_version = <"2.0.5">
