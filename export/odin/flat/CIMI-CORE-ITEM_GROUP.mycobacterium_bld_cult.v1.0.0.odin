(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/533-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Mycobacterium sp identified in Blood by Organism specific culture' concept">
				use = <"Use for Mycobacterium sp identified in Blood by Organism specific culture.">
				keywords = <"Tuberculosis", "Identity or presence", "Point in time", "Random", "Blood", "WB", "Whole blood", "Nominal", "Cult", "Cultures", "C&S", "Isolated", "species", "spp", "Acid Fast Bacilli", "Mycobact", "Myco", "AFB", "Acid fast bacillus", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.mycobacterium_bld_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"mycobacterium_bld_cult">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Mycobacterium sp identified in Blood by Organism specific culture">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Mycobacterium sp identified in Blood by Organism specific culture">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/533-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/533-0">
			>
		>
	>
	adl_version = <"2.0.5">
