(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/10587-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Sexual abstinence duration' concept">
				use = <"Use for Sexual abstinence duration.">
				keywords = <"Sex Abstin duration", "Durat", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "FERTILITY TESTING">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.sex_abstin_duration_time_patient.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"sex_abstin_duration_time_patient">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Sexual abstinence duration">
				>
				["at0.0.0.0.0.2"] = <
					text = <"d">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/10587-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/10587-4">
			>
		>
	>
	adl_version = <"2.0.5">
