(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/9557-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'CD2 cells [#/volume] in Blood' concept">
				use = <"Use for CD2 cells [#/volume] in Blood.">
				keywords = <"CD2 Cells", "Cell", "Cellularity", "#", "Number concentration", "Count/volume", "Count", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Leu-5", "Leu5", "CD2R", "E-rosette receptor", "T11", "Lymphocyte-function antigen-2", "LFA-2", "CELL MARKERS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cd2_cells_num_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cd2_cells_num_bld">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"CD2 cells [#/volume] in Blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"/uL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/9557-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/9557-0">
			>
		>
	>
	adl_version = <"2.0.5">
