(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/10355-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Microscopic observation [Identifier] in Bone marrow by Wright Giemsa stain' concept">
				use = <"Use for Microscopic observation [Identifier] in Bone marrow by Wright Giemsa stain.">
				keywords = <"Identity or presence", "Point in time", "Random", "BM", "Bone marrow", "BON", "Nominal", "Wright Gie Stn", "GMS", "Wrights", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.wright_gie_stn_mar.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"wright_gie_stn_mar">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Microscopic observation [Identifier] in Bone marrow by Wright Giemsa stain">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Microscopic observation [Identifier] in Bone marrow by Wright Giemsa stain">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/10355-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/10355-6">
			>
		>
	>
	adl_version = <"2.0.5">
