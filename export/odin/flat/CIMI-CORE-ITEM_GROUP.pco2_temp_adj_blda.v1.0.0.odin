(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32771-8.html>">
			["tool"] = <"cimi-gen v0.0.1">
			["time"] = <"2015-08-05T22:27:05">
		>
		details = <
			["en"] = <
				language = <[ISO_639-1::en]>
				purpose = <"Archetype for CIMI 'Carbon dioxide [Partial pressure] adjusted to patients actual temperature in Arterial blood' concept">
				use = <"Use for Carbon dioxide [Partial pressure] adjusted to patients actual temperature in Arterial blood.">
				keywords = <"Temp", "CO2", "Carbonic anhydride", "temp adj", "Partial pressure", "Point in time", "Random", "Arterial blood", "ART", "Art blood", "Art bld", "ABG", "Quantitative", "QNT", "Quant", "Quan", "Chemistry", "PCO2", "PaCO2">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pco2_temp_adj_blda.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pco2_temp_adj_blda">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32771-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32771-8">
			>
		>
	>
	adl_version = <"2.0.5">
