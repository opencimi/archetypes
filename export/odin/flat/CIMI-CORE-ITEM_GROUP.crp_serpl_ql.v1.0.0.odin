(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/11039-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'C reactive protein [Presence] in Serum or Plasma' concept">
				use = <"Use for C reactive protein [Presence] in Serum or Plasma.">
				keywords = <"Prot", "PR", "CRP", "Arbitrary concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Reac", "React", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.crp_serpl_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"crp_serpl_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"C reactive protein [Presence] in Serum or Plasma">
				>
				["id1.1.1.1.1.1"] = <
					text = <"C reactive protein [Presence] in Serum or Plasma">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/11039-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/11039-5">
			>
		>
	>
	adl_version = <"2.0.5">
