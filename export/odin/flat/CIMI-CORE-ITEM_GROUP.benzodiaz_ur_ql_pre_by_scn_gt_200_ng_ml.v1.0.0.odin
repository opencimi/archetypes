(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/70141-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Benzodiazepines [Presence] in Urine by Screen method >200 ng/mL' concept">
				use = <"Use for Benzodiazepines [Presence] in Urine by Screen method >200 ng/mL.">
				keywords = <"Benzodiaz", "Benz", "Benzodiazepine", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Scn>200 ng/mL", "Scn>200 ng/mL", "Scr", "Scn", "Scrn", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.benzodiaz_ur_ql_pre_by_scn_gt_200_ng_ml.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"benzodiaz_ur_ql_pre_by_scn_gt_200_ng_ml">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Benzodiazepines [Presence] in Urine by Screen method >200 ng/mL">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Benzodiazepines [Presence] in Urine by Screen method >200 ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/70141-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/70141-7">
			>
		>
	>
	adl_version = <"2.0.5">
