(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/47364-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hepatitis B virus surface Ag [Presence] in Serum from donor by Immunoassay' concept">
				use = <"Use for Hepatitis B virus surface Ag [Presence] in Serum from donor by Immunoassay.">
				keywords = <"Australia antigen", "HBsAG", "HBV surface", "Hep Bs", "HBs", "HepB", "Hep B", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Donr", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "Antigen", "Antigens", "Surf", "Hepatit", "Hepatis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hbv_surface_ag_ser_donr_ql_eia.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hbv_surface_ag_ser_donr_ql_eia">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hepatitis B virus surface Ag [Presence] in Serum from donor by Immunoassay">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Hepatitis B virus surface Ag [Presence] in Serum from donor by Immunoassay">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/47364-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/47364-5">
			>
		>
	>
	adl_version = <"2.0.5">
