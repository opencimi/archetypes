(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/59412-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oxygen saturation in Arterial blood by Pulse oximetry --post exercise' concept">
				use = <"Use for Oxygen saturation in Arterial blood by Pulse oximetry --post exercise.">
				keywords = <"SaO2", "SO2", "O2", "tO2", "p Exc", "Mass fraction", "Percent", "Point in time", "Random", "Arterial blood", "ART", "Art blood", "Art bld", "ABG", "Quantitative", "QNT", "Quant", "Quan", "PulseOx", "SpO2", "Satn", "SAT", "PST", "After", "EXCZ", "PULMONARY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.sao2_p_exc_percent_blda_pulseox.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"sao2_p_exc_percent_blda_pulseox">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Oxygen saturation in Arterial blood by Pulse oximetry --post exercise">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/59412-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/59412-7">
			>
		>
	>
	adl_version = <"2.0.5">
