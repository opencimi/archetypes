(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/50210-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Glomerular filtration rate/1.73 sq M.predicted by Cystatin-based formula' concept">
				use = <"Use for Glomerular filtration rate/1.73 sq M.predicted by Cystatin-based formula.">
				keywords = <"GFR", "Pred GFR", "Estimated GFR", "eGFR", "BSA.pred", "Volume rate/area", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Square Meter", "Glom", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.gfr_bsa_pred_serpl_cystatinbasedarvrat.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"gfr_bsa_pred_serpl_cystatinbasedarvrat">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/50210-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/50210-4">
			>
		>
	>
	adl_version = <"2.0.5">
