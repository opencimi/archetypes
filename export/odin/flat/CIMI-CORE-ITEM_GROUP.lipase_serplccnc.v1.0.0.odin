(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3040-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Lipase [Enzymatic activity/volume] in Serum or Plasma' concept">
				use = <"Use for Lipase [Enzymatic activity/volume] in Serum or Plasma.">
				keywords = <"Steapsin", "Tributyrase", "Tributyrinase", "LIPA", "Pancreatic lipase", "LPS", "Lipase", "Catalytic Concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.lipase_serplccnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"lipase_serplccnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Lipase [Enzymatic activity/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"U/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3040-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3040-3">
			>
		>
	>
	adl_version = <"2.0.5">
