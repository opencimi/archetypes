(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/8123-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'CD3+CD4+ (T4 helper) cells/100 cells in Blood' concept">
				use = <"Use for CD3+CD4+ (T4 helper) cells/100 cells in Blood.">
				keywords = <"CD3+CD4+ Cells", "T4 helper/inducer cells", "CD4+ T cells", "CD3+CD4+ Cells", "CD3 Cells", "Cell", "Cellularity", "Leu-4", "Leu4", "T3", "Gated cells", "Number fraction", "Percent", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Leu-3", "T-4", "Leu3", "W3/25", "Helper T cells", "Inducer T cells", "L3T4", "CELL MARKERS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cd3_plus_cd4_plus_cells_nfr_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cd3_plus_cd4_plus_cells_nfr_bld">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"CD3+CD4+ (T4 helper) cells/100 cells in Blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/8123-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/8123-2">
			>
		>
	>
	adl_version = <"2.0.5">
