(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6818-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Saccharopolyspora rectivirgula Ab [Presence] in Serum by Immune diffusion (ID)' concept">
				use = <"Use for Saccharopolyspora rectivirgula Ab [Presence] in Serum by Immune diffusion (ID).">
				keywords = <"M faeni", "Mcropolyspra", "Rm212", "Micropolyspora faeni", "Faenia rectivirgula", "F retivirgula", "S retivirgula", "Farmers lung", "S rectivirgula", "m212", "m22", "m50", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ID", "Immunodiff", "Immunodiffusion", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Imun", "Imune", "Imm", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.s_rectivirgula_ab_ser_ql_pre_by_id.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"s_rectivirgula_ab_ser_ql_pre_by_id">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Saccharopolyspora rectivirgula Ab [Presence] in Serum by Immune diffusion (ID)">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6818-9">
			>
			["opencem"] = <
