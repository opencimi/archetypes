(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/21525-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Sodium [Moles/volume] in 24 hour Urine' concept">
				use = <"Use for Sodium [Moles/volume] in 24 hour Urine.">
				keywords = <"Na+", "Na", "Substance concentration", "Level", "1 day", "24 hours", "24HR", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.sodium_24h_urscnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"sodium_24h_urscnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Sodium [Moles/volume] in 24 hour Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mol/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/21525-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/21525-1">
			>
		>
	>
	adl_version = <"2.0.5">
