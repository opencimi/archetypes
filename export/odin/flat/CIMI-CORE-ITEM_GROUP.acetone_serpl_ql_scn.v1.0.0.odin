(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20469-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Acetone [Presence] in Serum or Plasma by Screen method' concept">
				use = <"Use for Acetone [Presence] in Serum or Plasma by Screen method.">
				keywords = <"2-propanone", "Me2CO", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Scn", "Scr", "Scrn", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.acetone_serpl_ql_scn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"acetone_serpl_ql_scn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Acetone [Presence] in Serum or Plasma by Screen method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Acetone [Presence] in Serum or Plasma by Screen method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20469-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20469-3">
			>
		>
	>
	adl_version = <"2.0.5">
