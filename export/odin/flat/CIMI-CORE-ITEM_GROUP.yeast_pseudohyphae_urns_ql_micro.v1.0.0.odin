(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/41863-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Yeast.pseudohyphae [Presence] in Urine sediment by Light microscopy' concept">
				use = <"Use for Yeast.pseudohyphae [Presence] in Urine sediment by Light microscopy.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.yeast_pseudohyphae_urns_ql_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"yeast_pseudohyphae_urns_ql_micro">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/41863-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/41863-2">
			>
		>
	>
	adl_version = <"2.0.5">
