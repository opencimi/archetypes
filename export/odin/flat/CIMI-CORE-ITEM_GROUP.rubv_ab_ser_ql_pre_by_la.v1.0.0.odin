(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5332-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Rubella virus Ab [Presence] in Serum by Latex agglutination' concept">
				use = <"Use for Rubella virus Ab [Presence] in Serum by Latex agglutination.">
				keywords = <"RUBV", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Latex agglutination", "LAT", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.rubv_ab_ser_ql_pre_by_la.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"rubv_ab_ser_ql_pre_by_la">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Rubella virus Ab [Presence] in Serum by Latex agglutination">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Rubella virus Ab [Presence] in Serum by Latex agglutination">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5332-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5332-2">
			>
		>
	>
	adl_version = <"2.0.5">
