(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/47527-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cytology report of Cervical or vaginal smear or scraping Cyto stain.thin prep' concept">
				use = <"Use for Cytology report of Cervical or vaginal smear or scraping Cyto stain.thin prep.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cytology_cvx_vag_doc_thin_prep.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cytology_cvx_vag_doc_thin_prep">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/47527-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/47527-7">
			>
		>
	>
	adl_version = <"2.0.5">
