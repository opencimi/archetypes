(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2915-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Renin [Enzymatic activity/volume] in Plasma' concept">
				use = <"Use for Renin [Enzymatic activity/volume] in Plasma.">
				keywords = <"Angiotensin forming enzyme", "Catalytic Concentration", "Point in time", "Random", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry", "PRA", "Active renin", "Plasma renin activity">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.renin_plasccnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"renin_plasccnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Renin [Enzymatic activity/volume] in Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/mL/h">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/414800002">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2915-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2915-7">
			>
		>
	>
	adl_version = <"2.0.5">
