(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/17032-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Jo-1 extractable nuclear Ab [Units/volume] in Serum by Immunofluorescence' concept">
				use = <"Use for Jo-1 extractable nuclear Ab [Units/volume] in Serum by Immunofluorescence.">
				keywords = <"ANA", "Nuc", "ANF", "NA", "Antinuclear antibody", "Histidyl-tRNA synthease", "ENA Jo1", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "ACIF", "FA", "Fluorescent antibody", "Immune fluorescence", "Fluoresent", "Immunoflour", "Immunofluor", "Immunofluorescence", "IFA", "Time Resolved Fluorescence", "Anticomplement Immunofluorescence", "TRF", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "I", "Serology", "FANA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ena_jo1_ab_seracnc_pre_by_ser_ifacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ena_jo1_ab_seracnc_pre_by_ser_ifacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Jo-1 extractable nuclear Ab [Units/volume] in Serum by Immunofluorescence">
				>
				["at0.0.0.0.0.2"] = <
					text = <"">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/17032-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/17032-4">
			>
		>
	>
	adl_version = <"2.0.5">
