(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1825-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Alpha 1 antitrypsin [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Alpha 1 antitrypsin [Mass/volume] in Serum or Plasma.">
				keywords = <"A1AT", "A1A", "Alpha-1-protease inhibitor", "A1-AT", "Alpha-1-proteinase inhibitor", "A-1-AT", "AAT", "Alpha-1-trypsin inhibitor", "Alpha-1-antitrypsin.total", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "A1", "Alfa", "I", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.a1at_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"a1at_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Alpha 1 antitrypsin [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1825-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1825-9">
			>
		>
	>
	adl_version = <"2.0.5">
