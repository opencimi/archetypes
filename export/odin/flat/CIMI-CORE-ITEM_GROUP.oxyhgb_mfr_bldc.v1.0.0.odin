(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2715-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fractional oxyhemoglobin in Capillary blood' concept">
				use = <"Use for Fractional oxyhemoglobin in Capillary blood.">
				keywords = <"OxyHgb", "Oxygenated hemoglobin", "Oxygenated haemoglobin", "Haemoglobin oxygenated", "Hemoglobin oxygenated", "Oxyhaemoglobin", "HbO2", "O2Hb", "Hgb", "Hb", "Mass fraction", "Percent", "Point in time", "Random", "Cap blood", "Cap bld", "Capillary bld", "Capillary blood", "Finger stick", "Quantitative", "QNT", "Quant", "Quan", "Tot", "Totl", "Chemistry", "SO2", "Oxygen saturation", "O2 saturation", "Fractional hemoglobin", "FO2Hb">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.oxyhgb_mfr_bldc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"oxyhgb_mfr_bldc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2715-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2715-1">
			>
		>
	>
	adl_version = <"2.0.5">
