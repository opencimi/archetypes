(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19429-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Propoxyphene [Presence] in Urine by Screen method' concept">
				use = <"Use for Propoxyphene [Presence] in Urine by Screen method.">
				keywords = <"Propoxyph", "D-propoxyphene", "Cotonal-65", "Dextropropoxyphene", "Cosalgesic", "Dextrogesic", "Distalgesic", "Dolasan", "Napsalgesic", "Algaphan", "Depronal", "Doloxene", "Darvon", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Scn", "Scr", "Scrn", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.propoxyph_ur_ql_scn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"propoxyph_ur_ql_scn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Propoxyphene [Presence] in Urine by Screen method">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19429-0">
			>
			["opencem"] = <
