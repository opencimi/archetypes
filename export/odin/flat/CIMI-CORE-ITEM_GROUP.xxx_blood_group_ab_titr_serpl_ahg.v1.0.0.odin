(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/50970-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'XXX blood group Ab [Titer] in Serum or Plasma by Antihuman globulin' concept">
				use = <"Use for XXX blood group Ab [Titer] in Serum or Plasma by Antihuman globulin.">
				keywords = <"Dilution factor", "Titer", "Titre", "Ttr", "Titered", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "AHG", "Coombs", "Coomb", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.xxx_blood_group_ab_titr_serpl_ahg.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"xxx_blood_group_ab_titr_serpl_ahg">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"XXX blood group Ab [Titer] in Serum or Plasma by Antihuman globulin">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{titer}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/50970-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/50970-3">
			>
		>
	>
	adl_version = <"2.0.5">
