(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2615-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Methemoglobin/Hemoglobin.total in Arterial blood' concept">
				use = <"Use for Methemoglobin/Hemoglobin.total in Arterial blood.">
				keywords = <"MetHgb", "Methgb", "MetHb", "Hi", "Hemiglobin", "Methaemoglobin", "Hgb", "Hb", "Haemoglobin", "Mass fraction", "Percent", "Point in time", "Random", "Arterial blood", "ART", "Art blood", "Art bld", "ABG", "Quantitative", "QNT", "Quant", "Quan", "Tot", "Totl", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.methgb_mfr_blda.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"methgb_mfr_blda">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2615-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2615-3">
			>
		>
	>
	adl_version = <"2.0.5">
