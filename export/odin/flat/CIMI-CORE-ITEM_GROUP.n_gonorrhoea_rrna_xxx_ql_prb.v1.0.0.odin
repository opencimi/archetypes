(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5028-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Neisseria gonorrhoeae rRNA [Presence] in Unspecified specimen by DNA probe' concept">
				use = <"Use for Neisseria gonorrhoeae rRNA [Presence] in Unspecified specimen by DNA probe.">
				keywords = <"N gonorrhoea", "N gonorrhoeae", "Gono", "GC", "Gonorrhea", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Prb", "DNA probe", "ribosomal RNA", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.n_gonorrhoea_rrna_xxx_ql_prb.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"n_gonorrhoea_rrna_xxx_ql_prb">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Neisseria gonorrhoeae rRNA [Presence] in Unspecified specimen by DNA probe">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5028-6">
			>
			["opencem"] = <
