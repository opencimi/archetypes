(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/44607-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'HIV 1 [interpretation] in Serum by Immunoassay' concept">
				use = <"Use for HIV 1 [interpretation] in Serum by Immunoassay.">
				keywords = <"HIV1", "HIV type 1", "HIV type I", "AIDS", "Human immunodeficiency virus", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Serum", "SR", "Nominal", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hiv1_ser_eiaimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hiv1_ser_eiaimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"HIV 1 [interpretation] in Serum by Immunoassay">
				>
				["id1.1.1.1.1.1"] = <
					text = <"HIV 1 [interpretation] in Serum by Immunoassay">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/44607-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/44607-0">
			>
		>
	>
	adl_version = <"2.0.5">
