(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32046-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Pregnancy associated plasma protein A [Units/volume] in Serum or Plasma' concept">
				use = <"Use for Pregnancy associated plasma protein A [Units/volume] in Serum or Plasma.">
				keywords = <"Prot", "PR", "PAPP-A", "PAPPA", "Arbitrary concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Gestation", "Gravida", "Gestations", "Pregnancies", "Assoc", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pappa_serplacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pappa_serplacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Pregnancy associated plasma protein A [Units/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[IU]/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32046-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32046-5">
			>
		>
	>
	adl_version = <"2.0.5">
