(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/14627-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Bicarbonate [Moles/volume] in Venous blood' concept">
				use = <"Use for Bicarbonate [Moles/volume] in Venous blood.">
				keywords = <"HCO3", "BIC", "Bicarb", "bicar", "Substance concentration", "Level", "Point in time", "Random", "Blood - venous", "Bld ven", "Bld venous", "Blood venus", "Blood ven", "Venous", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hco3_bldvscnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hco3_bldvscnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/14627-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/14627-4">
			>
		>
	>
	adl_version = <"2.0.5">
