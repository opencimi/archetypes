(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/546-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Streptococcus.beta-hemolytic [Presence] in Throat by Organism specific culture' concept">
				use = <"Use for Streptococcus.beta-hemolytic [Presence] in Throat by Organism specific culture.">
				keywords = <"B-Hem Strep", "Arbitrary concentration", "Point in time", "Random", "Throat", "Upper respiratory", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Cult", "Cultures", "C&S", "Strept", "B", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bhem_strep_throat_ql_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bhem_strep_throat_ql_cult">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Streptococcus.beta-hemolytic [Presence] in Throat by Organism specific culture">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Streptococcus.beta-hemolytic [Presence] in Throat by Organism specific culture">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/546-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/546-2">
			>
		>
	>
	adl_version = <"2.0.5">
