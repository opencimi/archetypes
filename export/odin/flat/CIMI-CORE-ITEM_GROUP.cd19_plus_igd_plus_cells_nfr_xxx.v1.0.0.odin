(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49835-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'CD19+IgD+ cells/100 cells in Unspecified specimen' concept">
				use = <"Use for CD19+IgD+ cells/100 cells in Unspecified specimen.">
				keywords = <"CD19+IgD+ cells", "Immune globulin D", "Immunoglobulin D", "CD19+IgD+ cells", "CD19 Cells", "Cell", "Cellularity", "Leu-12", "B-4", "HD-37", "B4", "Leu12", "Gated cells", "Number fraction", "Percent", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Quantitative", "QNT", "Quant", "Quan", "CELL MARKERS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cd19_plus_igd_plus_cells_nfr_xxx.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cd19_plus_igd_plus_cells_nfr_xxx">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"CD19+IgD+ cells/100 cells in Unspecified specimen">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49835-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49835-2">
			>
		>
	>
	adl_version = <"2.0.5">
