(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/11050-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Immunoglobulin light chains.kappa [Mass/volume] in Serum' concept">
				use = <"Use for Immunoglobulin light chains.kappa [Mass/volume] in Serum.">
				keywords = <"Kappa LC", "BJ Protein", "BJP", "Bence Jones protein", "Mass concentration", "Level", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "Immune globulin", "Imunoglbon", "Immuno", "Imunoglobn", "Immunoglobin", "Immunoglob", "Chain", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.kappa_lc_sermcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"kappa_lc_sermcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Immunoglobulin light chains.kappa [Mass/volume] in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/11050-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/11050-2">
			>
		>
	>
	adl_version = <"2.0.5">
