(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/9624-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Vanillylmandelate [Mass/volume] in Urine' concept">
				use = <"Use for Vanillylmandelate [Mass/volume] in Urine.">
				keywords = <"VMA", "HMMA", "MHMA", "Hydroxy-methoxy-mandelate", "Hydroxy-methoxy-mandelic acid", "Catecholamine metabolite", "3-methyl,4-hydroxy mandelate", "Vanillylmandelic acid", "3-methoxy-4-hydroxymandelate", "3-methyl,4-oh mandelic acid", "Mass concentration", "Level", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.vma_urmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"vma_urmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Vanillylmandelate [Mass/volume] in Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/9624-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/9624-8">
			>
		>
	>
	adl_version = <"2.0.5">
