(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.gas_plus_co_pnl_bldv.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"gas_plus_co_pnl_bldv">
			...
			["1"] = <
				...
				children = <
					...
					["20"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.1">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.hco3_bldvscnc.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["21"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.2">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.base_deficit_bldvscnc.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["22"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.3">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.po2_temp_adj_bldv.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["23"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.4">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.base_excess_bldv_calcscnc.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["24"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.5">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.pco2_bldv.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["25"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.6">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.co2_bldvscnc.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["26"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.7">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.cohgb_mfr_bldv.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["27"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.8">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.methgb_mfr_bldv.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["28"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.9">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.po2_bldv.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["29"] = (P_C_ARCHETYPE_ROOT) <
						...
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.sao2_percent_bldv.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["30"] = (P_C_ARCHETYPE_ROOT) <
						...
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.oxyhgb_mfr_bldv.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["31"] = (P_C_ARCHETYPE_ROOT) <
						...
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.ph_bldv.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["32"] = (P_C_ARCHETYPE_ROOT) <
						...
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.hgb_bldvmcnc.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					...
					["35"] = (P_C_ARCHETYPE_ROOT) <
						...
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.ph_temp_adj_bldv.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["36"] = (P_C_ARCHETYPE_ROOT) <
						...
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.pco2_temp_adj_bldv.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.1"] = <
					text = <"Gas and Carbon monoxide panel - Venous blood">
				>
				["id0.1.1.1.1"] = <
					text = <"Bicarbonate [Moles/volume] in Venous blood">
				>
				["id0.1.1.1.10"] = <
					text = <"Oxygen saturation in Venous blood">
				>
				["id0.1.1.1.11"] = <
					text = <"Fractional oxyhemoglobin in Venous blood">
				>
				["id0.1.1.1.12"] = <
					text = <"pH of Venous blood">
				>
				["id0.1.1.1.13"] = <
					text = <"Hemoglobin [Mass/volume] in Venous blood">
				>
				["id0.1.1.1.14"] = <
				...
				>
				["id0.1.1.1.16"] = <
					text = <"pH of Venous blood adjusted to patients actual temperature">
				>
				["id0.1.1.1.17"] = <
					text = <"Carbon dioxide [Partial pressure] adjusted to patients actual temperature in Venous blood">
				>
				["id0.1.1.1.18"] = <
					text = <"Body temperature">
				>
				["id0.1.1.1.2"] = <
					text = <"Base deficit in Venous blood">
				>
				["id0.1.1.1.3"] = <
					text = <"Oxygen [Partial pressure] adjusted to patients actual temperature in Venous blood">
				>
				["id0.1.1.1.4"] = <
					text = <"Base excess in Venous blood by calculation">
				>
				["id0.1.1.1.5"] = <
					text = <"Carbon dioxide [Partial pressure] in Venous blood">
				>
				["id0.1.1.1.6"] = <
					text = <"Carbon dioxide, total [Moles/volume] in Venous blood">
				>
				["id0.1.1.1.7"] = <
					text = <"Carboxyhemoglobin/Hemoglobin.total in Venous blood">
				>
				["id0.1.1.1.8"] = <
					text = <"Methemoglobin/Hemoglobin.total in Venous blood">
				>
				["id0.1.1.1.9"] = <
					text = <"Oxygen [Partial pressure] in Venous blood">
				>
				["id1.1.1.1.1"] = <
					text = <"Gas and Carbon monoxide panel - Venous blood">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/24344-4">
				["at0.0.0.0.1"] = <"http://loinc.org/id/24344-4">
				["id0.1.1.1.1"] = <"http://loinc.org/id/14627-4">
				["id0.1.1.1.2"] = <"http://loinc.org/id/1924-0">
				["id0.1.1.1.3"] = <"http://loinc.org/id/19258-3">
				["id0.1.1.1.4"] = <"http://loinc.org/id/1927-3">
				["id0.1.1.1.5"] = <"http://loinc.org/id/2021-4">
				["id0.1.1.1.6"] = <"http://loinc.org/id/2027-1">
				["id0.1.1.1.7"] = <"http://loinc.org/id/2032-1">
				["id0.1.1.1.8"] = <"http://loinc.org/id/2617-9">
				["id0.1.1.1.9"] = <"http://loinc.org/id/2705-2">
				["id0.1.1.1.10"] = <"http://loinc.org/id/2711-0">
				["id0.1.1.1.11"] = <"http://loinc.org/id/2716-9">
				["id0.1.1.1.12"] = <"http://loinc.org/id/2746-6">
				["id0.1.1.1.13"] = <"http://loinc.org/id/30350-3">
				["id0.1.1.1.14"] = <"http://loinc.org/id/3150-0">
				["id0.1.1.1.15"] = <"http://loinc.org/id/3151-8">
				["id0.1.1.1.16"] = <"http://loinc.org/id/39486-6">
				["id0.1.1.1.17"] = <"http://loinc.org/id/40619-9">
				["id0.1.1.1.18"] = <"http://loinc.org/id/8310-5">
			>
		>
	>
	adl_version = <"2.0.5">
