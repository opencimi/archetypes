(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/18887-0.html>">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cefotetan_susc_islt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cefotetan_susc_islt">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/18887-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/18887-0">
			>
		>
	>
	adl_version = <"2.0.5">
