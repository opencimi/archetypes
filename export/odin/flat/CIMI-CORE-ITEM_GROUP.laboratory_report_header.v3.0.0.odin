(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'laboratory report header' concept">
				use = <"Use for laboratory report header.">
				keywords = <"laboratory", "report", "header">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.laboratory_report_header.v3.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"laboratory_report_header">
		release_version = <"3.0.0">
		version_status = <0>
		build_count = <0>
	>
	parent_archetype_id = <"CIMI-CORE-ITEM_GROUP.clinical_report_header.v1">
	definition = <
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["id1.1.1"] = <"http://snomed.info/id/364712009">
