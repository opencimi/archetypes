(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33910-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Rheumatoid factor [Presence] in Serum' concept">
				use = <"Use for Rheumatoid factor [Presence] in Serum.">
				keywords = <"Rheumatoid fact", "RF", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Fac", "Fact", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.rheumatoid_fact_ser_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"rheumatoid_fact_ser_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Rheumatoid factor [Presence] in Serum">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Rheumatoid factor [Presence] in Serum">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33910-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33910-1">
			>
		>
	>
	adl_version = <"2.0.5">
