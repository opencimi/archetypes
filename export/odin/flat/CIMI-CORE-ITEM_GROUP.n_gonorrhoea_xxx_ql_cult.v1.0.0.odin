(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/698-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Neisseria gonorrhoeae [Presence] in Unspecified specimen by Organism specific culture' concept">
				use = <"Use for Neisseria gonorrhoeae [Presence] in Unspecified specimen by Organism specific culture.">
				keywords = <"N gonorrhoea", "N gonorrhoeae", "Gono", "GC", "Gonorrhea", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Cult", "Cultures", "C&S", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.n_gonorrhoea_xxx_ql_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"n_gonorrhoea_xxx_ql_cult">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Neisseria gonorrhoeae [Presence] in Unspecified specimen by Organism specific culture">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Neisseria gonorrhoeae [Presence] in Unspecified specimen by Organism specific culture">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/698-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/698-1">
			>
		>
	>
	adl_version = <"2.0.5">
