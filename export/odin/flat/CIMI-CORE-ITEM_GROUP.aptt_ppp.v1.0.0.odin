(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/14979-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Activated partial thromboplastin time (aPTT) in Platelet poor plasma by Coagulation assay' concept">
				use = <"Use for Activated partial thromboplastin time (aPTT) in Platelet poor plasma by Coagulation assay.">
				keywords = <"aPTT", "PTT", "Partial Thromboplastin Time", "Activated partial thromboplastin time", "Little(A)PTT", "Point in time", "Random", "Platelet poor plasma", "Plas", "Quantitative", "QNT", "Quant", "Quan", "Coagulation assay", "Clot", "Tilt tube", "Clottable", "Surf">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.aptt_ppp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"aptt_ppp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Activated partial thromboplastin time (aPTT) in Platelet poor plasma by Coagulation assay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"s">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/14979-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/14979-9">
			>
		>
	>
	adl_version = <"2.0.5">
