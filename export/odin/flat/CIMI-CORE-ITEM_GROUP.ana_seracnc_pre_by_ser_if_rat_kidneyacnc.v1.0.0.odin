(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/44752-4.html>">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ana_seracnc_pre_by_ser_if_rat_kidneyacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ana_seracnc_pre_by_ser_if_rat_kidneyacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Nuclear Ab [Units/volume] in Serum by Immunofluorescence (IF) rat kidney">
				>
				["at0.0.0.0.0.2"] = <
					text = <"">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/44752-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/44752-4">
			>
		>
	>
	adl_version = <"2.0.5">
