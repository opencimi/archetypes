(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/18182-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Osmolality of Serum or Plasma by calculation' concept">
				use = <"Use for Osmolality of Serum or Plasma by calculation.">
				keywords = <"Osmo", "osmolarity", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Calc", "Calculation", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.osmolality_serpl_calc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"osmolality_serpl_calc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Osmolality of Serum or Plasma by calculation">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mosm/kg">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258870007">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/18182-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/18182-6">
			>
		>
	>
	adl_version = <"2.0.5">
