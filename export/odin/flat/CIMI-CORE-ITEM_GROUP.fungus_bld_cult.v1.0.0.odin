(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/601-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fungus identified in Blood by Culture' concept">
				use = <"Use for Fungus identified in Blood by Culture.">
				keywords = <"Fungal", "Fung", "Fungi", "Identity or presence", "Point in time", "Random", "Blood", "WB", "Whole blood", "Nominal", "Cult", "Cultures", "C&S", "Isolated", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fungus_bld_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fungus_bld_cult">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Fungus identified in Blood by Culture">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Fungus identified in Blood by Culture">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/601-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/601-5">
			>
		>
	>
	adl_version = <"2.0.5">
