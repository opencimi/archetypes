(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13942-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Spermatozoa Motile [Presence] in Semen by Light microscopy' concept">
				use = <"Use for Spermatozoa Motile [Presence] in Semen by Light microscopy.">
				keywords = <"Sperm Motile", "Arbitrary concentration", "Point in time", "Random", "Smn", "Ejaculate", "Seminal fluid", "SMPLS", "Sem", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Micro", "LM", "Micros", "Microscopic", "Mot", "FERTILITY TESTING", "Sperm motility grade">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.sperm_motile_smn_ql_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"sperm_motile_smn_ql_micro">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Spermatozoa Motile [Presence] in Semen by Light microscopy">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Spermatozoa Motile [Presence] in Semen by Light microscopy">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13942-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13942-8">
			>
		>
	>
	adl_version = <"2.0.5">
