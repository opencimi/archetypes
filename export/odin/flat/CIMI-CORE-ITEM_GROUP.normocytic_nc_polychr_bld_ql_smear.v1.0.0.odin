(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/7794-1.html>">
			["tool"] = <"cimi-gen v0.0.1">
			["time"] = <"2015-08-05T22:28:37">
		>
		details = <
			["en"] = <
				language = <[ISO_639-1::en]>
				purpose = <"Archetype for CIMI 'Normocytic/Normochromic polychromasia [Presence] in Blood by Light microscopy' concept">
				use = <"Use for Normocytic/Normochromic polychromasia [Presence] in Blood by Light microscopy.">
				keywords = <"Polychro", "Polychromatophilia", "Polychromic", "NC Polychr", "NC/NC Polychr", "Arbitrary concentration", "Point in time", "Random", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Micro", "LM", "Micros", "Microscopic", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.normocytic_nc_polychr_bld_ql_smear.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"normocytic_nc_polychr_bld_ql_smear">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/7794-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/7794-1">
			>
		>
	>
	adl_version = <"2.0.5">
