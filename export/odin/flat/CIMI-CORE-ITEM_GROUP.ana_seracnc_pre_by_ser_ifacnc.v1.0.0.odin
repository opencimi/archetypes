(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/9423-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Nuclear Ab [Units/volume] in Serum by Immunofluorescence' concept">
				use = <"Use for Nuclear Ab [Units/volume] in Serum by Immunofluorescence.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ana_seracnc_pre_by_ser_ifacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ana_seracnc_pre_by_ser_ifacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Nuclear Ab [Units/volume] in Serum by Immunofluorescence">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[IU]/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/9423-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/9423-5">
			>
		>
	>
	adl_version = <"2.0.5">
