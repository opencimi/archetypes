(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2341-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Glucose [Mass/volume] in Blood by Test strip manual' concept">
				use = <"Use for Glucose [Mass/volume] in Blood by Test strip manual.">
				keywords = <"Glu", "Gluc", "Glucoseur", "Mass concentration", "Level", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Manual Strip", "Dipstick", "Dip stick", "Manl", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.glucose_bldmcnc_pre_by_bld_manual_stripmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"glucose_bldmcnc_pre_by_bld_manual_stripmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Glucose [Mass/volume] in Blood by Test strip manual">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2341-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2341-6">
			>
		>
	>
	adl_version = <"2.0.5">
