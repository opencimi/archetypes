(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/17864-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Calcium.ionized [Mass/volume] in Serum or Plasma by Ion-selective membrane electrode (ISE)' concept">
				use = <"Use for Calcium.ionized [Mass/volume] in Serum or Plasma by Ion-selective membrane electrode (ISE).">
				keywords = <"Ca-I", "Calcium free", "iCa", "Calcium active", "Coagulation factor I", "Cal", "Ca", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Ion selective membrane electrode", "Ion-selective electrode", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cai_serplmcnc_pre_by_serpl_isemcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cai_serplmcnc_pre_by_serpl_isemcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Calcium.ionized [Mass/volume] in Serum or Plasma by Ion-selective membrane electrode (ISE)">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/17864-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/17864-0">
			>
		>
	>
	adl_version = <"2.0.5">
