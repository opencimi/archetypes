(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32166-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Choriogonadotropin [Multiple of the median] adjusted in Serum or Plasma' concept">
				use = <"Use for Choriogonadotropin [Multiple of the median] adjusted in Serum or Plasma.">
				keywords = <"HCG", "Chorionic gonadotropin", "CG", "Human chorionic gonadotropin", "Choriogonadotropins total", "adj", "Multiple of the median", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hcg_adj_mom_serpl.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hcg_adj_mom_serpl">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Choriogonadotropin [Multiple of the median] adjusted in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{M.o.M}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32166-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32166-1">
			>
		>
	>
	adl_version = <"2.0.5">
