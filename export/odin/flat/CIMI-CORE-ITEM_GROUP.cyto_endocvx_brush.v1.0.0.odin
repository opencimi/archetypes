(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49050-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Microscopic observation [Identifier] in Endocervical brush by Cyto stain' concept">
				use = <"Use for Microscopic observation [Identifier] in Endocervical brush by Cyto stain.">
				keywords = <"Micro", "Identity or presence", "Point in time", "Random", "Endocvx brush", "Nominal", "Pap Smear", "Pap Stain", "Cytostain", "Cytology stain", "Papanicolaou smear">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cyto_endocvx_brush.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cyto_endocvx_brush">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Microscopic observation [Identifier] in Endocervical brush by Cyto stain">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Microscopic observation [Identifier] in Endocervical brush by Cyto stain">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49050-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49050-8">
			>
		>
	>
	adl_version = <"2.0.5">
