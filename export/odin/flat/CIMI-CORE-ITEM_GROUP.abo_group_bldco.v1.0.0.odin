(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/51892-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'ABO group [Type] in Cord blood' concept">
				use = <"Use for ABO group [Type] in Cord blood.">
				keywords = <"Typ", "Point in time", "Random", "Cord (umbilical) blood", "Cord bld", "Cord blood", "Nominal", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.abo_group_bldco.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"abo_group_bldco">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"ABO group [Type] in Cord blood">
				>
				["id1.1.1.1.1.1"] = <
					text = <"ABO group [Type] in Cord blood">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/51892-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/51892-8">
			>
		>
	>
	adl_version = <"2.0.5">
