(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/48050-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Neutrophils [Presence] in Stool by Wright stain' concept">
				use = <"Use for Neutrophils [Presence] in Stool by Wright stain.">
				keywords = <"PNM", "Neutrophil", "Neutr", "PMN", "Neut", "Arbitrary concentration", "Point in time", "Random", "Stl", "Feces", "Faeces", "Bowel movement", "Fecal", "Faecal", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Wright Stn", "Wrights", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.neutrophils_stl_ql_pre_by_wright_stn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"neutrophils_stl_ql_pre_by_wright_stn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Neutrophils [Presence] in Stool by Wright stain">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Neutrophils [Presence] in Stool by Wright stain">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/48050-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/48050-9">
			>
		>
	>
	adl_version = <"2.0.5">
