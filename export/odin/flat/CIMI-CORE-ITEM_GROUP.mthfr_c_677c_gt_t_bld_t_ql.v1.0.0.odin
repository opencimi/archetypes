(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/28005-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'MTHFR gene c.677C>T [Presence] in Blood or Tissue by Molecular genetics method' concept">
				use = <"Use for MTHFR gene c.677C>T [Presence] in Blood or Tissue by Molecular genetics method.">
				keywords = <"MTHFR c.677C>T", "Vascular risk", "NADPH", "5,10-methylenetetrahydrofolate reductase gene", "Arbitrary", "Point in time", "Random", "Bld/T", "Tissue", "Bld/T", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "PCR", "Molecular genetics", "T prime", "MOLPATH.MUTATIONS", "MOLPATH.MUTATIONS", "Molecular pathology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.mthfr_c_677c_gt_t_bld_t_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"mthfr_c_677c_gt_t_bld_t_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"MTHFR gene c.677C>T [Presence] in Blood or Tissue by Molecular genetics method">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/28005-7">
			>
			["opencem"] = <
