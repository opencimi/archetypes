(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19153-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Volume of unspecified time Urine' concept">
				use = <"Use for Volume of unspecified time Urine.">
				keywords = <"Specimen vol", "?Tm", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.specimen_vol__tm_ur.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"specimen_vol__tm_ur">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Volume of unspecified time Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19153-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19153-6">
			>
		>
	>
	adl_version = <"2.0.5">
