(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6002-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Platelet factor 4 [Units/volume] in Platelet poor plasma' concept">
				use = <"Use for Platelet factor 4 [Units/volume] in Platelet poor plasma.">
				keywords = <"PF4", "PI-factor 4", "Platelet type heparin inactivator", "PF", "Plt", "Pl", "Platelets", "Thrombocytes", "Platelt", "Thrombocyte", "Arbitrary concentration", "Point in time", "Random", "Platelet poor plasma", "Plas", "Quantitative", "QNT", "Quant", "Quan", "Fac", "Fact", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pf4_pppacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pf4_pppacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Platelet factor 4 [Units/volume] in Platelet poor plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{OD_unit}">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258743006">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6002-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6002-0">
			>
		>
	>
	adl_version = <"2.0.5">
