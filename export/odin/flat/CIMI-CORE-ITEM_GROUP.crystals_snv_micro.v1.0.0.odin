(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5781-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Crystals [type] in Synovial fluid by Light microscopy' concept">
				use = <"Use for Crystals [type] in Synovial fluid by Light microscopy.">
				keywords = <"Cryst", "Crys", "Crystal", "Identity or presence", "Point in time", "Random", "Snv", "Joint fluid", "Joint aspirate", "Synovial fluid", "Syn fl", "Joint fld", "Joint flu", "Synov", "SNV", "SF", "Nominal", "Micro", "LM", "Micros", "Microscopic", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.crystals_snv_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"crystals_snv_micro">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"FluidAndTissueCrystalID_VALUESET_CODE">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Crystals [type] in Synovial fluid by Light microscopy">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5781-0">
			>
			["opencem"] = <
				["at0.0.0.0.0.1"] = <"http://opencem.org/id/FluidAndTissueCrystalID_VALUESET_CODE">
			>
		>
	>
	adl_version = <"2.0.5">
