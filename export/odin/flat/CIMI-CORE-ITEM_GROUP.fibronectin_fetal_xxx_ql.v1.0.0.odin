(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/48039-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fibronectin.fetal [Presence] in Unspecified specimen' concept">
				use = <"Use for Fibronectin.fetal [Presence] in Unspecified specimen.">
				keywords = <"fFN", "Fn", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fibronectin_fetal_xxx_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fibronectin_fetal_xxx_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Fibronectin.fetal [Presence] in Unspecified specimen">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Fibronectin.fetal [Presence] in Unspecified specimen">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/48039-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/48039-2">
			>
		>
	>
	adl_version = <"2.0.5">
