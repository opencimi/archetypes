(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/40527-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cocaine [Presence] in Meconium' concept">
				use = <"Use for Cocaine [Presence] in Meconium.">
				keywords = <"Coke", "Crack", "Snow", "Benzoylmethylecgonine", "Ecgonine methyl ester benzoate", "Point in time", "Random", "Mec", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cocaine_mec_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cocaine_mec_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cocaine [Presence] in Meconium">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Cocaine [Presence] in Meconium">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/40527-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/40527-4">
			>
		>
	>
	adl_version = <"2.0.5">
