(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/47283-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Platelet mean volume [Entitic volume] in Cord blood' concept">
				use = <"Use for Platelet mean volume [Entitic volume] in Cord blood.">
				keywords = <"Vol", "PMV", "MPV", "Plt", "Pl", "Platelets", "Thrombocytes", "Platelt", "Thrombocyte", "Entitic volume", "Point in time", "Random", "Cord (umbilical) blood", "Cord bld", "Cord blood", "Quantitative", "QNT", "Quant", "Quan", "Average", "Avg", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pmv_bldco.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pmv_bldco">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/47283-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/47283-7">
			>
		>
	>
	adl_version = <"2.0.5">
