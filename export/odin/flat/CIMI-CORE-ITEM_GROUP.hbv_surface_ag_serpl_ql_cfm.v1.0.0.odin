(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/65633-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hepatitis B virus surface Ag [Presence] in Serum or Plasma by Confirmatory method' concept">
				use = <"Use for Hepatitis B virus surface Ag [Presence] in Serum or Plasma by Confirmatory method.">
				keywords = <"Australia antigen", "HBsAG", "HBV surface", "Hep Bs", "HBs", "HepB", "Hep B", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Cfm", "CNFR", "CNFRM", "Conf", "Confirmation", "GCMS", "Confirmatory", "Antigen", "Antigens", "Surf", "Hepatit", "Hepatis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hbv_surface_ag_serpl_ql_cfm.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hbv_surface_ag_serpl_ql_cfm">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hepatitis B virus surface Ag [Presence] in Serum or Plasma by Confirmatory method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Hepatitis B virus surface Ag [Presence] in Serum or Plasma by Confirmatory method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/65633-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/65633-0">
			>
		>
	>
	adl_version = <"2.0.5">
