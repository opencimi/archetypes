(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/732-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Lymphocytes [#/volume] in Blood by Manual count' concept">
				use = <"Use for Lymphocytes [#/volume] in Blood by Manual count.">
				keywords = <"Lymphs", "Lymph", "Lymphocyte", "Lympho", "Lymphs%", "Lymp", "#", "Number concentration", "Count/volume", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Manl", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.lymphocytes_num_bld_pre_by_manual.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"lymphocytes_num_bld_pre_by_manual">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Lymphocytes [#/volume] in Blood by Manual count">
				>
				["at0.0.0.0.0.2"] = <
					text = <"10*3/uL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/732-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/732-8">
			>
		>
	>
	adl_version = <"2.0.5">
