(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20474-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Bacteria identified in Tissue by Biopsy culture' concept">
				use = <"Use for Bacteria identified in Tissue by Biopsy culture.">
				keywords = <"Bact", "Identity or presence", "Point in time", "Random", "Tissue", "Nominal", "Bx Cult", "Cultures", "C&S", "Isolated", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bacteria_tiss_bx_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bacteria_tiss_bx_cult">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Bacteria identified in Tissue by Biopsy culture">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Bacteria identified in Tissue by Biopsy culture">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20474-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20474-3">
			>
		>
	>
	adl_version = <"2.0.5">
