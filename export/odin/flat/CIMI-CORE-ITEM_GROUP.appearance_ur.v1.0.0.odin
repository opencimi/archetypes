(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5767-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Appearance of Urine' concept">
				use = <"Use for Appearance of Urine.">
				keywords = <"Appr", "Appear", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Nominal">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.appearance_ur.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"appearance_ur">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"UrineAppearance_VALUESET_CODE">
				>
				["id1.1.1.1.1.1"] = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5767-9">
			>
			["opencem"] = <
				["at0.0.0.0.0.1"] = <"http://opencem.org/id/UrineAppearance_VALUESET_CODE">
			>
		>
	>
	adl_version = <"2.0.5">
