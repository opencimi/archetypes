(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/931-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Blood product source [Type]' concept">
				use = <"Use for Blood product source [Type].">
				keywords = <"Bld Prod Source", "Typ", "Point in time", "Random", "Blood product unit", "Nominal", "Srce", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bld_prod_source_bpu.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bld_prod_source_bpu">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Blood product source [Type]">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Blood product source [Type]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/931-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/931-6">
			>
		>
	>
	adl_version = <"2.0.5">
