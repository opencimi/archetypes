(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20446-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Herpes simplex virus IgG Ab [interpretation] in Serum by Immunoassay' concept">
				use = <"Use for Herpes simplex virus IgG Ab [interpretation] in Serum by Immunoassay.">
				keywords = <"Immune globulin G", "Immunoglobulin G", "Herp splx", "HSV", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Serum", "SR", "Nominal", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hsv_igg_ser_eiaimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hsv_igg_ser_eiaimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Herpes simplex virus IgG Ab [interpretation] in Serum by Immunoassay">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Herpes simplex virus IgG Ab [interpretation] in Serum by Immunoassay">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20446-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20446-1">
			>
		>
	>
	adl_version = <"2.0.5">
