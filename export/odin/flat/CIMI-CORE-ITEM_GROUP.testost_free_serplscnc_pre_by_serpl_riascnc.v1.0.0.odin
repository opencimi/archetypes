(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/25987-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Testosterone Free [Moles/volume] in Serum or Plasma by Radioimmunoassay (RIA)' concept">
				use = <"Use for Testosterone Free [Moles/volume] in Serum or Plasma by Radioimmunoassay (RIA).">
				keywords = <"Testost Free", "Testosterone.unconjugated", "Testo", "Testos", "Substance concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Radioimmunoassay", "FR", "Non-protein bound", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.testost_free_serplscnc_pre_by_serpl_riascnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"testost_free_serplscnc_pre_by_serpl_riascnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Testosterone Free [Moles/volume] in Serum or Plasma by Radioimmunoassay (RIA)">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mmol/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/25987-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/25987-9">
			>
		>
	>
	adl_version = <"2.0.5">
