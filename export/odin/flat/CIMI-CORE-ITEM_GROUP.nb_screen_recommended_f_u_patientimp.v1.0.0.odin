(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49544-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Newborn screening recommended follow-up [interpretation]' concept">
				use = <"Use for Newborn screening recommended follow-up [interpretation].">
				keywords = <"Recom F/U", "Pap Smear", "Papinacolou Smear", "Pap Stain", "NB screen recommended f/u", "NBS", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Nominal", "SCN", "Asymptomatic", "Asympt", "New born", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.nb_screen_recommended_f_u_patientimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"nb_screen_recommended_f_u_patientimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Newborn screening recommended follow-up [interpretation]">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Newborn screening recommended follow-up [interpretation]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49544-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49544-0">
			>
		>
	>
	adl_version = <"2.0.5">
