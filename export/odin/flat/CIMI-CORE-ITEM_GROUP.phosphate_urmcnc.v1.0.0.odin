(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2778-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Phosphate [Mass/volume] in Urine' concept">
				use = <"Use for Phosphate [Mass/volume] in Urine.">
				keywords = <"Phos", "Phosphrous", "Phosphorous", "Pi", "i Phos", "PO4", "Phosphorus", "Inorganic phosphate", "Phosphate total", "Mass concentration", "Level", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.phosphate_urmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"phosphate_urmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Phosphate [Mass/volume] in Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2778-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2778-9">
			>
		>
	>
	adl_version = <"2.0.5">
