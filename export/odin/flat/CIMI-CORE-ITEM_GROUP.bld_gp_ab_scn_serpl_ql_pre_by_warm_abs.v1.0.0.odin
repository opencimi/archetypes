(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/904-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Blood group antibody screen [Presence] in Serum or Plasma by Warm absorption' concept">
				use = <"Use for Blood group antibody screen [Presence] in Serum or Plasma by Warm absorption.">
				keywords = <"Bld gp Ab Scn", "Ab Scr", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Warm Abs", "Scrn", "Absorp", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bld_gp_ab_scn_serpl_ql_pre_by_warm_abs.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bld_gp_ab_scn_serpl_ql_pre_by_warm_abs">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Blood group antibody screen [Presence] in Serum or Plasma by Warm absorption">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Blood group antibody screen [Presence] in Serum or Plasma by Warm absorption">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/904-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/904-3">
			>
		>
	>
	adl_version = <"2.0.5">
