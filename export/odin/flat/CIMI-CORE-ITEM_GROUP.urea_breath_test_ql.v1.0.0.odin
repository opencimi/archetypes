(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/29891-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Helicobacter pylori [Presence] in Stomach by urea breath test' concept">
				use = <"Use for Helicobacter pylori [Presence] in Stomach by urea breath test.">
				keywords = <"CO2", "Carbonic anhydride", "p urea", "carbamide", "p dose", "Arbitrary concentration", "Point in time", "Random", "ExG", "Breath", "Exhaled gas", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Gases", "PST", "After", "Microbiology", "Urea breath test", "Helicobacter pylori breath test", "UBT">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.urea_breath_test_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"urea_breath_test_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Helicobacter pylori [Presence] in Stomach by urea breath test">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/29891-9">
			>
			["opencem"] = <
