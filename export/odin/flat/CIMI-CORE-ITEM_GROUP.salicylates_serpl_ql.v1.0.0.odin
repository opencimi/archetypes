(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/4023-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Salicylates [Presence] in Serum or Plasma' concept">
				use = <"Use for Salicylates [Presence] in Serum or Plasma.">
				keywords = <"Salicilates", "Sali", "2-Hydroxybenzoic Acid", "o-Hydroxybenzoic Acid", "ortho-Hydroxybenzoic Acid", "ortho-Hydroxybenzoate", "2-Hydroxybenzoate", "o-Hydroxybenzoate", "Salicylic acid", "Salicylate", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.salicylates_serpl_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"salicylates_serpl_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Salicylates [Presence] in Serum or Plasma">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Salicylates [Presence] in Serum or Plasma">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/4023-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/4023-8">
			>
		>
	>
	adl_version = <"2.0.5">
