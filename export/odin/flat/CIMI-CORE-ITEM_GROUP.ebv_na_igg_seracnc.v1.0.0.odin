(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/31374-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Epstein Barr virus nuclear IgG Ab [Units/volume] in Serum' concept">
				use = <"Use for Epstein Barr virus nuclear IgG Ab [Units/volume] in Serum.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ebv_na_igg_seracnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ebv_na_igg_seracnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Epstein Barr virus nuclear IgG Ab [Units/volume] in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{Index_val}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/31374-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/31374-2">
			>
		>
	>
	adl_version = <"2.0.5">
