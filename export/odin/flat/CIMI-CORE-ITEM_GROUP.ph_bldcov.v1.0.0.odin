(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/28647-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'pH of Venous cord blood' concept">
				use = <"Use for pH of Venous cord blood.">
				keywords = <"Log molar concentration", "Point in time", "Random", "Bld cord", "Cord venous blood", "Cord BldV", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ph_bldcov.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ph_bldcov">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/28647-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/28647-6">
			>
		>
	>
	adl_version = <"2.0.5">
