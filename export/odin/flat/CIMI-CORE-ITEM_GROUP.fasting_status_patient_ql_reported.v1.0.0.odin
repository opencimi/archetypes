(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49541-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fasting status - Reported' concept">
				use = <"Use for Fasting status - Reported.">
				keywords = <"Arbitrary concentration", "Point in time", "Random", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fasting_status_patient_ql_reported.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fasting_status_patient_ql_reported">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"YesNo_VALUESET_CODE">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Fasting status - Reported">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49541-6">
			>
			["opencem"] = <
				["at0.0.0.0.0.1"] = <"http://opencem.org/id/YesNo_VALUESET_CODE">
			>
		>
	>
	adl_version = <"2.0.5">
