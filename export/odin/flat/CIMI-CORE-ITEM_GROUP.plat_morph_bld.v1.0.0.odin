(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/11125-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Platelet morphology finding [Identifier] in Blood' concept">
				use = <"Use for Platelet morphology finding [Identifier] in Blood.">
				keywords = <"Plat morph", "Plt", "Pl", "Platelets", "Thrombocytes", "Platelt", "Thrombocyte", "Identity or presence", "Point in time", "Random", "Blood", "WB", "Whole blood", "Nominal", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.plat_morph_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"plat_morph_bld">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/11125-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/11125-2">
			>
		>
	>
	adl_version = <"2.0.5">
