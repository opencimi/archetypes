(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/24114-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Epstein Barr virus capsid IgG Ab [Presence] in Serum by Immunoassay' concept">
				use = <"Use for Epstein Barr virus capsid IgG Ab [Presence] in Serum by Immunoassay.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ebv_vca_igg_ser_ql_eia.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ebv_vca_igg_ser_ql_eia">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Epstein Barr virus capsid IgG Ab [Presence] in Serum by Immunoassay">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/24114-1">
			>
			["opencem"] = <
