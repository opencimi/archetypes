(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/57021-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'CBC W Auto Differential panel - Blood' concept">
				use = <"Use for CBC W Auto Differential panel - Blood.">
				keywords = <"Diff Pnl", "CBC W Auto Diff", "Auto Diff Pnl", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Pan", "Panl", "Differl", "Differn", "Hemogram", "Complete Blood Count", "PANEL.HEMATOLOGY& CELL COUNTS", "PANEL.HEMATOLOGY& CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cbc_w_auto_diff_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cbc_w_auto_diff_bld">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/57021-8">
				["at0.0.0.0.1"] = <"http://loinc.org/id/57021-8">
				["id0.1.2.1.1"] = <"http://loinc.org/id/57023-4">
