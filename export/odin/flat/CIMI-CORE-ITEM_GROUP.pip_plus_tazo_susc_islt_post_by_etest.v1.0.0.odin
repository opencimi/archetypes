(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Piperacillin+Tazobactam [Susceptibility]' concept">
				use = <"Use for Piperacillin+Tazobactam [Susceptibility].">
				keywords = <"Pip+Tazo", "Zosyn", "Tazocin", "Tazocilline", "Piper", "Pipracil", "PIPJ", "Susceptibility", "Susceptibilty", "Sus", "Suscept", "Susceptibilities", "AST", "Point in time", "Random", "Islt", "Isol", "Tazobac", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pip_plus_tazo_susc_islt_post_by_etest.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pip_plus_tazo_susc_islt_post_by_etest">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Piperacillin+Tazobactam [Susceptibility]">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Piperacillin+Tazobactam [Susceptibility]">
				>
