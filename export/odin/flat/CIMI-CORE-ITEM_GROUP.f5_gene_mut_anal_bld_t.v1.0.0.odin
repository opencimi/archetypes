(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/21667-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'F5 gene mutations found [Identifier] in Blood or Tissue by Molecular genetics method Nominal' concept">
				use = <"Use for F5 gene mutations found [Identifier] in Blood or Tissue by Molecular genetics method Nominal.">
				keywords = <"Coagulation Factor V - Leiden gene", "APC", "Thrombophilia", "Labile factor", "Proaccelerin gene", "FVL", "Activated protein C cofactor", "Identity or presence", "Point in time", "Random", "Bld/T", "Tissue", "Bld/T", "Blood", "WB", "Whole blood", "Nominal", "PCR", "Molecular genetics", "Mut Anal", "Mutations", "MOLPATH.MUTATIONS", "MOLPATH.MUTATIONS", "Molecular pathology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.f5_gene_mut_anal_bld_t.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"f5_gene_mut_anal_bld_t">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"LabValue_VALUESET_CODE">
				>
				["id1.1.1.1.1.1"] = <
					text = <"F5 gene mutations found [Identifier] in Blood or Tissue by Molecular genetics method Nominal">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/21667-1">
			>
			["opencem"] = <
				["at0.0.0.0.0.1"] = <"http://opencem.org/id/LabValue_VALUESET_CODE">
			>
		>
	>
	adl_version = <"2.0.5">
