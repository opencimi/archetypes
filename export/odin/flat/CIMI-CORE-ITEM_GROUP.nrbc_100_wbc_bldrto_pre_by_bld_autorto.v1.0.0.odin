(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/58413-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Nucleated erythrocytes/100 leukocytes [Ratio] in Blood by Automated count' concept">
				use = <"Use for Nucleated erythrocytes/100 leukocytes [Ratio] in Blood by Automated count.">
				keywords = <"nRBC", "nRBCs", "Normoblasts", "Erythroblasts", "WBC", "White blood cell", "Leuc", "Leuk", "Leukocyte", "Lkcs", "White blood cells", "WBCs", "RBC", "Red blood corpusles", "Red blood corpuscle", "Erthrocyte", "Erythrocyte", "Red blood cell", "Red cell", "Red cells", "Discocytes", "Red blood cells", "RBCS", "100WBC", "nRBC/WBC", "Rto", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Auto", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.nrbc_100_wbc_bldrto_pre_by_bld_autorto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"nrbc_100_wbc_bldrto_pre_by_bld_autorto">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Nucleated erythrocytes/100 leukocytes [Ratio] in Blood by Automated count">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/58413-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/58413-6">
			>
		>
	>
	adl_version = <"2.0.5">
