(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/26051-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Epithelial cells.extrarenal [#/area] in Urine sediment by Microscopy high power field' concept">
				use = <"Use for Epithelial cells.extrarenal [#/area] in Urine sediment by Microscopy high power field.">
				keywords = <"Extraren Epi Cells", "Cell", "Cellularity", "#/area", "Number areic", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Micro", "LM", "Micros", "Microscopic", "Epith", "Epithelia", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.extraren_epi_cells_num_per_area_urns_hpf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"extraren_epi_cells_num_per_area_urns_hpf">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/26051-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/26051-3">
			>
		>
	>
	adl_version = <"2.0.5">
