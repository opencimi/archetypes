(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/28640-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Bicarbonate [Moles/volume] in Arterial cord blood' concept">
				use = <"Use for Bicarbonate [Moles/volume] in Arterial cord blood.">
				keywords = <"HCO3", "BIC", "Bicarb", "bicar", "Substance concentration", "Level", "Point in time", "Random", "Bld cord", "Cord arterial blood", "Cord BldA", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hco3_bldcoascnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hco3_bldcoascnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Bicarbonate [Moles/volume] in Arterial cord blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mmol/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/28640-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/28640-1">
			>
		>
	>
	adl_version = <"2.0.5">
