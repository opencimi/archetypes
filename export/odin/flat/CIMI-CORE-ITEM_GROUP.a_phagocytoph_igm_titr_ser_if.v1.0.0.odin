(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/23878-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Anaplasma phagocytophilum IgM Ab [Titer] in Serum by Immunofluorescence' concept">
				use = <"Use for Anaplasma phagocytophilum IgM Ab [Titer] in Serum by Immunofluorescence.">
				keywords = <"Immune globulin M", "Immunoglobulin M", "E equi", "E phagocytophila", "HGE", "Ehrlichia equi", "Ehrlichia phagocytophila", "Human granulocytic ehrlichiosis", "A phagocytoph", "Dilution factor", "Titer", "Titre", "Ttr", "Titered", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "ACIF", "FA", "Fluorescent antibody", "Immune fluorescence", "Fluoresent", "Immunoflour", "Immunofluor", "Immunofluorescence", "IFA", "Time Resolved Fluorescence", "Anticomplement Immunofluorescence", "TRF", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.a_phagocytoph_igm_titr_ser_if.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"a_phagocytoph_igm_titr_ser_if">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Anaplasma phagocytophilum IgM Ab [Titer] in Serum by Immunofluorescence">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{titer}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/23878-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/23878-2">
			>
		>
	>
	adl_version = <"2.0.5">
