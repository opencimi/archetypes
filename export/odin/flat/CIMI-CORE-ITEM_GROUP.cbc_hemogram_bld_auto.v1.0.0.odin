(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cbc_hemogram_bld_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cbc_hemogram_bld_auto">
			...
			["1"] = <
				...
				children = <
					...
					["20"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.1">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.rdw_rbc_auto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["21"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.2">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.pdw_bld_auto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["22"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.3">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.pmv_bld_pre_by_auto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["23"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.4">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.hct_vfr_bld_pre_by_auto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["24"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.5">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.wbc_num_bld_pre_by_auto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					...
					["26"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.7">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.platelet_num_bld_pre_by_auto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["27"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.8">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.mch_rbc_qn_pre_by_auto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["28"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.9">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.mchc_rbcmcnc_pre_by_rbc_automcnc.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["29"] = (P_C_ARCHETYPE_ROOT) <
						...
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.mcv_rbc_pre_by_auto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["30"] = (P_C_ARCHETYPE_ROOT) <
						...
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.rdw_rbcrto_pre_by_rbc_autorto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["31"] = (P_C_ARCHETYPE_ROOT) <
						...
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.rbc_num_bld_pre_by_auto.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
				>
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id0.1.1.1.10"] = <
					text = <"Erythrocyte mean corpuscular volume [Entitic volume] by Automated count">
				>
				["id0.1.1.1.11"] = <
				...
				>
				["id0.1.1.1.8"] = <
					text = <"Erythrocyte mean corpuscular hemoglobin [Entitic mass] by Automated count">
				>
				["id0.1.1.1.9"] = <
					text = <"Erythrocyte mean corpuscular hemoglobin concentration [Mass/volume] by Automated count">
				>
				["id1.1.1.1.1"] = <
					text = <"Complete blood count (hemogram) panel - Blood by Automated count">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/58410-2">
				["at0.0.0.0.1"] = <"http://loinc.org/id/58410-2">
				["id0.1.1.1.1"] = <"http://loinc.org/id/21000-5">
				["id0.1.1.1.2"] = <"http://loinc.org/id/32207-3">
				["id0.1.1.1.3"] = <"http://loinc.org/id/32623-1">
				["id0.1.1.1.4"] = <"http://loinc.org/id/4544-3">
				["id0.1.1.1.5"] = <"http://loinc.org/id/6690-2">
				["id0.1.1.1.6"] = <"http://loinc.org/id/718-7">
				["id0.1.1.1.7"] = <"http://loinc.org/id/777-3">
				["id0.1.1.1.8"] = <"http://loinc.org/id/785-6">
				["id0.1.1.1.9"] = <"http://loinc.org/id/786-4">
				["id0.1.1.1.10"] = <"http://loinc.org/id/787-2">
				["id0.1.1.1.11"] = <"http://loinc.org/id/788-0">
				["id0.1.1.1.12"] = <"http://loinc.org/id/789-8">
			>
		>
	>
	adl_version = <"2.0.5">
