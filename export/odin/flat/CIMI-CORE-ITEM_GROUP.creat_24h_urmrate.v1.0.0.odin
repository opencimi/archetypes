(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2162-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Creatinine [Mass/time] in 24 hour Urine' concept">
				use = <"Use for Creatinine [Mass/time] in 24 hour Urine.">
				keywords = <"Creat", "Crea", "CR", "mRate", "Mass rate", "1 day", "24 hours", "24HR", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Chemistry", "UCr">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.creat_24h_urmrate.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"creat_24h_urmrate">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2162-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2162-6">
			>
		>
	>
	adl_version = <"2.0.5">
