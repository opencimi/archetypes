(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/35024-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Monocytes+Macrophages [#/volume] in Synovial fluid' concept">
				use = <"Use for Monocytes+Macrophages [#/volume] in Synovial fluid.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.monos_plus_macros_num_snv.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"monos_plus_macros_num_snv">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/35024-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/35024-9">
			>
		>
	>
	adl_version = <"2.0.5">
