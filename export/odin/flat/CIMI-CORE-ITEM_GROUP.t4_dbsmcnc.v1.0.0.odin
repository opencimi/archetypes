(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/31144-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Thyroxine (T4) [Mass/volume] in Dried blood spot' concept">
				use = <"Use for Thyroxine (T4) [Mass/volume] in Dried blood spot.">
				keywords = <"T4", "T-4", "Thyrox", "Thyrx", "TT4", "Total T4", "thyroid hormone", "Thyroxin", "Levothyroxine", "Levo-thyroxine", "L-thyroxine", "Mass concentration", "Level", "Point in time", "Random", "DBS", "Filter paper", "FP", "Dried blood spot", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.t4_dbsmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"t4_dbsmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Thyroxine (T4) [Mass/volume] in Dried blood spot">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/31144-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/31144-9">
			>
		>
	>
	adl_version = <"2.0.5">
