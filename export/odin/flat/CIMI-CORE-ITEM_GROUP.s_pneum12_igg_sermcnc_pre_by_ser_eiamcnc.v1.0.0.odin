(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/40903-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Streptococcus pneumoniae 12 IgG Ab [Mass/volume] in Serum by Immunoassay' concept">
				use = <"Use for Streptococcus pneumoniae 12 IgG Ab [Mass/volume] in Serum by Immunoassay.">
				keywords = <"Streptococcus pneumoniae 12f", "S pneum12", "S pneumo", "S pneumoniae", "Pneumococcal", "Pneumococ", "Spn", "Pneumococcal pneumonia", "Pneumococcus", "Immune globulin G", "Immunoglobulin G", "Mass concentration", "Level", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Strep", "Strept", "Pneumon", "pneum", "Pneumo", "Pneumonia", "Pneu", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.s_pneum12_igg_sermcnc_pre_by_ser_eiamcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"s_pneum12_igg_sermcnc_pre_by_ser_eiamcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Streptococcus pneumoniae 12 IgG Ab [Mass/volume] in Serum by Immunoassay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/mL">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258801007">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/40903-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/40903-7">
			>
		>
	>
	adl_version = <"2.0.5">
