(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/10362-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Endomysium IgA Ab [Presence] in Serum' concept">
				use = <"Use for Endomysium IgA Ab [Presence] in Serum.">
				keywords = <"Immune globulin A", "Immunoglobulin A", "Endomysial", "Transglutaminase", "EMA", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.endomysium_iga_ser_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"endomysium_iga_ser_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Endomysium IgA Ab [Presence] in Serum">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Endomysium IgA Ab [Presence] in Serum">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/10362-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/10362-2">
			>
		>
	>
	adl_version = <"2.0.5">
