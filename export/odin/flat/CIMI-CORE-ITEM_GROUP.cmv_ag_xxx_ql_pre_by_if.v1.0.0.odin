(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6381-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cytomegalovirus Ag [Presence] in Unspecified specimen by Immunofluorescence' concept">
				use = <"Use for Cytomegalovirus Ag [Presence] in Unspecified specimen by Immunofluorescence.">
				keywords = <"CMV", "Cytomgal", "Cytomegalo virus", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ACIF", "FA", "Fluorescent antibody", "Immune fluorescence", "Fluoresent", "Immunoflour", "Immunofluor", "Immunofluorescence", "IFA", "Time Resolved Fluorescence", "Anticomplement Immunofluorescence", "TRF", "Antigen", "Antigens", "Microbiology", "DFA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cmv_ag_xxx_ql_pre_by_if.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cmv_ag_xxx_ql_pre_by_if">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cytomegalovirus Ag [Presence] in Unspecified specimen by Immunofluorescence">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Cytomegalovirus Ag [Presence] in Unspecified specimen by Immunofluorescence">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6381-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6381-8">
			>
		>
	>
	adl_version = <"2.0.5">
