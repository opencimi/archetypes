(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/14959-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Microalbumin/Creatinine [Mass Ratio] in Urine' concept">
				use = <"Use for Microalbumin/Creatinine [Mass Ratio] in Urine.">
				keywords = <"Protein.albumin", "Alb", "Creat", "Crea", "CR", "Mass concentration ratio", "Mass ratio", "MCRto", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "DL=20 mg/L", "DL=20 mg/L", "Chemistry", "MA", "Malb", "Micro albumin", "Microalbumin", "UCr">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.microalbumin_creat_ur.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"microalbumin_creat_ur">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/14959-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/14959-1">
			>
		>
	>
	adl_version = <"2.0.5">
