(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1744-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Alanine aminotransferase [Enzymatic activity/volume] in Serum or Plasma by Without P-5'-P' concept">
				use = <"Use for Alanine aminotransferase [Enzymatic activity/volume] in Serum or Plasma by Without P-5'-P.">
				keywords = <"ALT", "ALAT", "Glutamic-pyruvic transferase", "SGPT", "Alanine transaminase", "Ala", "L-alanine", "Alpha alanine", "Catalytic Concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "w/o P-5'-P", "w/o P-5'-P", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.alt_serplccnc_pre_by_serpl_w_o_p5_pccnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"alt_serplccnc_pre_by_serpl_w_o_p5_pccnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Alanine aminotransferase [Enzymatic activity/volume] in Serum or Plasma by Without P-5'-P">
				>
				["at0.0.0.0.0.2"] = <
					text = <"U/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1744-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1744-2">
			>
		>
	>
	adl_version = <"2.0.5">
