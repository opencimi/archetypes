(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/24356-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Urinalysis complete panel - Urine' concept">
				use = <"Use for Urinalysis complete panel - Urine.">
				keywords = <"Urinalysis complete pnl", "Point in time", "Random", "UR", "Urn", "Pnl", "Pan", "Panl", "PANEL.URINALYSIS", "PANEL.URINALYSIS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.urinalysis_complete_pnl_ur.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"urinalysis_complete_pnl_ur">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/24356-8">
				["at0.0.0.0.1"] = <"http://loinc.org/id/24356-8">
				["id0.1.2.1.1"] = <"http://loinc.org/id/24357-6">
				["id0.1.2.1.2"] = <"http://loinc.org/id/24365-9">
			>
		>
	>
	adl_version = <"2.0.5">
