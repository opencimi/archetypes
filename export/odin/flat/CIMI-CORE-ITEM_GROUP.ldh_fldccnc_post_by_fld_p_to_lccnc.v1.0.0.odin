(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ldh_fldccnc_post_by_fld_p_to_lccnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ldh_fldccnc_post_by_fld_p_to_lccnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.3"] = <
					text = <"Pyruvate to lactate reaction">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Lactate dehydrogenase [Enzymatic activity/volume] in Body fluid">
				>
