(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/44447-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Beta 2 glycoprotein 1 IgA Ab [Units/volume] in Serum or Plasma by Immunoassay' concept">
				use = <"Use for Beta 2 glycoprotein 1 IgA Ab [Units/volume] in Serum or Plasma by Immunoassay.">
				keywords = <"Immune globulin A", "Immunoglobulin A", "B2GPI", "Apolipoprotein H", "APOH", "B2 glycoprotein 1", "B2-GPI", "B2 Glycoprot1", "Arbitrary concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Glycoprot", "Glycoproteins", "gG", "GP", "B", "II", "I", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.b2_glycoprot1_iga_serpl_eiaacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"b2_glycoprot1_iga_serpl_eiaacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Beta 2 glycoprotein 1 IgA Ab [Units/volume] in Serum or Plasma by Immunoassay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[arb'U]/mL">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/418913000">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/44447-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/44447-1">
			>
		>
	>
	adl_version = <"2.0.5">
