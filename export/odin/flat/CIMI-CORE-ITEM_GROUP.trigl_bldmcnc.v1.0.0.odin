(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3043-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Triglyceride [Mass/volume] in Blood' concept">
				use = <"Use for Triglyceride [Mass/volume] in Blood.">
				keywords = <"Trigl", "TG", "Trigly", "Triglycrides", "Trig", "Triglycerides", "Mass concentration", "Level", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.trigl_bldmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"trigl_bldmcnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3043-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3043-7">
			>
		>
	>
	adl_version = <"2.0.5">
