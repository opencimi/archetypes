(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/40692-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Volume of Semen--pre washing' concept">
				use = <"Use for Volume of Semen--pre washing.">
				keywords = <"Specimen vol", "Before", "Pre Wash", "Point in time", "Random", "Smn", "Ejaculate", "Seminal fluid", "SMPLS", "Sem", "Quantitative", "QNT", "Quant", "Quan", "Spec", "FERTILITY TESTING">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.specimen_vol_pre_wash_smn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"specimen_vol_pre_wash_smn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Volume of Semen--pre washing">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/40692-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/40692-6">
			>
		>
	>
	adl_version = <"2.0.5">
