(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/8191-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cocaine [Presence] in Serum or Plasma by Screen method' concept">
				use = <"Use for Cocaine [Presence] in Serum or Plasma by Screen method.">
				keywords = <"Coke", "Crack", "Snow", "Benzoylmethylecgonine", "Ecgonine methyl ester benzoate", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Scn", "Scr", "Scrn", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cocaine_serpl_ql_pre_by_scn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cocaine_serpl_ql_pre_by_scn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cocaine [Presence] in Serum or Plasma by Screen method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Cocaine [Presence] in Serum or Plasma by Screen method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/8191-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/8191-9">
			>
		>
	>
	adl_version = <"2.0.5">
