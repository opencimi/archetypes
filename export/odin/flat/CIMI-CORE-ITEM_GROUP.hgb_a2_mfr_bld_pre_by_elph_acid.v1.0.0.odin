(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/4553-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemoglobin A2/Hemoglobin.total in Blood by Electrophoresis acid (pH 6.3)' concept">
				use = <"Use for Hemoglobin A2/Hemoglobin.total in Blood by Electrophoresis acid (pH 6.3).">
				keywords = <"Hgb A2", "Hb", "Haemoglobin", "Mass fraction", "Percent", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Elph Acid", "Elp", "Elect", "Electrophrs", "Electrophhrs", "Electr", "Elec", "Ep", "Electro", "Tot", "Totl", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hgb_a2_mfr_bld_pre_by_elph_acid.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hgb_a2_mfr_bld_pre_by_elph_acid">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hemoglobin A2/Hemoglobin.total in Blood by Electrophoresis acid (pH 6.3)">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/4553-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/4553-4">
			>
		>
	>
	adl_version = <"2.0.5">
