(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33384-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Neutrophils.segmented/100 leukocytes in Peritoneal fluid' concept">
				use = <"Use for Neutrophils.segmented/100 leukocytes in Peritoneal fluid.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.neuts_seg_nfr_prt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"neuts_seg_nfr_prt">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33384-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33384-9">
			>
		>
	>
	adl_version = <"2.0.5">
