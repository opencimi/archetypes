(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33255-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cell Fractions/Differential [interpretation] in Blood' concept">
				use = <"Use for Cell Fractions/Differential [interpretation] in Blood.">
				keywords = <"Cell Fract", "Differential count", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Blood", "WB", "Whole blood", "Nominal", "Frac", "Fractionation", "Fraction", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cell_fract_bldimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cell_fract_bldimp">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33255-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33255-1">
			>
		>
	>
	adl_version = <"2.0.5">
