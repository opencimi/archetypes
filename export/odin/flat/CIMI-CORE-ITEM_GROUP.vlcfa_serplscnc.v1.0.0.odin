(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/12215-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fatty acids.very long chain [Moles/volume] in Serum or Plasma' concept">
				use = <"Use for Fatty acids.very long chain [Moles/volume] in Serum or Plasma.">
				keywords = <"VLCFA", "Aliphatic carboxylate", "VLCF", "FA", "Fatty acid", "Lipid", "Substance concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "VLC", "Chn", "Chains", "Acd", "Acid", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.vlcfa_serplscnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"vlcfa_serplscnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Fatty acids.very long chain [Moles/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"umol/L">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258814008">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/12215-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/12215-0">
			>
		>
	>
	adl_version = <"2.0.5">
