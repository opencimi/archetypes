(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5766-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Ammonium urate crystals [Presence] in Urine sediment by Light microscopy' concept">
				use = <"Use for Ammonium urate crystals [Presence] in Urine sediment by Light microscopy.">
				keywords = <"Urate Cry", "Urates", "Uric acid", "Cryst", "Crys", "Crystal", "Amm Urate Cry", "Ammonium biurate", "NH4U", "Ammonium acid urate", "Ammon", "NH4", "Arbitrary concentration", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Micro", "LM", "Micros", "Microscopic", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.amm_urate_cry_urns_ql_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"amm_urate_cry_urns_ql_micro">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5766-1">
			>
			["opencem"] = <
