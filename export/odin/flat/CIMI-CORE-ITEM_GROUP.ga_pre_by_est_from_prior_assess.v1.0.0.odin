(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/53695-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Gestational age Estimated from prior assessment' concept">
				use = <"Use for Gestational age Estimated from prior assessment.">
				keywords = <"GA", "Point in time", "Random", "Fetal", "Quantitative", "QNT", "Quant", "Quan", "Est from prior assess", "predicted", "estimation", "Clin est", "Gest", "Gestation", "Prenatal", "OBSTERICAL.ULTRASOUND", "OBSTERICAL.ULTRASOUND", "Obstetrical", "Obstetrics", "Composite GA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ga_pre_by_est_from_prior_assess.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ga_pre_by_est_from_prior_assess">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Gestational age Estimated from prior assessment">
				>
				["at0.0.0.0.0.2"] = <
					text = <"d">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/53695-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/53695-3">
			>
		>
	>
	adl_version = <"2.0.5">
