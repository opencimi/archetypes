(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.psa_serplmcnc_post_by_serpl_dl_lte_0_01_ng_mlmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"psa_serplmcnc_post_by_serpl_dl_lte_0_01_ng_mlmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.3"] = <
					text = <"Detection limit <= 0.01 ng/mL">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Prostate specific Ag [Mass/volume] in Serum or Plasma">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.3"] = <"http://snomed.org/id/703437006">
			>
			["loinc"] = <
