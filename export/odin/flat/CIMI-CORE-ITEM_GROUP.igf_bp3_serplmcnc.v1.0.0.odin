(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2483-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Insulin-like growth factor binding protein 3 [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Insulin-like growth factor binding protein 3 [Mass/volume] in Serum or Plasma.">
				keywords = <"Prot", "PR", "IGF BP3", "Insul", "Humulin", "HUM", "IH7", "Lente", "NPH", "Semilente", "Ultralente", "Sliding", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "IGFBP", "IGF BP", "Fac", "Fact", "Bind", "III", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.igf_bp3_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"igf_bp3_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Insulin-like growth factor binding protein 3 [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2483-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2483-6">
			>
		>
	>
	adl_version = <"2.0.5">
