(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/560-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Chlamydia sp identified in Unspecified specimen by Organism specific culture' concept">
				use = <"Use for Chlamydia sp identified in Unspecified specimen by Organism specific culture.">
				keywords = <"Identity or presence", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Nominal", "Cult", "Cultures", "C&S", "Isolated", "species", "spp", "Chlam", "Chlamid", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.chlamydia_xxx_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"chlamydia_xxx_cult">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Chlamydia sp identified in Unspecified specimen by Organism specific culture">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Chlamydia sp identified in Unspecified specimen by Organism specific culture">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/560-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/560-3">
			>
		>
	>
	adl_version = <"2.0.5">
