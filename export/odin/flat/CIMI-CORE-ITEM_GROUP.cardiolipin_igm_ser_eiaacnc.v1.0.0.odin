(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3182-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cardiolipin IgM Ab [Units/volume] in Serum by Immunoassay' concept">
				use = <"Use for Cardiolipin IgM Ab [Units/volume] in Serum by Immunoassay.">
				keywords = <"Immune globulin M", "Immunoglobulin M", "Cardiolip", "Cardio", "Cardiolipn", "Cardiolpn", "ACA", "aCL", "Anticardiolipin", "CL", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cardiolipin_igm_ser_eiaacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cardiolipin_igm_ser_eiaacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cardiolipin IgM Ab [Units/volume] in Serum by Immunoassay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[MPL'U]">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/418406009">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3182-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3182-3">
			>
		>
	>
	adl_version = <"2.0.5">
