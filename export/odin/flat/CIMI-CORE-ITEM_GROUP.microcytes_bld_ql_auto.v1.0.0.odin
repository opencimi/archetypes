(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/15199-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Microcytes [Presence] in Blood by Automated count' concept">
				use = <"Use for Microcytes [Presence] in Blood by Automated count.">
				keywords = <"Microcyte", "Micros", "Microcytosis", "Arbitrary concentration", "Point in time", "Random", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Auto", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.microcytes_bld_ql_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"microcytes_bld_ql_auto">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Microcytes [Presence] in Blood by Automated count">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Microcytes [Presence] in Blood by Automated count">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/15199-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/15199-3">
			>
		>
	>
	adl_version = <"2.0.5">
