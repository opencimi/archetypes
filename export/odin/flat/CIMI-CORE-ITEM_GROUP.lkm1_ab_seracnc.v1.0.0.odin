(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32220-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Liver kidney microsomal 1 Ab [Units/volume] in Serum' concept">
				use = <"Use for Liver kidney microsomal 1 Ab [Units/volume] in Serum.">
				keywords = <"LKM1", "LKM-1", "LKM", "Liver kidney microsome", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Microsm", "Microsom", "I", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.lkm1_ab_seracnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"lkm1_ab_seracnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32220-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32220-6">
			>
		>
	>
	adl_version = <"2.0.5">
