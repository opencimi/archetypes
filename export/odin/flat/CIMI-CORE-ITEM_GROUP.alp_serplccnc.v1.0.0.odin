(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6768-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Alkaline phosphatase [Enzymatic activity/volume] in Serum or Plasma' concept">
				use = <"Use for Alkaline phosphatase [Enzymatic activity/volume] in Serum or Plasma.">
				keywords = <"ALP", "Alk phos", "Alkaline phos", "ALKP", "AP", "Alkaline phosphatase.total", "Catalytic Concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Phos", "Phosphtase", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.alp_serplccnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"alp_serplccnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6768-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6768-6">
			>
		>
	>
	adl_version = <"2.0.5">
