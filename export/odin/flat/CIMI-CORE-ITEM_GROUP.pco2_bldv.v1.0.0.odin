(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2021-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Carbon dioxide [Partial pressure] in Venous blood' concept">
				use = <"Use for Carbon dioxide [Partial pressure] in Venous blood.">
				keywords = <"CO2", "Carbonic anhydride", "Partial pressure", "Point in time", "Random", "Blood - venous", "Bld ven", "Bld venous", "Blood venus", "Blood ven", "Venous", "Quantitative", "QNT", "Quant", "Quan", "Chemistry", "PCO2">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pco2_bldv.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pco2_bldv">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2021-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2021-4">
			>
		>
	>
	adl_version = <"2.0.5">
