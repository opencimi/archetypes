(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19157-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Tube number of Cerebral spinal fluid' concept">
				use = <"Use for Tube number of Cerebral spinal fluid.">
				keywords = <"Tube #", "Num", "No", "Identifier", "Ident", "Point in time", "Random", "Cerebral spinal fluid", "Spinal Fluid", "Cerebrospinal Fl", "Spinal Flu", "Spinal Fld", "Nominal">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.tube_num_csf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"tube_num_csf">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Tube number of Cerebral spinal fluid">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Tube number of Cerebral spinal fluid">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19157-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19157-7">
			>
		>
	>
	adl_version = <"2.0.5">
