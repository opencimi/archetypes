(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/21027-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Platelet aggregation [interpretation] in Platelet poor plasma' concept">
				use = <"Use for Platelet aggregation [interpretation] in Platelet poor plasma.">
				keywords = <"PA", "Plt", "Pl", "Platelets", "Thrombocytes", "Platelt", "Thrombocyte", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Platelet poor plasma", "Plas", "Nominal", "Agg", "Aggr", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pa_pppimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pa_pppimp">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/21027-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/21027-8">
			>
		>
	>
	adl_version = <"2.0.5">
