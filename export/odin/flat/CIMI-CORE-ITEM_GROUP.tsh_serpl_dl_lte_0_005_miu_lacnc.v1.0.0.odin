(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/11580-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Thyrotropin [Units/volume] in Serum or Plasma by Detection limit <= 0.005 mIU/L' concept">
				use = <"Use for Thyrotropin [Units/volume] in Serum or Plasma by Detection limit <= 0.005 mIU/L.">
				keywords = <"TSH", "Thyrotropic hormone", "Thyroid stimulating hormone", "Arbitrary concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "DL<=0.005 mIU/L", "DL<=0.005 mIU/L", "Chemistry", "3rd generation TSH", "High sensitivity TSH">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.tsh_serpl_dl_lte_0_005_miu_lacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"tsh_serpl_dl_lte_0_005_miu_lacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Thyrotropin [Units/volume] in Serum or Plasma by Detection limit <= 0.005 mIU/L">
				>
				["at0.0.0.0.0.2"] = <
					text = <"m[IU]/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/11580-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/11580-8">
			>
		>
	>
	adl_version = <"2.0.5">
