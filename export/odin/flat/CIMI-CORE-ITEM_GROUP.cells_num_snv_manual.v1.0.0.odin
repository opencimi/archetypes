(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32164-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cells [#/volume] in Synovial fluid by Manual count' concept">
				use = <"Use for Cells [#/volume] in Synovial fluid by Manual count.">
				keywords = <"Cell", "Cellularity", "#", "Number concentration", "Count/volume", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Snv", "Joint fluid", "Joint aspirate", "Synovial fluid", "Syn fl", "Joint fld", "Joint flu", "Synov", "SNV", "SF", "Quantitative", "QNT", "Quant", "Quan", "Manl", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cells_num_snv_manual.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cells_num_snv_manual">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cells [#/volume] in Synovial fluid by Manual count">
				>
				["at0.0.0.0.0.2"] = <
					text = <"10*3/uL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32164-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32164-6">
			>
		>
	>
	adl_version = <"2.0.5">
