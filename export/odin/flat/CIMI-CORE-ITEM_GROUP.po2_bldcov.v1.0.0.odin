(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/28649-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oxygen [Partial pressure] in Venous cord blood' concept">
				use = <"Use for Oxygen [Partial pressure] in Venous cord blood.">
				keywords = <"O2", "tO2", "Partial pressure", "Point in time", "Random", "Bld cord", "Cord venous blood", "Cord BldV", "Quantitative", "QNT", "Quant", "Quan", "Chemistry", "O2 partial pressure", "PO2">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.po2_bldcov.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"po2_bldcov">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Oxygen [Partial pressure] in Venous cord blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mm[Hg]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/28649-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/28649-2">
			>
		>
	>
	adl_version = <"2.0.5">
