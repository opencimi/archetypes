(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/12201-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cryoglobulin [Presence] in Serum by 1 day cold incubation' concept">
				use = <"Use for Cryoglobulin [Presence] in Serum by 1 day cold incubation.">
				keywords = <"Cryoglob", "Cryoglobulins", "Cryo", "Cryoprecipitate", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "1D Cold Inc", "24h cold incubation", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cryoglob_ser_ql_1d_cold_inc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cryoglob_ser_ql_1d_cold_inc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cryoglobulin [Presence] in Serum by 1 day cold incubation">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Cryoglobulin [Presence] in Serum by 1 day cold incubation">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/12201-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/12201-0">
			>
		>
	>
	adl_version = <"2.0.5">
