(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/27939-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Collagen crosslinked N-telopeptide [Moles/volume] in Urine' concept">
				use = <"Use for Collagen crosslinked N-telopeptide [Moles/volume] in Urine.">
				keywords = <"Collagen NTx", "N-Telopeptide of Type I Collagen", "Aminoterminal cross-linking telopeptide of bone collagen", "Substance concentration", "Level", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.collagen_ntx_urscnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"collagen_ntx_urscnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Collagen crosslinked N-telopeptide [Moles/volume] in Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"nmol/ml">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/27939-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/27939-8">
			>
		>
	>
	adl_version = <"2.0.5">
