(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'person role' concept">
				use = <"Use for person role.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ROLE.person_role.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ROLE">
		concept_id = <"person_role">
		release_version = <"1.0.0">
		version_status = <0>
		build_count = <0>
	>
	parent_archetype_id = <"CIMI-CORE-ROLE.role.v1">
	definition = <
		rm_type_name = <"ROLE">
		node_id = <"id1.1.1">
		attributes = <
