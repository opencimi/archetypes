(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/56478-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Ethanol [Mass/volume] in Blood by Gas chromatography' concept">
				use = <"Use for Ethanol [Mass/volume] in Blood by Gas chromatography.">
				keywords = <"Alc", "Alcohol", "EtOH", "Ethyl alcohol", "Mass concentration", "Level", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Gas chromatography", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ethanol_bldmcnc_pre_by_bld_gcmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ethanol_bldmcnc_pre_by_bld_gcmcnc">
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258798001">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/56478-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/56478-1">
			>
		>
	>
	adl_version = <"2.0.5">
