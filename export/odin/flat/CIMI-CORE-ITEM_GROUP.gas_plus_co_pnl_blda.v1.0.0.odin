(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.gas_plus_co_pnl_blda.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"gas_plus_co_pnl_blda">
			...
			["1"] = <
				...
				children = <
					...
					["20"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.1">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.o2_ct_bldascnc.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["21"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.2">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.base_deficit_bldascnc.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["22"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.3">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.base_excess_blda_calcscnc.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["23"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.4">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.po2_temp_adj_blda.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["24"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.5">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.hco3_bldascnc.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["25"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.6">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.pco2_blda.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["26"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.7">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.co2_bldascnc.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["27"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.8">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.cohgb_mfr_blda.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["28"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.9">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.methgb_mfr_blda.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["29"] = (P_C_ARCHETYPE_ROOT) <
						...
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.po2_blda.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["30"] = (P_C_ARCHETYPE_ROOT) <
						...
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.sao2_percent_blda.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["31"] = (P_C_ARCHETYPE_ROOT) <
						...
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.oxyhgb_mfr_blda.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["32"] = (P_C_ARCHETYPE_ROOT) <
						...
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.ph_blda.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["33"] = (P_C_ARCHETYPE_ROOT) <
						...
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.hgb_bldamcnc.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					...
					["36"] = (P_C_ARCHETYPE_ROOT) <
						...
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.pco2_temp_adj_blda.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["37"] = (P_C_ARCHETYPE_ROOT) <
						...
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.ph_temp_adj_blda.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.1"] = <
					text = <"Gas and Carbon monoxide panel - Arterial blood">
				>
				["id0.1.1.1.1"] = <
					text = <"Oxygen content in Arterial blood">
				>
				["id0.1.1.1.10"] = <
				...
				>
				["id0.1.1.1.12"] = <
					text = <"Fractional oxyhemoglobin in Arterial blood">
				>
				["id0.1.1.1.13"] = <
					text = <"pH of Arterial blood">
				>
				["id0.1.1.1.14"] = <
					text = <"Hemoglobin [Mass/volume] in Arterial blood">
				>
				["id0.1.1.1.15"] = <
				...
				>
				["id0.1.1.1.17"] = <
					text = <"Carbon dioxide [Partial pressure] adjusted to patients actual temperature in Arterial blood">
				>
				["id0.1.1.1.18"] = <
					text = <"pH of Arterial blood adjusted to patients actual temperature">
				>
				["id0.1.1.1.19"] = <
					text = <"Body temperature">
				>
				["id0.1.1.1.2"] = <
					text = <"Base deficit in Arterial blood">
				>
				["id0.1.1.1.3"] = <
					text = <"Base excess in Arterial blood by calculation">
				>
				["id0.1.1.1.4"] = <
					text = <"Oxygen [Partial pressure] adjusted to patients actual temperature in Arterial blood">
				>
				["id0.1.1.1.5"] = <
					text = <"Bicarbonate [Moles/volume] in Arterial blood">
				>
				["id0.1.1.1.6"] = <
					text = <"Carbon dioxide [Partial pressure] in Arterial blood">
				>
				["id0.1.1.1.7"] = <
					text = <"Carbon dioxide, total [Moles/volume] in Arterial blood">
				>
				["id0.1.1.1.8"] = <
					text = <"Carboxyhemoglobin/Hemoglobin.total in Arterial blood">
				>
				["id0.1.1.1.9"] = <
					text = <"Methemoglobin/Hemoglobin.total in Arterial blood">
				>
				["id1.1.1.1.1"] = <
					text = <"Gas and Carbon monoxide panel - Arterial blood">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/24341-0">
				["at0.0.0.0.1"] = <"http://loinc.org/id/24341-0">
				["id0.1.1.1.1"] = <"http://loinc.org/id/19218-7">
				["id0.1.1.1.2"] = <"http://loinc.org/id/1922-4">
				["id0.1.1.1.3"] = <"http://loinc.org/id/1925-7">
				["id0.1.1.1.4"] = <"http://loinc.org/id/19255-9">
				["id0.1.1.1.5"] = <"http://loinc.org/id/1960-4">
				["id0.1.1.1.6"] = <"http://loinc.org/id/2019-8">
				["id0.1.1.1.7"] = <"http://loinc.org/id/2026-3">
				["id0.1.1.1.8"] = <"http://loinc.org/id/2030-5">
				["id0.1.1.1.9"] = <"http://loinc.org/id/2615-3">
				["id0.1.1.1.10"] = <"http://loinc.org/id/2703-7">
				["id0.1.1.1.11"] = <"http://loinc.org/id/2708-6">
				["id0.1.1.1.12"] = <"http://loinc.org/id/2714-4">
				["id0.1.1.1.13"] = <"http://loinc.org/id/2744-1">
				["id0.1.1.1.14"] = <"http://loinc.org/id/30313-1">
				["id0.1.1.1.15"] = <"http://loinc.org/id/3150-0">
				["id0.1.1.1.16"] = <"http://loinc.org/id/3151-8">
				["id0.1.1.1.17"] = <"http://loinc.org/id/32771-8">
				["id0.1.1.1.18"] = <"http://loinc.org/id/33254-4">
