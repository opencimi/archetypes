(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/8144-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Amphetamines [Presence] in Meconium' concept">
				use = <"Use for Amphetamines [Presence] in Meconium.">
				keywords = <"Amphetam", "Amph", "Amphetamine", "Speed", "Point in time", "Random", "Mec", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.amphetamines_mec_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"amphetamines_mec_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Amphetamines [Presence] in Meconium">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Amphetamines [Presence] in Meconium">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/8144-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/8144-8">
			>
		>
	>
	adl_version = <"2.0.5">
