(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/12851-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Protein Fractions [interpretation] in Serum or Plasma by Electrophoresis' concept">
				use = <"Use for Protein Fractions [interpretation] in Serum or Plasma by Electrophoresis.">
				keywords = <"Prot Pattern", "Protein fractions", "PR", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Nominal", "Elph", "Elp", "Elect", "Electrophrs", "Electrophhrs", "Electr", "Elec", "Ep", "Electro", "Chemistry", "SPEP">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.prot_pattern_serpl_elphimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"prot_pattern_serpl_elphimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Protein Fractions [interpretation] in Serum or Plasma by Electrophoresis">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Protein Fractions [interpretation] in Serum or Plasma by Electrophoresis">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/12851-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/12851-2">
			>
		>
	>
	adl_version = <"2.0.5">
