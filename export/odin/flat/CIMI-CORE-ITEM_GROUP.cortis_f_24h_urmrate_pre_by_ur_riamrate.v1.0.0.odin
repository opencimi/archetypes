(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/55844-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cortisol Free [Mass/time] in 24 hour Urine by Radioimmunoassay (RIA)' concept">
				use = <"Use for Cortisol Free [Mass/time] in 24 hour Urine by Radioimmunoassay (RIA).">
				keywords = <"Cortis F", "Coritsol", "Cort", "hydrocortisone", "Compound F", "17-Hydroxycorticosterone", "mRate", "Mass rate", "1 day", "24 hours", "24HR", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Radioimmunoassay", "FR", "Non-protein bound", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cortis_f_24h_urmrate_pre_by_ur_riamrate.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cortis_f_24h_urmrate_pre_by_ur_riamrate">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cortisol Free [Mass/time] in 24 hour Urine by Radioimmunoassay (RIA)">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/(24.h)">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258840002">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/55844-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/55844-5">
			>
		>
	>
	adl_version = <"2.0.5">
