(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13532-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Xanthochromia of Cerebral spinal fluid Qualitative' concept">
				use = <"Use for Xanthochromia of Cerebral spinal fluid Qualitative.">
				keywords = <"Xanthchromia", "Xanthochromic", "Arbitrary concentration", "Point in time", "Random", "Cerebral spinal fluid", "Spinal Fluid", "Cerebrospinal Fl", "Spinal Flu", "Spinal Fld", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.xanthochromia_csf_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"xanthochromia_csf_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Xanthochromia of Cerebral spinal fluid Qualitative">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13532-7">
			>
			["opencem"] = <
