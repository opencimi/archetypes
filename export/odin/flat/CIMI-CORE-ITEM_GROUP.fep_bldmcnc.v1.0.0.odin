(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2892-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Protoporphyrin Free [Mass/volume] in Blood' concept">
				use = <"Use for Protoporphyrin Free [Mass/volume] in Blood.">
				keywords = <"FEP", "Free erythrocyte protoporphyrin", "Protoporphrn", "Dicarboxylporphyrin", "Protoporph", "Protoporphyrins", "Dicarboxyl porphyrin", "Mass concentration", "Level", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "FR", "Non-protein bound", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fep_bldmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fep_bldmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Protoporphyrin Free [Mass/volume] in Blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2892-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2892-8">
			>
		>
	>
	adl_version = <"2.0.5">
