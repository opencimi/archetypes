(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/31100-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hematocrit [Volume Fraction] of Blood by Impedance' concept">
				use = <"Use for Hematocrit [Volume Fraction] of Blood by Impedance.">
				keywords = <"Hct", "PCV", "Volume fraction", "Volfr", "Percent", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Imped", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hct_vfr_bld_pre_by_imped.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hct_vfr_bld_pre_by_imped">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/31100-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/31100-1">
			>
		>
	>
	adl_version = <"2.0.5">
