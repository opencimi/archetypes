(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2597-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Magnesium [Moles/volume] in Red Blood Cells' concept">
				use = <"Use for Magnesium [Moles/volume] in Red Blood Cells.">
				keywords = <"MAG", "Magnes", "Mg", "Substance concentration", "Level", "Point in time", "Random", "Erythrocytes", "Red blood corpusles", "Red blood cells", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.magnesium_rbcscnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"magnesium_rbcscnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Magnesium [Moles/volume] in Red Blood Cells">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mmol/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2597-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2597-3">
			>
		>
	>
	adl_version = <"2.0.5">
