(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/40752-8.html>">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ebv_ea_igg_ser_ql_pre_by_eia.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ebv_ea_igg_ser_ql_pre_by_eia">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Epstein Barr virus early IgG Ab [Presence] in Serum by Immunoassay">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Epstein Barr virus early IgG Ab [Presence] in Serum by Immunoassay">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/40752-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/40752-8">
			>
		>
	>
	adl_version = <"2.0.5">
