(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49588-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'First trimester maternal screen with nuchal translucency [interpretation] Narrative' concept">
				use = <"Use for First trimester maternal screen with nuchal translucency [interpretation] Narrative.">
				keywords = <"1st trimester scn+NT", "Choriogonadotropin & Pregnancy associated plasma protein A & Nuchal translucency", "1st trimester maternal scn", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Narrative", "Report", "Scr", "Scn", "Scrn", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.1st_trimester_scn_plus_nt_patientimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"1st_trimester_scn_plus_nt_patientimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"First trimester maternal screen with nuchal translucency [interpretation] Narrative">
				>
				["id1.1.1.1.1.1"] = <
					text = <"First trimester maternal screen with nuchal translucency [interpretation] Narrative">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49588-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49588-7">
			>
		>
	>
	adl_version = <"2.0.5">
