(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19080-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Choriogonadotropin [Units/volume] in Serum or Plasma' concept">
				use = <"Use for Choriogonadotropin [Units/volume] in Serum or Plasma.">
				keywords = <"HCG", "Chorionic gonadotropin", "CG", "Human chorionic gonadotropin", "Choriogonadotropins total", "Arbitrary concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hcg_serplacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hcg_serplacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Choriogonadotropin [Units/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"m[IU]/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19080-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19080-1">
			>
		>
	>
	adl_version = <"2.0.5">
