(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5822-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Yeast [#/area] in Urine sediment by Microscopy high power field' concept">
				use = <"Use for Yeast [#/area] in Urine sediment by Microscopy high power field.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.yeast_num_per_area_urns_hpf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"yeast_num_per_area_urns_hpf">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5822-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5822-2">
			>
		>
	>
	adl_version = <"2.0.5">
