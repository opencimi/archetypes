(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19218-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oxygen content in Arterial blood' concept">
				use = <"Use for Oxygen content in Arterial blood.">
				keywords = <"O2 Ct", "ctO2", "O2CT", "tO2", "Substance concentration", "Level", "Point in time", "Random", "Arterial blood", "ART", "Art blood", "Art bld", "ABG", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.o2_ct_bldascnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"o2_ct_bldascnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19218-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19218-7">
			>
		>
	>
	adl_version = <"2.0.5">
