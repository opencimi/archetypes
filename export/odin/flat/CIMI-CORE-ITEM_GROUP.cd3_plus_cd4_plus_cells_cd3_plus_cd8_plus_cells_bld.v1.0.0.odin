(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/54218-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'CD3+CD4+ (T4 helper) cells/CD3+CD8+ (T8 suppressor cells) cells [# Ratio] in Blood' concept">
				use = <"Use for CD3+CD4+ (T4 helper) cells/CD3+CD8+ (T8 suppressor cells) cells [# Ratio] in Blood.">
				keywords = <"T4 helper/inducer cells", "CD4+ T cells", "CD3+CD8+ Cells", "Suppressor/cytotoxic T cells", "CD8 T cells", "T8 suppressor cells", "CD3 Cells", "Cell", "Cellularity", "Leu-4", "Leu4", "T3", "CD3+CD8+ Cells", "Number ratio", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Leu-2", "T-8", "Leu2", "Suppressor T cells", "Tsuppressor", "Leu-3", "T-4", "Leu3", "W3/25", "Helper T cells", "Inducer T cells", "L3T4", "CELL MARKERS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cd3_plus_cd4_plus_cells_cd3_plus_cd8_plus_cells_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cd3_plus_cd4_plus_cells_cd3_plus_cd8_plus_cells_bld">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"CD3+CD4+ (T4 helper) cells/CD3+CD8+ (T8 suppressor cells) cells [# Ratio] in Blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/415067009">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/54218-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/54218-3">
			>
		>
	>
	adl_version = <"2.0.5">
