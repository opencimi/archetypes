(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/23811-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Alpha-1-Fetoprotein [Multiple of the median] adjusted in Serum or Plasma' concept">
				use = <"Use for Alpha-1-Fetoprotein [Multiple of the median] adjusted in Serum or Plasma.">
				keywords = <"AFP", "Alphafetoprotein", "Alpha fetoprotein", "adj", "Multiple of the median", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Feto", "A1", "Alfa", "I", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.afp_adj_mom_serpl.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"afp_adj_mom_serpl">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Alpha-1-Fetoprotein [Multiple of the median] adjusted in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{M.o.M}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/23811-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/23811-3">
			>
		>
	>
	adl_version = <"2.0.5">
