(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'specimen collection site' concept">
				use = <"Use for specimen collection site.">
				keywords = <"specimen", "collection", "site">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.specimen_collection_site.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"specimen_collection_site">
		release_version = <"1.0.0">
		version_status = <0>
		build_count = <0>
	>
	parent_archetype_id = <"CIMI-CORE-ITEM_GROUP.anatomical_location.v2">
	definition = <
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["id1.1.1.1"] = <"http://snomed.info/id/123037004">
				["id0.0.1.1"] = <"http://snomed.info/id/182353008">
			>
		>
	>
	adl_version = <"2.0.5">
