(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20513-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Turbidity of Body fluid Qualitative' concept">
				use = <"Use for Turbidity of Body fluid Qualitative.">
				keywords = <"Arbitrary concentration", "Point in time", "Random", "BF", "Fluid", "Body fluid", "B/F", "FLU", "Fl", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.turbidity_fld_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"turbidity_fld_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Turbidity of Body fluid Qualitative">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Turbidity of Body fluid Qualitative">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20513-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20513-8">
			>
		>
	>
	adl_version = <"2.0.5">
