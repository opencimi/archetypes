(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/43212-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Albumin [Mass/volume] in Body fluid by Electrophoresis' concept">
				use = <"Use for Albumin [Mass/volume] in Body fluid by Electrophoresis.">
				keywords = <"Protein.albumin", "Alb", "Mass concentration", "Level", "Point in time", "Random", "BF", "Fluid", "Body fluid", "B/F", "FLU", "Fl", "Quantitative", "QNT", "Quant", "Quan", "Elph", "Elp", "Elect", "Electrophrs", "Electrophhrs", "Electr", "Elec", "Ep", "Electro", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.albumin_fldmcnc_pre_by_fld_elphmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"albumin_fldmcnc_pre_by_fld_elphmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Albumin [Mass/volume] in Body fluid by Electrophoresis">
				>
				["at0.0.0.0.0.2"] = <
					text = <"g/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/43212-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/43212-0">
			>
		>
	>
	adl_version = <"2.0.5">
