(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2513-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Ketones [Presence] in Serum or Plasma' concept">
				use = <"Use for Ketones [Presence] in Serum or Plasma.">
				keywords = <"Acetoacetate", "Acetest", "Ketone", "Acetoacetates", "Acetone bodies", "Ketone bodies", "Arbitrary concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ketones_serpl_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ketones_serpl_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Ketones [Presence] in Serum or Plasma">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Ketones [Presence] in Serum or Plasma">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2513-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2513-0">
			>
		>
	>
	adl_version = <"2.0.5">
