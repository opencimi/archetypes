(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/4821-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'HLA-B27 [Presence]' concept">
				use = <"Use for HLA-B27 [Presence].">
				keywords = <"Human Leukocyte Antigen", "Arbitrary concentration", "Point in time", "Random", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "HLA ANTIGEN">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hlab27_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hlab27_ql">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/4821-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/4821-5">
			>
		>
	>
	adl_version = <"2.0.5">
