(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13987-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Alpha 2 globulin/Protein.total in 24 hour Urine by Electrophoresis' concept">
				use = <"Use for Alpha 2 globulin/Protein.total in 24 hour Urine by Electrophoresis.">
				keywords = <"Alpha2 Glob", "Protein.alpha 2 globulin", "Prot", "PR", "GLB", "Globulins", "Glob%", "Globul", "TP", "Mass fraction", "Percent", "1 day", "24 hours", "24HR", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Elph", "Elp", "Elect", "Electrophrs", "Electrophhrs", "Electr", "Elec", "Ep", "Electro", "Tot", "Totl", "A2", "Alfa", "II", "Chemistry", "PEUR", "UPEP">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.alpha2_glob_24h_mfr_ur_elph.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"alpha2_glob_24h_mfr_ur_elph">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Alpha 2 globulin/Protein.total in 24 hour Urine by Electrophoresis">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13987-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13987-3">
			>
		>
	>
	adl_version = <"2.0.5">
