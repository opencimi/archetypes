(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/51656-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hepatitis C virus Ab Signal/Cutoff in Body fluid' concept">
				use = <"Use for Hepatitis C virus Ab Signal/Cutoff in Body fluid.">
				keywords = <"HCV Ab Signal", "HCV Ab s/co", "HCVAB", "Hep C", "co", "cut off", "RlACnc", "Point in time", "Random", "BF", "Fluid", "Body fluid", "B/F", "FLU", "Fl", "Quantitative", "QNT", "Quant", "Quan", "CtO", "Ab s/co", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Hepatit", "Hepatis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hcv_ab_s_co_fld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hcv_ab_s_co_fld">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hepatitis C virus Ab Signal/Cutoff in Body fluid">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{ratio}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/51656-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/51656-7">
			>
		>
	>
	adl_version = <"2.0.5">
