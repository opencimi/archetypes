(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/15917-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Peanut IgE Ab RAST class [Presence] in Serum' concept">
				use = <"Use for Peanut IgE Ab RAST class [Presence] in Serum.">
				keywords = <"Immune globulin E", "Immunoglobulin E", "Peanut", "f013", "f13", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "ALLERGY TESTING", "Allergens", "Allergen">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.peanut_ige_rast_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"peanut_ige_rast_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Peanut IgE Ab RAST class [Presence] in Serum">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Peanut IgE Ab RAST class [Presence] in Serum">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/15917-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/15917-8">
			>
		>
	>
	adl_version = <"2.0.5">
