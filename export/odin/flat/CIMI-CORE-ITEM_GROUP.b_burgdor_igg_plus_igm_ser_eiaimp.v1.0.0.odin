(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/46248-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Borrelia burgdorferi IgG and IgM [interpretation] in Serum by Immunoassay' concept">
				use = <"Use for Borrelia burgdorferi IgG and IgM [interpretation] in Serum by Immunoassay.">
				keywords = <"Immune globulin M", "Immunoglobulin M", "Immune globulin G", "Immunoglobulin G", "B burg", "B burgdorferi", "Lymes", "Burgdorf", "Lyme", "Bb", "Lyme disease", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Serum", "SR", "Nominal", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.b_burgdor_igg_plus_igm_ser_eiaimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"b_burgdor_igg_plus_igm_ser_eiaimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Borrelia burgdorferi IgG and IgM [interpretation] in Serum by Immunoassay">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Borrelia burgdorferi IgG and IgM [interpretation] in Serum by Immunoassay">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/46248-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/46248-1">
			>
		>
	>
	adl_version = <"2.0.5">
