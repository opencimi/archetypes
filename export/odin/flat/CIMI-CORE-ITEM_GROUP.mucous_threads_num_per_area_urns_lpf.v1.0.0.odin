(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/28545-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Mucus [#/area] in Urine sediment by Microscopy low power field' concept">
				use = <"Use for Mucus [#/area] in Urine sediment by Microscopy low power field.">
				keywords = <"Mucous Threads", "#/area", "Number areic", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Micro", "LM", "Micros", "Microscopic", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.mucous_threads_num_per_area_urns_lpf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"mucous_threads_num_per_area_urns_lpf">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Mucus [#/area] in Urine sediment by Microscopy low power field">
				>
				["at0.0.0.0.0.2"] = <
					text = <"/[HPF]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/28545-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/28545-2">
			>
		>
	>
	adl_version = <"2.0.5">
