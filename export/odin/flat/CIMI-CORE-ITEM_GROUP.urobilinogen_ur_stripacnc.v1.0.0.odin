(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19161-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Urobilinogen [Units/volume] in Urine by Test strip' concept">
				use = <"Use for Urobilinogen [Units/volume] in Urine by Test strip.">
				keywords = <"UBG", "Urobilngn", "Urobili", "Arbitrary concentration", "Point in time", "Random", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Dipstick", "Dip stick", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.urobilinogen_ur_stripacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"urobilinogen_ur_stripacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Urobilinogen [Units/volume] in Urine by Test strip">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{Ehrlich'U}/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19161-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19161-9">
			>
		>
	>
	adl_version = <"2.0.5">
