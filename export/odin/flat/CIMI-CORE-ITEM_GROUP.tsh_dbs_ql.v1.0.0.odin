(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/29574-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Thyrotropin [Presence] in Dried blood spot' concept">
				use = <"Use for Thyrotropin [Presence] in Dried blood spot.">
				keywords = <"TSH", "Thyrotropic hormone", "Thyroid stimulating hormone", "Arbitrary concentration", "Point in time", "Random", "DBS", "Filter paper", "FP", "Dried blood spot", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.tsh_dbs_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"tsh_dbs_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Thyrotropin [Presence] in Dried blood spot">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Thyrotropin [Presence] in Dried blood spot">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/29574-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/29574-1">
			>
		>
	>
	adl_version = <"2.0.5">
