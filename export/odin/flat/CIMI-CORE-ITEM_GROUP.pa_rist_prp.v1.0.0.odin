(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5998-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Platelet aggregation ristocetin induced [Mass threshold] in Platelet rich plasma' concept">
				use = <"Use for Platelet aggregation ristocetin induced [Mass threshold] in Platelet rich plasma.">
				keywords = <"PA Rist", "RIPA", "Plt", "Pl", "Platelets", "Thrombocytes", "Platelt", "Thrombocyte", "Threshold mass concentration", "Point in time", "Random", "Platelet rich plasma", "Quantitative", "QNT", "Quant", "Quan", "Agg", "Aggr", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pa_rist_prp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pa_rist_prp">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5998-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5998-0">
			>
		>
	>
	adl_version = <"2.0.5">
