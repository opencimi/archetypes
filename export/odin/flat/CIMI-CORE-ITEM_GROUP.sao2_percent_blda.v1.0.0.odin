(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2708-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oxygen saturation in Arterial blood' concept">
				use = <"Use for Oxygen saturation in Arterial blood.">
				keywords = <"SaO2", "SO2", "O2", "tO2", "Mass fraction", "Percent", "Point in time", "Random", "Arterial blood", "ART", "Art blood", "Art bld", "ABG", "Quantitative", "QNT", "Quant", "Quan", "Satn", "SAT", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.sao2_percent_blda.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"sao2_percent_blda">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2708-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2708-6">
			>
		>
	>
	adl_version = <"2.0.5">
