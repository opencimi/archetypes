(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/40787-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Calculus analysis [interpretation] in Stone by Infrared spectroscopy' concept">
				use = <"Use for Calculus analysis [interpretation] in Stone by Infrared spectroscopy.">
				keywords = <"Stone Analysis", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Calc", "Stn", "Stones", "Calculi", "Nominal", "IR", "Infared spectoscopy", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.stone_analysisimp_pre_by_analysis_irimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"stone_analysisimp_pre_by_analysis_irimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Calculus analysis [interpretation] in Stone by Infrared spectroscopy">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Calculus analysis [interpretation] in Stone by Infrared spectroscopy">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/40787-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/40787-4">
			>
		>
	>
	adl_version = <"2.0.5">
