(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/17790-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Leukocytes Left Shift [Presence] in Blood by Automated count' concept">
				use = <"Use for Leukocytes Left Shift [Presence] in Blood by Automated count.">
				keywords = <"WBC Left Shift", "White blood cell", "Leuc", "Leuk", "Leukocyte", "Lkcs", "White blood cells", "WBCs", "Arbitrary concentration", "Point in time", "Random", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Auto", "L", "LT", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.wbc_left_shift_bld_ql_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"wbc_left_shift_bld_ql_auto">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Leukocytes Left Shift [Presence] in Blood by Automated count">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Leukocytes Left Shift [Presence] in Blood by Automated count">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/17790-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/17790-7">
			>
		>
	>
	adl_version = <"2.0.5">
