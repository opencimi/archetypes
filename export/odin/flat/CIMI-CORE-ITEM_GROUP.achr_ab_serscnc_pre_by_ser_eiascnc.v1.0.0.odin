(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/68937-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Acetylcholine receptor Ab [Moles/volume] in Serum by Immunoassay' concept">
				use = <"Use for Acetylcholine receptor Ab [Moles/volume] in Serum by Immunoassay.">
				keywords = <"AChR", "ACRA", "ACH", "Acetylch", "Substance concentration", "Level", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Recep", "Recp", "Rec", "Receptors", "Recept", "Recptr", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.achr_ab_serscnc_pre_by_ser_eiascnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"achr_ab_serscnc_pre_by_ser_eiascnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Acetylcholine receptor Ab [Moles/volume] in Serum by Immunoassay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"nmol/L">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258817001">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/68937-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/68937-2">
			>
		>
	>
	adl_version = <"2.0.5">
