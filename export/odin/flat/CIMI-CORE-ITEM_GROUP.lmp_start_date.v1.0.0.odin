(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/8665-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Last menstrual period start date' concept">
				use = <"Use for Last menstrual period start date.">
				keywords = <"LMP Start date", "Time stamp", "Date and time", "Timestamp", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.lmp_start_date.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"lmp_start_date">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/8665-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/8665-2">
			>
		>
	>
	adl_version = <"2.0.5">
