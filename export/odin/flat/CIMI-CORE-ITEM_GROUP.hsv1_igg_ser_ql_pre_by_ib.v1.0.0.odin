(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33291-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Herpes simplex virus 1 IgG Ab [Presence] in Serum by Immunoblot (IB)' concept">
				use = <"Use for Herpes simplex virus 1 IgG Ab [Presence] in Serum by Immunoblot (IB).">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hsv1_igg_ser_ql_pre_by_ib.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hsv1_igg_ser_ql_pre_by_ib">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Herpes simplex virus 1 IgG Ab [Presence] in Serum by Immunoblot (IB)">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33291-6">
			>
			["opencem"] = <
