(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/14638-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Calculus analysis [interpretation] in Stone' concept">
				use = <"Use for Calculus analysis [interpretation] in Stone.">
				keywords = <"Stone Analysis", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Calc", "Stn", "Stones", "Calculi", "Nominal", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.stone_analysisimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"stone_analysisimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Calculus analysis [interpretation] in Stone">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Calculus analysis [interpretation] in Stone">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/14638-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/14638-1">
			>
		>
	>
	adl_version = <"2.0.5">
