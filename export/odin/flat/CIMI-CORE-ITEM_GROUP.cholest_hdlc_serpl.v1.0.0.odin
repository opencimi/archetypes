(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/9830-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cholesterol.total/Cholesterol in HDL [Mass Ratio] in Serum or Plasma' concept">
				use = <"Use for Cholesterol.total/Cholesterol in HDL [Mass Ratio] in Serum or Plasma.">
				keywords = <"Cholest", "TC", "Cholesterols", "HDLc", "TCHHDL", "HDL-C", "High density lipoprotein cholesterols", "Chol", "Choles", "Lipid", "Cholest/HDLc", "Mass concentration ratio", "Mass ratio", "MCRto", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cholest_hdlc_serpl.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cholest_hdlc_serpl">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cholesterol.total/Cholesterol in HDL [Mass Ratio] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{ratio}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/9830-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/9830-1">
			>
		>
	>
	adl_version = <"2.0.5">
