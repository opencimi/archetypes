(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/14958-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Microalbumin/Creatinine [Mass Ratio] in 24 hour Urine' concept">
				use = <"Use for Microalbumin/Creatinine [Mass Ratio] in 24 hour Urine.">
				keywords = <"Protein.albumin", "Alb", "Creat", "Crea", "CR", "Mass concentration ratio", "Mass ratio", "MCRto", "1 day", "24 hours", "24HR", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "DL=20 mg/L", "DL=20 mg/L", "Chemistry", "MA", "Malb", "Micro albumin", "Microalbumin", "UCr">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.albumin_pre_by_microalbuminur_24h_creat.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"albumin_pre_by_microalbuminur_24h_creat">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Microalbumin/Creatinine [Mass Ratio] in 24 hour Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/g{creat}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/14958-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/14958-3">
			>
		>
	>
	adl_version = <"2.0.5">
