(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/11054-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cholesterol in LDL/Cholesterol in HDL [Mass Ratio] in Serum or Plasma' concept">
				use = <"Use for Cholesterol in LDL/Cholesterol in HDL [Mass Ratio] in Serum or Plasma.">
				keywords = <"LDLc", "LDL-C", "Low density lipoprotein cholesterols", "Low density lipoprotein cholesterol", "HDLc", "TCHHDL", "HDL-C", "High density lipoprotein cholesterols", "Chol", "Choles", "Cholest", "Lipid", "Cholesterol total", "Cholesterols", "LDLc/HDLc", "Mass concentration ratio", "Mass ratio", "MCRto", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ldlc_hdlc_serpl.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ldlc_hdlc_serpl">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cholesterol in LDL/Cholesterol in HDL [Mass Ratio] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{ratio}">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/118586006">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/11054-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/11054-4">
			>
		>
	>
	adl_version = <"2.0.5">
