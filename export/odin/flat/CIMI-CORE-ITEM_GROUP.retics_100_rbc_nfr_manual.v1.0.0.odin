(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/31112-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Reticulocytes/100 erythrocytes in Blood by Manual' concept">
				use = <"Use for Reticulocytes/100 erythrocytes in Blood by Manual.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.retics_100_rbc_nfr_manual.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"retics_100_rbc_nfr_manual">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Reticulocytes/100 erythrocytes in Blood by Manual">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/31112-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/31112-6">
			>
		>
	>
	adl_version = <"2.0.5">
