(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/43399-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'JAK2 gene p.V617F [Presence] in Blood or Tissue by Molecular genetics method' concept">
				use = <"Use for JAK2 gene p.V617F [Presence] in Blood or Tissue by Molecular genetics method.">
				keywords = <"JAK2 p.V617F", "PV", "Janus kinase 2 gene", "Erythrocytosis", "Polycythemia vera", "Arbitrary", "Point in time", "Random", "Bld/T", "Tissue", "Bld/T", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "PCR", "Molecular genetics", "P prime", "MOLPATH.MUTATIONS", "MOLPATH.MUTATIONS", "Molecular pathology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.jak2_p_v617f_bld_t_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"jak2_p_v617f_bld_t_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"JAK2 gene p.V617F [Presence] in Blood or Tissue by Molecular genetics method">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/43399-5">
			>
			["opencem"] = <
