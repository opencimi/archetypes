(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/14956-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Microalbumin [Mass/time] in 24 hour Urine' concept">
				use = <"Use for Microalbumin [Mass/time] in 24 hour Urine.">
				keywords = <"Protein.albumin", "Alb", "mRate", "Mass rate", "1 day", "24 hours", "24HR", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "DL=20 mg/L", "DL=20 mg/L", "Chemistry", "MA", "Malb", "Micro albumin", "Microalbumin">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.microalbumin_24h_urmrate.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"microalbumin_24h_urmrate">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Microalbumin [Mass/time] in 24 hour Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/(24.h)">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/14956-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/14956-7">
			>
		>
	>
	adl_version = <"2.0.5">
