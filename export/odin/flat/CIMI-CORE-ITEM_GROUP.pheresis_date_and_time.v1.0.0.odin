(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49542-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Date and time of pheresis procedure' concept">
				use = <"Use for Date and time of pheresis procedure.">
				keywords = <"Pheresis Date&Time", "Time stamp", "Timestamp", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pheresis_date_and_time.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pheresis_date_and_time">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Date and time of pheresis procedure">
				>
				["at0.0.0.0.0.2"] = <
					text = <"">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49542-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49542-4">
			>
		>
	>
	adl_version = <"2.0.5">
