(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49540-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Acid citrate dextrose [Volume] in Blood product unit' concept">
				use = <"Use for Acid citrate dextrose [Volume] in Blood product unit.">
				keywords = <"Citric acid", "ACD", "Volume", "Point in time", "Random", "Blood product unit", "Quantitative", "QNT", "Quant", "Quan", "Acids", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.acid_citrate_dextrose_vol_bpu.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"acid_citrate_dextrose_vol_bpu">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Acid citrate dextrose [Volume] in Blood product unit">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mL">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258773002">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49540-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49540-8">
			>
		>
	>
	adl_version = <"2.0.5">
