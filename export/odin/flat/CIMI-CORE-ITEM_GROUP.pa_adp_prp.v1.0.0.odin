(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5992-3.html>">
			["tool"] = <"cimi-gen v0.0.1">
			["time"] = <"2015-08-05T22:27:53">
		>
		details = <
			["en"] = <
				language = <[ISO_639-1::en]>
				purpose = <"Archetype for CIMI 'Platelet aggregation ADP induced [Substance threshold] in Platelet rich plasma' concept">
				use = <"Use for Platelet aggregation ADP induced [Substance threshold] in Platelet rich plasma.">
				keywords = <"PA ADP", "P2Y12 Assay", "P2Y12 inhibition", "Plavix response assay", "Clopidogrel response assay", "Plt", "Pl", "Platelets", "Thrombocytes", "Platelt", "Thrombocyte", "Adenosine Pyrophosphate", "Adenosine 5'-Pyrophosphate", "Threshold substance concentration", "Point in time", "Random", "Platelet rich plasma", "Quantitative", "QNT", "Quant", "Quan", "Agg", "Aggr", "ANED", "Medication stress", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pa_adp_prp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pa_adp_prp">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5992-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5992-3">
			>
		>
	>
	adl_version = <"2.0.5">
