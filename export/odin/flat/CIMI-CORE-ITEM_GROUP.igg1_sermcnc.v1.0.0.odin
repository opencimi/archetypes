(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2466-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'IgG subclass 1 [Mass/volume] in Serum' concept">
				use = <"Use for IgG subclass 1 [Mass/volume] in Serum.">
				keywords = <"IgG1", "IgG 1", "Immunoglobulin G subclass 1", "Immune globulin G", "Mass concentration", "Level", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "Subclasses", "I", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.igg1_sermcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"igg1_sermcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"IgG subclass 1 [Mass/volume] in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2466-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2466-1">
			>
		>
	>
	adl_version = <"2.0.5">
