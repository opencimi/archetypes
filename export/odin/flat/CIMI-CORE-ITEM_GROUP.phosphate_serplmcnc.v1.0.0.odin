(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2777-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Phosphate [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Phosphate [Mass/volume] in Serum or Plasma.">
				keywords = <"Phos", "Phosphrous", "Phosphorous", "Pi", "i Phos", "PO4", "Phosphorus", "Inorganic phosphate", "Phosphate total", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.phosphate_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"phosphate_serplmcnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2777-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2777-1">
			>
		>
	>
	adl_version = <"2.0.5">
