(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/8335-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Body weight Estimated' concept">
				use = <"Use for Body weight Estimated.">
				keywords = <"Wt", "Bdy weight", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "Est", "estimation", "bod", "Bodies", "BODY WEIGHT.ATOM", "BODY WEIGHT.ATOM">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.weight_pre_by_est.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"weight_pre_by_est">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/8335-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/8335-2">
			>
		>
	>
	adl_version = <"2.0.5">
