(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/50791-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemoglobin pattern [interpretation] in Blood by Electrophoresis acid (pH 6.0)' concept">
				use = <"Use for Hemoglobin pattern [interpretation] in Blood by Electrophoresis acid (pH 6.0).">
				keywords = <"Hgb Fract", "Hb", "Haemoglobin", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Blood", "WB", "Whole blood", "Nominal", "Elph pH6.0", "Elp", "Elect", "Electrophrs", "Electrophhrs", "Electr", "Elec", "Ep", "Electro", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hgb_fract_bldimp_pre_by_bld_elph_ph6_0imp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hgb_fract_bldimp_pre_by_bld_elph_ph6_0imp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hemoglobin pattern [interpretation] in Blood by Electrophoresis acid (pH 6.0)">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Hemoglobin pattern [interpretation] in Blood by Electrophoresis acid (pH 6.0)">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/50791-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/50791-3">
			>
		>
	>
	adl_version = <"2.0.5">
