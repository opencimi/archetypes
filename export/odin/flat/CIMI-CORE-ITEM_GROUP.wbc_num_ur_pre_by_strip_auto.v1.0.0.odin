(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/58805-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Leukocytes [#/volume] in Urine by Automated test strip' concept">
				use = <"Use for Leukocytes [#/volume] in Urine by Automated test strip.">
				keywords = <"WBC", "White blood cell", "Leuc", "Leuk", "Leukocyte", "Lkcs", "White blood cells", "WBCs", "#", "Number concentration", "Count/volume", "Count", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Ur", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Strip.auto", "Strip.auto", "Dipstick", "Dip stick", "Auto", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.wbc_num_ur_pre_by_strip_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"wbc_num_ur_pre_by_strip_auto">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Leukocytes [#/volume] in Urine by Automated test strip">
				>
				["at0.0.0.0.0.2"] = <
					text = <"/uL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/58805-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/58805-3">
			>
		>
	>
	adl_version = <"2.0.5">
