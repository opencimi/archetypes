(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/655-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Microscopic observation [Identifier] in Unspecified specimen by Acid fast stain.Kinyoun modified' concept">
				use = <"Use for Microscopic observation [Identifier] in Unspecified specimen by Acid fast stain.Kinyoun modified.">
				keywords = <"Identity or presence", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Nominal", "Acid fast Mod Kiny Stn", "Acid fast Kiny Stn", "Acid fast Stn", "AFB stain", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.acid_fast_mod_kiny_stn_xxx.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"acid_fast_mod_kiny_stn_xxx">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Microscopic observation [Identifier] in Unspecified specimen by Acid fast stain.Kinyoun modified">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Microscopic observation [Identifier] in Unspecified specimen by Acid fast stain.Kinyoun modified">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/655-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/655-1">
			>
		>
	>
	adl_version = <"2.0.5">
