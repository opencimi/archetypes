(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/11559-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fractional oxyhemoglobin in Blood' concept">
				use = <"Use for Fractional oxyhemoglobin in Blood.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.oxyhgb_mfr_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"oxyhgb_mfr_bld">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/11559-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/11559-2">
			>
		>
	>
	adl_version = <"2.0.5">
