(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6568-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Trichomonas vaginalis rRNA [Presence] in Genital specimen by DNA probe' concept">
				use = <"Use for Trichomonas vaginalis rRNA [Presence] in Genital specimen by DNA probe.">
				keywords = <"T vaginalis", "Trichimoniasis", "Arbitrary concentration", "Point in time", "Random", "Gen", "Genital tract", "Urogenit", "Urogenital", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Prb", "DNA probe", "Trich", "Tric", "Trichomonad", "Trichomonads", "Trichomoniasis", "ribosomal RNA", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.t_vaginalis_rrna_genital_ql_prb.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"t_vaginalis_rrna_genital_ql_prb">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Trichomonas vaginalis rRNA [Presence] in Genital specimen by DNA probe">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Trichomonas vaginalis rRNA [Presence] in Genital specimen by DNA probe">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6568-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6568-0">
			>
		>
	>
	adl_version = <"2.0.5">
