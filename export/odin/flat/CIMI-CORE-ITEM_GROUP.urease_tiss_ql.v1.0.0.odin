(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32637-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Urease [Presence] in Tissue' concept">
				use = <"Use for Urease [Presence] in Tissue.">
				keywords = <"Clotest", "Helicobacter pylori biopsy test", "CLO test", "Arbitrary concentration", "Point in time", "Random", "Tissue", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.urease_tiss_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"urease_tiss_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Urease [Presence] in Tissue">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32637-1">
			>
			["opencem"] = <
