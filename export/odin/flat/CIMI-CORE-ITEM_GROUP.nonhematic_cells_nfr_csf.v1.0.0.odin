(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/30456-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Nonhematic cells/100 leukocytes in Cerebral spinal fluid' concept">
				use = <"Use for Nonhematic cells/100 leukocytes in Cerebral spinal fluid.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.nonhematic_cells_nfr_csf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"nonhematic_cells_nfr_csf">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/30456-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/30456-8">
			>
		>
	>
	adl_version = <"2.0.5">
