(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1742-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Alanine aminotransferase [Enzymatic activity/volume] in Serum or Plasma' concept">
				use = <"Use for Alanine aminotransferase [Enzymatic activity/volume] in Serum or Plasma.">
				keywords = <"ALT", "ALAT", "Glutamic-pyruvic transferase", "SGPT", "Alanine transaminase", "Ala", "L-alanine", "Alpha alanine", "Catalytic Concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.alt_serplccnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"alt_serplccnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1742-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1742-6">
			>
		>
	>
	adl_version = <"2.0.5">
