(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/40750-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Epstein Barr virus capsid IgG Ab [Presence] in Serum by Immunofluorescence' concept">
				use = <"Use for Epstein Barr virus capsid IgG Ab [Presence] in Serum by Immunofluorescence.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ebv_vca_igg_ser_ql_pre_by_if.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ebv_vca_igg_ser_ql_pre_by_if">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Epstein Barr virus capsid IgG Ab [Presence] in Serum by Immunofluorescence">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Epstein Barr virus capsid IgG Ab [Presence] in Serum by Immunofluorescence">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/40750-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/40750-2">
			>
		>
	>
	adl_version = <"2.0.5">
