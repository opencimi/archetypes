(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6604-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Influenza virus identified in Unspecified specimen by Organism specific culture' concept">
				use = <"Use for Influenza virus identified in Unspecified specimen by Organism specific culture.">
				keywords = <"FLUV", "Influ", "Identity or presence", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Nominal", "Cult", "Cultures", "C&S", "Isolated", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fluv_xxx_pre_by_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fluv_xxx_pre_by_cult">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Influenza virus identified in Unspecified specimen by Organism specific culture">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Influenza virus identified in Unspecified specimen by Organism specific culture">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6604-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6604-3">
			>
		>
	>
	adl_version = <"2.0.5">
