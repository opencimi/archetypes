(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/46744-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Organic acidemias newborn screen interpretation' concept">
				use = <"Use for Organic acidemias newborn screen interpretation.">
				keywords = <"OA", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "DBS", "Filter paper", "FP", "Dried blood spot", "Blood", "WB", "Whole blood", "Nominal", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.oa_dbsimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"oa_dbsimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Organic acidemias newborn screen interpretation">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Organic acidemias newborn screen interpretation">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/46744-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/46744-9">
			>
		>
	>
	adl_version = <"2.0.5">
