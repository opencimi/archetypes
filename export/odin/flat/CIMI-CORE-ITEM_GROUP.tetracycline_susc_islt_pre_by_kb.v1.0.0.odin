(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/497-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Tetracycline [Susceptibility] by Disk diffusion (KB)' concept">
				use = <"Use for Tetracycline [Susceptibility] by Disk diffusion (KB).">
				keywords = <"C18", "c211", "C75", "Achromycin V", "Chemiciclina", "Panmycin", "Tetrabioptal", "Susceptibility", "Susceptibilty", "Sus", "Suscept", "Susceptibilities", "AST", "Point in time", "Random", "Islt", "Isol", "KB", "Kirby-bauer", "Disk diffusion", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.tetracycline_susc_islt_pre_by_kb.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"tetracycline_susc_islt_pre_by_kb">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Tetracycline [Susceptibility] by Disk diffusion (KB)">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Tetracycline [Susceptibility] by Disk diffusion (KB)">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/497-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/497-8">
			>
		>
	>
	adl_version = <"2.0.5">
