(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5095-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Coccidioides immitis Ab [Presence] in Serum by Immune diffusion (ID)' concept">
				use = <"Use for Coccidioides immitis Ab [Presence] in Serum by Immune diffusion (ID).">
				keywords = <"C immitis", "Coccio", "Coccidioides esteriformis", "C esteriformis", "Blastomycoides immitis", "B immitis", "Geotrichum immite", "G immite", "Glenospora metaeuropea", "G metaeuropea", "Glenosporum louisianoideum", "G louisianoideum", "Posadasia esteriformis", "P esteriformis", "Pseudococcidioides mazzai", "P mazzai", "Trichosporon proteolyticum", "T proteolyticum", "Coccidiomycosis", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ID", "Immunodiff", "Immunodiffusion", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Imun", "Imune", "Imm", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.c_immitis_ab_ser_ql_pre_by_id.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"c_immitis_ab_ser_ql_pre_by_id">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Coccidioides immitis Ab [Presence] in Serum by Immune diffusion (ID)">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Coccidioides immitis Ab [Presence] in Serum by Immune diffusion (ID)">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5095-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5095-5">
			>
		>
	>
	adl_version = <"2.0.5">
