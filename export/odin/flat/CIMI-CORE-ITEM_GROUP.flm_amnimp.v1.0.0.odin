(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/47226-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fetal lung maturity [interpretation] in Amniotic fluid' concept">
				use = <"Use for Fetal lung maturity [interpretation] in Amniotic fluid.">
				keywords = <"FLM", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Amn", "Amniotic fluid", "Amn fl", "Amniotic flu", "AF", "Nominal", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.flm_amnimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"flm_amnimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Fetal lung maturity [interpretation] in Amniotic fluid">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Fetal lung maturity [interpretation] in Amniotic fluid">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/47226-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/47226-6">
			>
		>
	>
	adl_version = <"2.0.5">
