(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19145-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Reference lab test name' concept">
				use = <"Use for Reference lab test name.">
				keywords = <"Ref Lab Test Name", "Typ", "?Tm", "Narrative", "Report">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ref_lab_test_name.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ref_lab_test_name">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19145-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19145-2">
			>
		>
	>
	adl_version = <"2.0.5">
