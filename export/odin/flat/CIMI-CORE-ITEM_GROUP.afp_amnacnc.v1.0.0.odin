(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19171-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Alpha-1-Fetoprotein [Units/volume] in Amniotic fluid' concept">
				use = <"Use for Alpha-1-Fetoprotein [Units/volume] in Amniotic fluid.">
				keywords = <"AFP", "Alphafetoprotein", "Alpha fetoprotein", "Arbitrary concentration", "Point in time", "Random", "Amn", "Amniotic fluid", "Amn fl", "Amniotic flu", "AF", "Quantitative", "QNT", "Quant", "Quan", "Feto", "A1", "Alfa", "I", "Chemistry", "AFAFP">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.afp_amnacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"afp_amnacnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Alpha-1-Fetoprotein [Units/volume] in Amniotic fluid">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[IU]/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19171-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19171-8">
			>
		>
	>
	adl_version = <"2.0.5">
