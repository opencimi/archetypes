(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19593-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI '6-Monoacetylmorphine (6-MAM) [Mass/volume] in Urine by Confirmatory method' concept">
				use = <"Use for 6-Monoacetylmorphine (6-MAM) [Mass/volume] in Urine by Confirmatory method.">
				keywords = <"6MAM", "6 MAM", "6-acetylmorphine", "Acetylmorphine", "6 mono acetyl morphine", "Heroin metabolite", "Mass concentration", "Level", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Cfm", "CNFR", "CNFRM", "Conf", "Confirmation", "GCMS", "Confirmatory", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.6mam_urmcnc_pre_by_ur_cfmmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"6mam_urmcnc_pre_by_ur_cfmmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"6-Monoacetylmorphine (6-MAM) [Mass/volume] in Urine by Confirmatory method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19593-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19593-3">
			>
		>
	>
	adl_version = <"2.0.5">
