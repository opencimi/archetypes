(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/53129-3.html>">
			["tool"] = <"cimi-gen v0.0.1">
			["time"] = <"2015-08-05T22:27:36">
		>
		details = <
			["en"] = <
				language = <[ISO_639-1::en]>
				purpose = <"Archetype for CIMI 'Sodium urate crystals [#/area] in Urine sediment by Microscopy high power field' concept">
				use = <"Use for Sodium urate crystals [#/area] in Urine sediment by Microscopy high power field.">
				keywords = <"Urate Cry", "Urates", "Uric acid", "Na Urate Cry", "NaU", "Monosodium Urate", "Na+", "Cryst", "Crys", "Crystal", "#/area", "Number areic", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Micro", "LM", "Micros", "Microscopic", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.na_urate_cry_num_per_area_urns_hpf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"na_urate_cry_num_per_area_urns_hpf">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/53129-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/53129-3">
			>
		>
	>
	adl_version = <"2.0.5">
