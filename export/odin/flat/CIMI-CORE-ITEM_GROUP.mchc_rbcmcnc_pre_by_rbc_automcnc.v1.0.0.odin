(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/786-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Erythrocyte mean corpuscular hemoglobin concentration [Mass/volume] by Automated count' concept">
				use = <"Use for Erythrocyte mean corpuscular hemoglobin concentration [Mass/volume] by Automated count.">
				keywords = <"Hgb", "Hb", "Haemoglobin", "MCHC", "MCH", "Erythrocytes", "Red blood corpusles", "Red blood corpuscle", "Red blood cell", "Red cell", "Red cells", "Discocyte", "Erc", "Red blood cells", "Mass concentration", "Level", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "Auto", "Average", "Avg", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.mchc_rbcmcnc_pre_by_rbc_automcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"mchc_rbcmcnc_pre_by_rbc_automcnc">
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258795003">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/786-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/786-4">
			>
		>
	>
	adl_version = <"2.0.5">
