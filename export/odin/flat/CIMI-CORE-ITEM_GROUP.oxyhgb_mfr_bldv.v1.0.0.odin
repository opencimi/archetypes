(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2716-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fractional oxyhemoglobin in Venous blood' concept">
				use = <"Use for Fractional oxyhemoglobin in Venous blood.">
				keywords = <"OxyHgb", "Oxygenated hemoglobin", "Oxygenated haemoglobin", "Haemoglobin oxygenated", "Hemoglobin oxygenated", "Oxyhaemoglobin", "HbO2", "O2Hb", "Hgb", "Hb", "Mass fraction", "Percent", "Point in time", "Random", "Blood - venous", "Bld ven", "Bld venous", "Blood venus", "Blood ven", "Venous", "Quantitative", "QNT", "Quant", "Quan", "Tot", "Totl", "Chemistry", "SO2", "Oxygen saturation", "O2 saturation", "Fractional hemoglobin", "FO2Hb">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.oxyhgb_mfr_bldv.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"oxyhgb_mfr_bldv">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2716-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2716-9">
			>
		>
	>
	adl_version = <"2.0.5">
