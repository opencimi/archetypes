(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2704-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oxygen [Partial pressure] in Capillary blood' concept">
				use = <"Use for Oxygen [Partial pressure] in Capillary blood.">
				keywords = <"O2", "tO2", "Partial pressure", "Point in time", "Random", "Cap blood", "Cap bld", "Capillary bld", "Capillary blood", "Finger stick", "Quantitative", "QNT", "Quant", "Quan", "Chemistry", "O2 partial pressure", "PO2">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.po2_bldc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"po2_bldc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2704-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2704-5">
			>
		>
	>
	adl_version = <"2.0.5">
