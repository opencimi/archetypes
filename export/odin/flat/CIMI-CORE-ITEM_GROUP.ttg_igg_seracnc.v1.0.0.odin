(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32998-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Tissue transglutaminase IgG Ab [Units/volume] in Serum' concept">
				use = <"Use for Tissue transglutaminase IgG Ab [Units/volume] in Serum.">
				keywords = <"TG2", "Celiac disease", "tTG", "Protein-glutamine gamma glutamyltransferase", "Fibrin stabilizing factor", "Immune globulin G", "Immunoglobulin G", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ttg_igg_seracnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ttg_igg_seracnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Tissue transglutaminase IgG Ab [Units/volume] in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[arb'U]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32998-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32998-7">
			>
		>
	>
	adl_version = <"2.0.5">
