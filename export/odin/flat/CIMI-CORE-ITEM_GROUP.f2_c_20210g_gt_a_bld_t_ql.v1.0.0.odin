(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/24475-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'F2 gene c.20210G>A [Presence] in Blood or Tissue by Molecular genetics method' concept">
				use = <"Use for F2 gene c.20210G>A [Presence] in Blood or Tissue by Molecular genetics method.">
				keywords = <"F2 c.20210G>A", "Prothrombin precursor", "Coagulation Factor 2 gene", "Prothrombin gene", "Coagulation Factor II gene", "Arbitrary", "Point in time", "Random", "Bld/T", "Tissue", "Bld/T", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "PCR", "Molecular genetics", "MOLPATH.MUTATIONS", "MOLPATH.MUTATIONS", "Molecular pathology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.f2_c_20210g_gt_a_bld_t_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"f2_c_20210g_gt_a_bld_t_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"F2 gene c.20210G>A [Presence] in Blood or Tissue by Molecular genetics method">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/24475-6">
			>
			["opencem"] = <
