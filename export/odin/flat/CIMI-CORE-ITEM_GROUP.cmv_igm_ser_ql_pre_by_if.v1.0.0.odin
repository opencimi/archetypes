(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49539-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cytomegalovirus IgM Ab [Presence] in Serum by Immunofluorescence' concept">
				use = <"Use for Cytomegalovirus IgM Ab [Presence] in Serum by Immunofluorescence.">
				keywords = <"Immune globulin M", "Immunoglobulin M", "Cytomgal", "Cytomegalo virus", "CMV", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ACIF", "FA", "Fluorescent antibody", "Immune fluorescence", "Fluoresent", "Immunoflour", "Immunofluor", "Immunofluorescence", "IFA", "Time Resolved Fluorescence", "Anticomplement Immunofluorescence", "TRF", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cmv_igm_ser_ql_pre_by_if.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cmv_igm_ser_ql_pre_by_if">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cytomegalovirus IgM Ab [Presence] in Serum by Immunofluorescence">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Cytomegalovirus IgM Ab [Presence] in Serum by Immunofluorescence">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49539-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49539-0">
			>
		>
	>
	adl_version = <"2.0.5">
