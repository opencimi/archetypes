(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1761-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Aldolase [Enzymatic activity/volume] in Serum or Plasma' concept">
				use = <"Use for Aldolase [Enzymatic activity/volume] in Serum or Plasma.">
				keywords = <"Fructose Aldolase", "Fructose Biphosphate Aldolase", "Catalytic Concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.aldolase_serplccnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"aldolase_serplccnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Aldolase [Enzymatic activity/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mU/mL">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258954009">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1761-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1761-6">
			>
		>
	>
	adl_version = <"2.0.5">
