(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6349-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Chlamydia trachomatis [Presence] in Unspecified specimen by Organism specific culture' concept">
				use = <"Use for Chlamydia trachomatis [Presence] in Unspecified specimen by Organism specific culture.">
				keywords = <"C trach", "C trac", "C trachomatis", "Chlam trac", "C tracho", "CT", "Trachoma", "Lymphogranuloma venereum", "LGV", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Cult", "Cultures", "C&S", "Chlamid", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.c_trach_xxx_ql_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"c_trach_xxx_ql_cult">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Chlamydia trachomatis [Presence] in Unspecified specimen by Organism specific culture">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Chlamydia trachomatis [Presence] in Unspecified specimen by Organism specific culture">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6349-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6349-5">
			>
		>
	>
	adl_version = <"2.0.5">
