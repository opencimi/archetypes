(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/11778-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Delivery date Estimated' concept">
				use = <"Use for Delivery date Estimated.">
				keywords = <"Deliv date", "Due date", "Date of confinement", "Time stamp", "Date and time", "Timestamp", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "Clin est", "Est", "estimation", "OBSTERICAL.ULTRASOUND", "OBSTERICAL.ULTRASOUND", "Obstetrical", "Obstetrics", "EDC", "EDD">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.deliv_date_clin_est.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"deliv_date_clin_est">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/11778-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/11778-8">
			>
		>
	>
	adl_version = <"2.0.5">
