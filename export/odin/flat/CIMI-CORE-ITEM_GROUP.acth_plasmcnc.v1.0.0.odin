(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2141-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Corticotropin [Mass/volume] in Plasma' concept">
				use = <"Use for Corticotropin [Mass/volume] in Plasma.">
				keywords = <"ACTH", "Rc206", "c74", "Cortrosyn", "c206", "Adrenocorticotropin", "Adrenocorticotrophic hormone", "Mass concentration", "Level", "Point in time", "Random", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.acth_plasmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"acth_plasmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Corticotropin [Mass/volume] in Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"pg/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2141-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2141-0">
			>
		>
	>
	adl_version = <"2.0.5">
