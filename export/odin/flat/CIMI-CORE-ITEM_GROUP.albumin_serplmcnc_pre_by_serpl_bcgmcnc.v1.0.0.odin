(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/61151-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Albumin [Mass/volume] in Serum or Plasma by Bromocresol green (BCG) dye binding method' concept">
				use = <"Use for Albumin [Mass/volume] in Serum or Plasma by Bromocresol green (BCG) dye binding method.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.albumin_serplmcnc_pre_by_serpl_bcgmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"albumin_serplmcnc_pre_by_serpl_bcgmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Albumin [Mass/volume] in Serum or Plasma by Bromocresol green (BCG) dye binding method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"g/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/61151-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/61151-7">
			>
		>
	>
	adl_version = <"2.0.5">
