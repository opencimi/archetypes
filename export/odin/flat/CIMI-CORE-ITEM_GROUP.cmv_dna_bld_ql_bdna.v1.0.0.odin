(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/28008-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cytomegalovirus DNA [Presence] in Blood by Probe and signal amplification method' concept">
				use = <"Use for Cytomegalovirus DNA [Presence] in Blood by Probe and signal amplification method.">
				keywords = <"Deoxyribonucleic acid", "CMV", "Cytomgal", "Cytomegalo virus", "Arbitrary concentration", "Point in time", "Random", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "bDNA", "HPA", "Hybidization Protection Assay", "Bdn-A", "Branched Chain DNA", "Hybrid Capture", "Probe with signal amplification", "Hybrid Capture nucleic acid hybridization", "HC", "Amp Prb", "Probe with ampification", "DNA probe", "Amplification", "Amplified", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cmv_dna_bld_ql_bdna.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cmv_dna_bld_ql_bdna">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cytomegalovirus DNA [Presence] in Blood by Probe and signal amplification method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Cytomegalovirus DNA [Presence] in Blood by Probe and signal amplification method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/28008-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/28008-1">
			>
		>
	>
	adl_version = <"2.0.5">
