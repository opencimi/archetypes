(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/35270-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Candida sp Ab [Presence] in Serum by Immune diffusion (ID)' concept">
				use = <"Use for Candida sp Ab [Presence] in Serum by Immune diffusion (ID).">
				keywords = <"Monilia", "Thrush", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ID", "Immunodiff", "Immunodiffusion", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Imun", "Imune", "Imm", "species", "spp", "Cand", "Candidiasis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.candida_ab_ser_ql_pre_by_id.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"candida_ab_ser_ql_pre_by_id">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Candida sp Ab [Presence] in Serum by Immune diffusion (ID)">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/35270-8">
			>
			["opencem"] = <
