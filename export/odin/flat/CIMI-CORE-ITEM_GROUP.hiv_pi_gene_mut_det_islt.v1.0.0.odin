(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33630-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'HIV protease gene mutations detected [Identifier]' concept">
				use = <"Use for HIV protease gene mutations detected [Identifier].">
				keywords = <"HIV PI gene mut", "AIDS", "Human immunodeficiency virus", "Identity or presence", "Point in time", "Random", "Islt", "Isol", "Nominal", "Mut Det", "PR", "Mutation", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hiv_pi_gene_mut_det_islt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hiv_pi_gene_mut_det_islt">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"HIV protease gene mutations detected [Identifier]">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33630-5">
			>
			["opencem"] = <
