(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20499-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Phosphatidylglycerol/Surfactant.total in Amniotic fluid' concept">
				use = <"Use for Phosphatidylglycerol/Surfactant.total in Amniotic fluid.">
				keywords = <"PG", "Phosphotidylglycerol", "Phosphatidyl glycerol", "Fetal lung maturity", "Mass fraction", "Percent", "Point in time", "Random", "Amn", "Amniotic fluid", "Amn fl", "Amniotic flu", "AF", "Quantitative", "QNT", "Quant", "Quan", "Tot", "Totl", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pg_mfr_amn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pg_mfr_amn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Phosphatidylglycerol/Surfactant.total in Amniotic fluid">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20499-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20499-0">
			>
		>
	>
	adl_version = <"2.0.5">
