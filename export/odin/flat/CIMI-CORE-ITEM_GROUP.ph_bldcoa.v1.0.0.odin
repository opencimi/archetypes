(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/28646-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'pH of Arterial cord blood' concept">
				use = <"Use for pH of Arterial cord blood.">
				keywords = <"Log molar concentration", "Point in time", "Random", "Bld cord", "Cord arterial blood", "Cord BldA", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ph_bldcoa.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ph_bldcoa">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"pH of Arterial cord blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[pH]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/28646-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/28646-8">
			>
		>
	>
	adl_version = <"2.0.5">
