(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/46995-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'HLA-DP+DQ+DR (class II) Ab in Serum' concept">
				use = <"Use for HLA-DP+DQ+DR (class II) Ab in Serum.">
				keywords = <"HLA class II", "Human Leukocyte Antigen", "Number fraction", "Percent", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "HLA ANTIGEN">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hladp_plus_dq_plus_dr_ab_nfr_ser.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hladp_plus_dq_plus_dr_ab_nfr_ser">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"HLA-DP+DQ+DR (class II) Ab in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/46995-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/46995-7">
			>
		>
	>
	adl_version = <"2.0.5">
