(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5785-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Eosinophils [#/area] in Urine sediment by Microscopy high power field' concept">
				use = <"Use for Eosinophils [#/area] in Urine sediment by Microscopy high power field.">
				keywords = <"Eosinophil", "Eos", "Eosins", "Eosin", "Eosino", "#/area", "Number areic", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Micro", "LM", "Micros", "Microscopic", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.eosinophil_num_per_area_urns_hpf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"eosinophil_num_per_area_urns_hpf">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5785-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5785-1">
			>
		>
	>
	adl_version = <"2.0.5">
