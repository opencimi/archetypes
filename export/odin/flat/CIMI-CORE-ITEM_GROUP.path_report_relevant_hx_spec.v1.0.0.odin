(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/22636-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Pathology report relevant history Narrative' concept">
				use = <"Use for Pathology report relevant history Narrative.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.path_report_relevant_hx_spec.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"path_report_relevant_hx_spec">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Pathology report relevant history Narrative">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Pathology report relevant history Narrative">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/22636-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/22636-5">
			>
		>
	>
	adl_version = <"2.0.5">
