(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5995-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Platelet aggregation collagen induced [Mass threshold] in Platelet rich plasma' concept">
				use = <"Use for Platelet aggregation collagen induced [Mass threshold] in Platelet rich plasma.">
				keywords = <"PA Coll", "Plt", "Pl", "Platelets", "Thrombocytes", "Platelt", "Thrombocyte", "Threshold mass concentration", "Point in time", "Random", "Platelet rich plasma", "Quantitative", "QNT", "Quant", "Quan", "Agg", "Aggr", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pa_coll_prp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pa_coll_prp">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5995-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5995-6">
			>
		>
	>
	adl_version = <"2.0.5">
