(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/28645-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Carbon dioxide [Partial pressure] in Venous cord blood' concept">
				use = <"Use for Carbon dioxide [Partial pressure] in Venous cord blood.">
				keywords = <"CO2", "Carbonic anhydride", "Partial pressure", "Point in time", "Random", "Bld cord", "Cord venous blood", "Cord BldV", "Quantitative", "QNT", "Quant", "Quan", "Chemistry", "PCO2">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pco2_bldcov.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pco2_bldcov">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Carbon dioxide [Partial pressure] in Venous cord blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mm[Hg]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/28645-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/28645-0">
			>
		>
	>
	adl_version = <"2.0.5">
