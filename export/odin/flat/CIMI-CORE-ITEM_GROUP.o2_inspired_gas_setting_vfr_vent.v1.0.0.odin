(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19994-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oxygen/Inspired gas setting [Volume Fraction] Ventilator' concept">
				use = <"Use for Oxygen/Inspired gas setting [Volume Fraction] Ventilator.">
				keywords = <"O2", "tO2", "Volume fraction", "Volfr", "Percent", "Point in time", "Random", "Vent", "Quantitative", "QNT", "Quant", "Quan", "Gases", "FIO2", "PULMONARY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.o2_inspired_gas_setting_vfr_vent.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"o2_inspired_gas_setting_vfr_vent">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Oxygen/Inspired gas setting [Volume Fraction] Ventilator">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19994-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19994-3">
			>
		>
	>
	adl_version = <"2.0.5">
