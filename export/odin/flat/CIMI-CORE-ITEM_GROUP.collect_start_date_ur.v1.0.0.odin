(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19088-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Collection of urine specimen start date' concept">
				use = <"Use for Collection of urine specimen start date.">
				keywords = <"Collect Start Date", "Time stamp", "Date and time", "Timestamp", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Started", "Coll", "Collected">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.collect_start_date_ur.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"collect_start_date_ur">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Collection of urine specimen start date">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{date}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19088-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19088-4">
			>
		>
	>
	adl_version = <"2.0.5">
