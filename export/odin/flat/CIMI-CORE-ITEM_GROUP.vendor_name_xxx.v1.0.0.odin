(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/59841-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Vendor name [Identifier] in Unspecified specimen' concept">
				use = <"Use for Vendor name [Identifier] in Unspecified specimen.">
				keywords = <"Identifier", "Ident", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Nominal", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.vendor_name_xxx.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"vendor_name_xxx">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Vendor name [Identifier] in Unspecified specimen">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Vendor name [Identifier] in Unspecified specimen">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/59841-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/59841-7">
			>
		>
	>
	adl_version = <"2.0.5">
