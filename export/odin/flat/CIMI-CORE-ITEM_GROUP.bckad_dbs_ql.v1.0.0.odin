(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/38479-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Branched chain keto-acid dehydrogenase complex [Presence] in Dried blood spot' concept">
				use = <"Use for Branched chain keto-acid dehydrogenase complex [Presence] in Dried blood spot.">
				keywords = <"BCKAD", "BCKADH", "BCKDH", "BCKDC", "Branch chain ketoaciduria", "Maple syrup urine disease", "MSUD", "Arbitrary concentration", "Point in time", "Random", "DBS", "Filter paper", "FP", "Dried blood spot", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Dehydrog", "Dehyrdogenase", "Compx", "Chn", "Chains", "Acd", "Acids", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bckad_dbs_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bckad_dbs_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Branched chain keto-acid dehydrogenase complex [Presence] in Dried blood spot">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Branched chain keto-acid dehydrogenase complex [Presence] in Dried blood spot">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/38479-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/38479-2">
			>
		>
	>
	adl_version = <"2.0.5">
