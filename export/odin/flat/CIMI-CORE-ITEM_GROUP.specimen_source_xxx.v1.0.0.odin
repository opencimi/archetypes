(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/31208-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Specimen source [Identifier] of Unspecified specimen' concept">
				use = <"Use for Specimen source [Identifier] of Unspecified specimen.">
				keywords = <"Identity or presence", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Nominal", "Srce">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.specimen_source_xxx.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"specimen_source_xxx">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Specimen source [Identifier] of Unspecified specimen">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/31208-2">
			>
			["opencem"] = <
