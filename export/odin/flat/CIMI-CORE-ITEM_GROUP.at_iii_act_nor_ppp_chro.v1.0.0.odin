(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/27811-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Antithrombin actual/normal in Platelet poor plasma by Chromogenic method' concept">
				use = <"Use for Antithrombin actual/normal in Platelet poor plasma by Chromogenic method.">
				keywords = <"AT III", "ATIII", "Antithrombn", "Antithrm", "Anti thrombin", "Antithrombin III", "Heparin cofactor I", "Thrombin inhibitor I", "Nor", "RlCCnc", "Point in time", "Random", "Platelet poor plasma", "Plas", "Quantitative", "QNT", "Quant", "Quan", "Chro", "Enzymatic assay", "Chromogenic assay", "ENZY", "Act/Nor", "Control", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.at_iii_act_nor_ppp_chro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"at_iii_act_nor_ppp_chro">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Antithrombin actual/normal in Platelet poor plasma by Chromogenic method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/27811-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/27811-9">
			>
		>
	>
	adl_version = <"2.0.5">
