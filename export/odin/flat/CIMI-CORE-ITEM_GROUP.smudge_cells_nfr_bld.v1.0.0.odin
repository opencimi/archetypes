(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/34992-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Smudge cells/100 leukocytes in Blood' concept">
				use = <"Use for Smudge cells/100 leukocytes in Blood.">
				keywords = <"Basket cells", "WBC", "White blood cell", "Leuc", "Leuk", "Leukocyte", "Lkcs", "White blood cells", "WBCs", "Cell", "Cellularity", "100WBC", "Number fraction", "Percent", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.smudge_cells_nfr_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"smudge_cells_nfr_bld">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/34992-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/34992-8">
			>
		>
	>
	adl_version = <"2.0.5">
