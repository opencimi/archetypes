(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3173-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Activated partial thromboplastin time (aPTT) in Blood by Coagulation assay' concept">
				use = <"Use for Activated partial thromboplastin time (aPTT) in Blood by Coagulation assay.">
				keywords = <"aPTT", "PTT", "Partial Thromboplastin Time", "Activated partial thromboplastin time", "Little(A)PTT", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Coagulation assay", "Clot", "Tilt tube", "Clottable", "Surf">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.aptt_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"aptt_bld">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Activated partial thromboplastin time (aPTT) in Blood by Coagulation assay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"s">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3173-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3173-2">
			>
		>
	>
	adl_version = <"2.0.5">
