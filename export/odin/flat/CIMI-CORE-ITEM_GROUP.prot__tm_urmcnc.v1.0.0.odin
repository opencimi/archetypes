(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/35663-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Protein [Mass/volume] in unspecified time Urine' concept">
				use = <"Use for Protein [Mass/volume] in unspecified time Urine.">
				keywords = <"Prot", "PR", "Mass concentration", "Level", "?Tm", "Ur", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "URINALYSIS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.prot__tm_urmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"prot__tm_urmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Protein [Mass/volume] in unspecified time Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/35663-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/35663-4">
			>
		>
	>
	adl_version = <"2.0.5">
