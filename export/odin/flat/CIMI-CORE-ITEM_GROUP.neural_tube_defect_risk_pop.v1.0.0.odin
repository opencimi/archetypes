(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49838-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Neural tube defect risk in population' concept">
				use = <"Use for Neural tube defect risk in population.">
				keywords = <"ONTD", "Neural tube def", "Neural tube defct", "Open spina bifida", "OSB", "Anencephaly", "NTD", "Finding", "Findings", "Point in time", "Random", "pop", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.neural_tube_defect_risk_pop.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"neural_tube_defect_risk_pop">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Neural tube defect risk in population">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{risk}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49838-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49838-6">
			>
		>
	>
	adl_version = <"2.0.5">
