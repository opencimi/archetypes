(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5804-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Protein [Mass/volume] in Urine by Test strip' concept">
				use = <"Use for Protein [Mass/volume] in Urine by Test strip.">
				keywords = <"Prot", "PR", "Mass concentration", "Level", "Point in time", "Random", "Ur", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Dipstick", "Dip stick", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.prot_urmcnc_pre_by_ur_stripmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"prot_urmcnc_pre_by_ur_stripmcnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5804-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5804-0">
			>
		>
	>
	adl_version = <"2.0.5">
