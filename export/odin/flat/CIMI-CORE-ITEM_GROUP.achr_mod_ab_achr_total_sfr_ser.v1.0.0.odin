(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/30192-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Acetylcholine receptor modulation Ab/Acetylcholine Ab.total in Serum' concept">
				use = <"Use for Acetylcholine receptor modulation Ab/Acetylcholine Ab.total in Serum.">
				keywords = <"AChR Mod", "ACH", "Acetylch", "AChR Total", "AChR Mod Ab/AChR Total", "Substance fraction", "Percent", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.achr_mod_ab_achr_total_sfr_ser.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"achr_mod_ab_achr_total_sfr_ser">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Acetylcholine receptor modulation Ab/Acetylcholine Ab.total in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/30192-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/30192-9">
			>
		>
	>
	adl_version = <"2.0.5">
