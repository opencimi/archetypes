(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/47282-9.html>">
			["tool"] = <"cimi-gen v0.0.1">
			["time"] = <"2015-08-05T22:27:27">
		>
		details = <
			["en"] = <
				language = <[ISO_639-1::en]>
				purpose = <"Archetype for CIMI 'Erythrocyte mean corpuscular volume [Entitic volume] in Cord blood' concept">
				use = <"Use for Erythrocyte mean corpuscular volume [Entitic volume] in Cord blood.">
				keywords = <"Vol", "MCV", "Erythrocytes", "Red blood corpusles", "Red blood corpuscle", "Red blood cell", "Red cell", "Red cells", "Discocyte", "Erc", "Red blood cells", "RBC", "Entitic volume", "Point in time", "Random", "Cord (umbilical) blood", "Cord bld", "Cord blood", "Quantitative", "QNT", "Quant", "Quan", "Average", "Avg", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.mcv_bldco.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"mcv_bldco">
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258775009">
				["at0.0.0.0.0.3"] = <"http://snomed.org/id/intentional_blank">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/47282-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/47282-9">
			>
		>
	>
	adl_version = <"2.0.5">
