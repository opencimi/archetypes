(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/27816-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'von Willebrand factor (vWf) Ag actual/normal in Platelet poor plasma by Immunologic method' concept">
				use = <"Use for von Willebrand factor (vWf) Ag actual/normal in Platelet poor plasma by Immunologic method.">
				keywords = <"vWF:Ag", "vWf", "Nor", "Relative mass concentration", "RLMCNC", "Point in time", "Random", "Platelet poor plasma", "Plas", "Quantitative", "QNT", "Quant", "Quan", "Immunology", "Immunol", "Ag Act/Nor", "Antigen", "Antigens", "Act/Nor", "Vonwillebrand", "Von will", "Control", "Fac", "Fact", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.vwf_ag_act_nor_ppp_imm.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"vwf_ag_act_nor_ppp_imm">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"von Willebrand factor (vWf) Ag actual/normal in Platelet poor plasma by Immunologic method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/27816-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/27816-8">
			>
		>
	>
	adl_version = <"2.0.5">
