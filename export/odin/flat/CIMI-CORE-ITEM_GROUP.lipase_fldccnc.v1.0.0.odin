(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/15212-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Lipase [Enzymatic activity/volume] in Body fluid' concept">
				use = <"Use for Lipase [Enzymatic activity/volume] in Body fluid.">
				keywords = <"Steapsin", "Tributyrase", "Tributyrinase", "LIPA", "Pancreatic lipase", "LPS", "Lipase", "Catalytic Concentration", "Point in time", "Random", "BF", "Fluid", "Body fluid", "B/F", "FLU", "Fl", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.lipase_fldccnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"lipase_fldccnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Lipase [Enzymatic activity/volume] in Body fluid">
				>
				["at0.0.0.0.0.2"] = <
					text = <"U/dL">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/415783003">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/15212-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/15212-4">
			>
		>
	>
	adl_version = <"2.0.5">
