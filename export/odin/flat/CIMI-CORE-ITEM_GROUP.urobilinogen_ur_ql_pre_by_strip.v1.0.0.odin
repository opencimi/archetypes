(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5818-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Urobilinogen [Presence] in Urine by Test strip' concept">
				use = <"Use for Urobilinogen [Presence] in Urine by Test strip.">
				keywords = <"UBG", "Urobilngn", "Urobili", "Arbitrary concentration", "Point in time", "Random", "UR", "Urn", "UA", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Dipstick", "Dip stick", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.urobilinogen_ur_ql_pre_by_strip.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"urobilinogen_ur_ql_pre_by_strip">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Urobilinogen [Presence] in Urine by Test strip">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Urobilinogen [Presence] in Urine by Test strip">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5818-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5818-0">
			>
		>
	>
	adl_version = <"2.0.5">
