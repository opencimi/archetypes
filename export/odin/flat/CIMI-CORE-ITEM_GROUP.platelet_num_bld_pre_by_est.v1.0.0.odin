(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49497-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Platelets [#/volume] in Blood by Estimate' concept">
				use = <"Use for Platelets [#/volume] in Blood by Estimate.">
				keywords = <"Platelet", "Plt", "Thrombocytes", "Platelt", "Thrb", "Thrombocyte", "#", "Number concentration", "Count/volume", "Count", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Est", "estimation", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS", "Platelet count">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.platelet_num_bld_pre_by_est.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"platelet_num_bld_pre_by_est">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Platelets [#/volume] in Blood by Estimate">
				>
				["at0.0.0.0.0.2"] = <
					text = <"10*3/uL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49497-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49497-1">
			>
		>
	>
	adl_version = <"2.0.5">
