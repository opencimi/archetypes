(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3281-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Lupus anticoagulant [interpretation] in Platelet poor plasma' concept">
				use = <"Use for Lupus anticoagulant [interpretation] in Platelet poor plasma.">
				keywords = <"LA", "dRVVT", "LAC", "Lupus inhibitor", "Coagulation inhibiting antibody", "Anti-phospholipid antibody", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Platelet poor plasma", "Plas", "Nominal", "Anticoag">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.la_pppimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"la_pppimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Lupus anticoagulant [interpretation] in Platelet poor plasma">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Lupus anticoagulant [interpretation] in Platelet poor plasma">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3281-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3281-3">
			>
		>
	>
	adl_version = <"2.0.5">
