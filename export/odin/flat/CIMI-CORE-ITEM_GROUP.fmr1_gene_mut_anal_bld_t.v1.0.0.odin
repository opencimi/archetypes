(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/36913-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'FMR1 gene mutation analysis in Blood or Tissue by Molecular genetics method Narrative' concept">
				use = <"Use for FMR1 gene mutation analysis in Blood or Tissue by Molecular genetics method Narrative.">
				keywords = <"Fragile X syndrome", "Fragile X mental retardation 1", "FRAXA", "Identity or presence", "Point in time", "Random", "Bld/T", "Tissue", "Bld/T", "Blood", "WB", "Whole blood", "Narrative", "Report", "PCR", "Molecular genetics", "Mut Anal", "Mutations", "MOLPATH.MUTATIONS", "MOLPATH.MUTATIONS", "Molecular pathology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fmr1_gene_mut_anal_bld_t.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fmr1_gene_mut_anal_bld_t">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"FMR1 gene mutation analysis in Blood or Tissue by Molecular genetics method Narrative">
				>
				["id1.1.1.1.1.1"] = <
					text = <"FMR1 gene mutation analysis in Blood or Tissue by Molecular genetics method Narrative">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/36913-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/36913-2">
			>
		>
	>
	adl_version = <"2.0.5">
