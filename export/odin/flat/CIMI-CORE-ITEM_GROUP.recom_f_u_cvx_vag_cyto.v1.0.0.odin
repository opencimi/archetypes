(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19773-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Recommended follow-up [Identifier] in Cervical or vaginal smear or scraping by Cyto stain' concept">
				use = <"Use for Recommended follow-up [Identifier] in Cervical or vaginal smear or scraping by Cyto stain.">
				keywords = <"Recom F/U", "Pap Smear", "Papinacolou Smear", "Pap Stain", "Identity or presence", "Point in time", "Random", "Genital tract", "Genital vaginal", "Vagina", "Vaginal fluid", "Vag fluid", "Vag fld", "Cervix", "Nominal", "Cytostain", "Cytology stain", "Papanicolaou smear">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.recom_f_u_cvx_vag_cyto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"recom_f_u_cvx_vag_cyto">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Recommended follow-up [Identifier] in Cervical or vaginal smear or scraping by Cyto stain">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Recommended follow-up [Identifier] in Cervical or vaginal smear or scraping by Cyto stain">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19773-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19773-1">
			>
		>
	>
	adl_version = <"2.0.5">
