(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6584-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Virus identified in Unspecified specimen by Culture' concept">
				use = <"Use for Virus identified in Unspecified specimen by Culture.">
				keywords = <"Identity or presence", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Nominal", "Cult", "Cultures", "C&S", "Isolated", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.virus_xxx_pre_by_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"virus_xxx_pre_by_cult">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Virus identified in Unspecified specimen by Culture">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Virus identified in Unspecified specimen by Culture">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6584-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6584-7">
			>
		>
	>
	adl_version = <"2.0.5">
