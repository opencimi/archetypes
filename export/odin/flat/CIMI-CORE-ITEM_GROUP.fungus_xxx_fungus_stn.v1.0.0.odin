(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/21003-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fungus identified in Unspecified specimen by Fungus stain' concept">
				use = <"Use for Fungus identified in Unspecified specimen by Fungus stain.">
				keywords = <"Fungal", "Fung", "Fungi", "Identity or presence", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Nominal", "Fungus Stn", "Isolated", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fungus_xxx_fungus_stn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fungus_xxx_fungus_stn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Fungus identified in Unspecified specimen by Fungus stain">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Fungus identified in Unspecified specimen by Fungus stain">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/21003-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/21003-9">
			>
		>
	>
	adl_version = <"2.0.5">
