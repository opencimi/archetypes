(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/47549-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Adenosine deaminase [Enzymatic activity/mass] in Red Blood Cells' concept">
				use = <"Use for Adenosine deaminase [Enzymatic activity/mass] in Red Blood Cells.">
				keywords = <"ADA", "ADO", "Catalytic Content", "Point in time", "Random", "Erythrocytes", "Red blood corpusles", "Red blood cells", "Quantitative", "QNT", "Quant", "Quan", "ANED", "Medication stress", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.adenosine_deaminase_rbcccnt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"adenosine_deaminase_rbcccnt">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/47549-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/47549-1">
			>
		>
	>
	adl_version = <"2.0.5">
