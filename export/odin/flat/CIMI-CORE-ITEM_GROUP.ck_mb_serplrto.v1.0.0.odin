(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49136-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Creatine kinase.MB/Creatine kinase.total [Ratio] in Serum or Plasma' concept">
				use = <"Use for Creatine kinase.MB/Creatine kinase.total [Ratio] in Serum or Plasma.">
				keywords = <"CK MB", "CKMB", "CK 2", "Creatine phosphokinase", "CPK", "CK MB/CK", "CKMB Relative index", "MB index", "Rto", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ck_mb_serplrto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ck_mb_serplrto">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Creatine kinase.MB/Creatine kinase.total [Ratio] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49136-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49136-5">
			>
		>
	>
	adl_version = <"2.0.5">
