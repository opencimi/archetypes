(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2031-3.html>">
			["tool"] = <"cimi-gen v0.0.1">
			["time"] = <"2015-08-05T22:26:50">
		>
		details = <
			["en"] = <
				language = <[ISO_639-1::en]>
				purpose = <"Archetype for CIMI 'Carboxyhemoglobin/Hemoglobin.total in Capillary blood' concept">
				use = <"Use for Carboxyhemoglobin/Hemoglobin.total in Capillary blood.">
				keywords = <"COHgb", "Carboxyhemoglob", "Carbon monoxide.hemoglobin", "COHb", "HbCO", "Carbonyl hemoglobin", "Carbonmonoxyhemoglobin", "CO haemoglobin", "CO hemoglobin", "Carboxyhaemoglobin", "Hemoglobin bound with carbon dioxide", "Carbonyl Hgb", "Carbonyl haemoglobin", "Hb", "Haemoglobin", "Mass fraction", "Percent", "Point in time", "Random", "Cap blood", "Cap bld", "Capillary bld", "Capillary blood", "Finger stick", "Quantitative", "QNT", "Quant", "Quan", "Tot", "Totl", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cohgb_mfr_bldc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cohgb_mfr_bldc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2031-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2031-3">
			>
		>
	>
	adl_version = <"2.0.5">
