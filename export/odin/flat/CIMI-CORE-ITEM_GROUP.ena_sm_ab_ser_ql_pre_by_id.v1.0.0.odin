(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5357-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Smith extractable nuclear Ab [Presence] in Serum by Immune diffusion (ID)' concept">
				use = <"Use for Smith extractable nuclear Ab [Presence] in Serum by Immune diffusion (ID).">
				keywords = <"SM", "ENA SM", "ANA", "Nuc", "ANF", "NA", "Antinuclear antibody", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ID", "Immunodiff", "Immunodiffusion", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Imun", "Imune", "Imm", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ena_sm_ab_ser_ql_pre_by_id.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ena_sm_ab_ser_ql_pre_by_id">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Smith extractable nuclear Ab [Presence] in Serum by Immune diffusion (ID)">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Smith extractable nuclear Ab [Presence] in Serum by Immune diffusion (ID)">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5357-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5357-9">
			>
		>
	>
	adl_version = <"2.0.5">
