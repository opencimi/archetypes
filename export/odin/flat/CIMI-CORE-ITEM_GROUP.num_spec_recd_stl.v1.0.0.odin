(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/38527-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Number of specimens received of Stool' concept">
				use = <"Use for Number of specimens received of Stool.">
				keywords = <"# Spec Recd", "No", "Count", "Cnt", "Sutdies", "Studies", "Study", "Stl", "Feces", "Faeces", "Bowel movement", "Fecal", "Faecal", "Quantitative", "QNT", "Quant", "Quan">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.num_spec_recd_stl.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"num_spec_recd_stl">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Number of specimens received of Stool">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{#}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/38527-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/38527-8">
			>
		>
	>
	adl_version = <"2.0.5">
