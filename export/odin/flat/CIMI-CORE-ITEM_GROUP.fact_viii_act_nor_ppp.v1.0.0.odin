(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3209-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Coagulation factor VIII activity actual/normal in Platelet poor plasma by Coagulation assay' concept">
				use = <"Use for Coagulation factor VIII activity actual/normal in Platelet poor plasma by Coagulation assay.">
				keywords = <"Fact VIII", "VIII:C", "Antihemophilic factor", "AHF", "Antihemophilic globulin", "AHG", "Factor VIII clotting activity", "Thrombocyte cofactor A", "Circulating anticoagulant", "Activ", "Movements", "Nor", "RlTm", "Point in time", "Random", "Platelet poor plasma", "Plas", "Quantitative", "QNT", "Quant", "Quan", "Coagulation assay", "Clot", "Tilt tube", "Clottable", "Act/Nor", "Control", "F8", "FVIII", "Factor 8", "Fac", "Actvty">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fact_viii_act_nor_ppp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fact_viii_act_nor_ppp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Coagulation factor VIII activity actual/normal in Platelet poor plasma by Coagulation assay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3209-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3209-4">
			>
		>
	>
	adl_version = <"2.0.5">
