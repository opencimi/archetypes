(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5859-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Herpes simplex virus identified in Unspecified specimen by Organism specific culture' concept">
				use = <"Use for Herpes simplex virus identified in Unspecified specimen by Organism specific culture.">
				keywords = <"HSV", "Herp splx", "Identity or presence", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Nominal", "Cult", "Cultures", "C&S", "Isolated", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hsv_xxx_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hsv_xxx_cult">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Herpes simplex virus identified in Unspecified specimen by Organism specific culture">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Herpes simplex virus identified in Unspecified specimen by Organism specific culture">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5859-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5859-4">
			>
		>
	>
	adl_version = <"2.0.5">
