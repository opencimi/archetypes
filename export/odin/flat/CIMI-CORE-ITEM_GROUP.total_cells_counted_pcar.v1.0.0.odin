(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32165-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cells Counted Total [#] in Pericardial fluid' concept">
				use = <"Use for Cells Counted Total [#] in Pericardial fluid.">
				keywords = <"Total Cells Counted", "Total cells", "Cell", "Cellularity", "Number", "Count", "Cnt", "Point in time", "Random", "Pcar", "PCAR", "Pericardial fluid", "Quantitative", "QNT", "Quant", "Quan", "Tot", "Totl", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.total_cells_counted_pcar.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"total_cells_counted_pcar">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32165-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32165-3">
			>
		>
	>
	adl_version = <"2.0.5">
