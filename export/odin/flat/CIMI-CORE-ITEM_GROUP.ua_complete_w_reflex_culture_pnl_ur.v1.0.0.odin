(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/58077-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Urinalysis complete W Reflex Culture panel - Urine' concept">
				use = <"Use for Urinalysis complete W Reflex Culture panel - Urine.">
				keywords = <"UA complete W Reflex Culture pnl", "Point in time", "Random", "Ur", "UR", "Urn", "Pnl", "Pan", "Panl", "PANEL.URINALYSIS", "PANEL.URINALYSIS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ua_complete_w_reflex_culture_pnl_ur.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ua_complete_w_reflex_culture_pnl_ur">
			...
			["1"] = <
				...
				children = <
					...
					["11"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.1">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.bacteria_ur_cult.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["12"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.2.1.1">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.urinalysis_complete_pnl_ur.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.1"] = <
					text = <"Urinalysis complete W Reflex Culture panel - Urine">
				>
				["id0.1.1.1.1"] = <
					text = <"Bacteria identified in Urine by Culture">
				>
				["id0.1.2.1.1"] = <
					text = <"Urinalysis complete panel - Urine">
				>
				["id1.1.1.1.1"] = <
					text = <"Urinalysis complete W Reflex Culture panel - Urine">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/58077-9">
				["at0.0.0.0.1"] = <"http://loinc.org/id/58077-9">
				["id0.1.1.1.1"] = <"http://loinc.org/id/630-4">
				["id0.1.2.1.1"] = <"http://loinc.org/id/24356-8">
			>
		>
	>
	adl_version = <"2.0.5">
