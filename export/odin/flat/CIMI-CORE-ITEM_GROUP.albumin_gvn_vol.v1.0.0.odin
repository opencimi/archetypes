(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/10386-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Albumin given [Volume]' concept">
				use = <"Use for Albumin given [Volume].">
				keywords = <"Protein.albumin", "Alb", "Volume", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "Gvn", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.albumin_gvn_vol.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"albumin_gvn_vol">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/10386-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/10386-1">
			>
		>
	>
	adl_version = <"2.0.5">
