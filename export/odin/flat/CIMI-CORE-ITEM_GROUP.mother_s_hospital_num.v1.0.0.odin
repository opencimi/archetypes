(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19111-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Mother's hospital number' concept">
				use = <"Use for Mother's hospital number.">
				keywords = <"Num", "No", "Hospital #", "Hosp", "Identifier", "Ident", "Point in time", "Random", "Mat", "Maternal", "Matnl", "Nominal">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.mother_s_hospital_num.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"mother_s_hospital_num">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19111-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19111-4">
			>
		>
	>
	adl_version = <"2.0.5">
