(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/12198-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cryofibrinogen [Presence] in Plasma by 2 day cold incubation' concept">
				use = <"Use for Cryofibrinogen [Presence] in Plasma by 2 day cold incubation.">
				keywords = <"Cryofib", "Arbitrary concentration", "Point in time", "Random", "Plasma", "Pl", "Plsm", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "2D Cold Inc", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cryofib_plas_ql_pre_by_2d_cold_inc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cryofib_plas_ql_pre_by_2d_cold_inc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cryofibrinogen [Presence] in Plasma by 2 day cold incubation">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Cryofibrinogen [Presence] in Plasma by 2 day cold incubation">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/12198-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/12198-8">
			>
		>
	>
	adl_version = <"2.0.5">
