(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/12235-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Microscopic observation [Identifier] in Urine sediment by Light microscopy' concept">
				use = <"Use for Microscopic observation [Identifier] in Urine sediment by Light microscopy.">
				keywords = <"Micro", "Identity or presence", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Nominal", "LM", "Micros", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.micro_urns.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"micro_urns">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/12235-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/12235-8">
			>
		>
	>
	adl_version = <"2.0.5">
