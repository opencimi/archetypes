(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/890-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Blood group antibody screen [Presence] in Serum or Plasma' concept">
				use = <"Use for Blood group antibody screen [Presence] in Serum or Plasma.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bld_gp_ab_scn_serpl_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bld_gp_ab_scn_serpl_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Blood group antibody screen [Presence] in Serum or Plasma">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/890-4">
			>
			["opencem"] = <
