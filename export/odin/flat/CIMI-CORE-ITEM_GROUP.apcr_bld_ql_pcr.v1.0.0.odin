(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13589-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Activated protein C resistance [Presence] in Blood by Probe and target amplification method' concept">
				use = <"Use for Activated protein C resistance [Presence] in Blood by Probe and target amplification method.">
				keywords = <"Prot C", "PC", "Autoprothrombin II-a", "PR", "aPCR", "APCr", "APC-R", "Arbitrary concentration", "Point in time", "Random", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "PCR", "Polymerase chain reaction", "Transcription mediated amplification", "NASBA", "Nucleic acid sequence based analysis", "SDA", "Strand Displacement Amplification", "LAT", "Ligation-activated transcription", "3SR SR", "3 Self-Sustaining Sequence Replication", "LCR", "Ligase chain reaction", "QBR", "Probe with target amplification", "NAAT", "TMA", "Amp Prb", "Probe with ampification", "DNA probe", "Amplified", "Resistanc", "Resist", "Resistent", "Resistant", "APC", "Activ", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.apcr_bld_ql_pcr.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"apcr_bld_ql_pcr">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Activated protein C resistance [Presence] in Blood by Probe and target amplification method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Activated protein C resistance [Presence] in Blood by Probe and target amplification method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13589-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13589-7">
			>
		>
	>
	adl_version = <"2.0.5">
