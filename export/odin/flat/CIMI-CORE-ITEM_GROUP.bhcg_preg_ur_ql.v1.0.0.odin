(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2112-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Choriogonadotropin.beta subunit (pregnancy test) [Presence] in Urine' concept">
				use = <"Use for Choriogonadotropin.beta subunit (pregnancy test) [Presence] in Urine.">
				keywords = <"B-HCG Preg", "B-HCG", "B HCG", "Beta HCG", "Beta human chorionic gonadotropin", "Choriogonadotropin beta chain", "Chorionic gonadotropin", "CG", "Human chorionic gonadotropin", "Choriogonadotropins total", "Arbitrary concentration", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "PG test", "Preg test", "Gestation", "Gravida", "Gestations", "Pregnancies", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bhcg_preg_ur_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bhcg_preg_ur_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Choriogonadotropin.beta subunit (pregnancy test) [Presence] in Urine">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2112-1">
			>
			["opencem"] = <
