(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/925-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Blood product disposition [Type]' concept">
				use = <"Use for Blood product disposition [Type].">
				keywords = <"Bld Prod Disposition", "Typ", "Point in time", "Random", "Blood product unit", "Nominal", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bld_prod_disposition_bpu.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bld_prod_disposition_bpu">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"BloodProductStatusCodedValues_VALUESET_CODE">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Blood product disposition [Type]">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/925-8">
			>
			["opencem"] = <
				["at0.0.0.0.0.1"] = <"http://opencem.org/id/BloodProductStatusCodedValues_VALUESET_CODE">
			>
		>
	>
	adl_version = <"2.0.5">
