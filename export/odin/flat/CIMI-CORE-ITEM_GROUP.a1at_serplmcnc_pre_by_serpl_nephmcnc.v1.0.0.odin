(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6771-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Alpha 1 antitrypsin [Mass/volume] in Serum or Plasma by Nephlometry' concept">
				use = <"Use for Alpha 1 antitrypsin [Mass/volume] in Serum or Plasma by Nephlometry.">
				keywords = <"A1AT", "A1A", "Alpha-1-protease inhibitor", "A1-AT", "Alpha-1-proteinase inhibitor", "A-1-AT", "AAT", "Alpha-1-trypsin inhibitor", "Alpha-1-antitrypsin.total", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Neph", "Nephelom", "Light scattering", "A1", "Alfa", "I", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.a1at_serplmcnc_pre_by_serpl_nephmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"a1at_serplmcnc_pre_by_serpl_nephmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Alpha 1 antitrypsin [Mass/volume] in Serum or Plasma by Nephlometry">
				>
				["at0.0.0.0.0.2"] = <
					text = <"g/L">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258794004">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6771-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6771-0">
			>
		>
	>
	adl_version = <"2.0.5">
