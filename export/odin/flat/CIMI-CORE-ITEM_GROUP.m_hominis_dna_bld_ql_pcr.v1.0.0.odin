(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/42621-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Mycoplasma hominis DNA [Presence] in Blood by Probe and target amplification method' concept">
				use = <"Use for Mycoplasma hominis DNA [Presence] in Blood by Probe and target amplification method.">
				keywords = <"M hominis", "Deoxyribonucleic acid", "Arbitrary concentration", "Point in time", "Random", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "PCR", "Polymerase chain reaction", "Transcription mediated amplification", "NASBA", "Nucleic acid sequence based analysis", "SDA", "Strand Displacement Amplification", "LAT", "Ligation-activated transcription", "3SR SR", "3 Self-Sustaining Sequence Replication", "LCR", "Ligase chain reaction", "QBR", "Probe with target amplification", "NAAT", "TMA", "Amp Prb", "Probe with ampification", "DNA probe", "Amplified", "Mycoplasm", "Mycoplsm", "Mycoplas", "Myco", "Mycoplasmosis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.m_hominis_dna_bld_ql_pcr.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"m_hominis_dna_bld_ql_pcr">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Mycoplasma hominis DNA [Presence] in Blood by Probe and target amplification method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Mycoplasma hominis DNA [Presence] in Blood by Probe and target amplification method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/42621-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/42621-3">
			>
		>
	>
	adl_version = <"2.0.5">
