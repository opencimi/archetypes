(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/48345-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'HIV 1+O+2 Ab [Presence] in Serum or Plasma' concept">
				use = <"Use for HIV 1+O+2 Ab [Presence] in Serum or Plasma.">
				keywords = <"HIV1", "HIV type 1", "HIV type I", "AIDS", "Human immunodeficiency virus", "Arbitrary concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "II", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hiv_1_plus_o_plus_2_ab_serpl_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hiv_1_plus_o_plus_2_ab_serpl_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"HIV 1+O+2 Ab [Presence] in Serum or Plasma">
				>
				["id1.1.1.1.1.1"] = <
					text = <"HIV 1+O+2 Ab [Presence] in Serum or Plasma">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/48345-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/48345-3">
			>
		>
	>
	adl_version = <"2.0.5">
