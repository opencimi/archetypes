(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/46082-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Influenza virus A Ag [Presence] in Nasopharynx by Immunoassay' concept">
				use = <"Use for Influenza virus A Ag [Presence] in Nasopharynx by Immunoassay.">
				keywords = <"FLUAV", "Avian influenza", "Fowl plague", "Influenza A virus", "FLUA", "Bird flu", "FLUV", "Influ", "Arbitrary concentration", "Point in time", "Random", "Nasopharynx", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "Antigen", "Antigens", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fluav_ag_nph_ql_pre_by_eia.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fluav_ag_nph_ql_pre_by_eia">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Influenza virus A Ag [Presence] in Nasopharynx by Immunoassay">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Influenza virus A Ag [Presence] in Nasopharynx by Immunoassay">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/46082-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/46082-4">
			>
		>
	>
	adl_version = <"2.0.5">
