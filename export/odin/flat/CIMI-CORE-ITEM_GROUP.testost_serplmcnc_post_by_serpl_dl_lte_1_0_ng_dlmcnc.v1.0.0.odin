(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.testost_serplmcnc_post_by_serpl_dl_lte_1_0_ng_dlmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"testost_serplmcnc_post_by_serpl_dl_lte_1_0_ng_dlmcnc">
