(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/53800-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Platelets panel - Blood by Automated count' concept">
				use = <"Use for Platelets panel - Blood by Automated count.">
				keywords = <"Platelets Pnl", "Plt", "Platelet", "Thrombocytes", "Platelt", "Thrb", "Thrombocyte", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Auto", "Pan", "Panl", "PANEL.HEMATOLOGY& CELL COUNTS", "PANEL.HEMATOLOGY& CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.platelets_pnl_bld_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"platelets_pnl_bld_auto">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.1"] = <
					text = <"Platelets panel - Blood by Automated count">
				>
				["id0.1.1.1.1"] = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/53800-9">
				["at0.0.0.0.1"] = <"http://loinc.org/id/53800-9">
				["id0.1.1.1.1"] = <"http://loinc.org/id/32623-1">
				["id0.1.1.1.2"] = <"http://loinc.org/id/777-3">
			>
		>
	>
	adl_version = <"2.0.5">
