(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/25158-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oval fat bodies (globules) [Presence] in Urine sediment by Light microscopy' concept">
				use = <"Use for Oval fat bodies (globules) [Presence] in Urine sediment by Light microscopy.">
				keywords = <"Fat bodies.oval", "Fat droplets", "Arbitrary concentration", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Micro", "LM", "Micros", "Microscopic", "Body", "bod", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.oval_fat_bodies_urns_ql_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"oval_fat_bodies_urns_ql_micro">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Oval fat bodies (globules) [Presence] in Urine sediment by Light microscopy">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Oval fat bodies (globules) [Presence] in Urine sediment by Light microscopy">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/25158-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/25158-7">
			>
		>
	>
	adl_version = <"2.0.5">
