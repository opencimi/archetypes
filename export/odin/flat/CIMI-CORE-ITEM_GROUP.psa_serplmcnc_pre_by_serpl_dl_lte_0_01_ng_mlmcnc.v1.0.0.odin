(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/35741-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Prostate specific Ag [Mass/volume] in Serum or Plasma by Detection limit <= 0.01 ng/mL' concept">
				use = <"Use for Prostate specific Ag [Mass/volume] in Serum or Plasma by Detection limit <= 0.01 ng/mL.">
				keywords = <"PSA", "P-30 antigen", "seminin", "Kallikrein 3", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "DL<=0.01 ng/mL", "Ultrasensitive", "DL<=0.01 ng/mL", "Antigen", "Antigens", "Spec", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.psa_serplmcnc_pre_by_serpl_dl_lte_0_01_ng_mlmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"psa_serplmcnc_pre_by_serpl_dl_lte_0_01_ng_mlmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Prostate specific Ag [Mass/volume] in Serum or Plasma by Detection limit <= 0.01 ng/mL">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/L">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258799009">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/35741-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/35741-8">
			>
		>
	>
	adl_version = <"2.0.5">
