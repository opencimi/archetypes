(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/888-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Blood group antibodies identified in Serum or Plasma' concept">
				use = <"Use for Blood group antibodies identified in Serum or Plasma.">
				keywords = <"Ab", "Identity or presence", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Nominal", "Isolated", "BLOOD BANK">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.blood_group_antibodies_serpl.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"blood_group_antibodies_serpl">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"AntibodyID_VALUESET_CODE">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Blood group antibodies identified in Serum or Plasma">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/888-8">
			>
			["opencem"] = <
				["at0.0.0.0.0.1"] = <"http://opencem.org/id/AntibodyID_VALUESET_CODE">
			>
		>
	>
	adl_version = <"2.0.5">
