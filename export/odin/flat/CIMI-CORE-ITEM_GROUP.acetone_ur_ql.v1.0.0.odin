(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5569-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Acetone [Presence] in Urine' concept">
				use = <"Use for Acetone [Presence] in Urine.">
				keywords = <"2-propanone", "Me2CO", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.acetone_ur_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"acetone_ur_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Acetone [Presence] in Urine">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Acetone [Presence] in Urine">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5569-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5569-9">
			>
		>
	>
	adl_version = <"2.0.5">
