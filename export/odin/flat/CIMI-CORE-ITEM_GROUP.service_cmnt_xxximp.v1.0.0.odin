(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/8251-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Service comment' concept">
				use = <"Use for Service comment.">
				keywords = <"Service Cmnt", "Comments", "Remarks", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Miscellaneous", "Unspecified", "Other", "Nominal", "Com", "Comm", "Commt", "cmnt", "cmmt">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.service_cmnt_xxximp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"service_cmnt_xxximp">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/8251-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/8251-1">
			>
		>
	>
	adl_version = <"2.0.5">
