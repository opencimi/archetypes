(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/4537-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Erythrocyte sedimentation rate by Westergren method' concept">
				use = <"Use for Erythrocyte sedimentation rate by Westergren method.">
				keywords = <"ESR", "E.S.R.", "Sed rate", "Erythrocytes", "Red blood corpusles", "Red blood corpuscle", "Red blood cell", "Red cell", "Red cells", "Discocyte", "Erc", "Red blood cells", "RBC", "Velocity", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Westrgrn", "Westerg", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.esr_bld_qn_pre_by_westrgrn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"esr_bld_qn_pre_by_westrgrn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Erythrocyte sedimentation rate by Westergren method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mm/h">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258992005">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/4537-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/4537-7">
			>
		>
	>
	adl_version = <"2.0.5">
