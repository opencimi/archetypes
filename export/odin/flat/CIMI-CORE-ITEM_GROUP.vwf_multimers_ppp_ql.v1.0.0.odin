(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32217-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'von Willebrand factor (vWf) multimers [Presence] in Platelet poor plasma' concept">
				use = <"Use for von Willebrand factor (vWf) multimers [Presence] in Platelet poor plasma.">
				keywords = <"vWF multimers", "Von will mul", "vWf", "Arbitrary concentration", "Point in time", "Random", "Platelet poor plasma", "Plas", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Vonwillebrand", "Mul", "Multimer", "Fac", "Fact", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.vwf_multimers_ppp_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"vwf_multimers_ppp_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"von Willebrand factor (vWf) multimers [Presence] in Platelet poor plasma">
				>
				["id1.1.1.1.1.1"] = <
					text = <"von Willebrand factor (vWf) multimers [Presence] in Platelet poor plasma">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32217-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32217-2">
			>
		>
	>
	adl_version = <"2.0.5">
