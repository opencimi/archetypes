(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/22633-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Pathology report site of origin Narrative' concept">
				use = <"Use for Pathology report site of origin Narrative.">
				keywords = <"Anatomy", "Point in time", "Random", "Spec", "Narrative", "TUMOR REGISTRY(NAACCR)", "TUMOR REGISTRY(NAACCR)">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.path_report_site_of_origin_spec.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"path_report_site_of_origin_spec">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Pathology report site of origin Narrative">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Pathology report site of origin Narrative">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/22633-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/22633-2">
			>
		>
	>
	adl_version = <"2.0.5">
