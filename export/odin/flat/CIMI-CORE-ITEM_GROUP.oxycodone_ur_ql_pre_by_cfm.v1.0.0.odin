(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19643-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oxycodone [Presence] in Urine by Confirmatory method' concept">
				use = <"Use for Oxycodone [Presence] in Urine by Confirmatory method.">
				keywords = <"OxyContin", "Percocet", "Vicodin", "Lortab", "Percodan", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Cfm", "CNFR", "CNFRM", "Conf", "Confirmation", "GCMS", "Confirmatory", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.oxycodone_ur_ql_pre_by_cfm.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"oxycodone_ur_ql_pre_by_cfm">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Oxycodone [Presence] in Urine by Confirmatory method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Oxycodone [Presence] in Urine by Confirmatory method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19643-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19643-6">
			>
		>
	>
	adl_version = <"2.0.5">
