(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49053-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'History of neural tube defect Narrative' concept">
				use = <"Use for History of neural tube defect Narrative.">
				keywords = <"ONTD", "Neural tube def", "Neural tube defct", "Open spina bifida", "OSB", "Anencephaly", "NTD", "Neural tube defect Hx", "Finding", "Findings", "Point in time", "Random", "Narrative", "Report", "H/O", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.neural_tube_defect_hx_patient.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"neural_tube_defect_hx_patient">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"History of neural tube defect Narrative">
				>
				["id1.1.1.1.1.1"] = <
					text = <"History of neural tube defect Narrative">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49053-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49053-2">
			>
		>
	>
	adl_version = <"2.0.5">
