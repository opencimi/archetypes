(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/53327-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Bilirubin.total [Mass/volume] in Urine by Automated test strip' concept">
				use = <"Use for Bilirubin.total [Mass/volume] in Urine by Automated test strip.">
				keywords = <"Bilirub", "Bili", "TBIL", "Bilirubins", "Mass concentration", "Level", "Point in time", "Random", "Ur", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Strip.auto", "Strip.auto", "Dipstick", "Dip stick", "Auto", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bilirub_urmcnc_pre_by_ur_strip_automcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bilirub_urmcnc_pre_by_ur_strip_automcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Bilirubin.total [Mass/volume] in Urine by Automated test strip">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/53327-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/53327-3">
			>
		>
	>
	adl_version = <"2.0.5">
