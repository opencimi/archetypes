(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/35538-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Baker's yeast IgG Ab [Mass/volume] in Serum' concept">
				use = <"Use for Baker's yeast IgG Ab [Mass/volume] in Serum.">
				keywords = <"Baker's yeast", "f045", "f45", "Yeast", "SCA", "ASCA", "Baker's yeast", "f403", "Immune globulin G", "Immunoglobulin G", "Mass concentration", "Level", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "ALLERGY TESTING", "Allergens", "Allergen">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.baker_s_yeast_iggmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"baker_s_yeast_iggmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Baker's yeast IgG Ab [Mass/volume] in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/35538-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/35538-8">
			>
		>
	>
	adl_version = <"2.0.5">
