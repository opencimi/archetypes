(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33227-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Coarse Granular Casts [#/area] in Urine sediment by Automated count' concept">
				use = <"Use for Coarse Granular Casts [#/area] in Urine sediment by Automated count.">
				keywords = <"Coarse Gran Casts", "Cast", "#/area", "Number areic", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Auto", "URINALYSIS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.coarse_gran_casts_num_per_area_urns_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"coarse_gran_casts_num_per_area_urns_auto">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33227-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33227-0">
			>
		>
	>
	adl_version = <"2.0.5">
