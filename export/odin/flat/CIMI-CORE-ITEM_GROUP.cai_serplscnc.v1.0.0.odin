(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1995-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Calcium.ionized [Moles/volume] in Serum or Plasma' concept">
				use = <"Use for Calcium.ionized [Moles/volume] in Serum or Plasma.">
				keywords = <"Ca-I", "Calcium free", "iCa", "Calcium active", "Coagulation factor I", "Cal", "Ca", "Substance concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Ion", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cai_serplscnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cai_serplscnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Calcium.ionized [Moles/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mmol/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1995-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1995-0">
			>
		>
	>
	adl_version = <"2.0.5">
