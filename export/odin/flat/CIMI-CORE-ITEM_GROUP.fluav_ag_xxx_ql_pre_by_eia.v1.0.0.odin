(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5862-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Influenza virus A Ag [Presence] in Unspecified specimen by Immunoassay' concept">
				use = <"Use for Influenza virus A Ag [Presence] in Unspecified specimen by Immunoassay.">
				keywords = <"FLUAV", "Avian influenza", "Fowl plague", "Influenza A virus", "FLUA", "Bird flu", "FLUV", "Influ", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "Antigen", "Antigens", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.fluav_ag_xxx_ql_pre_by_eia.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"fluav_ag_xxx_ql_pre_by_eia">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Influenza virus A Ag [Presence] in Unspecified specimen by Immunoassay">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Influenza virus A Ag [Presence] in Unspecified specimen by Immunoassay">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5862-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5862-8">
			>
		>
	>
	adl_version = <"2.0.5">
