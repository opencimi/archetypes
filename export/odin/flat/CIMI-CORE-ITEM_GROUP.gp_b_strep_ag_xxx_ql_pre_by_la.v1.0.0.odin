(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20459-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Streptococcus agalactiae Ag [Presence] in Unspecified specimen by Latex agglutination' concept">
				use = <"Use for Streptococcus agalactiae Ag [Presence] in Unspecified specimen by Latex agglutination.">
				keywords = <"Gp B Strep", "Strep group B", "Strep B", "S agalactiae", "Group B", "GBS", "Steptococcus Group B", "Group B Strep", "Streptococci group B", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Latex agglutination", "LAT", "Antigen", "Antigens", "Strept", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.gp_b_strep_ag_xxx_ql_pre_by_la.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"gp_b_strep_ag_xxx_ql_pre_by_la">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Streptococcus agalactiae Ag [Presence] in Unspecified specimen by Latex agglutination">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Streptococcus agalactiae Ag [Presence] in Unspecified specimen by Latex agglutination">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20459-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20459-4">
			>
		>
	>
	adl_version = <"2.0.5">
