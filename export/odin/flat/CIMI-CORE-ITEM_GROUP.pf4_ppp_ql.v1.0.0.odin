(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33594-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Platelet factor 4 [Presence] in Platelet poor plasma' concept">
				use = <"Use for Platelet factor 4 [Presence] in Platelet poor plasma.">
				keywords = <"PF4", "PI-factor 4", "Platelet type heparin inactivator", "PF", "Plt", "Pl", "Platelets", "Thrombocytes", "Platelt", "Thrombocyte", "Arbitrary concentration", "Point in time", "Random", "Platelet poor plasma", "Plas", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Fac", "Fact", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pf4_ppp_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pf4_ppp_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Platelet factor 4 [Presence] in Platelet poor plasma">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Platelet factor 4 [Presence] in Platelet poor plasma">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33594-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33594-3">
			>
		>
	>
	adl_version = <"2.0.5">
