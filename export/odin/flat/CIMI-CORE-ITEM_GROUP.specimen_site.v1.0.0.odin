(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19803-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Specimen site Narrative' concept">
				use = <"Use for Specimen site Narrative.">
				keywords = <"Typ", "Sutdies", "Studies", "Study", "Narrative", "Report", "Spec", "GI.ENDOSCOPY", "GI.ENDOSCOPY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.specimen_site.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"specimen_site">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19803-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19803-6">
			>
		>
	>
	adl_version = <"2.0.5">
