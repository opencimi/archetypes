(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/22763-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Ammonia [Mass/volume] in Plasma' concept">
				use = <"Use for Ammonia [Mass/volume] in Plasma.">
				keywords = <"Amm", "Ammon", "Amon", "NH3", "Mass concentration", "Level", "Point in time", "Random", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ammonia_plasmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ammonia_plasmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Ammonia [Mass/volume] in Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/22763-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/22763-7">
			>
		>
	>
	adl_version = <"2.0.5">
