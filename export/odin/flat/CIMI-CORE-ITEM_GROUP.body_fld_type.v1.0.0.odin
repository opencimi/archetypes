(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/14725-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI '[Type] of Body fluid' concept">
				use = <"Use for [Type] of Body fluid.">
				keywords = <"Typ", "Point in time", "Random", "BF", "Body fluid", "B/F", "FLU", "Fl", "Nominal">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.body_fld_type.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"body_fld_type">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/14725-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/14725-6">
			>
		>
	>
	adl_version = <"2.0.5">
