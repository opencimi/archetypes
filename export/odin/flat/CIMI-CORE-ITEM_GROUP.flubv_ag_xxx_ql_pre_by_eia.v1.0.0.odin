(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5866-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Influenza virus B Ag [Presence] in Unspecified specimen by Immunoassay' concept">
				use = <"Use for Influenza virus B Ag [Presence] in Unspecified specimen by Immunoassay.">
				keywords = <"FLUBV", "Influenza B virus", "FLUB", "FLUV", "Influ", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Enzyme immunoassay", "ELISA", "MEIA", "SUDS", "ELFA", "IAA", "Antigen", "Antigens", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.flubv_ag_xxx_ql_pre_by_eia.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"flubv_ag_xxx_ql_pre_by_eia">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Influenza virus B Ag [Presence] in Unspecified specimen by Immunoassay">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Influenza virus B Ag [Presence] in Unspecified specimen by Immunoassay">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5866-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5866-9">
			>
		>
	>
	adl_version = <"2.0.5">
