(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/25800-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Tobramycin [Susceptibility] by Method for Slow-growing mycobacteria' concept">
				use = <"Use for Tobramycin [Susceptibility] by Method for Slow-growing mycobacteria.">
				keywords = <"TOBRA", "NEBCIN", "TOBJ", "NEBDIN", "Susceptibility", "Susceptibilty", "Sus", "Suscept", "Susceptibilities", "AST", "Point in time", "Random", "Islt", "Isol", "SlowMyco", "Mycobacterial susceptibility", "Mycobacteria susceptibility", "TB", "Myco", "AFB", "Tuberculosis", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.tobramycin_susc_islt_pre_by_slowmyco.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"tobramycin_susc_islt_pre_by_slowmyco">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Tobramycin [Susceptibility] by Method for Slow-growing mycobacteria">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Tobramycin [Susceptibility] by Method for Slow-growing mycobacteria">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/25800-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/25800-4">
			>
		>
	>
	adl_version = <"2.0.5">
