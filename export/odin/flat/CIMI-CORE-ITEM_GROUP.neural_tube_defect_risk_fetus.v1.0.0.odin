(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/48803-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Neural tube defect risk in Fetus' concept">
				use = <"Use for Neural tube defect risk in Fetus.">
				keywords = <"ONTD", "Neural tube def", "Neural tube defct", "Open spina bifida", "OSB", "Anencephaly", "NTD", "Finding", "Findings", "Point in time", "Random", "Fetal", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.neural_tube_defect_risk_fetus.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"neural_tube_defect_risk_fetus">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Neural tube defect risk in Fetus">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/48803-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/48803-1">
			>
		>
	>
	adl_version = <"2.0.5">
