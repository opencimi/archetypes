(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/10834-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Globulin [Mass/volume] in Serum by calculation' concept">
				use = <"Use for Globulin [Mass/volume] in Serum by calculation.">
				keywords = <"GLB", "Globulins", "Glob", "Glob%", "Globul", "Mass concentration", "Level", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "Calc", "Calculation", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.globulin_ser_calcmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"globulin_ser_calcmcnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/10834-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/10834-0">
			>
		>
	>
	adl_version = <"2.0.5">
