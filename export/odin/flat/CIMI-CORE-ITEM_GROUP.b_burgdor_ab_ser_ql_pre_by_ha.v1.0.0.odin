(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/26006-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Borrelia burgdorferi Ab [Presence] in Serum by Hemagglutination' concept">
				use = <"Use for Borrelia burgdorferi Ab [Presence] in Serum by Hemagglutination.">
				keywords = <"B burg", "B burgdorferi", "Lymes", "Burgdorf", "Lyme", "Bb", "Lyme disease", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "IHA", "Hemagglutination", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.b_burgdor_ab_ser_ql_pre_by_ha.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"b_burgdor_ab_ser_ql_pre_by_ha">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Borrelia burgdorferi Ab [Presence] in Serum by Hemagglutination">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Borrelia burgdorferi Ab [Presence] in Serum by Hemagglutination">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/26006-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/26006-7">
			>
		>
	>
	adl_version = <"2.0.5">
