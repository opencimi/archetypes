(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/42481-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Human papilloma virus 6+11+42+43+44 DNA [Presence] in Cervix by Probe and signal amplification method' concept">
				use = <"Use for Human papilloma virus 6+11+42+43+44 DNA [Presence] in Cervix by Probe and signal amplification method.">
				keywords = <"HPV Low Risk", "Papilloma virus low risk", "HPV6+11", "Human papillomavirus", "Genital warts", "Deoxyribonucleic acid", "Arbitrary concentration", "Point in time", "Random", "Cervix", "Genital tract", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "bDNA", "HPA", "Hybidization Protection Assay", "Bdn-A", "Branched Chain DNA", "Hybrid Capture", "Probe with signal amplification", "Hybrid Capture nucleic acid hybridization", "HC", "Amp Prb", "Probe with ampification", "DNA probe", "Amplification", "Amplified", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hpv_low_risk_dna_cervix_ql_bdna.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hpv_low_risk_dna_cervix_ql_bdna">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Human papilloma virus 6+11+42+43+44 DNA [Presence] in Cervix by Probe and signal amplification method">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/42481-2">
			>
			["opencem"] = <
