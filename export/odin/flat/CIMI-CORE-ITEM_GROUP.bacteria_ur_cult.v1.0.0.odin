(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/630-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Bacteria identified in Urine by Culture' concept">
				use = <"Use for Bacteria identified in Urine by Culture.">
				keywords = <"Bact", "Identity or presence", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Nominal", "Cult", "Cultures", "C&S", "Isolated", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bacteria_ur_cult.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bacteria_ur_cult">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/630-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/630-4">
			>
		>
	>
	adl_version = <"2.0.5">
