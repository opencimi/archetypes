(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.albumin_serplmcnc_post_by_serpl_bcpmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"albumin_serplmcnc_post_by_serpl_bcpmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.3"] = <
					text = <"Bromocresol purple (BCP) dye binding method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Albumin [Mass/volume] in Serum or Plasma">
				>
