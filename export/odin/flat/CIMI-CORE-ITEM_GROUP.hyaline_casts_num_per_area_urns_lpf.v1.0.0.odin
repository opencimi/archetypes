(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5796-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hyaline casts [#/area] in Urine sediment by Microscopy low power field' concept">
				use = <"Use for Hyaline casts [#/area] in Urine sediment by Microscopy low power field.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hyaline_casts_num_per_area_urns_lpf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hyaline_casts_num_per_area_urns_lpf">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5796-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5796-8">
			>
		>
	>
	adl_version = <"2.0.5">
