(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19287-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cannabinoids tested for in Urine by Screen method Nominal' concept">
				use = <"Use for Cannabinoids tested for in Urine by Screen method Nominal.">
				keywords = <"Cannabinoid", "THC", "Delta-9-tetrahydrocannabinol", "Marijuana", "Identity or presence", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Nominal", "Scn", "Scr", "Scrn", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cannabinoids_tested_ur_scn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cannabinoids_tested_ur_scn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cannabinoids tested for in Urine by Screen method Nominal">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Cannabinoids tested for in Urine by Screen method Nominal">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19287-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19287-2">
			>
		>
	>
	adl_version = <"2.0.5">
