(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/44538-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'HTLV 1+2 Ab [Presence] in Serum from donor' concept">
				use = <"Use for HTLV 1+2 Ab [Presence] in Serum from donor.">
				keywords = <"HTLV type 1+2", "HTLV type I+II", "HTLV1+2", "HTLV1", "HTLVI", "HTLV-I", "HTLV type 1", "HTLV type I", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Donr", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Human T-cell Lymphotrophic Virus", "Human T-cell Leukemia Virus", "II", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.htlv1_plus_2_ab_ser_donr_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"htlv1_plus_2_ab_ser_donr_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"HTLV 1+2 Ab [Presence] in Serum from donor">
				>
				["id1.1.1.1.1.1"] = <
					text = <"HTLV 1+2 Ab [Presence] in Serum from donor">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/44538-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/44538-7">
			>
		>
	>
	adl_version = <"2.0.5">
