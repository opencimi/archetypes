(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/22131-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Borrelia burgdorferi IgG+IgM Ab [Presence] in Serum' concept">
				use = <"Use for Borrelia burgdorferi IgG+IgM Ab [Presence] in Serum.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.b_burgdor_igg_plus_igm_ser_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"b_burgdor_igg_plus_igm_ser_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Borrelia burgdorferi IgG+IgM Ab [Presence] in Serum">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Borrelia burgdorferi IgG+IgM Ab [Presence] in Serum">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/22131-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/22131-7">
			>
		>
	>
	adl_version = <"2.0.5">
