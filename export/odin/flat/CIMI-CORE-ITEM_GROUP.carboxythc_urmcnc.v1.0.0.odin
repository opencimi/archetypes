(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3436-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Carboxy tetrahydrocannabinol [Mass/volume] in Urine' concept">
				use = <"Use for Carboxy tetrahydrocannabinol [Mass/volume] in Urine.">
				keywords = <"THC", "Delta-9-tetrahydrocannabinol", "Marijuana", "Delta(9)-THC", "Dronabinol", "Nabilone", "CarboxyTHC", "THCCOOH", "Delta-9-tetrahydrocannabinol metabolite", "THCC", "9-carboxy-11-nor-delta-9-tetrahydrocannabinol", "THCA", "THC-COOH", "Carboxy-THC-delta-9", "Carboxytetrahydrocannabinol", "Mass concentration", "Level", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.carboxythc_urmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"carboxythc_urmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Carboxy tetrahydrocannabinol [Mass/volume] in Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3436-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3436-3">
			>
		>
	>
	adl_version = <"2.0.5">
