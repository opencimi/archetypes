(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/21440-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Human papilloma virus 16+18+31+33+35+45+51+52+56 DNA [Presence] in Cervix by DNA probe' concept">
				use = <"Use for Human papilloma virus 16+18+31+33+35+45+51+52+56 DNA [Presence] in Cervix by DNA probe.">
				keywords = <"HPV I/H Risk", "Papilloma virus intermediate/high risk", "HPV16+18", "Papilloma virus high risk", "HPV 16 & 18", "Human papillomavirus", "Genital warts", "Deoxyribonucleic acid", "Arbitrary concentration", "Point in time", "Random", "Cervix", "Genital tract", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Prb", "DNA probe", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hpv_i_h_risk_dna_cervix_ql_prb.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hpv_i_h_risk_dna_cervix_ql_prb">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Human papilloma virus 16+18+31+33+35+45+51+52+56 DNA [Presence] in Cervix by DNA probe">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Human papilloma virus 16+18+31+33+35+45+51+52+56 DNA [Presence] in Cervix by DNA probe">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/21440-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/21440-3">
			>
		>
	>
	adl_version = <"2.0.5">
