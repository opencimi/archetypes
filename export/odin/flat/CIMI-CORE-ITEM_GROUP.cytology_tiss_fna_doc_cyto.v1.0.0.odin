(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33718-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cytology report of Tissue fine needle aspirate Cyto stain' concept">
				use = <"Use for Cytology report of Tissue fine needle aspirate Cyto stain.">
				keywords = <"Finding", "Findings", "Point in time", "Random", "Tissue fine needle aspirate", "Pap Smear", "Pap Stain", "Cytostain", "Cytology stain", "Papanicolaou smear", "Fine needle">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cytology_tiss_fna_doc_cyto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cytology_tiss_fna_doc_cyto">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cytology report of Tissue fine needle aspirate Cyto stain">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Cytology report of Tissue fine needle aspirate Cyto stain">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33718-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33718-8">
			>
		>
	>
	adl_version = <"2.0.5">
