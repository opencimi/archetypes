(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/60017-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Lactate dehydrogenase [Enzymatic activity/volume] in Body fluid by Pyruvate to lactate reaction' concept">
				use = <"Use for Lactate dehydrogenase [Enzymatic activity/volume] in Body fluid by Pyruvate to lactate reaction.">
				keywords = <"LDH", "L.D.H", "Lactic acid dehydrogenase", "LD", "L-lactate dehydrogenase", "Lact", "2-Hydroxypropanoic acid", "2-hydroxy-propionic acid", "2-hydroxy-propionate", "Catalytic Concentration", "Point in time", "Random", "BF", "Fluid", "Body fluid", "B/F", "FLU", "Fl", "Quantitative", "QNT", "Quant", "Quan", "P to L", "Rxn", "React", "Dehydrog", "Dehyrdogenase", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ldh_fldccnc_pre_by_fld_p_to_lccnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ldh_fldccnc_pre_by_fld_p_to_lccnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Lactate dehydrogenase [Enzymatic activity/volume] in Body fluid by Pyruvate to lactate reaction">
				>
				["at0.0.0.0.0.2"] = <
					text = <"U/L">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258947003">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/60017-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/60017-1">
			>
		>
	>
	adl_version = <"2.0.5">
