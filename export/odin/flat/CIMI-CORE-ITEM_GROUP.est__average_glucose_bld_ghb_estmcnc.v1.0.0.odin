(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/27353-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Glucose mean value [Mass/volume] in Blood Estimated from glycated hemoglobin' concept">
				use = <"Use for Glucose mean value [Mass/volume] in Blood Estimated from glycated hemoglobin.">
				keywords = <"Glu", "Gluc", "Glucoseur", "Est. average glucose", "Glucose mean value", "eAVG", "eAG", "Mass concentration", "Level", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "gHb Est", "predicted", "estimation", "Glycosylated", "Glycos", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.est__average_glucose_bld_ghb_estmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"est__average_glucose_bld_ghb_estmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Glucose mean value [Mass/volume] in Blood Estimated from glycated hemoglobin">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/27353-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/27353-2">
			>
		>
	>
	adl_version = <"2.0.5">
