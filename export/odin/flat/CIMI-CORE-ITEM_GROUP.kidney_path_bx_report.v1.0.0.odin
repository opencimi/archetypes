(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/65757-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Kidney Pathology biopsy report' concept">
				use = <"Use for Kidney Pathology biopsy report.">
				keywords = <"Path Bx report", "Finding", "Findings", "Point in time", "Random", "Renal", "Nephric", "Narrative">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.kidney_path_bx_report.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"kidney_path_bx_report">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Kidney Pathology biopsy report">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Kidney Pathology biopsy report">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/65757-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/65757-7">
			>
		>
	>
	adl_version = <"2.0.5">
