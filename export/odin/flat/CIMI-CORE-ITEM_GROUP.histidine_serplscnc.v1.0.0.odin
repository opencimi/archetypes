(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20645-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Histidine [Moles/volume] in Serum or Plasma' concept">
				use = <"Use for Histidine [Moles/volume] in Serum or Plasma.">
				keywords = <"His", "Substance concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.histidine_serplscnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"histidine_serplscnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Histidine [Moles/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"umol/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20645-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20645-8">
			>
		>
	>
	adl_version = <"2.0.5">
