(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/30239-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Aspartate aminotransferase [Enzymatic activity/volume] in Serum or Plasma by With P-5'-P' concept">
				use = <"Use for Aspartate aminotransferase [Enzymatic activity/volume] in Serum or Plasma by With P-5'-P.">
				keywords = <"AST", "Aspartate amino transferase", "Glutamic oxaloacetic transaminase", "Aspartate transaminase", "SGOT", "Asp", "Aspartic acid", "Catalytic Concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "w P-5'-P", "w P-5'-P", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ast_serplccnc_pre_by_serpl_w_p5_pccnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ast_serplccnc_pre_by_serpl_w_p5_pccnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Aspartate aminotransferase [Enzymatic activity/volume] in Serum or Plasma by With P-5'-P">
				>
				["at0.0.0.0.0.2"] = <
					text = <"U/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/30239-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/30239-8">
			>
		>
	>
	adl_version = <"2.0.5">
