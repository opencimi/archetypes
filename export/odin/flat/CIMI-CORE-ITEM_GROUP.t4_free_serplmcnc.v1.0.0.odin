(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3024-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Thyroxine (T4) free [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Thyroxine (T4) free [Mass/volume] in Serum or Plasma.">
				keywords = <"T4 Free", "T-4", "FreeT4", "Thyrox", "Thyrx", "TT4", "Total T4", "thyroid hormone", "Thyroxin", "Levothyroxine", "Levo-thyroxine", "L-thyroxine", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "FT4", "FR", "Non-protein bound", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.t4_free_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"t4_free_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Thyroxine (T4) free [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3024-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3024-7">
			>
		>
	>
	adl_version = <"2.0.5">
