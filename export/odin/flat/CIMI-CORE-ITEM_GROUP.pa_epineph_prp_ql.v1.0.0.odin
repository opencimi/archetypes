(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/24378-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Platelet aggregation epinephrine induced [Presence] in Platelet rich plasma' concept">
				use = <"Use for Platelet aggregation epinephrine induced [Presence] in Platelet rich plasma.">
				keywords = <"PA Epineph", "Plt", "Pl", "Platelets", "Thrombocytes", "Platelt", "Thrombocyte", "Epinep", "Epinphrine", "Eppi", "Epin", "Adrenaline", "E", "Adrenalin", "Adreneline", "Epi", "Arbitrary concentration", "Point in time", "Random", "Platelet rich plasma", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Agg", "Aggr", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pa_epineph_prp_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pa_epineph_prp_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Platelet aggregation epinephrine induced [Presence] in Platelet rich plasma">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Platelet aggregation epinephrine induced [Presence] in Platelet rich plasma">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/24378-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/24378-2">
			>
		>
	>
	adl_version = <"2.0.5">
