(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/30313-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemoglobin [Mass/volume] in Arterial blood' concept">
				use = <"Use for Hemoglobin [Mass/volume] in Arterial blood.">
				keywords = <"Hgb", "Hb", "Haemoglobin", "Mass concentration", "Level", "Point in time", "Random", "Arterial blood", "ART", "Art blood", "Art bld", "ABG", "Quantitative", "QNT", "Quant", "Quan", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hgb_bldamcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hgb_bldamcnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/30313-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/30313-1">
			>
		>
	>
	adl_version = <"2.0.5">
