(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/21032-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Thrombin time [interpretation] in Blood' concept">
				use = <"Use for Thrombin time [interpretation] in Blood.">
				keywords = <"TT", "Thrombin time", "Thrombin clotting time", "TCT", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Blood", "WB", "Whole blood", "Nominal", "Throm">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.tt_bldimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"tt_bldimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Thrombin time [interpretation] in Blood">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Thrombin time [interpretation] in Blood">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/21032-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/21032-8">
			>
		>
	>
	adl_version = <"2.0.5">
