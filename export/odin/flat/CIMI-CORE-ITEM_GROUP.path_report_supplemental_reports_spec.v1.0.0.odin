(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/22639-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Pathology report supplemental reports Narrative' concept">
				use = <"Use for Pathology report supplemental reports Narrative.">
				keywords = <"Finding", "Findings", "Point in time", "Random", "Spec", "Narrative", "TUMOR REGISTRY(NAACCR)", "TUMOR REGISTRY(NAACCR)">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.path_report_supplemental_reports_spec.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"path_report_supplemental_reports_spec">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Pathology report supplemental reports Narrative">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Pathology report supplemental reports Narrative">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/22639-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/22639-9">
			>
		>
	>
	adl_version = <"2.0.5">
