(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6448-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Legionella pneumophila Ag [Presence] in Urine by Radioimmunoassay (RIA)' concept">
				use = <"Use for Legionella pneumophila Ag [Presence] in Urine by Radioimmunoassay (RIA).">
				keywords = <"L pneumo", "L pneumonphila", "Arbitrary concentration", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Radioimmunoassay", "Antigen", "Antigens", "Pneumophilia", "pneum", "Pneu", "Legionela", "Legion", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.l_pneumo_ag_ur_ql_pre_by_ria.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"l_pneumo_ag_ur_ql_pre_by_ria">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Legionella pneumophila Ag [Presence] in Urine by Radioimmunoassay (RIA)">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Legionella pneumophila Ag [Presence] in Urine by Radioimmunoassay (RIA)">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6448-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6448-5">
			>
		>
	>
	adl_version = <"2.0.5">
