(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/24108-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cancer Ag 19-9 [Units/volume] in Serum or Plasma' concept">
				use = <"Use for Cancer Ag 19-9 [Units/volume] in Serum or Plasma.">
				keywords = <"Cancer Ag19-9", "Carbohydrate antigen 19-9", "CA 19-9", "Cancer antigen 19-9", "Arbitrary concentration", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Antigen", "Antigens", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cancer_ag199_serplacnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cancer_ag199_serplacnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/24108-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/24108-3">
			>
		>
	>
	adl_version = <"2.0.5">
