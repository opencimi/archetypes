(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/38540-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Spermatozoa Motile/100 spermatozoa in Semen --pre washing' concept">
				use = <"Use for Spermatozoa Motile/100 spermatozoa in Semen --pre washing.">
				keywords = <"Sperm Motile", "Before", "Pre Wash", "Number fraction", "Percent", "Point in time", "Random", "Smn", "Ejaculate", "Seminal fluid", "SMPLS", "Sem", "Quantitative", "QNT", "Quant", "Quan", "Mot", "FERTILITY TESTING">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.sperm_motile_pre_wash_nfr_smn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"sperm_motile_pre_wash_nfr_smn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Spermatozoa Motile/100 spermatozoa in Semen --pre washing">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/38540-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/38540-1">
			>
		>
	>
	adl_version = <"2.0.5">
