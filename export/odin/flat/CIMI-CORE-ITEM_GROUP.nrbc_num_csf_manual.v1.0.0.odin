(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13529-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Nucleated erythrocytes [#/volume] in Cerebral spinal fluid by Manual count' concept">
				use = <"Use for Nucleated erythrocytes [#/volume] in Cerebral spinal fluid by Manual count.">
				keywords = <"nRBC", "nRBCs", "Normoblasts", "Erythroblasts", "RBC", "Red blood corpusles", "Red blood corpuscle", "Erthrocyte", "Erythrocyte", "Red blood cell", "Red cell", "Red cells", "Discocytes", "Red blood cells", "RBCS", "#", "Number concentration", "Count/volume", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Cerebral spinal fluid", "Spinal Fluid", "Cerebrospinal Fl", "Spinal Flu", "Spinal Fld", "Quantitative", "QNT", "Quant", "Quan", "Manl", "Nuc", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.nrbc_num_csf_manual.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"nrbc_num_csf_manual">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Nucleated erythrocytes [#/volume] in Cerebral spinal fluid by Manual count">
				>
				["at0.0.0.0.0.2"] = <
					text = <"/uL">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/420167005">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13529-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13529-3">
			>
		>
	>
	adl_version = <"2.0.5">
