(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/9335-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Appearance of Body fluid' concept">
				use = <"Use for Appearance of Body fluid.">
				keywords = <"Appr", "Appear", "Point in time", "Random", "BF", "Fluid", "Body fluid", "B/F", "FLU", "Fl", "Nominal">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.appearance_fld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"appearance_fld">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"BodyFluidAppearance_VALUESET_CODE">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Appearance of Body fluid">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/9335-1">
			>
			["opencem"] = <
				["at0.0.0.0.0.1"] = <"http://opencem.org/id/BodyFluidAppearance_VALUESET_CODE">
			>
		>
	>
	adl_version = <"2.0.5">
