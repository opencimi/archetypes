(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32585-2.html>">
			["tool"] = <"cimi-gen v0.0.1">
			["time"] = <"2015-08-05T22:26:39">
		>
		details = <
			["en"] = <
				language = <[ISO_639-1::en]>
				purpose = <"Archetype for CIMI 'Epstein Barr virus DNA [#/volume] (viral load) in Unspecified specimen by Probe and target amplification method' concept">
				use = <"Use for Epstein Barr virus DNA [#/volume] (viral load) in Unspecified specimen by Probe and target amplification method.">
				keywords = <"EBV", "Mono", "HHV-4", "human herpesvirus 4", "Mononucleosis", "Deoxyribonucleic acid", "#", "Number concentration", "Count/volume", "Count", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Quantitative", "QNT", "Quant", "Quan", "PCR", "Polymerase chain reaction", "Transcription mediated amplification", "NASBA", "Nucleic acid sequence based analysis", "SDA", "Strand Displacement Amplification", "LAT", "Ligation-activated transcription", "3SR SR", "3 Self-Sustaining Sequence Replication", "LCR", "Ligase chain reaction", "QBR", "Probe with target amplification", "NAAT", "TMA", "Amp Prb", "Probe with ampification", "DNA probe", "Amplified", "Epstn", "Microbiology", "Viral load">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ebv_dna_num_xxx_pcr.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ebv_dna_num_xxx_pcr">
		release_version = <"1.0.0">
		version_status = <0>
		build_count = <0>
	>
	parent_archetype_id = <"CIMI-CORE-ITEM_GROUP.laboratory_test_quantitative.v1">
	definition = <
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1"] = <
					text = <"Laboratory test quantitative">
				>
				["id5.0.8.0.1"] = <
					text = <"Result value">
				>
				["at0.0.0.0.0.1"] = <
					text = <"Epstein Barr virus DNA [#/volume] (viral load) in Unspecified specimen by Probe and target amplification method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{copies}/mL">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/______">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32585-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32585-2">
			>
		>
	>
	adl_version = <"2.0.5">
