(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32787-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Neutrophil cytoplasmic Ab.perinuclear [Titer] in Serum' concept">
				use = <"Use for Neutrophil cytoplasmic Ab.perinuclear [Titer] in Serum.">
				keywords = <"p-ANCA", "NSNA", "Perinuclear ANCA", "pANCA", "Granulocyte nucleus ab", "ACPA", "Granulocyte ab", "ACNA", "PNM", "Neutrophils", "Neutr", "PMN", "Neut", "Cytopl", "Cytoplas", "Dilution factor", "Titer", "Titre", "Ttr", "Titered", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.panca_titr_ser.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"panca_titr_ser">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Neutrophil cytoplasmic Ab.perinuclear [Titer] in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{titer}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32787-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32787-4">
			>
		>
	>
	adl_version = <"2.0.5">
