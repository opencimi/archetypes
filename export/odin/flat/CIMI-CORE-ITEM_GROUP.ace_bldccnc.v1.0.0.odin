(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1857-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Angiotensin converting enzyme [Enzymatic activity/volume] in Blood' concept">
				use = <"Use for Angiotensin converting enzyme [Enzymatic activity/volume] in Blood.">
				keywords = <"ACE", "Angio convert enzy", "Peptidyl dipeptidase A", "PDPA", "Proangiotensin", "Angiotensin I converting enzyme", "Carboxycathepsin", "Kininase II", "Dipeptidylcarboxypeptidase", "Peptidase P", "Catalytic Concentration", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Enzymes", "Enz", "AGT", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ace_bldccnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ace_bldccnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Angiotensin converting enzyme [Enzymatic activity/volume] in Blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"U/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1857-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1857-2">
			>
		>
	>
	adl_version = <"2.0.5">
