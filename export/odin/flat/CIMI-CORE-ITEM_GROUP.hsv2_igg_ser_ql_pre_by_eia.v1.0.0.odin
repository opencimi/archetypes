(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/43180-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Herpes simplex virus 2 IgG Ab [Presence] in Serum by Immunoassay' concept">
				use = <"Use for Herpes simplex virus 2 IgG Ab [Presence] in Serum by Immunoassay.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hsv2_igg_ser_ql_pre_by_eia.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hsv2_igg_ser_ql_pre_by_eia">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Herpes simplex virus 2 IgG Ab [Presence] in Serum by Immunoassay">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Herpes simplex virus 2 IgG Ab [Presence] in Serum by Immunoassay">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/43180-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/43180-9">
			>
		>
	>
	adl_version = <"2.0.5">
