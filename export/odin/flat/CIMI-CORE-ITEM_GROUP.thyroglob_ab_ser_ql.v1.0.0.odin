(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/15210-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Thyroglobulin Ab [Presence] in Serum' concept">
				use = <"Use for Thyroglobulin Ab [Presence] in Serum.">
				keywords = <"Thyglobulin", "Thyroglbn", "Antithyroglob", "Thyroglob", "Tg", "TgAbs", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.thyroglob_ab_ser_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"thyroglob_ab_ser_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Thyroglobulin Ab [Presence] in Serum">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Thyroglobulin Ab [Presence] in Serum">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/15210-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/15210-8">
			>
		>
	>
	adl_version = <"2.0.5">
