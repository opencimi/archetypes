(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/12248-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Epithelial cells.renal [Presence] in Urine sediment by Light microscopy' concept">
				use = <"Use for Epithelial cells.renal [Presence] in Urine sediment by Light microscopy.">
				keywords = <"Renal Epi Cells", "REC", "RTC", "RTE", "Kidney cells", "Renal tubular cells", "Cell", "Cellularity", "Arbitrary concentration", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Micro", "LM", "Micros", "Microscopic", "Epith", "Epithelia", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.renal_epi_cells_urns_ql_micro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"renal_epi_cells_urns_ql_micro">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/12248-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/12248-1">
			>
		>
	>
	adl_version = <"2.0.5">
