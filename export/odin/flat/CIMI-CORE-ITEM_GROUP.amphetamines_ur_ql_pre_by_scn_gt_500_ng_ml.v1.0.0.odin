(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/43983-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Amphetamines [Presence] in Urine by Screen method >500 ng/mL' concept">
				use = <"Use for Amphetamines [Presence] in Urine by Screen method >500 ng/mL.">
				keywords = <"Amphetam", "Amph", "Amphetamine", "Speed", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Scn>500 ng/mL", "Scn>500 ng/mL", "Scr", "Scn", "Scrn", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.amphetamines_ur_ql_pre_by_scn_gt_500_ng_ml.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"amphetamines_ur_ql_pre_by_scn_gt_500_ng_ml">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Amphetamines [Presence] in Urine by Screen method >500 ng/mL">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Amphetamines [Presence] in Urine by Screen method >500 ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/43983-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/43983-6">
			>
		>
	>
	adl_version = <"2.0.5">
