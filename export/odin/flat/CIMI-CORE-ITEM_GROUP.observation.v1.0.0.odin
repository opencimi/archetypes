(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'observation' concept">
				use = <"Use for observation archetypes.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.observation.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
