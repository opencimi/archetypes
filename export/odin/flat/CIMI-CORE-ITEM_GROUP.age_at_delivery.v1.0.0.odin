(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/43993-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Age at delivery' concept">
				use = <"Use for Age at delivery.">
				keywords = <"Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "OBSTERICAL.ULTRASOUND", "OBSTERICAL.ULTRASOUND", "Obstetrical", "Obstetrics">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.age_at_delivery.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"age_at_delivery">
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258707000">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/43993-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/43993-5">
			>
		>
	>
	adl_version = <"2.0.5">
