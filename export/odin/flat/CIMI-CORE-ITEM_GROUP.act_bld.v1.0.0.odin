(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3184-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Activated clotting time in Blood by Coagulation assay' concept">
				use = <"Use for Activated clotting time in Blood by Coagulation assay.">
				keywords = <"ACT", "Activated coagulation time", "Activated clotting time", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Coagulation assay", "Clot", "Tilt tube", "Clottable", "Activ">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.act_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"act_bld">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Activated clotting time in Blood by Coagulation assay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"s">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3184-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3184-9">
			>
		>
	>
	adl_version = <"2.0.5">
