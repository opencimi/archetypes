(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/21582-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Tryptase [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Tryptase [Mass/volume] in Serum or Plasma.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.tryptase_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"tryptase_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Tryptase [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/21582-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/21582-2">
			>
		>
	>
	adl_version = <"2.0.5">
