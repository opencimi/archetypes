(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3122-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Vanillylmandelate [Mass/time] in 24 hour Urine' concept">
				use = <"Use for Vanillylmandelate [Mass/time] in 24 hour Urine.">
				keywords = <"VMA", "HMMA", "MHMA", "Hydroxy-methoxy-mandelate", "Hydroxy-methoxy-mandelic acid", "Catecholamine metabolite", "3-methyl,4-hydroxy mandelate", "Vanillylmandelic acid", "3-methoxy-4-hydroxymandelate", "3-methyl,4-oh mandelic acid", "mRate", "Mass rate", "1 day", "24 hours", "24HR", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.vma_24h_urmrate.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"vma_24h_urmrate">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Vanillylmandelate [Mass/time] in 24 hour Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/(24.h)">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3122-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3122-9">
			>
		>
	>
	adl_version = <"2.0.5">
