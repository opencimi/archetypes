(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20458-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Rubella virus IgG Ab [interpretation] in Serum' concept">
				use = <"Use for Rubella virus IgG Ab [interpretation] in Serum.">
				keywords = <"RUBV", "Immune globulin G", "Immunoglobulin G", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Serum", "SR", "Nominal", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.rubv_igg_serimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"rubv_igg_serimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Rubella virus IgG Ab [interpretation] in Serum">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Rubella virus IgG Ab [interpretation] in Serum">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20458-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20458-6">
			>
		>
	>
	adl_version = <"2.0.5">
