(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'collect action' concept">
				use = <"Use for collect action.">
				keywords = <"collect", "action">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.collect_action.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"collect_action">
			...
			["1"] = <
				...
				children = <
					...
					["11"] = (P_C_ARCHETYPE_ROOT) <
						rm_type_name = <"ITEM_GROUP">
						node_id = <"id0.0.2">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.specimen_collection_site.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["id2.5.1"] = <"http://snomed.info/id/138875005">
				["id2.6.1"] = <"http://snomed.info/id/138875005">
