(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33086-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Gestational age estimated from Outer-Inner Biparietal diameter by method of Chitty 1997 (US)' concept">
				use = <"Use for Gestational age estimated from Outer-Inner Biparietal diameter by method of Chitty 1997 (US).">
				keywords = <"GA", "Point in time", "Random", "Fetal", "Quantitative", "QNT", "Quant", "Quan", "97", "BPD-OI", "US.est", "predicted", "Ultrasound", "ULS", "Sonogram", "Sonography", "Sonograph", "Echography", "Est", "estimation", "Gest", "Gestation", "Prenatal", "OBSTERICAL.ULTRASOUND", "OBSTERICAL.ULTRASOUND", "Obstetrical", "Obstetrics">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ga_pre_by_from_oi_bpd_chitty_1997.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ga_pre_by_from_oi_bpd_chitty_1997">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Gestational age estimated from Outer-Inner Biparietal diameter by method of Chitty 1997 (US)">
				>
				["at0.0.0.0.0.2"] = <
					text = <"d">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33086-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33086-0">
			>
		>
	>
	adl_version = <"2.0.5">
