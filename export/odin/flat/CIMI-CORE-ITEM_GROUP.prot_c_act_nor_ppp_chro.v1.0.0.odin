(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/27818-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Protein C actual/normal in Platelet poor plasma by Chromogenic method' concept">
				use = <"Use for Protein C actual/normal in Platelet poor plasma by Chromogenic method.">
				keywords = <"Prot C", "PC", "Autoprothrombin II-a", "PR", "Nor", "RlCCnc", "Point in time", "Random", "Platelet poor plasma", "Plas", "Quantitative", "QNT", "Quant", "Quan", "Chro", "Enzymatic assay", "Chromogenic assay", "ENZY", "Act/Nor", "Control", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.prot_c_act_nor_ppp_chro.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"prot_c_act_nor_ppp_chro">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Protein C actual/normal in Platelet poor plasma by Chromogenic method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/27818-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/27818-4">
			>
		>
	>
	adl_version = <"2.0.5">
