(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/14117-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'IgG index in Serum and CSF' concept">
				use = <"Use for IgG index in Serum and CSF.">
				keywords = <"Immune globulin G", "Immunoglobulin G", "Relative ratio", "Point in time", "Random", "Serum", "SR", "Cerebral spinal fluid", "Spinal Fluid", "Cerebrospinal Fl", "Spinal Flu", "Spinal Fld", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.igg_index_ser_plus_csf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"igg_index_ser_plus_csf">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"IgG index in Serum and CSF">
				>
				["at0.0.0.0.0.2"] = <
					text = <"">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/14117-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/14117-6">
			>
		>
	>
	adl_version = <"2.0.5">
