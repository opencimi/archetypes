(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.albumin_fldmcnc_post_by_microalbumin_fld_dl_lte_1mg_lmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"albumin_fldmcnc_post_by_microalbumin_fld_dl_lte_1mg_lmcnc">
