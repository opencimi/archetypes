(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5297-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Rheumatoid factor [Presence] in Serum by Latex agglutination' concept">
				use = <"Use for Rheumatoid factor [Presence] in Serum by Latex agglutination.">
				keywords = <"Rheumatoid fact", "RF", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Latex agglutination", "LAT", "Fac", "Fact", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.rheumatoid_fact_ser_ql_pre_by_la.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"rheumatoid_fact_ser_ql_pre_by_la">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Rheumatoid factor [Presence] in Serum by Latex agglutination">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5297-7">
			>
			["opencem"] = <
