(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20564-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oxygen saturation in Blood' concept">
				use = <"Use for Oxygen saturation in Blood.">
				keywords = <"SaO2", "SO2", "O2", "tO2", "Mass fraction", "Percent", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Satn", "SAT", "HEMODYNAMICS.MOLEC", "HEMODYNAMICS.MOLEC">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.sao2_percent_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"sao2_percent_bld">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20564-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20564-1">
			>
		>
	>
	adl_version = <"2.0.5">
