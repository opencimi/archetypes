(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/25700-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Immunofixation [interpretation] for Serum or Plasma' concept">
				use = <"Use for Immunofixation [interpretation] for Serum or Plasma.">
				keywords = <"Interp", "Intrp", "Interpret", "Interpt", "Impression", "Impressions", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Nominal", "IFE", "Ifix", "Immunofixation electrophoresis", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.interpretation_serpl_ifeimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"interpretation_serpl_ifeimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Immunofixation [interpretation] for Serum or Plasma">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Immunofixation [interpretation] for Serum or Plasma">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/25700-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/25700-6">
			>
		>
	>
	adl_version = <"2.0.5">
