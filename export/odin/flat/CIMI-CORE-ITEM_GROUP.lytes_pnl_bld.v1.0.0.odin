(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/55231-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Electrolytes panel - Blood' concept">
				use = <"Use for Electrolytes panel - Blood.">
				keywords = <"Lytes Pnl", "Elect", "Electr", "Electrolyte", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Pan", "Panl", "PANEL.CHEMISTRY", "PANEL.CHEMISTRY", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.lytes_pnl_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"lytes_pnl_bld">
			...
			["1"] = <
				...
				children = <
					...
					["21"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.2">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.chloride_bldscnc.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["22"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.3">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.sodium_bldscnc.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["23"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.4">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.anion_gap_bldscnc.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["24"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.5">
						occurrences = <"1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.potassium_bldscnc.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
				>
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/55231-5">
				["at0.0.0.0.1"] = <"http://loinc.org/id/55231-5">
				["id0.1.1.1.1"] = <"http://loinc.org/id/20565-8">
				["id0.1.1.1.2"] = <"http://loinc.org/id/2069-3">
				["id0.1.1.1.3"] = <"http://loinc.org/id/2947-0">
				["id0.1.1.1.4"] = <"http://loinc.org/id/41276-7">
				["id0.1.1.1.5"] = <"http://loinc.org/id/6298-4">
			>
		>
	>
	adl_version = <"2.0.5">
