(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/18932-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Imipenem [Susceptibility]' concept">
				use = <"Use for Imipenem [Susceptibility].">
				keywords = <"Imp", "Imipeneum", "Primaxin", "Susceptibility", "Susceptibilty", "Sus", "Suscept", "Susceptibilities", "AST", "Point in time", "Random", "Islt", "Isol", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.imipenem_susc_islt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"imipenem_susc_islt">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/18932-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/18932-4">
			>
		>
	>
	adl_version = <"2.0.5">
