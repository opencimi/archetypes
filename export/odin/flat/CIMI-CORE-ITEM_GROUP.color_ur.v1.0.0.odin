(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5778-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Color of Urine' concept">
				use = <"Use for Color of Urine.">
				keywords = <"Colour", "Appearance", "Typ", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Nominal">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.color_ur.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"color_ur">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5778-6">
			>
			["opencem"] = <
				["at0.0.0.0.0.1"] = <"http://opencem.org/id/UrineColor_VALUESET_CODE">
			>
		>
	>
	adl_version = <"2.0.5">
