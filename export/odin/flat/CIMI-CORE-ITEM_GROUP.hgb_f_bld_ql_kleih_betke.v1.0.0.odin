(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32140-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemoglobin F [Presence] in Blood by Kleihauer-Betke method' concept">
				use = <"Use for Hemoglobin F [Presence] in Blood by Kleihauer-Betke method.">
				keywords = <"Hgb F", "HbF", "Fetal hemoglobin", "Hb", "Haemoglobin", "Arbitrary concentration", "Point in time", "Random", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Kleih Betke", "Kleihauer-Braun-Betke", "KB", "Kleihauer-Betke test", "Kleihauer-Betke stain", "Kleihauer stain", "Kleihauer test", "Fetal maternal hemorrhage screen", "Acid elution", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hgb_f_bld_ql_kleih_betke.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hgb_f_bld_ql_kleih_betke">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hemoglobin F [Presence] in Blood by Kleihauer-Betke method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Hemoglobin F [Presence] in Blood by Kleihauer-Betke method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32140-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32140-6">
			>
		>
	>
	adl_version = <"2.0.5">
