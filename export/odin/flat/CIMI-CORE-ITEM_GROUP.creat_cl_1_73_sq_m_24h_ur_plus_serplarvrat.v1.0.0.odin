(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/12195-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Creatinine renal clearance/1.73 sq M in 24 hour' concept">
				use = <"Use for Creatinine renal clearance/1.73 sq M in 24 hour.">
				keywords = <"Creat", "Crea", "CR", "BSA", "CrCl/BSA", "Volume rate/area", "1 day", "24 hours", "24HR", "Ur+SerPl", "Ur+SerPl", "UR", "Urn", "UA", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Cl", "Chemistry", "UCr">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.creat_cl_1_73_sq_m_24h_ur_plus_serplarvrat.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"creat_cl_1_73_sq_m_24h_ur_plus_serplarvrat">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/12195-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/12195-4">
			>
		>
	>
	adl_version = <"2.0.5">
