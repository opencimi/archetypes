(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2115-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Choriogonadotropin.beta subunit free [Moles/volume] in Serum or Plasma' concept">
				use = <"Use for Choriogonadotropin.beta subunit free [Moles/volume] in Serum or Plasma.">
				keywords = <"B-HCG Free", "B-HCG", "B HCG", "Beta HCG", "Beta human chorionic gonadotropin", "Choriogonadotropin beta chain", "Chorionic gonadotropin", "CG", "Human chorionic gonadotropin", "Choriogonadotropins total", "Substance concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "FR", "Non-protein bound", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bhcg_free_serplscnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bhcg_free_serplscnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Choriogonadotropin.beta subunit free [Moles/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mmol/L">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/258813002">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2115-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2115-4">
			>
		>
	>
	adl_version = <"2.0.5">
