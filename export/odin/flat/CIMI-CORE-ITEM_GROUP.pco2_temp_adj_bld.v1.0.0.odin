(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/34705-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Carbon dioxide [Partial pressure] adjusted to patients actual temperature in Blood' concept">
				use = <"Use for Carbon dioxide [Partial pressure] adjusted to patients actual temperature in Blood.">
				keywords = <"Temp", "CO2", "Carbonic anhydride", "temp adj", "Partial pressure", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Chemistry", "PCO2">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.pco2_temp_adj_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"pco2_temp_adj_bld">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/34705-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/34705-4">
			>
		>
	>
	adl_version = <"2.0.5">
