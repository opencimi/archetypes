(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/38256-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cells Counted Total [#] in Body fluid' concept">
				use = <"Use for Cells Counted Total [#] in Body fluid.">
				keywords = <"Total Cells Counted", "Total cells", "Cell", "Cellularity", "Number", "Count", "Cnt", "Point in time", "Random", "BF", "Fluid", "Body fluid", "B/F", "FLU", "Fl", "Quantitative", "QNT", "Quant", "Quan", "Tot", "Totl", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.total_cells_counted_fld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"total_cells_counted_fld">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cells Counted Total [#] in Body fluid">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{#}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/38256-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/38256-4">
			>
		>
	>
	adl_version = <"2.0.5">
