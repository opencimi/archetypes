(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1695-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI '5-Hydroxyindoleacetate [Mass/time] in 24 hour Urine' concept">
				use = <"Use for 5-Hydroxyindoleacetate [Mass/time] in 24 hour Urine.">
				keywords = <"5OH-indoleacetate", "Hydroxyindoacet", "5HIAA", "5HIA", "5-Hydroxy indoleacetate", "Serotonin metabolite", "5-HIAA", "5-hydroxyindoleacetic acid", "mRate", "Mass rate", "1 day", "24 hours", "24HR", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.5ohindoleacetate_24h_urmrate.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"5ohindoleacetate_24h_urmrate">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"5-Hydroxyindoleacetate [Mass/time] in 24 hour Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/(24.h)">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1695-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1695-6">
			>
		>
	>
	adl_version = <"2.0.5">
