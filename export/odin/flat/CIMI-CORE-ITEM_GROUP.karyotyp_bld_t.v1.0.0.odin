(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/29770-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Karyotype [Identifier] in Blood or Tissue Nominal' concept">
				use = <"Use for Karyotype [Identifier] in Blood or Tissue Nominal.">
				keywords = <"Karyotyp", "Karyogram", "Genotype", "Chromosome analysis", "Identity or presence", "Point in time", "Random", "Bld/T", "Tissue", "Bld/T", "Blood", "WB", "Whole blood", "Nominal", "Molecular pathology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.karyotyp_bld_t.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"karyotyp_bld_t">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Karyotype [Identifier] in Blood or Tissue Nominal">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Karyotype [Identifier] in Blood or Tissue Nominal">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/29770-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/29770-5">
			>
		>
	>
	adl_version = <"2.0.5">
