(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3282-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Lupus anticoagulant neutralization hexagonal phase phospholipid [Time] in Platelet poor plasma by Coagulation assay' concept">
				use = <"Use for Lupus anticoagulant neutralization hexagonal phase phospholipid [Time] in Platelet poor plasma by Coagulation assay.">
				keywords = <"Pl", "Phoslpd", "Phospholipids", "Lipid", "LA Nt Hex PL", "HPP", "STAClot LA", "dRVVT", "LAC", "Lupus inhibitor", "Coagulation inhibiting antibody", "Anti-phospholipid antibody", "Point in time", "Random", "Platelet poor plasma", "Plas", "Quantitative", "QNT", "Quant", "Quan", "Coagulation assay", "Clot", "Tilt tube", "Clottable", "Neutr", "Neut", "Anticoag">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.la_nt_hex_pl_ppp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"la_nt_hex_pl_ppp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Lupus anticoagulant neutralization hexagonal phase phospholipid [Time] in Platelet poor plasma by Coagulation assay">
				>
				["at0.0.0.0.0.2"] = <
					text = <"s">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3282-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3282-1">
			>
		>
	>
	adl_version = <"2.0.5">
