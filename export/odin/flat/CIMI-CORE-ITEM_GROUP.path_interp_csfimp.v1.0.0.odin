(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/21024-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Pathologist interpretation of Cerebral spinal fluid tests' concept">
				use = <"Use for Pathologist interpretation of Cerebral spinal fluid tests.">
				keywords = <"Path Interp", "Intrp", "Interpret", "Interpt", "Impression", "Impressions", "Point in time", "Random", "Cerebral spinal fluid", "Spinal Fluid", "Cerebrospinal Fl", "Spinal Flu", "Spinal Fld", "Nominal", "PATHOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.path_interp_csfimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"path_interp_csfimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Pathologist interpretation of Cerebral spinal fluid tests">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Pathologist interpretation of Cerebral spinal fluid tests">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/21024-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/21024-5">
			>
		>
	>
	adl_version = <"2.0.5">
