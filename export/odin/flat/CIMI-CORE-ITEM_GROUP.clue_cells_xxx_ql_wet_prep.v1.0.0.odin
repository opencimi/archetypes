(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/32764-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Clue cells [Presence] in Unspecified specimen by Wet preparation' concept">
				use = <"Use for Clue cells [Presence] in Unspecified specimen by Wet preparation.">
				keywords = <"Vaginosis", "Cell", "Cellularity", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Wet Prep", "Wet mount", "Wet prep", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.clue_cells_xxx_ql_wet_prep.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"clue_cells_xxx_ql_wet_prep">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Clue cells [Presence] in Unspecified specimen by Wet preparation">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Clue cells [Presence] in Unspecified specimen by Wet preparation">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/32764-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/32764-3">
			>
		>
	>
	adl_version = <"2.0.5">
