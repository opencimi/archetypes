(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13451-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Creatinine dialysis fluid clearance' concept">
				use = <"Use for Creatinine dialysis fluid clearance.">
				keywords = <"Cr DF Cl", "Creat", "Crea", "CR", "vRate", "Volume rate", "Flow", "Point in time", "Random", "Dial fld+SerPl", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Dial fld+SerPl", "Dialysate", "Diaf", "Quantitative", "QNT", "Quant", "Quan", "Dialy", "Clear", "Clearanc", "Clearances", "Clr", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.creat_cl_dial_fld_plus_serplvrate.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"creat_cl_dial_fld_plus_serplvrate">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Creatinine dialysis fluid clearance">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mL/min">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13451-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/13451-0">
			>
		>
	>
	adl_version = <"2.0.5">
