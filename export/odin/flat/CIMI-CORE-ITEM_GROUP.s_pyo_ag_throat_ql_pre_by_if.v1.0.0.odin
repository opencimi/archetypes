(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6557-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Streptococcus pyogenes Ag [Presence] in Throat by Immunofluorescence' concept">
				use = <"Use for Streptococcus pyogenes Ag [Presence] in Throat by Immunofluorescence.">
				keywords = <"S pyo", "S pyogenes", "GAS", "Steptococcus Group A", "Group A Strep", "Streptococci group A", "Streptococcus group A", "Arbitrary concentration", "Point in time", "Random", "Throat", "Upper respiratory", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ACIF", "FA", "Fluorescent antibody", "Immune fluorescence", "Fluoresent", "Immunoflour", "Immunofluor", "Immunofluorescence", "IFA", "Time Resolved Fluorescence", "Anticomplement Immunofluorescence", "TRF", "Antigen", "Antigens", "Strept", "Microbiology", "DFA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.s_pyo_ag_throat_ql_pre_by_if.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"s_pyo_ag_throat_ql_pre_by_if">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Streptococcus pyogenes Ag [Presence] in Throat by Immunofluorescence">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Streptococcus pyogenes Ag [Presence] in Throat by Immunofluorescence">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6557-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6557-3">
			>
		>
	>
	adl_version = <"2.0.5">
