(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/48066-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fibrin D-dimer DDU [Mass/volume] in Platelet poor plasma' concept">
				use = <"Use for Fibrin D-dimer DDU [Mass/volume] in Platelet poor plasma.">
				keywords = <"Fragment D-dimer", "Rhesus", "Rh", "Mass concentration", "Level", "Point in time", "Random", "Platelet poor plasma", "Plas", "Quantitative", "QNT", "Quant", "Quan", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.d_dimer_ddu_pppmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"d_dimer_ddu_pppmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Fibrin D-dimer DDU [Mass/volume] in Platelet poor plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/L{DDU}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/48066-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/48066-5">
			>
		>
	>
	adl_version = <"2.0.5">
