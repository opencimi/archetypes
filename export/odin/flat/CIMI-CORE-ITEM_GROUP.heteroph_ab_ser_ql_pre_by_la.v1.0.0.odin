(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5213-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Heterophile Ab [Presence] in Serum by Latex agglutination' concept">
				use = <"Use for Heterophile Ab [Presence] in Serum by Latex agglutination.">
				keywords = <"Mono screen", "Mono slide", "Hetero", "Heteroph", "Hetr", "Mononucleosis screen", "Mono test", "Mono spot", "Mononucleosis test", "Epstein-Barr virus", "Monospot", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Latex agglutination", "LAT", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.heteroph_ab_ser_ql_pre_by_la.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"heteroph_ab_ser_ql_pre_by_la">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Heterophile Ab [Presence] in Serum by Latex agglutination">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5213-4">
			>
			["opencem"] = <
