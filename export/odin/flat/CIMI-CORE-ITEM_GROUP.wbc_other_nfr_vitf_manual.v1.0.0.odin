(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/68432-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Leukocytes other/100 leukocytes in Vitreous fluid by Manual count' concept">
				use = <"Use for Leukocytes other/100 leukocytes in Vitreous fluid by Manual count.">
				keywords = <"WBC Other", "White blood cell", "Leuc", "Leuk", "Leukocyte", "Lkcs", "White blood cells", "WBCs", "100WBC", "Number fraction", "Percent", "Point in time", "Random", "Vitf", "Vitreous fluid", "VitF", "Vitreous humor", "Vitreous humour", "Quantitative", "QNT", "Quant", "Quan", "Manl", "Othr", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.wbc_other_nfr_vitf_manual.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"wbc_other_nfr_vitf_manual">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/68432-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/68432-4">
			>
		>
	>
	adl_version = <"2.0.5">
