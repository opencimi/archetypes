(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2749-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'pH of Gastric fluid' concept">
				use = <"Use for pH of Gastric fluid.">
				keywords = <"Log molar concentration", "Point in time", "Random", "Gastric contents", "Gastric fluid", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ph_gast.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ph_gast">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2749-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2749-0">
			>
		>
	>
	adl_version = <"2.0.5">
