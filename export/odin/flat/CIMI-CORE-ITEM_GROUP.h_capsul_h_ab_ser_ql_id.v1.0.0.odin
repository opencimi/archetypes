(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/35732-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Histoplasma capsulatum H Ab [Presence] in Serum by Immune diffusion (ID)' concept">
				use = <"Use for Histoplasma capsulatum H Ab [Presence] in Serum by Immune diffusion (ID).">
				keywords = <"H capsul H", "H capsulatum", "H farciminosum", "Histoplasma farciminosum", "Bombay AB", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ID", "Immunodiff", "Immunodiffusion", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Imun", "Imune", "Imm", "Histo", "Histopl", "Histoplasmos", "Histoplasmosis", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.h_capsul_h_ab_ser_ql_id.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"h_capsul_h_ab_ser_ql_id">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Histoplasma capsulatum H Ab [Presence] in Serum by Immune diffusion (ID)">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Histoplasma capsulatum H Ab [Presence] in Serum by Immune diffusion (ID)">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/35732-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/35732-7">
			>
		>
	>
	adl_version = <"2.0.5">
