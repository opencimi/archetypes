(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/27096-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Streptococcus pneumoniae 3 IgG Ab [Mass/volume] in Serum' concept">
				use = <"Use for Streptococcus pneumoniae 3 IgG Ab [Mass/volume] in Serum.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.s_pneum3_igg_sermcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"s_pneum3_igg_sermcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Streptococcus pneumoniae 3 IgG Ab [Mass/volume] in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/27096-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/27096-7">
			>
		>
	>
	adl_version = <"2.0.5">
