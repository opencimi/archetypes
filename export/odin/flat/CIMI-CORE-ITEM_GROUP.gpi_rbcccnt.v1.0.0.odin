(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/44050-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Glucose phosphate isomerase [Enzymatic activity/mass] in Red Blood Cells' concept">
				use = <"Use for Glucose phosphate isomerase [Enzymatic activity/mass] in Red Blood Cells.">
				keywords = <"Phos", "Phosphrous", "Phosphorous", "Pi", "i Phos", "PO4", "Phosphorus", "Inorganic phosphate", "Phosphate total", "GPI", "Phosphohexose isomerase", "Glucosephosphate isomerase", "PHI", "Phosphohexoisomerase", "Glucose-6-phosphate isomerase", "Glu", "Gluc", "Glucoseur", "Catalytic Content", "Point in time", "Random", "Erythrocytes", "Red blood corpusles", "Red blood cells", "Quantitative", "QNT", "Quant", "Quan", "Isom", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.gpi_rbcccnt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"gpi_rbcccnt">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/44050-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/44050-3">
			>
		>
	>
	adl_version = <"2.0.5">
