(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/44054-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Triosephosphate isomerase [Enzymatic activity/mass] in Red Blood Cells' concept">
				use = <"Use for Triosephosphate isomerase [Enzymatic activity/mass] in Red Blood Cells.">
				keywords = <"TPI", "TIM", "Triose phosphate isomerase", "Triose phosphate mutase", "Catalytic Content", "Point in time", "Random", "Erythrocytes", "Red blood corpusles", "Red blood cells", "Quantitative", "QNT", "Quant", "Quan", "Isom", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.tpi_rbcccnt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"tpi_rbcccnt">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/44054-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/44054-5">
			>
		>
	>
	adl_version = <"2.0.5">
