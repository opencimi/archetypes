(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/30193-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Acylcarnitine/Carnitine.free (C0) [Molar ratio] in Serum or Plasma' concept">
				use = <"Use for Acylcarnitine/Carnitine.free (C0) [Molar ratio] in Serum or Plasma.">
				keywords = <"Acylcarni", "Acyl carnitine", "FC", "Carnitine.total", "Substance concentration ratio", "Substance ratio", "Scrto", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "FR", "Non-protein bound", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.acylcarnitine_c0_serplsrto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"acylcarnitine_c0_serplsrto">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Acylcarnitine/Carnitine.free (C0) [Molar ratio] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{ratio}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/30193-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/30193-7">
			>
		>
	>
	adl_version = <"2.0.5">
