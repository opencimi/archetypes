(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/3389-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Benzodiazepines [Presence] in Serum or Plasma' concept">
				use = <"Use for Benzodiazepines [Presence] in Serum or Plasma.">
				keywords = <"Benzodiaz", "Benz", "Benzodiazepine", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.benzodiaz_serpl_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"benzodiaz_serpl_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Benzodiazepines [Presence] in Serum or Plasma">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Benzodiazepines [Presence] in Serum or Plasma">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/3389-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/3389-4">
			>
		>
	>
	adl_version = <"2.0.5">
