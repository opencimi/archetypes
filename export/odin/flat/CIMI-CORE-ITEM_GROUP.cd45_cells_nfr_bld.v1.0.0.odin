(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/8130-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'CD45 (Lymphs) cells/100 cells in Blood' concept">
				use = <"Use for CD45 (Lymphs) cells/100 cells in Blood.">
				keywords = <"CD45 Cells", "Cell", "Cellularity", "CD45RO", "CD45RB", "CD45RA", "LCA", "B220", "CD45R", "CD45RC", "Leukocyte common antigen", "T200", "Ly5", "Gated cells", "Number fraction", "Percent", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "CELL MARKERS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cd45_cells_nfr_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cd45_cells_nfr_bld">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"CD45 (Lymphs) cells/100 cells in Blood">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/8130-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/8130-7">
			>
		>
	>
	adl_version = <"2.0.5">
