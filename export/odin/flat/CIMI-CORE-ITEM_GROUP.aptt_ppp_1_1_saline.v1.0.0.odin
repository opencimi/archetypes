(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/43734-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Activated partial thromboplastin time (aPTT) in Platelet poor plasma by Coagulation 1:1 saline' concept">
				use = <"Use for Activated partial thromboplastin time (aPTT) in Platelet poor plasma by Coagulation 1:1 saline.">
				keywords = <"aPTT", "PTT", "Partial Thromboplastin Time", "Activated partial thromboplastin time", "Little(A)PTT", "Point in time", "Random", "Platelet poor plasma", "Plas", "Quantitative", "QNT", "Quant", "Quan", "1:1 saline", "1:1 saline", "Coagulation assay", "Clot", "Tilt tube", "Clottable", "Surf">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.aptt_ppp_1_1_saline.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"aptt_ppp_1_1_saline">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Activated partial thromboplastin time (aPTT) in Platelet poor plasma by Coagulation 1:1 saline">
				>
				["at0.0.0.0.0.2"] = <
					text = <"s">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/43734-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/43734-3">
			>
		>
	>
	adl_version = <"2.0.5">
