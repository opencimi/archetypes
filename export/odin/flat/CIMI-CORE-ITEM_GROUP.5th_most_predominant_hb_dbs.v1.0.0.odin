(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/64121-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fifth most predominant hemoglobin in Dried blood spot' concept">
				use = <"Use for Fifth most predominant hemoglobin in Dried blood spot.">
				keywords = <"Most predominant Hb", "Hgb", "Haemoglobin", "5th most predominant Hb", "Finding", "Findings", "Point in time", "Random", "DBS", "Filter paper", "FP", "Dried blood spot", "Blood", "WB", "Whole blood", "Nominal", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.5th_most_predominant_hb_dbs.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"5th_most_predominant_hb_dbs">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/64121-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/64121-7">
			>
		>
	>
	adl_version = <"2.0.5">
