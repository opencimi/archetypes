(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/26530-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cortisol [Mass/volume] in Serum or Plasma --30 minutes post dose corticotropin' concept">
				use = <"Use for Cortisol [Mass/volume] in Serum or Plasma --30 minutes post dose corticotropin.">
				keywords = <"Cortis", "Coritsol", "F", "Cort", "hydrocortisone", "Compound F", "17-Hydroxycorticosterone", "ACTH", "Rc206", "c74", "Cortrosyn", "c206", "Adrenocorticotropin", "Adrenocorticotrophic hormone", "30M p ACTH", "p dose", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "PST", "After", "CHEMISTRY.CHALLENGE TESTING", "CHEMISTRY.CHALLENGE TESTING">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cortis_30m_p_acth_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cortis_30m_p_acth_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cortisol [Mass/volume] in Serum or Plasma --30 minutes post dose corticotropin">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/26530-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/26530-6">
			>
		>
	>
	adl_version = <"2.0.5">
