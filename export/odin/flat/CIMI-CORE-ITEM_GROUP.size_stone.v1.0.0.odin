(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/9802-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Size [Entitic volume] of Stone' concept">
				use = <"Use for Size [Entitic volume] of Stone.">
				keywords = <"Entitic volume", "Point in time", "Random", "Stone", "Calc", "Stn", "Stones", "Calculi", "Quantitative", "QNT", "Quant", "Quan", "PATHOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.size_stone.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"size_stone">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Size [Entitic volume] of Stone">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mm3">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/9802-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/9802-0">
			>
		>
	>
	adl_version = <"2.0.5">
