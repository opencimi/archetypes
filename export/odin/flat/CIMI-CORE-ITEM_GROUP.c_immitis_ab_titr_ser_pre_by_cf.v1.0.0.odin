(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5096-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Coccidioides immitis Ab [Titer] in Serum by Complement fixation' concept">
				use = <"Use for Coccidioides immitis Ab [Titer] in Serum by Complement fixation.">
				keywords = <"C immitis", "Coccio", "Coccidioides esteriformis", "C esteriformis", "Blastomycoides immitis", "B immitis", "Geotrichum immite", "G immite", "Glenospora metaeuropea", "G metaeuropea", "Glenosporum louisianoideum", "G louisianoideum", "Posadasia esteriformis", "P esteriformis", "Pseudococcidioides mazzai", "P mazzai", "Trichosporon proteolyticum", "T proteolyticum", "Coccidiomycosis", "Dilution factor", "Titer", "Titre", "Ttr", "Titered", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "CF", "Complement fixation", "Compfix", "Comp fixation", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.c_immitis_ab_titr_ser_pre_by_cf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"c_immitis_ab_titr_ser_pre_by_cf">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Coccidioides immitis Ab [Titer] in Serum by Complement fixation">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{titer}">
				>
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/118590008">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5096-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5096-3">
			>
		>
	>
	adl_version = <"2.0.5">
