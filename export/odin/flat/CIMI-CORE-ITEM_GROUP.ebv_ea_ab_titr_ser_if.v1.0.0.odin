(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/14083-0.html>">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ebv_ea_ab_titr_ser_if.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ebv_ea_ab_titr_ser_if">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Epstein Barr virus early Ab [Titer] in Serum by Immunofluorescence">
				>
				["at0.0.0.0.0.2"] = <
					text = <"{titer}">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/14083-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/14083-0">
			>
		>
	>
	adl_version = <"2.0.5">
