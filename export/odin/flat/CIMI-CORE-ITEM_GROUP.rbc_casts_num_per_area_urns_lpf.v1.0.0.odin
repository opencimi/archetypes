(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5807-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'RBC casts [#/area] in Urine sediment by Microscopy low power field' concept">
				use = <"Use for RBC casts [#/area] in Urine sediment by Microscopy low power field.">
				keywords = <"RBC Casts", "Erythrocytes", "Red blood corpusles", "Red blood corpuscle", "Red blood cell", "Red cell", "Red cells", "Discocyte", "Erc", "Red blood cells", "Cast", "#/area", "Number areic", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Micro", "LM", "Micros", "Microscopic", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.rbc_casts_num_per_area_urns_lpf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"rbc_casts_num_per_area_urns_lpf">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5807-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5807-3">
			>
		>
	>
	adl_version = <"2.0.5">
