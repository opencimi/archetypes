(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6034-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Bahia grass IgE Ab [Units/volume] in Serum' concept">
				use = <"Use for Bahia grass IgE Ab [Units/volume] in Serum.">
				keywords = <"Bahia grass", "g017", "g17", "Immune globulin E", "Immunoglobulin E", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "ALLERGY TESTING", "Allergens", "Allergen">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.bahia_grass_ige_qn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"bahia_grass_ige_qn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Bahia grass IgE Ab [Units/volume] in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"k[IU]/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6034-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6034-3">
			>
		>
	>
	adl_version = <"2.0.5">
