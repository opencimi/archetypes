(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		details = <
			["en"] = <
				...
				keywords = <"Vitamin D2", "Vit D2", "Vit D 1 25 hydroxy", "Pro vitamin D", "Viosterol", "Ergocalciferol", "C28H43OH", "Activated ergosterol", "Ercalciol", "25-hydroxyvitamin D2 + D3", "25-hydroxyvitamin D metabolites", "25(OH)D3", "25-hydroxycholecalciferol", "Vitamin D 25 hydroxy", "25-hydroxyvitamin D 3", "Calciderol", "25-hydroxyvitamin D3", "Calcifediol", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.calcidiol_plus_calciferol_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"calcidiol_plus_calciferol_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Calcidiol+Calciferol [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49543-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49543-2">
			>
		>
	>
	adl_version = <"2.0.5">
