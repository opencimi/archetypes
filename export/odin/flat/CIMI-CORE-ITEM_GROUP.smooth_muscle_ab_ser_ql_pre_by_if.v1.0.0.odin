(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/26971-2.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Smooth muscle Ab [Presence] in Serum by Immunofluorescence' concept">
				use = <"Use for Smooth muscle Ab [Presence] in Serum by Immunofluorescence.">
				keywords = <"SMA", "ASMA", "SM", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "ACIF", "FA", "Fluorescent antibody", "Immune fluorescence", "Fluoresent", "Immunoflour", "Immunofluor", "Immunofluorescence", "IFA", "Time Resolved Fluorescence", "Anticomplement Immunofluorescence", "TRF", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Musc", "Muscl", "Serology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.smooth_muscle_ab_ser_ql_pre_by_if.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"smooth_muscle_ab_ser_ql_pre_by_if">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Smooth muscle Ab [Presence] in Serum by Immunofluorescence">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Smooth muscle Ab [Presence] in Serum by Immunofluorescence">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/26971-2">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/26971-2">
			>
		>
	>
	adl_version = <"2.0.5">
