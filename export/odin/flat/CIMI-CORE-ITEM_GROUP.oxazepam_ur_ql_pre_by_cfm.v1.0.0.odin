(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/19639-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oxazepam [Presence] in Urine by Confirmatory method' concept">
				use = <"Use for Oxazepam [Presence] in Urine by Confirmatory method.">
				keywords = <"Diazepam metabolite", "Alepam", "Serax", "Chlordiazepoxide metabolite", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Cfm", "CNFR", "CNFRM", "Conf", "Confirmation", "GCMS", "Confirmatory", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.oxazepam_ur_ql_pre_by_cfm.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"oxazepam_ur_ql_pre_by_cfm">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Oxazepam [Presence] in Urine by Confirmatory method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Oxazepam [Presence] in Urine by Confirmatory method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/19639-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/19639-4">
			>
		>
	>
	adl_version = <"2.0.5">
