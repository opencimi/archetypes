(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/42176-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI '1,3 beta glucan [Mass/volume] in Serum' concept">
				use = <"Use for 1,3 beta glucan [Mass/volume] in Serum.">
				keywords = <"1,3-Beta-D-Glucan", "Mass concentration", "Level", "Point in time", "Random", "Serum", "SR", "Quantitative", "QNT", "Quant", "Quan", "B", "III", "I", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.1__3_beta_glucan_sermcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"1__3_beta_glucan_sermcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"1,3 beta glucan [Mass/volume] in Serum">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/42176-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/42176-8">
			>
		>
	>
	adl_version = <"2.0.5">
