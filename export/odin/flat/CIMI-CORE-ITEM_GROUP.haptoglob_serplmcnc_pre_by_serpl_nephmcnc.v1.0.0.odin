(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/46127-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Haptoglobin [Mass/volume] in Serum or Plasma by Nephlometry' concept">
				use = <"Use for Haptoglobin [Mass/volume] in Serum or Plasma by Nephlometry.">
				keywords = <"Haptoglob", "Hp", "Hpt", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Neph", "Nephelom", "Light scattering", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.haptoglob_serplmcnc_pre_by_serpl_nephmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"haptoglob_serplmcnc_pre_by_serpl_nephmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Haptoglobin [Mass/volume] in Serum or Plasma by Nephlometry">
				>
				["at0.0.0.0.0.2"] = <
					text = <"g/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/46127-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/46127-7">
			>
		>
	>
	adl_version = <"2.0.5">
