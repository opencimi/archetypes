(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/49573-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'HIV genotype [Susceptibility] in Isolate by Genotype method Narrative' concept">
				use = <"Use for HIV genotype [Susceptibility] in Isolate by Genotype method Narrative.">
				keywords = <"AIDS", "Human immunodeficiency virus", "Susceptibility", "Susceptibilty", "Sus", "Suscept", "Susceptibilities", "AST", "Point in time", "Random", "Islt", "Isol", "Narrative", "Report", "Genotyp", "Genotypic", "Gentyp", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hiv_gentyp_islt.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hiv_gentyp_islt">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"HIV genotype [Susceptibility] in Isolate by Genotype method Narrative">
				>
				["id1.1.1.1.1.1"] = <
					text = <"HIV genotype [Susceptibility] in Isolate by Genotype method Narrative">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/49573-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/49573-9">
			>
		>
	>
	adl_version = <"2.0.5">
