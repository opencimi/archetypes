(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1960-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Bicarbonate [Moles/volume] in Arterial blood' concept">
				use = <"Use for Bicarbonate [Moles/volume] in Arterial blood.">
				keywords = <"HCO3", "BIC", "Bicarb", "bicar", "Substance concentration", "Level", "Point in time", "Random", "Arterial blood", "ART", "Art blood", "Art bld", "ABG", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hco3_bldascnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hco3_bldascnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1960-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/1960-4">
			>
		>
	>
	adl_version = <"2.0.5">
