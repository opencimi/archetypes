(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/22635-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Pathology report microscopic observation Narrative Other stain' concept">
				use = <"Use for Pathology report microscopic observation Narrative Other stain.">
				keywords = <"Micro", "Identity or presence", "Point in time", "Random", "Spec", "Narrative", "Other Stn", "TUMOR REGISTRY(NAACCR)", "TUMOR REGISTRY(NAACCR)">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.path_report_microscopic_spec_other_stn.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"path_report_microscopic_spec_other_stn">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Pathology report microscopic observation Narrative Other stain">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Pathology report microscopic observation Narrative Other stain">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/22635-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/22635-7">
			>
		>
	>
	adl_version = <"2.0.5">
