(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/50896-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'pH of Body fluid by Test strip' concept">
				use = <"Use for pH of Body fluid by Test strip.">
				keywords = <"Log molar concentration", "Point in time", "Random", "BF", "Fluid", "Body fluid", "B/F", "FLU", "Fl", "Quantitative", "QNT", "Quant", "Quan", "Dipstick", "Dip stick", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ph_fld_pre_by_strip.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ph_fld_pre_by_strip">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"pH of Body fluid by Test strip">
				>
				["at0.0.0.0.0.2"] = <
					text = <"[pH]">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/50896-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/50896-0">
			>
		>
	>
	adl_version = <"2.0.5">
