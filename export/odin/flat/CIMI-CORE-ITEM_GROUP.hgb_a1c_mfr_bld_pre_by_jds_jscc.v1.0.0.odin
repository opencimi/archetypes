(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/62388-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemoglobin A1c/Hemoglobin.total in Blood by JDS/JSCC protocol' concept">
				use = <"Use for Hemoglobin A1c/Hemoglobin.total in Blood by JDS/JSCC protocol.">
				keywords = <"Hgb A1c", "Glycohemogolobin", "Glycohaemogolobin", "GHb", "HA1c", "HbA1c", "Glycated hemoglobin", "Glycosylated hemoglobin", "Hb", "Haemoglobin", "Mass fraction", "Percent", "Point in time", "Random", "Blood", "WB", "Whole blood", "Quantitative", "QNT", "Quant", "Quan", "Japanese Diabetes Society/Japanese Society for Clinical Chemistry", "Tot", "Totl", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hgb_a1c_mfr_bld_pre_by_jds_jscc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hgb_a1c_mfr_bld_pre_by_jds_jscc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hemoglobin A1c/Hemoglobin.total in Blood by JDS/JSCC protocol">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/62388-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/62388-4">
			>
		>
	>
	adl_version = <"2.0.5">
