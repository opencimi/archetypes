(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/20405-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Urobilinogen [Mass/volume] in Urine by Test strip' concept">
				use = <"Use for Urobilinogen [Mass/volume] in Urine by Test strip.">
				keywords = <"UBG", "Urobilngn", "Urobili", "Mass concentration", "Level", "Point in time", "Random", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Dipstick", "Dip stick", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.urobilinogen_ur_stripmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"urobilinogen_ur_stripmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Urobilinogen [Mass/volume] in Urine by Test strip">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/20405-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/20405-7">
			>
		>
	>
	adl_version = <"2.0.5">
