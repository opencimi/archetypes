(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2873-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Gamma globulin [Mass/volume] in Cerebral spinal fluid by Electrophoresis' concept">
				use = <"Use for Gamma globulin [Mass/volume] in Cerebral spinal fluid by Electrophoresis.">
				keywords = <"GLB", "Globulins", "Glob", "Glob%", "Globul", "Gamma glob", "Protein gamma globulin", "Mass concentration", "Level", "Point in time", "Random", "Cerebral spinal fluid", "Spinal Fluid", "Cerebrospinal Fl", "Spinal Flu", "Spinal Fld", "Quantitative", "QNT", "Quant", "Quan", "Elph", "Elp", "Elect", "Electrophrs", "Electrophhrs", "Electr", "Elec", "Ep", "Electro", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.gamma_glob_csf_elphmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"gamma_glob_csf_elphmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Gamma globulin [Mass/volume] in Cerebral spinal fluid by Electrophoresis">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mg/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2873-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2873-8">
			>
		>
	>
	adl_version = <"2.0.5">
