(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/25161-1.html>">
			["tool"] = <"cimi-gen v0.0.1">
			["time"] = <"2015-08-05T22:26:55">
		>
		details = <
			["en"] = <
				language = <[ISO_639-1::en]>
				purpose = <"Archetype for CIMI 'Hippurate crystals [#/area] in Urine sediment by Microscopy high power field' concept">
				use = <"Use for Hippurate crystals [#/area] in Urine sediment by Microscopy high power field.">
				keywords = <"Hippurate Cry", "Hipp", "Hippuran", "Toluene metabolite", "Benzyl alcohol metabolite", "Hippuric acid", "HIP-REX", "Hippramine", "Hiprex", "Urex", "Urotractan", "Cryst", "Crys", "Crystal", "#/area", "Number areic", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Micro", "LM", "Micros", "Microscopic", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hippurate_cry_num_per_area_urns_hpf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hippurate_cry_num_per_area_urns_hpf">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/25161-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/25161-1">
			>
		>
	>
	adl_version = <"2.0.5">
