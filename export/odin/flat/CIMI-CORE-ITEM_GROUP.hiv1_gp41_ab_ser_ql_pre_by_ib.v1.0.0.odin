(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/9662-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'HIV 1 gp41 Ab [Presence] in Serum by Immunoblot (IB)' concept">
				use = <"Use for HIV 1 gp41 Ab [Presence] in Serum by Immunoblot (IB).">
				keywords = <"HIV1 gp41", "HIV type 1", "HIV type I", "AIDS", "Human immunodeficiency virus", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Western blot", "WB", "Immune blot", "Immunobl", "Blt", "WBLOT", "West blt", "West blot", "RIBA", "Immunoblot", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hiv1_gp41_ab_ser_ql_pre_by_ib.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hiv1_gp41_ab_ser_ql_pre_by_ib">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"HIV 1 gp41 Ab [Presence] in Serum by Immunoblot (IB)">
				>
				["id1.1.1.1.1.1"] = <
					text = <"HIV 1 gp41 Ab [Presence] in Serum by Immunoblot (IB)">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/9662-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/9662-8">
			>
		>
	>
	adl_version = <"2.0.5">
