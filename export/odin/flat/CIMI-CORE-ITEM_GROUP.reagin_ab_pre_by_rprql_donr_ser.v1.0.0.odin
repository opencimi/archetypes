(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/47360-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Reagin Ab [Presence] in Serum from donor by RPR' concept">
				use = <"Use for Reagin Ab [Presence] in Serum from donor by RPR.">
				keywords = <"Treponema", "Syphilis", "Neurosyphilis", "Arbitrary concentration", "Point in time", "Random", "Serum", "SR", "Donr", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Charcoal flocculation", "Rapid plasma reagin", "ABS", "Antibodies", "Autoantibody", "Antibody", "Autoantibodies", "Antby", "Aby", "Anti", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.reagin_ab_pre_by_rprql_donr_ser.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"reagin_ab_pre_by_rprql_donr_ser">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Reagin Ab [Presence] in Serum from donor by RPR">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Reagin Ab [Presence] in Serum from donor by RPR">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/47360-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/47360-3">
			>
		>
	>
	adl_version = <"2.0.5">
