(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/17395-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Oxymorphone [Mass/volume] in Urine by Confirmatory method' concept">
				use = <"Use for Oxymorphone [Mass/volume] in Urine by Confirmatory method.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.oxymorphone_ur_cfmmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"oxymorphone_ur_cfmmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Oxymorphone [Mass/volume] in Urine by Confirmatory method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/17395-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/17395-5">
			>
		>
	>
	adl_version = <"2.0.5">
