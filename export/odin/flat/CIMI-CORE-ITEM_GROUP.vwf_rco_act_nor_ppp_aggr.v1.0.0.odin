(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6014-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'von Willebrand factor (vWf) ristocetin cofactor actual/normal in Platelet poor plasma by Aggregation' concept">
				use = <"Use for von Willebrand factor (vWf) ristocetin cofactor actual/normal in Platelet poor plasma by Aggregation.">
				keywords = <"vWf:RCo", "Von willebrand factor activity", "vWf Activity", "vWf:RCo", "Risto", "AggRecetin", "Activ", "Movements", "Nor", "RlTm", "Point in time", "Random", "Platelet poor plasma", "Plas", "Quantitative", "QNT", "Quant", "Quan", "Aggregation", "Agg", "Aggreg", "Act/Nor", "Vonwillebrand", "Von will", "Control", "Fac", "Fact", "Cofact", "Actvty", "COAGULATION">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.vwf_rco_act_nor_ppp_aggr.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"vwf_rco_act_nor_ppp_aggr">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"von Willebrand factor (vWf) ristocetin cofactor actual/normal in Platelet poor plasma by Aggregation">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6014-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6014-5">
			>
		>
	>
	adl_version = <"2.0.5">
