(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2027-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Carbon dioxide, total [Moles/volume] in Venous blood' concept">
				use = <"Use for Carbon dioxide, total [Moles/volume] in Venous blood.">
				keywords = <"CO2", "Carbonic anhydride", "Substance concentration", "Level", "Point in time", "Random", "Blood - venous", "Bld ven", "Bld venous", "Blood venus", "Blood ven", "Venous", "Quantitative", "QNT", "Quant", "Quan", "Chemistry", "CO2 TOTAL", "cCO2", "tCO2", "ctCO2", "CO2CT">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.co2_bldvscnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"co2_bldvscnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2027-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2027-1">
			>
		>
	>
	adl_version = <"2.0.5">
