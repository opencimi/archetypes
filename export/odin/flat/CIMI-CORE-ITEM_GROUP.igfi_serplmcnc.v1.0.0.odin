(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2484-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Insulin-like growth factor-I [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Insulin-like growth factor-I [Mass/volume] in Serum or Plasma.">
				keywords = <"IGF-I", "IGF-1", "IGF1", "Somatomedin C", "IGF", "Insul", "Humulin", "HUM", "IH7", "Lente", "NPH", "Semilente", "Ultralente", "Sliding", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "FI", "Factor 1", "Fac", "Fact", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.igfi_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"igfi_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Insulin-like growth factor-I [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2484-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2484-4">
			>
		>
	>
	adl_version = <"2.0.5">
