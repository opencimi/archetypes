(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/16131-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Herpes simplex virus 2 DNA [Presence] in Unspecified specimen by Probe and target amplification method' concept">
				use = <"Use for Herpes simplex virus 2 DNA [Presence] in Unspecified specimen by Probe and target amplification method.">
				keywords = <"HSV2", "Herpes simplex virus type 2", "Herpes simplex virus type II", "Herp splx", "HSV", "Deoxyribonucleic acid", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "PCR", "Polymerase chain reaction", "Transcription mediated amplification", "NASBA", "Nucleic acid sequence based analysis", "SDA", "Strand Displacement Amplification", "LAT", "Ligation-activated transcription", "3SR SR", "3 Self-Sustaining Sequence Replication", "LCR", "Ligase chain reaction", "QBR", "Probe with target amplification", "NAAT", "TMA", "Amp Prb", "Probe with ampification", "DNA probe", "Amplified", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hsv2_dna_xxx_ql_pcr.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hsv2_dna_xxx_ql_pcr">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Herpes simplex virus 2 DNA [Presence] in Unspecified specimen by Probe and target amplification method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Herpes simplex virus 2 DNA [Presence] in Unspecified specimen by Probe and target amplification method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/16131-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/16131-5">
			>
		>
	>
	adl_version = <"2.0.5">
