(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/8220-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Opiates [Mass/volume] in Urine' concept">
				use = <"Use for Opiates [Mass/volume] in Urine.">
				keywords = <"Opi", "Opiate", "OP", "Heroin", "Mass concentration", "Level", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Quantitative", "QNT", "Quant", "Quan", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.opiates_urmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"opiates_urmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Opiates [Mass/volume] in Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/8220-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/8220-6">
			>
		>
	>
	adl_version = <"2.0.5">
