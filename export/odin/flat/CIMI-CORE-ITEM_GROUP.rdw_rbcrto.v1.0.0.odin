(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/30385-9.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Erythrocyte distribution width [Ratio]' concept">
				use = <"Use for Erythrocyte distribution width [Ratio].">
				keywords = <"RDW", "Erythrocyte morphology index", "RCMI", "Erythrocytes", "Red blood corpusles", "Red blood corpuscle", "Red blood cell", "Red cell", "Red cells", "Discocyte", "Erc", "Red blood cells", "Rto", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS", "RDW-CV">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.rdw_rbcrto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"rdw_rbcrto">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/30385-9">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/30385-9">
			>
		>
	>
	adl_version = <"2.0.5">
