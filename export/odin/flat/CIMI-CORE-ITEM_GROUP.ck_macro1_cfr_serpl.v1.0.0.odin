(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/26019-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Creatine Kinase.macromolecular type 1/Creatine kinase.total in Serum or Plasma' concept">
				use = <"Use for Creatine Kinase.macromolecular type 1/Creatine kinase.total in Serum or Plasma.">
				keywords = <"CK Macro1", "CK macro", "Creatine phosphokinase", "CPK", "Catalytic Fraction", "Percent", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Tot", "Totl", "I", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ck_macro1_cfr_serpl.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ck_macro1_cfr_serpl">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Creatine Kinase.macromolecular type 1/Creatine kinase.total in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"%">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/26019-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/26019-0">
			>
		>
	>
	adl_version = <"2.0.5">
