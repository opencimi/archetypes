(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/58445-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Manual differential comment [interpretation] in Blood Narrative' concept">
				use = <"Use for Manual differential comment [interpretation] in Blood Narrative.">
				keywords = <"Manual dif comment", "Remarks", "Interpretation", "Interp", "Impression", "Impressions", "Point in time", "Random", "Blood", "WB", "Whole blood", "Narrative", "Report", "Diff", "Differl", "Differn", "Com", "Comm", "Commt", "Comments", "cmnt", "cmmt", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.manual_dif_comment_bldimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"manual_dif_comment_bldimp">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/58445-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/58445-8">
			>
		>
	>
	adl_version = <"2.0.5">
