(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/13440-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Immunofixation [interpretation] for Urine' concept">
				use = <"Use for Immunofixation [interpretation] for Urine.">
				keywords = <"Interp", "Intrp", "Interpret", "Interpt", "Impression", "Impressions", "Point in time", "Random", "Ur", "UR", "Urn", "UA", "Nominal", "IFE", "Ifix", "Immunofixation electrophoresis", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.interpretation_ur_ifeimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"interpretation_ur_ifeimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["id1.1.1.1.1.1"] = <
					text = <"Immunofixation [interpretation] for Urine">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/13440-3">
			>
			["opencem"] = <
