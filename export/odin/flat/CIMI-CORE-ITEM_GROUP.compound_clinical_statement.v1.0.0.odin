(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		details = <
			["en"] = <
				...
				purpose = <"Top-level reference archetype for CIMI 'compound clinical statement' concept">
				use = <"Use as a specialisation precursor for other high-level reference archetypes.">
				keywords = <"compound", "clinical", "statement">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.compound_clinical_statement.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"compound_clinical_statement">
		release_version = <"1.0.0">
		version_status = <0>
		build_count = <0>
	>
	parent_archetype_id = <"CIMI-CORE-ITEM_GROUP.clinical_statement.v1">
	definition = <
			...
			["1"] = <
				...
				children = <
					...
					["4"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1">
						occurrences = <"0..*">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.clinical_statement.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
				>
