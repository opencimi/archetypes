(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/71694-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemoglobin [Entitic mass] in Reticulocytes by Automated count' concept">
				use = <"Use for Hemoglobin [Entitic mass] in Reticulocytes by Automated count.">
				keywords = <"Hgb", "Hb", "Haemoglobin", "Entitic mass", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "Auto", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS", "Reticulocyte hemoglobin content", "CHr">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hgb_retic_qn_pre_by_auto.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hgb_retic_qn_pre_by_auto">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hemoglobin [Entitic mass] in Reticulocytes by Automated count">
				>
				["at0.0.0.0.0.2"] = <
					text = <"pg">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/71694-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/71694-4">
			>
		>
	>
	adl_version = <"2.0.5">
