(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/74394-8.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Normoblasts [#/volume] in Cord blood' concept">
				use = <"Use for Normoblasts [#/volume] in Cord blood.">
				keywords = <"Erythroblast", "Normoblast", "Immature erythrocytes", "Erythroblasts", "#", "Number concentration", "Count/volume", "Count", "ABS", "CT", "absolute", "absolutes", "Cnt", "Point in time", "Random", "Cord (umbilical) blood", "Cord bld", "Cord blood", "Quantitative", "QNT", "Quant", "Quan", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.normoblasts_num_bldco.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"normoblasts_num_bldco">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/74394-8">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/74394-8">
			>
		>
	>
	adl_version = <"2.0.5">
