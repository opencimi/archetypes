(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/6864-3.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Hemoglobin S [Presence] in Blood by Solubility test' concept">
				use = <"Use for Hemoglobin S [Presence] in Blood by Solubility test.">
				keywords = <"Hgb S", "Sickle cell", "Sickle cells", "HbS", "Hb", "Haemoglobin", "Arbitrary concentration", "Point in time", "Random", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Soly", "S prime", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS", "Sickle cell screen", "Sicklequik", "Sickledex">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hgb_s_bld_ql_pre_by_soly.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hgb_s_bld_ql_pre_by_soly">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Hemoglobin S [Presence] in Blood by Solubility test">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Hemoglobin S [Presence] in Blood by Solubility test">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/6864-3">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/6864-3">
			>
		>
	>
	adl_version = <"2.0.5">
