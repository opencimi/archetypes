(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/48065-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Fibrin D-dimer FEU [Mass/volume] in Platelet poor plasma' concept">
				use = <"Use for Fibrin D-dimer FEU [Mass/volume] in Platelet poor plasma.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.d_dimer_feu_pppmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"d_dimer_feu_pppmcnc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/48065-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/48065-7">
			>
		>
	>
	adl_version = <"2.0.5">
