(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33393-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Coarse Granular Casts [#/area] in Urine sediment by Microscopy low power field' concept">
				use = <"Use for Coarse Granular Casts [#/area] in Urine sediment by Microscopy low power field.">
				keywords = <"Coarse Gran Casts", "Cast", "#/area", "Number areic", "Point in time", "Random", "UrnS", "Urine sediment", "UR", "Urn", "Quantitative", "QNT", "Quant", "Quan", "Micro", "LM", "Micros", "Microscopic", "URINALYSIS", "UA">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.coarse_gran_casts_num_per_area_urns_lpf.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"coarse_gran_casts_num_per_area_urns_lpf">
	...
	terminology = <
		...
		term_bindings = <
			["snomed-ct"] = <
				...
				["at0.0.0.0.0.2"] = <"http://snomed.org/id/415059001">
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33393-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33393-0">
			>
		>
	>
	adl_version = <"2.0.5">
