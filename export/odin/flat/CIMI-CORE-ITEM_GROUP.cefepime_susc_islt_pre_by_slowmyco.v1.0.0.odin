(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/50631-1.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Cefepime [Susceptibility] by Method for Slow-growing mycobacteria' concept">
				use = <"Use for Cefepime [Susceptibility] by Method for Slow-growing mycobacteria.">
				keywords = <"Maxipime", "Cefipime", "Susceptibility", "Susceptibilty", "Sus", "Suscept", "Susceptibilities", "AST", "Point in time", "Random", "Islt", "Isol", "SlowMyco", "Mycobacterial susceptibility", "Mycobacteria susceptibility", "TB", "Myco", "AFB", "Tuberculosis", "ANTIBIOTIC SUSCEPTIBILITIES">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.cefepime_susc_islt_pre_by_slowmyco.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"cefepime_susc_islt_pre_by_slowmyco">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Cefepime [Susceptibility] by Method for Slow-growing mycobacteria">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Cefepime [Susceptibility] by Method for Slow-growing mycobacteria">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/50631-1">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/50631-1">
			>
		>
	>
	adl_version = <"2.0.5">
