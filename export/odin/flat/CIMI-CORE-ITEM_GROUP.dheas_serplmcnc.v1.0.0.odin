(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2191-5.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Dehydroepiandrosterone sulfate (DHEA-S) [Mass/volume] in Serum or Plasma' concept">
				use = <"Use for Dehydroepiandrosterone sulfate (DHEA-S) [Mass/volume] in Serum or Plasma.">
				keywords = <"SO4-2", "Sulf", "SO4", "DHEA-S", "DHEAS", "DHEA-SO4", "Prasterone", "DHEA", "Mass concentration", "Level", "Point in time", "Random", "SerPl", "SerPlas", "SerP", "Serum", "SR", "Plasma", "Pl", "Plsm", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.dheas_serplmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"dheas_serplmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Dehydroepiandrosterone sulfate (DHEA-S) [Mass/volume] in Serum or Plasma">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ug/dL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2191-5">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2191-5">
			>
		>
	>
	adl_version = <"2.0.5">
