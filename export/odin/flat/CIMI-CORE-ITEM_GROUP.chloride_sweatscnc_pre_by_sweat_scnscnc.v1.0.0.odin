(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/56448-4.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Chloride [Moles/volume] in Sweat by Screen method' concept">
				use = <"Use for Chloride [Moles/volume] in Sweat by Screen method.">
				keywords = <"Cl-", "Cl", "Substance concentration", "Level", "Point in time", "Random", "SWT", "Quantitative", "QNT", "Quant", "Quan", "Scn", "Scr", "Scrn", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.chloride_sweatscnc_pre_by_sweat_scnscnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"chloride_sweatscnc_pre_by_sweat_scnscnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Chloride [Moles/volume] in Sweat by Screen method">
				>
				["at0.0.0.0.0.2"] = <
					text = <"mmol/L">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/56448-4">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/56448-4">
			>
		>
	>
	adl_version = <"2.0.5">
