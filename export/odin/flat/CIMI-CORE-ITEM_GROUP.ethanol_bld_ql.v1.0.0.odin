(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/5639-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Ethanol [Presence] in Blood' concept">
				use = <"Use for Ethanol [Presence] in Blood.">
				keywords = <"Alc", "Alcohol", "EtOH", "Ethyl alcohol", "Point in time", "Random", "Blood", "WB", "Whole blood", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "Drugs", "DRUG/TOXICOLOGY", "DRUG/TOXICOLOGY">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.ethanol_bld_ql.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"ethanol_bld_ql">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Ethanol [Presence] in Blood">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Ethanol [Presence] in Blood">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/5639-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/5639-0">
			>
		>
	>
	adl_version = <"2.0.5">
