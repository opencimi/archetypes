(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/1250-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Major crossmatch [interpretation]' concept">
				use = <"Use for Major crossmatch [interpretation].">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.maj_xm_serplimp.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"maj_xm_serplimp">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"CrossMatchCompatibility_VALUESET_CODE">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Major crossmatch [interpretation]">
				>
			>
		>
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/1250-0">
			>
			["opencem"] = <
				["at0.0.0.0.0.1"] = <"http://opencem.org/id/CrossMatchCompatibility_VALUESET_CODE">
			>
		>
	>
	adl_version = <"2.0.5">
