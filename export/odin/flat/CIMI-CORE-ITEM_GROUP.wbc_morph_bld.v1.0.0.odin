(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/11156-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Leukocyte morphology finding [Identifier] in Blood' concept">
				use = <"Use for Leukocyte morphology finding [Identifier] in Blood.">
				keywords = <"WBC morph", "Identity or presence", "Point in time", "Random", "Blood", "WB", "Whole blood", "Nominal", "White blood cell", "Leuc", "Leuk", "Lkcs", "Leukocytes", "White blood cells", "WBCs", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.wbc_morph_bld.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"wbc_morph_bld">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/11156-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/11156-7">
			>
		>
	>
	adl_version = <"2.0.5">
