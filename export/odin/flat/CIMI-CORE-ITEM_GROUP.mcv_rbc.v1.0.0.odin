(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/30428-7.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Erythrocyte mean corpuscular volume [Entitic volume]' concept">
				use = <"Use for Erythrocyte mean corpuscular volume [Entitic volume].">
				keywords = <"Vol", "MCV", "Erythrocytes", "Red blood corpusles", "Red blood corpuscle", "Red blood cell", "Red cell", "Red cells", "Discocyte", "Erc", "Red blood cells", "Entitic volume", "Point in time", "Random", "Quantitative", "QNT", "Quant", "Quan", "Average", "Avg", "HEMATOLOGY/CELL COUNTS", "HEMATOLOGY/CELL COUNTS">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.mcv_rbc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"mcv_rbc">
	...
	terminology = <
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/30428-7">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/30428-7">
			>
		>
	>
	adl_version = <"2.0.5">
