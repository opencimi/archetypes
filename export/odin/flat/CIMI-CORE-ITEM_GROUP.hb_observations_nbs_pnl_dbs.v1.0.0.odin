(P_AUTHORED_ARCHETYPE) <
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.hb_observations_nbs_pnl_dbs.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"hb_observations_nbs_pnl_dbs">
			...
			["1"] = <
				...
				children = <
					...
					["20"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.1">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.most_predominant_hb_dbs.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["21"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.2">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.2nd_most_predominant_hb_dbs.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["22"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.3">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.3rd_most_predominant_hb_dbs.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["23"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.4">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.4th_most_predominant_hb_dbs.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["24"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.5">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.5th_most_predominant_hb_dbs.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
					["25"] = (P_C_ARCHETYPE_ROOT) <
						...
						node_id = <"id0.1.1.1.6">
						occurrences = <"0..1">
						archetype_ref = <"CIMI-CORE-ITEM_GROUP.hb_pres_id_based_on_avail_contr_dbs.v1">
						is_deprecated = <False>
						is_frozen = <False>
					>
				>
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.1"] = <
					text = <"Hemoglobin observations newborn screening panel">
				>
				["id0.1.1.1.1"] = <
					text = <"Most predominant hemoglobin in Dried blood spot">
				>
				["id0.1.1.1.2"] = <
					text = <"Second most predominant hemoglobin in Dried blood spot">
				>
				["id0.1.1.1.3"] = <
					text = <"Third most predominant hemoglobin in Dried blood spot">
				>
				["id0.1.1.1.4"] = <
					text = <"Fourth most predominant hemoglobin in Dried blood spot">
				>
				["id0.1.1.1.5"] = <
					text = <"Fifth most predominant hemoglobin in Dried blood spot">
				>
				["id0.1.1.1.6"] = <
					text = <"Hemoglobins that can be presumptively identified based on available controls in Dried blood spot">
				>
				["id1.1.1.1.1"] = <
					text = <"Hemoglobin observations newborn screening panel">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1"] = <"http://loinc.org/id/64116-7">
				["at0.0.0.0.1"] = <"http://loinc.org/id/64116-7">
				["id0.1.1.1.1"] = <"http://loinc.org/id/64117-5">
				["id0.1.1.1.2"] = <"http://loinc.org/id/64118-3">
				["id0.1.1.1.3"] = <"http://loinc.org/id/64119-1">
				["id0.1.1.1.4"] = <"http://loinc.org/id/64120-9">
				["id0.1.1.1.5"] = <"http://loinc.org/id/64121-7">
				["id0.1.1.1.6"] = <"http://loinc.org/id/64122-5">
			>
		>
	>
	adl_version = <"2.0.5">
