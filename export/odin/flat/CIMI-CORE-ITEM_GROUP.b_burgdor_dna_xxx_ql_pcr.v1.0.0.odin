(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/4991-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Borrelia burgdorferi DNA [Presence] in Unspecified specimen by Probe and target amplification method' concept">
				use = <"Use for Borrelia burgdorferi DNA [Presence] in Unspecified specimen by Probe and target amplification method.">
				keywords = <"Deoxyribonucleic acid", "B burgdor", "B burg", "B burgdorferi", "Lymes", "Burgdorf", "Lyme", "Bb", "Lyme disease", "Arbitrary concentration", "Point in time", "Random", "Misc", "Miscellaneous", "Unspecified", "Other", "Ql", "Ordinal", "QL", "Qualitative", "Qual", "Screen", "PCR", "Polymerase chain reaction", "Transcription mediated amplification", "NASBA", "Nucleic acid sequence based analysis", "SDA", "Strand Displacement Amplification", "LAT", "Ligation-activated transcription", "3SR SR", "3 Self-Sustaining Sequence Replication", "LCR", "Ligase chain reaction", "QBR", "Probe with target amplification", "NAAT", "TMA", "Amp Prb", "Probe with ampification", "DNA probe", "Amplified", "Microbiology">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.b_burgdor_dna_xxx_ql_pcr.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"b_burgdor_dna_xxx_ql_pcr">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Borrelia burgdorferi DNA [Presence] in Unspecified specimen by Probe and target amplification method">
				>
				["id1.1.1.1.1.1"] = <
					text = <"Borrelia burgdorferi DNA [Presence] in Unspecified specimen by Probe and target amplification method">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/4991-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/4991-6">
			>
		>
	>
	adl_version = <"2.0.5">
