(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/33917-6.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Nornicotine [Mass/volume] in Urine' concept">
				use = <"Use for Nornicotine [Mass/volume] in Urine.">
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.nornicotine_urmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"nornicotine_urmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Nornicotine [Mass/volume] in Urine">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/33917-6">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/33917-6">
			>
		>
	>
	adl_version = <"2.0.5">
