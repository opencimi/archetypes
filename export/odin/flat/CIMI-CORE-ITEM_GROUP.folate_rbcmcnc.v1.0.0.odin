(P_AUTHORED_ARCHETYPE) <
	...
	description = <
		...
		>
		conversion_details = <
			["source_model"] = <"<http://s.details.loinc.org/LOINC/2283-0.html>">
		...
		details = <
			["en"] = <
				...
				purpose = <"Archetype for CIMI 'Folate [Mass/volume] in Red Blood Cells' concept">
				use = <"Use for Folate [Mass/volume] in Red Blood Cells.">
				keywords = <"Vit M", "Pteroylglutamate", "Folat", "Folic acid", "Vitamin M", "Pteroylglutamic acid", "Mass concentration", "Level", "Point in time", "Random", "Erythrocytes", "Red blood corpusles", "Red blood cells", "Quantitative", "QNT", "Quant", "Quan", "Chemistry">
			>
		>
	...
	archetype_id = <
		physical_id = <"CIMI-CORE-ITEM_GROUP.folate_rbcmcnc.v1.0.0">
		rm_publisher = <"CIMI">
		rm_package = <"CORE">
		rm_class = <"ITEM_GROUP">
		concept_id = <"folate_rbcmcnc">
	...
	terminology = <
		...
		term_definitions = <
			["en"] = <
				...
				>
				["at0.0.0.0.0.1"] = <
					text = <"Folate [Mass/volume] in Red Blood Cells">
				>
				["at0.0.0.0.0.2"] = <
					text = <"ng/mL">
				>
		...
		term_bindings = <
			...
			>
			["loinc"] = <
				["id1.1.1.1.1.1"] = <"http://loinc.org/id/2283-0">
				["at0.0.0.0.0.1"] = <"http://loinc.org/id/2283-0">
			>
		>
	>
	adl_version = <"2.0.5">
